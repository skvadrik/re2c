...
\setstretch{0.8}
    ...
    \Fn {$\underline{\retonfa(e, q_f)} \smallskip$} {
        ...
        \BlankLine
        \ElseIf {$e = (0, \emptyset, e_1 \mid e_2)$} {
            $(\Sigma, Q_2, M_2, \Delta_2, q_2, q_f) = \retonfa (e_2, q_f)$ \;
        ...
        \BlankLine
        \ElseIf {$e = (0, \emptyset, e_1^{1,\infty})$} {
        ...
        \BlankLine
        \lElseIf {$e = (0, \emptyset, e_1^{1,1})$} {
            \Return $\retonfa (e_1, q_f)$
        }
        \BlankLine
        \ElseIf {$e = (0, \emptyset, e_1^{1,m}) \mid_{1 < m < \infty}$} {
