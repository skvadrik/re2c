...
yy13 State{..} _n =
    yyfnbin State{..} $ _n * 2 + (peek_digit _str _cur 48)
...
yy16 State{..} _n =
    yyfnoct State{..} $ _n * 8 + (peek_digit _str _cur 48)
...
yy19 State{..} _n =
    yyfndec State{..} $ _n * 10 + (peek_digit _str _cur 48)
...
yy22 State{..} _n =
    yyfnhex State{..} $ _n * 16 + (peek_digit _str _cur 48)

yy23 :: State -> Int -> Maybe Int
yy23 State{..} _n =
    yyfnhex State{..} $ _n * 16 + (peek_digit _str _cur 55)

yy24 :: State -> Int -> Maybe Int
yy24 State{..} _n =
    yyfnhex State{..} $ _n * 16 + (peek_digit _str _cur 87)
