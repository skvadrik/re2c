...
#23 "haskell/eof/01_sentinel.re"
    _cnt
#38 "haskell/eof/01_sentinel.hs"

yy2 :: State -> Int -> Int
yy2 State{..} _cnt =
#22 "haskell/eof/01_sentinel.re"
    (-1)
#44 "haskell/eof/01_sentinel.hs"
...
#24 "haskell/eof/01_sentinel.re"
    lexer State{..} (_cnt + 1)
#76 "haskell/eof/01_sentinel.hs"

lexer :: State -> Int -> Int
lexer State{..} _cnt =
    yy0 State{..} _cnt

#26 "haskell/eof/01_sentinel.re"
