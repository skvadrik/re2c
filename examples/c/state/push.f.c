...
yy3:
	++in->cur;
yy4:
#line 66 "c/state/push.f.re"
	{ return BAD_PACKET; }
#line 114 "c/state/push.f.c"
yy5:
	in->mar = ++in->cur;
yyFillLabel1:
	yych = *in->cur;
...
yy6:
	++in->cur;
#line 68 "c/state/push.f.re"
	{ *recv = *recv + 1; goto loop; }
#line 158 "c/state/push.f.c"
yy8:
	++in->cur;
yyFillLabel2:
	yych = *in->cur;
...
yy10:
	...
	goto yy4;
yyeof1:
#line 67 "c/state/push.f.re"
	{ return END; }
#line 204 "c/state/push.f.c"
#line 69 "c/state/push.f.re"
