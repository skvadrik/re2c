...
#line 71 "c/state/push.f--lang(c).c"
...
#line 67 "c/state/push.f--lang(c).re"
	{ return BAD_PACKET; }
#line 115 "c/state/push.f--lang(c).c"
yy5:
	in->mar = ++in->cur;
yyFillLabel1:
	yych = *in->cur;
...
#line 159 "c/state/push.f--lang(c).c"
yy8:
	++in->cur;
yyFillLabel2:
	yych = *in->cur;
...
#line 68 "c/state/push.f--lang(c).re"
	{ return END; }
#line 205 "c/state/push.f--lang(c).c"
#line 70 "c/state/push.f--lang(c).re"
