...
#line 16 "c/eof/05_generic_api_eof_rule.c"
{
	char yych;
	yych = cur < lim ? *cur : 0;
	switch (yych) {
...
yy2:
	++cur;
yy3:
#line 24 "c/eof/05_generic_api_eof_rule.re"
	{ return -1; }
#line 32 "c/eof/05_generic_api_eof_rule.c"
yy4:
	++cur;
	yych = cur < lim ? *cur : 0;
	switch (yych) {
...
#line 27 "c/eof/05_generic_api_eof_rule.re"
	{ goto loop; }
#line 43 "c/eof/05_generic_api_eof_rule.c"
yy7:
	++cur;
	mar = cur;
	yych = cur < lim ? *cur : 0;
...
#line 26 "c/eof/05_generic_api_eof_rule.re"
	{ ++count; goto loop; }
#line 65 "c/eof/05_generic_api_eof_rule.c"
yy12:
	++cur;
	yych = cur < lim ? *cur : 0;
	if (yych <= 0x00) {
