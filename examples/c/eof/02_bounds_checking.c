...
#line 19 "c/eof/02_bounds_checking.c"
{
	char yych;
...
#line 34 "c/eof/02_bounds_checking.c"
yy4:
	++YYCURSOR;
#line 19 "c/eof/02_bounds_checking.re"
	{ return -1; }
...
#line 22 "c/eof/02_bounds_checking.re"
	{ goto loop; }
#line 51 "c/eof/02_bounds_checking.c"
yy9:
	++YYCURSOR;
	if (YYLIMIT <= YYCURSOR) return -1;
	yych = *YYCURSOR;
...
#line 21 "c/eof/02_bounds_checking.re"
	{ ++count; goto loop; }
#line 65 "c/eof/02_bounds_checking.c"
yy13:
	++YYCURSOR;
	if (YYLIMIT <= YYCURSOR) return -1;
	yych = *YYCURSOR;
