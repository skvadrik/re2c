...
#line 17 "c/eof/04_generic_api_sentinel.--lang(c).c"
{
	char yych;
	yych = cur < lim ? *cur : 0;
	switch (yych) {
...
#line 23 "c/eof/04_generic_api_sentinel.--lang(c).re"
	{ return count; }
#line 56 "c/eof/04_generic_api_sentinel.--lang(c).c"
yy4:
	++cur;
#line 22 "c/eof/04_generic_api_sentinel.--lang(c).re"
	{ return -1; }
#line 61 "c/eof/04_generic_api_sentinel.--lang(c).c"
yy6:
	++cur;
	yych = cur < lim ? *cur : 0;
	switch (yych) {
...
yy8:
#line 25 "c/eof/04_generic_api_sentinel.--lang(c).re"
	{ goto loop; }
#line 72 "c/eof/04_generic_api_sentinel.--lang(c).c"
yy9:
	++cur;
	yych = cur < lim ? *cur : 0;
	switch (yych) {
...
#line 24 "c/eof/04_generic_api_sentinel.--lang(c).re"
	{ ++count; goto loop; }
#line 108 "c/eof/04_generic_api_sentinel.--lang(c).c"
}
#line 27 "c/eof/04_generic_api_sentinel.--lang(c).re"
