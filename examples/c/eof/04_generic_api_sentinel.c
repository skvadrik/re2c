...
#line 16 "c/eof/04_generic_api_sentinel.c"
{
	char yych;
	yych = cur < lim ? *cur : 0;
	switch (yych) {
...
#line 22 "c/eof/04_generic_api_sentinel.re"
	{ return count; }
#line 55 "c/eof/04_generic_api_sentinel.c"
yy4:
	++cur;
#line 21 "c/eof/04_generic_api_sentinel.re"
	{ return -1; }
#line 60 "c/eof/04_generic_api_sentinel.c"
yy6:
	++cur;
	yych = cur < lim ? *cur : 0;
	switch (yych) {
...
#line 24 "c/eof/04_generic_api_sentinel.re"
	{ goto loop; }
#line 71 "c/eof/04_generic_api_sentinel.c"
yy9:
	++cur;
	yych = cur < lim ? *cur : 0;
	switch (yych) {
...
#line 23 "c/eof/04_generic_api_sentinel.re"
	{ ++count; goto loop; }
#line 107 "c/eof/04_generic_api_sentinel.c"
}
