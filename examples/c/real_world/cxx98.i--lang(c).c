...
c/real_world/cxx98.i--lang(c).re:152:14: warning: rule matches empty string [-Wmatch-empty-string]
c/real_world/cxx98.i--lang(c).re:158:14: warning: rule matches empty string [-Wmatch-empty-string]
c/real_world/cxx98.i--lang(c).re:163:14: warning: rule matches empty string [-Wmatch-empty-string]
c/real_world/cxx98.i--lang(c).re:349:24: warning: rule matches empty string [-Wmatch-empty-string]
