/* Generated by re2c */
#line 1 "c/fill/01_fill.--lang(c).re"
// re2c $INPUT -o $OUTPUT 
#include <assert.h>
#include <stdio.h>
#include <string.h>
...
#line 51 "c/fill/01_fill.--lang(c).c"
{
	char yych;
yyFillLabel0:
	yych = *in->cur;
...
yy2:
	++in->cur;
yy3:
#line 56 "c/fill/01_fill.--lang(c).re"
	{ return -1; }
#line 71 "c/fill/01_fill.--lang(c).c"
yy4:
	++in->cur;
yyFillLabel1:
	yych = *in->cur;
...
yy6:
#line 59 "c/fill/01_fill.--lang(c).re"
	{ goto loop; }
#line 87 "c/fill/01_fill.--lang(c).c"
yy7:
	in->mar = ++in->cur;
yyFillLabel2:
	yych = *in->cur;
...
yy10:
	++in->cur;
#line 58 "c/fill/01_fill.--lang(c).re"
	{ ++count; goto loop; }
#line 116 "c/fill/01_fill.--lang(c).c"
yy12:
	++in->cur;
yyFillLabel4:
	yych = *in->cur;
...
yy13:
	...
	goto yy3;
yyeof1:
#line 57 "c/fill/01_fill.--lang(c).re"
	{ return count; }
#line 135 "c/fill/01_fill.--lang(c).c"
}
#line 61 "c/fill/01_fill.--lang(c).re"
