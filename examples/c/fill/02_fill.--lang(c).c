/* Generated by re2c */
#line 1 "c/fill/02_fill.--lang(c).re"
// re2c $INPUT -o $OUTPUT 
#include <assert.h>
#include <stdio.h>
#include <string.h>
...
#line 56 "c/fill/02_fill.--lang(c).c"
{
	char yych;
...
yy2:
	++in->cur;
#line 60 "c/fill/02_fill.--lang(c).re"
	{ return (YYMAXFILL == in->lim - in->tok) ? count : -1; }
#line 71 "c/fill/02_fill.--lang(c).c"
yy4:
	++in->cur;
#line 59 "c/fill/02_fill.--lang(c).re"
	{ return -1; }
#line 76 "c/fill/02_fill.--lang(c).c"
yy6:
	++in->cur;
	if (in->lim <= in->cur) if (fill(in, 1) != 0) return -1;
	yych = *in->cur;
...
yy8:
#line 62 "c/fill/02_fill.--lang(c).re"
	{ goto loop; }
#line 88 "c/fill/02_fill.--lang(c).c"
yy9:
	++in->cur;
	if (in->lim <= in->cur) if (fill(in, 1) != 0) return -1;
	yych = *in->cur;
...
yy11:
	++in->cur;
#line 61 "c/fill/02_fill.--lang(c).re"
	{ ++count; goto loop; }
#line 102 "c/fill/02_fill.--lang(c).c"
yy13:
	++in->cur;
	if (in->lim <= in->cur) if (fill(in, 1) != 0) return -1;
	yych = *in->cur;
...
#line 64 "c/fill/02_fill.--lang(c).re"
