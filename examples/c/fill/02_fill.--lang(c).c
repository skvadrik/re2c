...
#line 55 "c/fill/02_fill.--lang(c).c"
{
	char yych;
...
#line 70 "c/fill/02_fill.--lang(c).c"
yy4:
	++in->cur;
#line 58 "c/fill/02_fill.--lang(c).re"
	{ return -1; }
#line 75 "c/fill/02_fill.--lang(c).c"
yy6:
	++in->cur;
	if (in->lim <= in->cur) if (fill(in, 1) != 0) return -1;
	yych = *in->cur;
...
#line 61 "c/fill/02_fill.--lang(c).re"
	{ goto loop; }
#line 87 "c/fill/02_fill.--lang(c).c"
yy9:
	++in->cur;
	if (in->lim <= in->cur) if (fill(in, 1) != 0) return -1;
	yych = *in->cur;
...
#line 60 "c/fill/02_fill.--lang(c).re"
	{ ++count; goto loop; }
#line 101 "c/fill/02_fill.--lang(c).c"
yy13:
	++in->cur;
	if (in->lim <= in->cur) if (fill(in, 1) != 0) return -1;
	yych = *in->cur;
...
#line 63 "c/fill/02_fill.--lang(c).re"
