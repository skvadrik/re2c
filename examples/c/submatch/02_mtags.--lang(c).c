...
#line 43 "c/submatch/02_mtags.--lang(c).c"
{
	char yych;
...
yy2:
	++YYCURSOR;
yy3:
#line 49 "c/submatch/02_mtags.--lang(c).re"
	{ return false; }
#line 84 "c/submatch/02_mtags.--lang(c).c"
yy4:
	yyaccept = 0;
...
yy6:
	x = yyt1;
	y = yyt3;
#line 44 "c/submatch/02_mtags.--lang(c).re"
	{
        words.clear();
        unfold(tree, x, y, words);
        return true;
    }
#line 166 "c/submatch/02_mtags.--lang(c).c"
yy7:
	yych = *++YYCURSOR;
	switch (yych) {
	case ';':
