/* Generated by re2c */
#line 1 "c/submatch/02_mtags.--lang(c).re"
// re2c $INPUT -o $OUTPUT 
#include <assert.h>
#include <vector>
#include <string>
...
#line 44 "c/submatch/02_mtags.--lang(c).c"
{
	char yych;
...
yy2:
	++YYCURSOR;
yy3:
#line 50 "c/submatch/02_mtags.--lang(c).re"
	{ return false; }
#line 85 "c/submatch/02_mtags.--lang(c).c"
yy4:
	yyaccept = 0;
...
yy6:
	x = yyt1;
	y = yyt3;
#line 45 "c/submatch/02_mtags.--lang(c).re"
	{
        words.clear();
        unfold(tree, x, y, words);
        return true;
    }
#line 167 "c/submatch/02_mtags.--lang(c).c"
yy7:
	yych = *++YYCURSOR;
	switch (yych) {
	case ';':
...
#line 51 "c/submatch/02_mtags.--lang(c).re"
