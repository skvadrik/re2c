/* Generated by re2c */
#line 1 "c/submatch/03_posix.--lang(c).re"
#include <assert.h>
#include <stdint.h>
...
#line 26 "c/submatch/03_posix.--lang(c).c"
{
	char yych;
	yych = *YYCURSOR;
	switch (yych) {
...
yy2:
	++YYCURSOR;
yy3:
#line 37 "c/submatch/03_posix.--lang(c).re"
	{ return ERROR; }
#line 56 "c/submatch/03_posix.--lang(c).c"
yy4:
...
#line 30 "c/submatch/03_posix.--lang(c).re"
	{
        assert(yynmatch == 5);
...
#line 422 "c/submatch/03_posix.--lang(c).c"
yy31:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0x00:	goto yy29;
...
#line 38 "c/submatch/03_posix.--lang(c).re"
