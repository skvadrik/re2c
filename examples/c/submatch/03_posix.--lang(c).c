...
#line 27 "c/submatch/03_posix.--lang(c).c"
{
	char yych;
	yych = *YYCURSOR;
	switch (yych) {
...
#line 38 "c/submatch/03_posix.--lang(c).re"
	{ return ERROR; }
#line 57 "c/submatch/03_posix.--lang(c).c"
yy4:
...
#line 31 "c/submatch/03_posix.--lang(c).re"
	{
        assert(yynmatch == 5);
...
#line 423 "c/submatch/03_posix.--lang(c).c"
yy31:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0x00:	goto yy29;
...
#line 39 "c/submatch/03_posix.--lang(c).re"
