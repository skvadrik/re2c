...
static int fill(Input *in)
{
    ...
    if (in->yyt1) in->yyt1 -= free;if (in->yyt2) in->yyt2 -= free;if (in->yyt3) in->yyt3 -= free;if (in->yyt4) in->yyt4 -= free;
...
static void init(Input *in, FILE *file)
{
    ...
    in->yyt1 = in->lim;in->yyt2 = in->lim;in->yyt3 = in->lim;in->yyt4 = in->lim;
    in->eof = 0;
    fill(in);
}
...
yy2:
	++in->cur;
yy3:
#line 96 "c/submatch/01_stags.re"
	{ return false; }
#line 111 "c/submatch/01_stags.c"
yy4:
	in->mar = ++in->cur;
yyFillLabel1:
	yych = *in->cur;
...
yy29:
	...
	o3 = in->yyt3;
	o4 = in->yyt4;
#line 88 "c/submatch/01_stags.re"
	{
...
#line 616 "c/submatch/01_stags.c"
yy31:
	++in->cur;
yyFillLabel25:
	yych = *in->cur;
...
yy32:
#line 95 "c/submatch/01_stags.re"
	{ return true; }
#line 638 "c/submatch/01_stags.c"
}
#line 97 "c/submatch/01_stags.re"
