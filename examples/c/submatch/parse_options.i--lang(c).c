...
c/submatch/parse_options.i--lang(c).re:71:12: warning: rule matches empty string [-Wmatch-empty-string]
c/submatch/parse_options.i--lang(c).re:83:35: warning: tag 'k' has 2nd degree of nondeterminism [-Wnondeterministic-tags]
c/submatch/parse_options.i--lang(c).re:83:35: warning: tag 'v' has 2nd degree of nondeterminism [-Wnondeterministic-tags]
