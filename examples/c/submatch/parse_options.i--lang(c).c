...
c/submatch/parse_options.i--lang(c).re:70:12: warning: rule matches empty string [-Wmatch-empty-string]
c/submatch/parse_options.i--lang(c).re:82:35: warning: tag 'k' has 2nd degree of nondeterminism [-Wnondeterministic-tags]
c/submatch/parse_options.i--lang(c).re:82:35: warning: tag 'v' has 2nd degree of nondeterminism [-Wnondeterministic-tags]
