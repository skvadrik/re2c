...
yy2:
	++YYCURSOR;
yy3:
#line 49 "submatch/02_mtags.re"
	{ return false; }
#line 84 "submatch/02_mtags.c"
yy4:
	yyaccept = 0;
...
yy6:
	x = yyt1;
	y = yyt3;
#line 44 "submatch/02_mtags.re"
	{
        words.clear();
        unfold(tree, x, y, words);
        return true;
    }
#line 166 "submatch/02_mtags.c"
yy7:
	yych = *++YYCURSOR;
	switch (yych) {
	case ';':
