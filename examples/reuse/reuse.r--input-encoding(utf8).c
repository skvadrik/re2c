/* Generated by re2c */
#line 1 "reuse/reuse.r--input-encoding(utf8).re"
#include <assert.h>
#include <stdint.h>

#line 9 "reuse/reuse.r--input-encoding(utf8).re"
...
#line 14 "reuse/reuse.r--input-encoding(utf8).c"
{
	uint8_t yych;
	yych = *YYCURSOR;
	switch (yych) {
...
yy2:
	++YYCURSOR;
yy3:
#line 8 "reuse/reuse.r--input-encoding(utf8).re"
	{ return 1; }
#line 27 "reuse/reuse.r--input-encoding(utf8).c"
yy4:
...
yy22:
	++YYCURSOR;
#line 7 "reuse/reuse.r--input-encoding(utf8).re"
	{ return 0; }
#line 137 "reuse/reuse.r--input-encoding(utf8).c"
}
#line 17 "reuse/reuse.r--input-encoding(utf8).re"
...
#line 147 "reuse/reuse.r--input-encoding(utf8).c"
{
	uint32_t yych;
	yych = *YYCURSOR;
...
#line 8 "reuse/reuse.r--input-encoding(utf8).re"
	{ return 1; }
#line 156 "reuse/reuse.r--input-encoding(utf8).c"
yy28:
	yych = *(YYMARKER = ++YYCURSOR);
	if (yych != 'x') goto yy27;
	yych = *++YYCURSOR;
...
#line 7 "reuse/reuse.r--input-encoding(utf8).re"
	{ return 0; }
#line 191 "reuse/reuse.r--input-encoding(utf8).c"
}
#line 27 "reuse/reuse.r--input-encoding(utf8).re"
