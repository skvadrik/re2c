...
//line "go/reuse/reuse.r--input-encoding(utf8)--lang(go).re":1
...
//line "go/reuse/reuse.r--input-encoding(utf8)--lang(go).go":15
{
	var yych uint8
	yych = str[cursor]
	switch (yych) {
...
//line "go/reuse/reuse.r--input-encoding(utf8)--lang(go).re":22
...
//line "go/reuse/reuse.r--input-encoding(utf8)--lang(go).go":201
{
	var yych uint32
	yych = str[cursor]
	if (yych == 0x00002200) {
