...
func lex(in *Input) []int {
	...
	// different from tag variables autogenerated with , as
...
//line "go/submatch/01_stags.go":93
{
	var yych byte
yyFillLabel0:
...
yy2:
	in.cursor += 1
yy3:
//line "go/submatch/01_stags.re":114
	{ return nil }
//line "go/submatch/01_stags.go":137
yy4:
	in.cursor += 1
	in.marker = in.cursor
yyFillLabel1:
...
yy29:
	...
	o3 = in.yyt3
	o4 = in.yyt4
//line "go/submatch/01_stags.re":106
	{
...
//line "go/submatch/01_stags.go":881
yy31:
	in.cursor += 1
yyFillLabel25:
	yych = in.data[in.cursor]
...
yy32:
//line "go/submatch/01_stags.re":113
	{ return ips }
//line "go/submatch/01_stags.go":912
}
//line "go/submatch/01_stags.re":115
