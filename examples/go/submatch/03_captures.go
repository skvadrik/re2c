...
//line "go/submatch/03_captures.go":23
	var yyt1 int
	var yyt2 int
	var yyt3 int
	var yyt4 int
	var yyt5 int
//line "go/submatch/03_captures.re":19


	
//line "go/submatch/03_captures.go":33
{
	var yych byte
...
yy1:
	yycursor += 1
yy2:
//line "go/submatch/03_captures.re":38
	{ return nil }
//line "go/submatch/03_captures.go":49
yy3:
	yycursor += 1
	yymarker = yycursor
	yych = yyinput[yycursor]
...
yy8:
	...
	yytr1 = yyt2
	yytr1 -= 1
//line "go/submatch/03_captures.re":29
	{
...
//line "go/submatch/03_captures.go":125
yy9:
	yycursor += 1
	yych = yyinput[yycursor]
	if (yych <= 0x00) {
