...
//line "go/submatch/02_mtags.--lang(go).re":1
...
//line "go/submatch/02_mtags.--lang(go).go":65
{
	var yych byte
	yych = str[cursor]
	switch (yych) {
...
yy2:
	...
	x = yyt1
	y = yyt2
//line "go/submatch/02_mtags.--lang(go).re":73
	{ return unwind(trie, x, y, str) }
//line "go/submatch/02_mtags.--lang(go).go":136
yy4:
	cursor += 1
yy5:
//line "go/submatch/02_mtags.--lang(go).re":74
	{ return nil }
//line "go/submatch/02_mtags.--lang(go).go":142
yy6:
	cursor += 1
	marker = cursor
	yych = str[cursor]
...
//line "go/submatch/02_mtags.--lang(go).re":75
