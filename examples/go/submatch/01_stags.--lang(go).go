...
//line "go/submatch/01_stags.--lang(go).re":1
...
//line "go/submatch/01_stags.--lang(go).go":30
{
	var yych byte
	yych = str[cursor]
	switch (yych) {
...
yy2:
	cursor += 1
yy3:
//line "go/submatch/01_stags.--lang(go).re":44
	{ return 0, eBadIP }
//line "go/submatch/01_stags.--lang(go).go":67
yy4:
	cursor += 1
	marker = cursor
	yych = str[cursor]
...
yy29:
	...
	o3 = yyt3
	o4 = yyt4
//line "go/submatch/01_stags.--lang(go).re":38
	{
...
//line "go/submatch/01_stags.--lang(go).go":664
yy31:
	cursor += 1
	yych = str[cursor]
	switch (yych) {
...
//line "go/submatch/01_stags.--lang(go).re":45
