...
//line "go/fill/02_fill.--lang(go).re":1
...
//line "go/fill/02_fill.--lang(go).go":73
{
	var yych byte
...
yy2:
	in.cursor += 1
//line "go/fill/02_fill.--lang(go).re":78
	{ return count }
//line "go/fill/02_fill.--lang(go).go":94
yy4:
	in.cursor += 1
//line "go/fill/02_fill.--lang(go).re":77
	{ return -1 }
//line "go/fill/02_fill.--lang(go).go":99
yy6:
	in.cursor += 1
	if (in.limit-in.cursor < 1) {
		if r := fill(in, 1); r != 0 { return r }
...
yy8:
//line "go/fill/02_fill.--lang(go).re":80
	{ goto loop }
//line "go/fill/02_fill.--lang(go).go":115
yy9:
	in.cursor += 1
	if (in.limit-in.cursor < 1) {
		if r := fill(in, 1); r != 0 { return r }
...
yy11:
	in.cursor += 1
//line "go/fill/02_fill.--lang(go).re":79
	{ count += 1; goto loop }
//line "go/fill/02_fill.--lang(go).go":134
yy13:
	in.cursor += 1
	if (in.limit-in.cursor < 1) {
		if r := fill(in, 1); r != 0 { return r }
...
//line "go/fill/02_fill.--lang(go).re":81
