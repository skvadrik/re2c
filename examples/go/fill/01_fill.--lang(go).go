...
//line "go/fill/01_fill.--lang(go).re":1
...
//line "go/fill/01_fill.--lang(go).go":66
{
	var yych byte
yyFillLabel0:
...
yy2:
	in.cursor += 1
yy3:
//line "go/fill/01_fill.--lang(go).re":72
	{ return -1 }
//line "go/fill/01_fill.--lang(go).go":90
yy4:
	in.cursor += 1
yyFillLabel1:
	yych = in.data[in.cursor]
...
yy6:
//line "go/fill/01_fill.--lang(go).re":75
	{ goto loop }
//line "go/fill/01_fill.--lang(go).go":109
yy7:
	in.cursor += 1
	in.marker = in.cursor
yyFillLabel2:
...
yy10:
	in.cursor += 1
//line "go/fill/01_fill.--lang(go).re":74
	{ count += 1; goto loop }
//line "go/fill/01_fill.--lang(go).go":147
yy12:
	in.cursor += 1
yyFillLabel4:
	yych = in.data[in.cursor]
...
yy13:
	...
	goto yy3
yyeof1:
//line "go/fill/01_fill.--lang(go).re":73
	{ return count }
//line "go/fill/01_fill.--lang(go).go":168
}
//line "go/fill/01_fill.--lang(go).re":76
