...
//line "v/submatch/03_captures.v":25
	mut yyt1 := 0
	mut yyt2 := 0
	mut yyt3 := 0
	mut yyt4 := 0
	mut yyt5 := 0
//line "v/submatch/03_captures.re":21


    
//line "v/submatch/03_captures.v":35
    mut yych := 0
...
yy1:
    yycursor += 1
yy2:
//line "v/submatch/03_captures.re":37
    return none
//line "v/submatch/03_captures.v":50
yy3:
    yycursor += 1
    yymarker = yycursor
    yych = yyinput[yycursor]
...
yy8:
    ...
    yytr1 = yyt2
    yytr1-= 1
//line "v/submatch/03_captures.re":29
...
//line "v/submatch/03_captures.v":119
yy9:
    yycursor += 1
    yych = yyinput[yycursor]
    if yych <= 0x00 {
