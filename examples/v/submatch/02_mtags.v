...
//line "v/submatch/02_mtags.v":66
mut t1 := tag_none
mut t2 := tag_none
//line "v/submatch/02_mtags.re":62

    
//line "v/submatch/02_mtags.v":72
mut t3 := mtag_root
mut t4 := mtag_root
//line "v/submatch/02_mtags.re":63


    // Intermediate tag variables used by the lexer (must be autogenerated).
    
//line "v/submatch/02_mtags.v":80
mut yyt1 := tag_none
mut yyt2 := tag_none
//line "v/submatch/02_mtags.re":66

    
//line "v/submatch/02_mtags.v":86
mut yytm3 := mtag_root
mut yytm4 := mtag_root
//line "v/submatch/02_mtags.re":67


    
//line "v/submatch/02_mtags.v":93
    mut yych := u8(0)
...
//line "v/submatch/02_mtags.re":83
    return none
//line "v/submatch/02_mtags.v":108
yy3:
    yycursor += 1
    yymarker = yycursor
    yych = yyinput[yycursor]
...
//line "v/submatch/02_mtags.v":140
yy5:
    yycursor += 1
    yych = yyinput[yycursor]
    match yych {
