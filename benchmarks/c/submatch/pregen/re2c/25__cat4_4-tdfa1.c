...
#line 30 "gen/re2c/25__cat4_4-tdfa1.c"
char *yyt1;
char *yyt10;
char *yyt11;
char *yyt12;
...
#line 93 "gen/re2c/25__cat4_4-tdfa1.c"
...
#line 104 "gen/re2c/25__cat4_4-tdfa1.c"
...
#line 148 "gen/re2c/25__cat4_4-tdfa1.c"
#define YYMAXFILL 16
...
#line 167 "gen/re2c/25__cat4_4-tdfa1.c"
...
#line 249 "gen/re2c/25__cat4_4-tdfa1.c"
in->yyt1 = 0;
in->yyt10 = 0;
in->yyt11 = 0;
in->yyt12 = 0;
...
#line 312 "gen/re2c/25__cat4_4-tdfa1.c"
...
#line 363 "gen/re2c/25__cat4_4-tdfa1.c"
{
	char yych;
...
#line 3 "../../../../benchmarks/c/submatch/src/re2c/include/fill.re"
	{ return 0; }
#line 380 "gen/re2c/25__cat4_4-tdfa1.c"
yy2:
	++in->cur;
yy3:
#line 11 "../../../../benchmarks/c/submatch/src/re2c/25__cat4_4.re"
	{ return 1; }
#line 386 "gen/re2c/25__cat4_4-tdfa1.c"
yy4:
	yych = *(in->mar = ++in->cur);
	switch (yych) {
		case 'a':
...
#line 1151 "gen/re2c/25__cat4_4-tdfa1.c"
yy68:
	++in->cur;
	if ((in->lim - in->cur) < 12) if (fill(in, 12) != 0) return 1;
	yych = *in->cur;
