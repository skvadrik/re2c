...
// aaaaaaaaaaaaaaaaa;
const buffer_unit_t const_1_1[18] = {0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x3b};
// aaaaaaaaaaaaaaaaaaa.
const buffer_unit_t const_1_2[20] = {0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x2e};
// aaaaaaaaaaaaaaaaaaaaaaa.
const buffer_unit_t const_1_3[24] = {0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x2e};
void printCompilationInfo()
{
  fprintf(stdout, "No object file generated!\nOptions:\nSST optimization level:  3\nWord size:               UInt8T\nIdentity tables removed: False\n\nSource file: ../../../benchmarks/submatch_dfa_aot/src/kleenex/32__rep_cat_23_19_17.kex\nSource md5:  e9 2e920 28b746d957a18cefb d9528\nSST states:  5\n");
}
...
l1_0: if (!readnext(1, 23))
      ...
      if (((avail >= 23) && (cmp(&next[0],(unsigned char *) "aaaaaaaaaaaaaaaaaaaaaaa",23) && 1)))
      {
         outputarray(const_1_3,192);
         consume(23);
         goto l1_1;
      }
      goto fail1;
l1_1: if (!readnext(19, 19))
      {
         goto fail1;
      }
      if (((avail >= 19) && (cmp(&next[0],(unsigned char *) "aaaaaaaaaaaaaaaaaaa",19) && 1)))
      {
         outputarray(const_1_2,160);
         consume(19);
         goto l1_2;
      }
      goto fail1;
l1_2: if (!readnext(17, 17))
      {
         goto fail1;
      }
      if (((avail >= 17) && (cmp(&next[0],(unsigned char *) "aaaaaaaaaaaaaaaaa",17) && 1)))
      {
         outputarray(const_1_1,144);
         consume(17);
         goto l1_3;
      }
      goto fail1;
l1_3: if (!readnext(1, 23))
      {
         goto fail1;
      }
      if (((avail >= 1) && ((next[0] == 10) && 1)))
