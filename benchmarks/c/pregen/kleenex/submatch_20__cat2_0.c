...
// .a
const buffer_unit_t const_1_4[2] = {0x2e,0x61};
// .b
const buffer_unit_t const_1_5[2] = {0x2e,0x62};
// a
...
void printCompilationInfo()
{
  fprintf(stdout, "No object file generated!\nOptions:\nSST optimization level:  3\nWord size:               UInt8T\nIdentity tables removed: False\n\nSource file: ../../../benchmarks/submatch_dfa_aot/src/kleenex/20__cat2_0.kex\nSource md5:  2a1c6fa6b7682bb74d 0bddd4dcf7a51\nSST states:  6\n");
}
