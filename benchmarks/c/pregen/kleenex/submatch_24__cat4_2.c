...
// .aa..aa..aa..aab
const buffer_unit_t const_1_11[16] = {0x2e,0x61,0x61,0x2e,0x2e,0x61,0x61,0x2e,0x2e,0x61,0x61,0x2e,0x2e,0x61,0x61,0x62};
// .aa..aa..aab
const buffer_unit_t const_1_12[12] = {0x2e,0x61,0x61,0x2e,0x2e,0x61,0x61,0x2e,0x2e,0x61,0x61,0x62};
// .aa..aab
const buffer_unit_t const_1_13[8] = {0x2e,0x61,0x61,0x2e,0x2e,0x61,0x61,0x62};
// .aa.a
const buffer_unit_t const_1_14[5] = {0x2e,0x61,0x61,0x2e,0x61};
// .aab
const buffer_unit_t const_1_15[4] = {0x2e,0x61,0x61,0x62};
// a
const buffer_unit_t const_1_16[1] = {0x61};
// a.aa
const buffer_unit_t const_1_17[4] = {0x61,0x2e,0x61,0x61};
// a.aa..aa
const buffer_unit_t const_1_18[8] = {0x61,0x2e,0x61,0x61,0x2e,0x2e,0x61,0x61};
// a.aa..aa..aa
const buffer_unit_t const_1_19[12] = {0x61,0x2e,0x61,0x61,0x2e,0x2e,0x61,0x61,0x2e,0x2e,0x61,0x61};
// aa
const buffer_unit_t const_1_20[2] = {0x61,0x61};
// aa.aab
const buffer_unit_t const_1_21[6] = {0x61,0x61,0x2e,0x61,0x61,0x62};
// aaa
const buffer_unit_t const_1_22[3] = {0x61,0x61,0x61};
// b
const buffer_unit_t const_1_23[1] = {0x62};
void printCompilationInfo()
{
  fprintf(stdout, "No object file generated!\nOptions:\nSST optimization level:  3\nWord size:               UInt8T\nIdentity tables removed: False\n\nSource file: ../../../benchmarks/submatch_dfa_aot/src/kleenex/24__cat4_2.kex\nSource md5:  6d87f4572f3b6f 6f926fef12519ef74\nSST states:  52\n");
}
...
l1_11: if (!readnext(1, 2))
       ...
       if (((avail >= 1) && ((next[0] == 'a') && 1)))
       {
          ...
          {
             reset(&buf_4);
             appendarray(&buf_4,const_1_4,32);
             reset(&buf_1);
             appendarray(&buf_1,const_1_20,16);
             consume(2);
             goto l1_31;
          }
          reset(&buf_4);
          appendarray(&buf_4,const_1_14,40);
          reset(&buf_1);
...
l1_22: if (!readnext(1, 2))
       ...
       if (((avail >= 1) && ((next[0] == 'a') && 1)))
       {
          ...
          {
             reset(&buf_5);
             appendarray(&buf_5,const_1_4,32);
             appendarray(&buf_4,const_1_1,8);
             reset(&buf_2);
             appendarray(&buf_2,const_1_20,16);
             consume(2);
             goto l1_39;
          }
          reset(&buf_5);
          appendarray(&buf_5,const_1_14,40);
          appendarray(&buf_4,const_1_2,16);
          reset(&buf_2);
          appendarray(&buf_2,const_1_22,24);
          consume(1);
          goto l1_21;
       }
       if (((avail >= 1) && ((next[0] == 'b') && 1)))
...
l1_31: if (!readnext(1, 2))
       ...
       if (((avail >= 1) && ((next[0] == 'a') && 1)))
       {
          ...
          appendarray(&buf_4,const_1_17,32);
          appendarray(&buf_1,const_1_16,8);
          consume(1);
          goto l1_22;
       }
...
l1_33: if (!readnext(1, 2))
       ...
       if (((avail >= 1) && ((next[0] == 'a') && 1)))
       {
          ...
          {
             reset(&buf_6);
             appendarray(&buf_6,const_1_4,32);
             appendarray(&buf_5,const_1_1,8);
             appendarray(&buf_4,const_1_1,8);
             reset(&buf_3);
             appendarray(&buf_3,const_1_20,16);
             consume(2);
             goto l1_45;
          }
          reset(&buf_6);
          appendarray(&buf_6,const_1_14,40);
          appendarray(&buf_5,const_1_2,16);
          appendarray(&buf_4,const_1_2,16);
          reset(&buf_3);
...
l1_38: if (!readnext(1, 2))
       ...
       if (((avail >= 1) && ((next[0] == 'a') && 1)))
       {
          ...
          reset(&buf_4);
          appendarray(&buf_4,const_1_5,56);
          reset(&buf_1);
          appendarray(&buf_1,const_1_20,16);
          outputarray(const_1_16,8);
          consume(1);
       ...
       {
          reset(&buf_4);
          appendarray(&buf_4,const_1_13,64);
          reset(&buf_1);
          appendarray(&buf_1,const_1_21,48);
          consume(1);
          goto l1_17;
       }
       goto fail1;
l1_39: if (!readnext(1, 2))
       ...
       if (((avail >= 1) && ((next[0] == 'a') && 1)))
       {
          ...
          appendarray(&buf_5,const_1_17,32);
          appendarray(&buf_4,const_1_17,32);
          appendarray(&buf_2,const_1_16,8);
          consume(1);
          goto l1_33;
...
l1_44: if (!readnext(1, 2))
       ...
       if (((avail >= 1) && ((next[0] == 'a') && 1)))
       {
          ...
          reset(&buf_5);
          appendarray(&buf_5,const_1_5,56);
          appendarray(&buf_4,const_1_18,64);
          reset(&buf_2);
          appendarray(&buf_2,const_1_20,16);
          appendarray(&buf_1,const_1_16,8);
          consume(1);
       ...
       {
          reset(&buf_5);
          appendarray(&buf_5,const_1_13,64);
          appendarray(&buf_4,const_1_13,64);
          reset(&buf_2);
          appendarray(&buf_2,const_1_21,48);
          consume(1);
          goto l1_29;
       }
       goto fail1;
l1_45: if (!readnext(1, 2))
       ...
       if (((avail >= 1) && ((next[0] == 'a') && 1)))
       {
          ...
          appendarray(&buf_6,const_1_17,32);
          appendarray(&buf_5,const_1_17,32);
          appendarray(&buf_4,const_1_17,32);
          appendarray(&buf_3,const_1_16,8);
          consume(1);
...
l1_47: if (!readnext(1, 2))
       ...
       if (((avail >= 1) && ((next[0] == 'a') && 1)))
       {
          ...
          appendarray(&buf_5,const_1_5,56);
          reset(&buf_4);
          appendarray(&buf_4,const_1_7,88);
          reset(&buf_2);
          appendarray(&buf_2,const_1_20,16);
          reset(&buf_1);
          appendarray(&buf_1,const_1_20,16);
       ...
       if (((avail >= 1) && ((next[0] == 'b') && 1)))
       {
          ...
          appendarray(&buf_5,const_1_13,64);
          reset(&buf_4);
          appendarray(&buf_4,const_1_12,96);
          reset(&buf_2);
          appendarray(&buf_2,const_1_21,48);
          reset(&buf_1);
          appendarray(&buf_1,const_1_20,16);
...
l1_48: if (!readnext(1, 2))
       ...
       if (((avail >= 1) && ((next[0] == 'a') && 1)))
       {
          ...
          reset(&buf_6);
          appendarray(&buf_6,const_1_5,56);
          appendarray(&buf_5,const_1_18,64);
          appendarray(&buf_4,const_1_18,64);
          reset(&buf_3);
          appendarray(&buf_3,const_1_20,16);
          appendarray(&buf_2,const_1_16,8);
       ...
       {
          reset(&buf_6);
          appendarray(&buf_6,const_1_13,64);
          appendarray(&buf_5,const_1_13,64);
          appendarray(&buf_4,const_1_13,64);
          reset(&buf_3);
          appendarray(&buf_3,const_1_21,48);
          consume(1);
          goto l1_37;
       }
       goto fail1;
...
l1_50: if (!readnext(1, 2))
       ...
       if (((avail >= 1) && ((next[0] == 'a') && 1)))
       {
          ...
          appendarray(&buf_6,const_1_5,56);
          reset(&buf_5);
          appendarray(&buf_5,const_1_7,88);
          appendarray(&buf_4,const_1_19,96);
          reset(&buf_3);
          appendarray(&buf_3,const_1_20,16);
          reset(&buf_2);
          appendarray(&buf_2,const_1_20,16);
       ...
       if (((avail >= 1) && ((next[0] == 'b') && 1)))
       {
          ...
          appendarray(&buf_6,const_1_13,64);
          reset(&buf_5);
          appendarray(&buf_5,const_1_12,96);
          appendarray(&buf_4,const_1_12,96);
          reset(&buf_3);
          appendarray(&buf_3,const_1_21,48);
          reset(&buf_2);
...
l1_51: if (!readnext(1, 2))
       ...
       if (((avail >= 1) && ((next[0] == 'a') && 1)))
       {
          ...
          appendarray(&buf_5,const_1_7,88);
          reset(&buf_4);
          appendarray(&buf_4,const_1_9,120);
          reset(&buf_3);
          appendarray(&buf_3,const_1_20,16);
          reset(&buf_2);
          appendarray(&buf_2,const_1_20,16);
       ...
       if (((avail >= 1) && ((next[0] == 'b') && 1)))
       {
          ...
          appendarray(&buf_5,const_1_12,96);
          reset(&buf_4);
          appendarray(&buf_4,const_1_11,128);
          reset(&buf_3);
          appendarray(&buf_3,const_1_21,48);
          reset(&buf_2);
          appendarray(&buf_2,const_1_20,16);
