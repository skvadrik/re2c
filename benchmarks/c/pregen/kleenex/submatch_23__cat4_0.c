...
// .a
const buffer_unit_t const_1_8[2] = {0x2e,0x61};
// .b
const buffer_unit_t const_1_9[2] = {0x2e,0x62};
// a
...
void printCompilationInfo()
{
  fprintf(stdout, "No object file generated!\nOptions:\nSST optimization level:  3\nWord size:               UInt8T\nIdentity tables removed: False\n\nSource file: ../../../benchmarks/submatch_dfa_aot/src/kleenex/23__cat4_0.kex\nSource md5:  e946b180723e5ef24b20 174dc2f1119\nSST states:  10\n");
}
