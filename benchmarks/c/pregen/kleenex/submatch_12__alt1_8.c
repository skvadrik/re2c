...
// Aa
const buffer_unit_t const_1_2[2] = {0x41,0x61};
// Bb
const buffer_unit_t const_1_3[2] = {0x42,0x62};
// Cc
const buffer_unit_t const_1_4[2] = {0x43,0x63};
// Dd
const buffer_unit_t const_1_5[2] = {0x44,0x64};
// Ee
const buffer_unit_t const_1_6[2] = {0x45,0x65};
// Ff
const buffer_unit_t const_1_7[2] = {0x46,0x66};
// Gg
const buffer_unit_t const_1_8[2] = {0x47,0x67};
// Hh
const buffer_unit_t const_1_9[2] = {0x48,0x68};
// a
...
// e
const buffer_unit_t const_1_14[1] = {0x65};
// f
const buffer_unit_t const_1_15[1] = {0x66};
// g
const buffer_unit_t const_1_16[1] = {0x67};
// h
const buffer_unit_t const_1_17[1] = {0x68};
void printCompilationInfo()
{
  fprintf(stdout, "No object file generated!\nOptions:\nSST optimization level:  3\nWord size:               UInt8T\nIdentity tables removed: False\n\nSource file: ../../../benchmarks/submatch_dfa_aot/src/kleenex/12__alt1_8.kex\nSource md5:  ba40f7ea 99c54e73bc1dee39826 aef\nSST states:  10\n");
}
