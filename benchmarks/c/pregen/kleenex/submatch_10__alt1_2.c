...
// a
const buffer_unit_t const_1_4[1] = {0x61};
// b
const buffer_unit_t const_1_5[1] = {0x62};
void printCompilationInfo()
{
  fprintf(stdout, "No object file generated!\nOptions:\nSST optimization level:  3\nWord size:               UInt8T\nIdentity tables removed: False\n\nSource file: ../../../benchmarks/submatch_dfa_aot/src/kleenex/10__alt1_2.kex\nSource md5:  933017c27ef6b9d9873167f64a593afc\nSST states:  4\n");
}
