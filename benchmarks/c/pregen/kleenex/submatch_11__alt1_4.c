...
// c
const buffer_unit_t const_1_8[1] = {0x63};
// d
const buffer_unit_t const_1_9[1] = {0x64};
void printCompilationInfo()
{
  fprintf(stdout, "No object file generated!\nOptions:\nSST optimization level:  3\nWord size:               UInt8T\nIdentity tables removed: False\n\nSource file: ../../../benchmarks/submatch_dfa_aot/src/kleenex/11__alt1_4.kex\nSource md5:  a46aa0b6cb7b64dabc59 919 e23de80\nSST states:  6\n");
}
