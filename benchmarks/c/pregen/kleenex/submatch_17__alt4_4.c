...
// Aa
const buffer_unit_t const_1_8[2] = {0x41,0x61};
// Bb
const buffer_unit_t const_1_9[2] = {0x42,0x62};
// Cc
const buffer_unit_t const_1_10[2] = {0x43,0x63};
// Dd
const buffer_unit_t const_1_11[2] = {0x44,0x64};
// a
const buffer_unit_t const_1_12[1] = {0x61};
// b
const buffer_unit_t const_1_13[1] = {0x62};
// c
const buffer_unit_t const_1_14[1] = {0x63};
// d
const buffer_unit_t const_1_15[1] = {0x64};
void printCompilationInfo()
{
  fprintf(stdout, "No object file generated!\nOptions:\nSST optimization level:  3\nWord size:               UInt8T\nIdentity tables removed: False\n\nSource file: ../../../benchmarks/submatch_dfa_aot/src/kleenex/17__alt4_4.kex\nSource md5:  ba5affec4770c07fed384456c1e56847\nSST states:  18\n");
}
...
l1_0: if (!readnext(1, 1))
      ...
      {
         reset(&buf_6);
         appendarray(&buf_6,const_1_9,16);
         reset(&buf_5);
         appendarray(&buf_5,const_1_9,16);
         reset(&buf_4);
         appendarray(&buf_4,const_1_9,16);
         reset(&buf_3);
      ...
      {
         reset(&buf_6);
         appendarray(&buf_6,const_1_10,16);
         reset(&buf_5);
         appendarray(&buf_5,const_1_10,16);
         reset(&buf_4);
         appendarray(&buf_4,const_1_10,16);
         reset(&buf_3);
      ...
      {
         reset(&buf_6);
         appendarray(&buf_6,const_1_11,16);
         reset(&buf_5);
         appendarray(&buf_5,const_1_11,16);
         reset(&buf_4);
         appendarray(&buf_4,const_1_11,16);
         reset(&buf_3);
...
l1_6: if (!readnext(1, 1))
      ...
      if (((avail >= 1) && ((next[0] == 'a') && 1)))
      {
         appendarray(&buf_4,const_1_12,8);
         appendarray(&buf_1,const_1_12,8);
         consume(1);
         goto l1_6;
      }
      if (((avail >= 1) && ((next[0] == 'b') && 1)))
...
l1_7: if (!readnext(1, 1))
      ...
      if (((avail >= 1) && ((next[0] == 'b') && 1)))
      {
         appendarray(&buf_4,const_1_13,8);
...
l1_11: if (!readnext(1, 1))
       ...
       if (((avail >= 1) && ((next[0] == 'a') && 1)))
       {
          appendarray(&buf_5,const_1_12,8);
          appendarray(&buf_4,const_1_12,8);
          appendarray(&buf_2,const_1_12,8);
          consume(1);
          goto l1_11;
       }
       if (((avail >= 1) && ((next[0] == 'b') && 1)))
       ...
       if (((avail >= 1) && ((next[0] == 'c') && 1)))
       {
          ...
          appendarray(&buf_1,const_1_1,8);
          concat(&buf_1,&buf_5);
          appendarray(&buf_1,const_1_10,16);
          consume(1);
          goto l1_8;
       }
       if (((avail >= 1) && ((next[0] == 'd') && 1)))
       {
          ...
          appendarray(&buf_1,const_1_1,8);
          concat(&buf_1,&buf_5);
          appendarray(&buf_1,const_1_11,16);
          consume(1);
          goto l1_9;
       }
       goto fail1;
l1_12: if (!readnext(1, 1))
       ...
       if (((avail >= 1) && ((next[0] == 'a') && 1)))
       {
          appendarray(&buf_4,const_1_8,16);
          reset(&buf_1);
          appendarray(&buf_1,const_1_1,8);
          concat(&buf_1,&buf_5);
          appendarray(&buf_1,const_1_8,16);
          consume(1);
          goto l1_6;
       }
       if (((avail >= 1) && ((next[0] == 'b') && 1)))
       {
          ...
          appendarray(&buf_4,const_1_13,8);
          appendarray(&buf_2,const_1_13,8);
          consume(1);
          goto l1_12;
       }
       if (((avail >= 1) && ((next[0] == 'c') && 1)))
...
l1_15: if (!readnext(1, 1))
       ...
       if (((avail >= 1) && ((next[0] == 'a') && 1)))
       {
          appendarray(&buf_5,const_1_8,16);
          appendarray(&buf_4,const_1_8,16);
          reset(&buf_2);
          appendarray(&buf_2,const_1_1,8);
          concat(&buf_2,&buf_6);
          appendarray(&buf_2,const_1_8,16);
          consume(1);
          goto l1_11;
       }
       if (((avail >= 1) && ((next[0] == 'b') && 1)))
       {
          appendarray(&buf_6,const_1_13,8);
          appendarray(&buf_5,const_1_13,8);
          appendarray(&buf_4,const_1_13,8);
          appendarray(&buf_3,const_1_13,8);
          consume(1);
          goto l1_15;
       }
       if (((avail >= 1) && ((next[0] == 'c') && 1)))
       {
          ...
          appendarray(&buf_2,const_1_1,8);
          concat(&buf_2,&buf_6);
          appendarray(&buf_2,const_1_10,16);
          consume(1);
          goto l1_13;
       }
       if (((avail >= 1) && ((next[0] == 'd') && 1)))
...
l1_16: if (!readnext(1, 1))
       ...
       if (((avail >= 1) && ((next[0] == 'b') && 1)))
       {
          ...
          appendarray(&buf_2,const_1_1,8);
          concat(&buf_2,&buf_6);
          appendarray(&buf_2,const_1_9,16);
          consume(1);
          goto l1_12;
       }
       if (((avail >= 1) && ((next[0] == 'c') && 1)))
