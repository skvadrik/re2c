...
// aa;
const buffer_unit_t const_1_1[3] = {0x61,0x61,0x3b};
// aaa.
const buffer_unit_t const_1_2[4] = {0x61,0x61,0x61,0x2e};
// aaaaa.
const buffer_unit_t const_1_3[6] = {0x61,0x61,0x61,0x61,0x61,0x2e};
void printCompilationInfo()
{
  fprintf(stdout, "No object file generated!\nOptions:\nSST optimization level:  3\nWord size:               UInt8T\nIdentity tables removed: False\n\nSource file: ../../../benchmarks/submatch_dfa_aot/src/kleenex/30__rep_cat_5_3_2.kex\nSource md5:  c0ad3e9c7b246e7c3eb6 1ada8ac90b5\nSST states:  5\n");
}
...
l1_0: if (!readnext(1, 5))
      ...
      if (((avail >= 5) && (cmp(&next[0],(unsigned char *) "aaaaa",5) && 1)))
      {
      ...
      goto fail1;
l1_1: if (!readnext(3, 3))
      {
         goto fail1;
      }
      if (((avail >= 3) && (cmp(&next[0],(unsigned char *) "aaa",3) && 1)))
      {
         outputarray(const_1_2,32);
         consume(3);
         goto l1_2;
      }
      goto fail1;
