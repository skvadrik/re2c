...
// Aa
const buffer_unit_t const_1_4[2] = {0x41,0x61};
// Bb
const buffer_unit_t const_1_5[2] = {0x42,0x62};
// a
const buffer_unit_t const_1_6[1] = {0x61};
// b
const buffer_unit_t const_1_7[1] = {0x62};
void printCompilationInfo()
{
  fprintf(stdout, "No object file generated!\nOptions:\nSST optimization level:  3\nWord size:               UInt8T\nIdentity tables removed: False\n\nSource file: ../../../benchmarks/submatch_dfa_aot/src/kleenex/13__alt2_2.kex\nSource md5:  8e558b 4654ac181234bab147e994f1d\nSST states:  6\n");
}
...
l1_0: if (!readnext(1, 1))
      ...
      {
         reset(&buf_2);
         appendarray(&buf_2,const_1_5,16);
         reset(&buf_1);
...
l1_4: if (!readnext(1, 1))
      ...
      if (((avail >= 1) && ((next[0] == 'b') && 1)))
      {
         appendarray(&buf_2,const_1_7,8);
         appendarray(&buf_1,const_1_7,8);
         consume(1);
         goto l1_4;
      }
      goto fail1;
