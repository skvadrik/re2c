...
//  
const buffer_unit_t const_1_1[1] = {0x20};
// -
const buffer_unit_t const_1_2[1] = {0x2d};
// .
const buffer_unit_t const_1_3[1] = {0x2e};
void printCompilationInfo()
{
  fprintf(stdout, "No object file generated!\nOptions:\nSST optimization level:  3\nWord size:               UInt8T\nIdentity tables removed: False\n\nSource file: ../../../benchmarks/submatch_dfa_aot/src/kleenex/06__email.kex\nSource md5:  437ac440bbbfc56a11b3965ce24849 0\nSST states:  11\n");
}
...
l1_0: if (!readnext(1, 1))
      ...
      if (((avail >= 1) && ((((0 <= next[0]) && (next[0] <= 9)) || (((11 <= next[0]) && (next[0] <= ' ')) || ((next[0] == '"') || ((('(' <= next[0]) && (next[0] <= ')')) || ((next[0] == ',') || ((next[0] == '.') || (((':' <= next[0]) && (next[0] <= '<')) || ((next[0] == '>') || ((('@' <= next[0]) && (next[0] <= ']')) || ((127 <= next[0]) && (next[0] <= 255))))))))))) && 1)))
      {
         consume(1);
         goto l1_2;
      }
      ...
      if (((avail >= 1) && (((next[0] == '!') || ((('#' <= next[0]) && (next[0] <= 39)) || ((('*' <= next[0]) && (next[0] <= '+')) || ((next[0] == '-') || ((('/' <= next[0]) && (next[0] <= '9')) || ((next[0] == '=') || ((next[0] == '?') || (('^' <= next[0]) && (next[0] <= '~'))))))))) && 1)))
      {
         reset(&buf_1);
...
l1_1: if (!readnext(1, 1))
      ...
      if (((avail >= 1) && ((((0 <= next[0]) && (next[0] <= 9)) || (((11 <= next[0]) && (next[0] <= '/')) || (((':' <= next[0]) && (next[0] <= '`')) || (('{' <= next[0]) && (next[0] <= 255))))) && 1)))
      {
         consume(1);
         goto l1_2;
      }
      ...
      if (((avail >= 1) && (((('0' <= next[0]) && (next[0] <= '9')) || (('a' <= next[0]) && (next[0] <= 'z'))) && 1)))
      {
         append(&buf_1,next[0],8);
         consume(1);
         goto l1_8;
...
l1_3: if (!readnext(1, 2))
      ...
      if (((avail >= 1) && ((((0 <= next[0]) && (next[0] <= 9)) || (((11 <= next[0]) && (next[0] <= ' ')) || ((next[0] == '"') || ((('(' <= next[0]) && (next[0] <= ')')) || ((next[0] == ',') || (((':' <= next[0]) && (next[0] <= '<')) || ((next[0] == '>') || ((('A' <= next[0]) && (next[0] <= ']')) || ((127 <= next[0]) && (next[0] <= 255)))))))))) && 1)))
      {
         consume(1);
         goto l1_2;
      }
      ...
      if (((avail >= 1) && ((next[0] == '.') && 1)))
      {
         if (((avail >= 2) && (((next[1] == '!') || ((('#' <= next[1]) && (next[1] <= 39)) || ((('*' <= next[1]) && (next[1] <= '+')) || ((next[1] == '-') || ((('/' <= next[1]) && (next[1] <= '9')) || ((next[1] == '=') || ((next[1] == '?') || (('^' <= next[1]) && (next[1] <= '~'))))))))) && 1)))
         {
            for(i = 0; i < 2; i++)
...
l1_7: if (!readnext(1, 2))
      ...
      if (((avail >= 1) && ((((0 <= next[0]) && (next[0] <= 9)) || (((11 <= next[0]) && (next[0] <= ',')) || ((('.' <= next[0]) && (next[0] <= '/')) || (((':' <= next[0]) && (next[0] <= '`')) || (('{' <= next[0]) && (next[0] <= 255)))))) && 1)))
      {
         consume(1);
         goto l1_2;
      }
...
l1_8: if (!readnext(1, 2))
      ...
      if (((avail >= 1) && ((((0 <= next[0]) && (next[0] <= 9)) || (((11 <= next[0]) && (next[0] <= ',')) || ((next[0] == '/') || (((':' <= next[0]) && (next[0] <= '`')) || (('{' <= next[0]) && (next[0] <= 255)))))) && 1)))
      {
         consume(1);
         goto l1_2;
      }
...
l1_9: if (!readnext(1, 2))
      ...
      if (((avail >= 1) && ((next[0] == '-') && 1)))
      {
         ...
         appendarray(&buf_2,const_1_2,8);
         consume(1);
         goto l1_9;
      }
      if (((avail >= 1) && (((('0' <= next[0]) && (next[0] <= '9')) || (('a' <= next[0]) && (next[0] <= 'z'))) && 1)))
      {
         if (((avail >= 2) && ((next[1] == 10) && 1)))
         {
            output(&buf_1);
            output(&buf_3);
