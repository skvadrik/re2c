...
// Cc
const buffer_unit_t const_1_8[2] = {0x43,0x63};
// Dd
const buffer_unit_t const_1_9[2] = {0x44,0x64};
// a
const buffer_unit_t const_1_10[1] = {0x61};
// b
const buffer_unit_t const_1_11[1] = {0x62};
// c
const buffer_unit_t const_1_12[1] = {0x63};
// d
const buffer_unit_t const_1_13[1] = {0x64};
void printCompilationInfo()
{
  fprintf(stdout, "No object file generated!\nOptions:\nSST optimization level:  3\nWord size:               UInt8T\nIdentity tables removed: False\n\nSource file: ../../../benchmarks/submatch_dfa_aot/src/kleenex/14__alt2_4.kex\nSource md5:  a7516a1d89d83c9d3ebcb1332232 4b6\nSST states:  10\n");
}
...
l1_0: if (!readnext(1, 1))
      ...
      {
         reset(&buf_2);
         appendarray(&buf_2,const_1_7,16);
         reset(&buf_1);
...
l1_6: if (!readnext(1, 1))
      ...
      if (((avail >= 1) && ((next[0] == 'b') && 1)))
      {
         appendarray(&buf_2,const_1_11,8);
