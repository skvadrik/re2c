...
buffer_t buf_0;
// \xaagent: "
const buffer_unit_t const_1_0[9] = {0xa,0x61,0x67,0x65,0x6e,0x74,0x3a,0x20,0x22};
// \xaauthuser: 
const buffer_unit_t const_1_1[11] = {0xa,0x61,0x75,0x74,0x68,0x75,0x73,0x65,0x72,0x3a,0x20};
// \xadate: 
const buffer_unit_t const_1_2[7] = {0xa,0x64,0x61,0x74,0x65,0x3a,0x20};
// \xarequest: 
const buffer_unit_t const_1_3[10] = {0xa,0x72,0x65,0x71,0x75,0x65,0x73,0x74,0x3a,0x20};
// \xasize: 
const buffer_unit_t const_1_4[7] = {0xa,0x73,0x69,0x7a,0x65,0x3a,0x20};
// \xastatus: 
const buffer_unit_t const_1_5[9] = {0xa,0x73,0x74,0x61,0x74,0x75,0x73,0x3a,0x20};
// \xaurl: "
const buffer_unit_t const_1_6[7] = {0xa,0x75,0x72,0x6c,0x3a,0x20,0x22};
// \xauserid: 
const buffer_unit_t const_1_7[9] = {0xa,0x75,0x73,0x65,0x72,0x69,0x64,0x3a,0x20};
// "\xa\xa
const buffer_unit_t const_1_8[3] = {0x22,0xa,0xa};
// host: 
const buffer_unit_t const_1_9[6] = {0x68,0x6f,0x73,0x74,0x3a,0x20};
void printCompilationInfo()
{
  fprintf(stdout, "No object file generated!\nOptions:\nSST optimization level:  3\nWord size:               UInt8T\nIdentity tables removed: False\n\nSource file: ../../../benchmarks/submatch_dfa_aot/src/kleenex/04__apache_log.kex\nSource md5:  5c2abee157 d 228b3e24d48c2163bfd\nSST states:  17\n");
}
...
l1_0: if (!readnext(1, 1))
      ...
      if (((avail >= 1) && (((next[0] == '.') || (('0' <= next[0]) && (next[0] <= '9'))) && 1)))
      {
         outputarray(const_1_9,48);
...
l1_3: if (!readnext(1, 2))
      ...
      if (((avail >= 2) && ((next[0] == '-') && (((next[1] == 9) || (next[1] == ' ')) && 1))))
      {
...
l1_5: if (!readnext(1, 2))
      ...
      if (((avail >= 2) && ((next[0] == '"') && ((((0 <= next[1]) && (next[1] <= 9)) || (((11 <= next[1]) && (next[1] <= '!')) || (('#' <= next[1]) && (next[1] <= 255)))) && 1))))
      {
...
l1_6: if (!readnext(1, 2))
      ...
      if (((avail >= 2) && ((next[0] == '[') && ((((0 <= next[1]) && (next[1] <= 9)) || (((11 <= next[1]) && (next[1] <= 92)) || (('^' <= next[1]) && (next[1] <= 255)))) && 1))))
      {
         outputarray(const_1_2,56);
         for(i = 0; i < 2; i++)
         {  outputconst(next[0 + i],8);
         }
         consume(2);
...
l1_11: if (!readnext(1, 2))
       ...
       if (((avail >= 1) && ((((0 <= next[0]) && (next[0] <= 9)) || (((11 <= next[0]) && (next[0] <= 92)) || (('^' <= next[0]) && (next[0] <= 255)))) && 1)))
       {
          outputconst(next[0],8);
          consume(1);
          goto l1_11;
...
l1_14: if (!readnext(1, 2))
       ...
       if (((avail >= 2) && (cmp(&next[0],(unsigned char *) """\x22""""\xa""",2) && 1)))
       {
          outputarray(const_1_8,24);
          consume(2);
          goto l1_9;
       }
       goto fail1;
