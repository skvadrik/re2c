...
#line 30 "gen/re2c/submatch_22__cat2_8-stadfa.c"
char *yyt1;
char *yyt10;
char *yyt11;
char *yyt12;
...
#line 84 "gen/re2c/submatch_22__cat2_8-stadfa.c"
...
#line 95 "gen/re2c/submatch_22__cat2_8-stadfa.c"
...
#line 139 "gen/re2c/submatch_22__cat2_8-stadfa.c"
#define YYMAXFILL 16
...
#line 158 "gen/re2c/submatch_22__cat2_8-stadfa.c"
...
#line 231 "gen/re2c/submatch_22__cat2_8-stadfa.c"
in->yyt1 = 0;
in->yyt10 = 0;
in->yyt11 = 0;
in->yyt12 = 0;
...
#line 285 "gen/re2c/submatch_22__cat2_8-stadfa.c"
...
#line 336 "gen/re2c/submatch_22__cat2_8-stadfa.c"
{
	char yych;
...
#line 3 "../../../benchmarks/c/src/re2c/include/fill.re"
	{ return 0; }
#line 350 "gen/re2c/submatch_22__cat2_8-stadfa.c"
yy2:
	++in->cur;
yy3:
#line 11 "../../../benchmarks/c/src/re2c/submatch_22__cat2_8.re"
	{ return 1; }
#line 356 "gen/re2c/submatch_22__cat2_8-stadfa.c"
yy4:
	yych = *(in->mar = ++in->cur);
	in->yyt5 = in->yyt6 = in->cur - 1;
	switch (yych) {
		case 'a': goto yy5;
		default: goto yy3;
	}
...
yy16:
	...
	in->yyt26 = in->yyt21;
	in->yyt25 = in->yyt19;
	in->yyt5 = in->yyt23 = in->yyt24 = in->cur - 1;
	in->yyt21 = in->yyt22;
	in->yyt19 = in->yyt20;
	switch (yych) {
		case 'a': goto yy18;
...
#line 996 "gen/re2c/submatch_22__cat2_8-stadfa.c"
yy30:
	++in->cur;
	if ((in->lim - in->cur) < 8) if (fill(in, 8) != 0) return 1;
	yych = *in->cur;
