...
#line 30 "gen/re2c/submatch_21__cat2_4-tdfa1.c"
char *yyt1;
char *yyt10;
char *yyt11;
char *yyt12;
...
#line 49 "gen/re2c/submatch_21__cat2_4-tdfa1.c"
...
#line 60 "gen/re2c/submatch_21__cat2_4-tdfa1.c"
...
#line 104 "gen/re2c/submatch_21__cat2_4-tdfa1.c"
#define YYMAXFILL 8
...
#line 123 "gen/re2c/submatch_21__cat2_4-tdfa1.c"
...
#line 161 "gen/re2c/submatch_21__cat2_4-tdfa1.c"
in->yyt1 = 0;
in->yyt10 = 0;
in->yyt11 = 0;
in->yyt12 = 0;
...
#line 180 "gen/re2c/submatch_21__cat2_4-tdfa1.c"
...
#line 231 "gen/re2c/submatch_21__cat2_4-tdfa1.c"
{
	char yych;
...
#line 3 "../../../benchmarks/c/src/re2c/include/fill.re"
	{ return 0; }
#line 248 "gen/re2c/submatch_21__cat2_4-tdfa1.c"
yy2:
	++in->cur;
yy3:
#line 11 "../../../benchmarks/c/src/re2c/submatch_21__cat2_4.re"
	{ return 1; }
#line 254 "gen/re2c/submatch_21__cat2_4-tdfa1.c"
yy4:
	yych = *(in->mar = ++in->cur);
	switch (yych) {
		case 'a':
...
#line 403 "gen/re2c/submatch_21__cat2_4-tdfa1.c"
yy19:
	++in->cur;
	if ((in->lim - in->cur) < 4) if (fill(in, 4) != 0) return 1;
	yych = *in->cur;
