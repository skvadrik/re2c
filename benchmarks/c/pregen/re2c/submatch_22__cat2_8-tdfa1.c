...
#line 30 "gen/re2c/submatch_22__cat2_8-tdfa1.c"
char *yyt1;
char *yyt10;
char *yyt11;
char *yyt12;
...
#line 65 "gen/re2c/submatch_22__cat2_8-tdfa1.c"
...
#line 76 "gen/re2c/submatch_22__cat2_8-tdfa1.c"
...
#line 120 "gen/re2c/submatch_22__cat2_8-tdfa1.c"
#define YYMAXFILL 16
...
#line 139 "gen/re2c/submatch_22__cat2_8-tdfa1.c"
...
#line 193 "gen/re2c/submatch_22__cat2_8-tdfa1.c"
in->yyt1 = 0;
in->yyt10 = 0;
in->yyt11 = 0;
in->yyt12 = 0;
...
#line 228 "gen/re2c/submatch_22__cat2_8-tdfa1.c"
...
#line 279 "gen/re2c/submatch_22__cat2_8-tdfa1.c"
{
	char yych;
...
#line 3 "../../../benchmarks/c/src/re2c/include/fill.re"
	{ return 0; }
#line 296 "gen/re2c/submatch_22__cat2_8-tdfa1.c"
yy2:
	++in->cur;
yy3:
#line 11 "../../../benchmarks/c/src/re2c/submatch_22__cat2_8.re"
	{ return 1; }
#line 302 "gen/re2c/submatch_22__cat2_8-tdfa1.c"
yy4:
	yych = *(in->mar = ++in->cur);
	switch (yych) {
		case 'a':
...
#line 583 "gen/re2c/submatch_22__cat2_8-tdfa1.c"
yy31:
	++in->cur;
	if ((in->lim - in->cur) < 8) if (fill(in, 8) != 0) return 1;
	yych = *in->cur;
