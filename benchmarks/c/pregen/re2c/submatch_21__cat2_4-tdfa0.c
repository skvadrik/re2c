...
#line 30 "gen/re2c/submatch_21__cat2_4-tdfa0.c"
char *yyt1;
char *yyt10;
char *yyt11;
char *yyt12;
...
#line 52 "gen/re2c/submatch_21__cat2_4-tdfa0.c"
...
#line 63 "gen/re2c/submatch_21__cat2_4-tdfa0.c"
...
#line 107 "gen/re2c/submatch_21__cat2_4-tdfa0.c"
#define YYMAXFILL 8
...
#line 126 "gen/re2c/submatch_21__cat2_4-tdfa0.c"
...
#line 167 "gen/re2c/submatch_21__cat2_4-tdfa0.c"
in->yyt1 = 0;
in->yyt10 = 0;
in->yyt11 = 0;
in->yyt12 = 0;
...
#line 189 "gen/re2c/submatch_21__cat2_4-tdfa0.c"
...
#line 240 "gen/re2c/submatch_21__cat2_4-tdfa0.c"
{
	char yych;
...
#line 3 "../../../benchmarks/c/src/re2c/include/fill.re"
	{ return 0; }
#line 256 "gen/re2c/submatch_21__cat2_4-tdfa0.c"
yy2:
yy3:
#line 11 "../../../benchmarks/c/src/re2c/submatch_21__cat2_4.re"
	{ return 1; }
#line 261 "gen/re2c/submatch_21__cat2_4-tdfa0.c"
yy4:
	yych = *(in->mar = in->cur);
	switch (yych) {
		case 'a':
...
yy7:
	...
	switch (yych) {
		case 'a':
			++in->cur;
			in->yyt3 = in->yyt4 = in->yyt8 = in->cur;
			goto yy8;
		default: goto yy6;
	}
yy8:
...
#line 429 "gen/re2c/submatch_21__cat2_4-tdfa0.c"
yy19:
	if ((in->lim - in->cur) < 4) if (fill(in, 4) != 0) return 1;
	yych = *in->cur;
	switch (yych) {
