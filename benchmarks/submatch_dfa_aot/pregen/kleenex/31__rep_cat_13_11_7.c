...
// aaaaaaa;
const buffer_unit_t const_1_1[8] = {0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x3b};
// aaaaaaaaaaa.
const buffer_unit_t const_1_2[12] = {0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x2e};
// aaaaaaaaaaaaa.
const buffer_unit_t const_1_3[14] = {0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x2e};
void printCompilationInfo()
{
  fprintf(stdout, "No object file generated!\nOptions:\nSST optimization level:  3\nWord size:               UInt8T\nIdentity tables removed: False\n\nSource file: ../../../benchmarks/submatch_dfa_aot/src/kleenex/31__rep_cat_13_11_7.kex\nSource md5:  1ee9134887f0913668fc89b18cc5986e\nSST states:  5\n");
}
...
l1_0: if (!readnext(1, 13))
      ...
      if (((avail >= 13) && (cmp(&next[0],(unsigned char *) "aaaaaaaaaaaaa",13) && 1)))
      {
         outputarray(const_1_3,112);
         consume(13);
         goto l1_1;
      }
      goto fail1;
l1_1: if (!readnext(11, 11))
      {
         goto fail1;
      }
      if (((avail >= 11) && (cmp(&next[0],(unsigned char *) "aaaaaaaaaaa",11) && 1)))
      {
         outputarray(const_1_2,96);
         consume(11);
         goto l1_2;
      }
      goto fail1;
l1_2: if (!readnext(7, 7))
      {
         goto fail1;
      }
      if (((avail >= 7) && (cmp(&next[0],(unsigned char *) "aaaaaaa",7) && 1)))
      {
         outputarray(const_1_1,64);
         consume(7);
         goto l1_3;
      }
      goto fail1;
l1_3: if (!readnext(1, 13))
      {
         goto fail1;
      }
      if (((avail >= 1) && ((next[0] == 10) && 1)))
