...
// \xaday: 
const buffer_unit_t const_1_1[6] = {0xa,0x64,0x61,0x79,0x3a,0x20};
// \xahours: 
const buffer_unit_t const_1_2[8] = {0xa,0x68,0x6f,0x75,0x72,0x73,0x3a,0x20};
// \xaminutes: 
const buffer_unit_t const_1_3[10] = {0xa,0x6d,0x69,0x6e,0x75,0x74,0x65,0x73,0x3a,0x20};
// \xamonth: 
const buffer_unit_t const_1_4[8] = {0xa,0x6d,0x6f,0x6e,0x74,0x68,0x3a,0x20};
// \xaseconds: 
const buffer_unit_t const_1_5[10] = {0xa,0x73,0x65,0x63,0x6f,0x6e,0x64,0x73,0x3a,0x20};
// \xatz: 
const buffer_unit_t const_1_6[5] = {0xa,0x74,0x7a,0x3a,0x20};
// Z\xa
const buffer_unit_t const_1_7[2] = {0x5a,0xa};
// year: 
const buffer_unit_t const_1_8[6] = {0x79,0x65,0x61,0x72,0x3a,0x20};
// year: 0
const buffer_unit_t const_1_9[7] = {0x79,0x65,0x61,0x72,0x3a,0x20,0x30};
void printCompilationInfo()
{
  fprintf(stdout, "No object file generated!\nOptions:\nSST optimization level:  3\nWord size:               UInt8T\nIdentity tables removed: False\n\nSource file: ../../../benchmarks/submatch_dfa_aot/src/kleenex/05__datetime.kex\nSource md5:  c45f984dab5249fecb87 e76fa5b3c1f\nSST states:  13\n");
}
...
l1_0: if (!readnext(1, 1))
      ...
      {
         outputarray(const_1_9,56);
         consume(1);
         goto l1_1;
      }
      if (((avail >= 1) && ((('1' <= next[0]) && (next[0] <= '9')) && 1)))
      {
         reset(&buf_2);
         reset(&buf_1);
         outputarray(const_1_8,48);
         outputconst(next[0],8);
         consume(1);
         goto l1_12;
      }
      goto fail1;
l1_1: if (!readnext(4, 4))
      {
         goto fail1;
      }
      if (((avail >= 4) && ((('0' <= next[0]) && (next[0] <= '9')) && ((('0' <= next[1]) && (next[1] <= '9')) && ((('0' <= next[2]) && (next[2] <= '9')) && ((next[3] == '-') && 1))))))
      {
         for(i = 0; i < 3; i++)
         {  outputconst(next[0 + i],8);
         }
         outputarray(const_1_4,64);
         consume(4);
         goto l1_6;
      }
      goto fail1;
l1_2: if (!readnext(2, 2))
      {
         goto fail1;
      }
      if (((avail >= 2) && ((('0' <= next[0]) && (next[0] <= '5')) && ((('0' <= next[1]) && (next[1] <= '9')) && 1))))
      {
         for(i = 0; i < 2; i++)
         {  outputconst(next[0 + i],8);
         }
         outputarray(const_1_6,40);
         consume(2);
         goto l1_10;
      }
      goto fail1;
l1_3: if (!readnext(3, 3))
      {
         goto fail1;
      }
      if (((avail >= 3) && ((('0' <= next[0]) && (next[0] <= '5')) && ((('0' <= next[1]) && (next[1] <= '9')) && ((next[2] == ':') && 1)))))
      {
         for(i = 0; i < 2; i++)
         {  outputconst(next[0 + i],8);
         }
         outputarray(const_1_5,80);
         consume(3);
         goto l1_2;
      }
      goto fail1;
...
l1_5: if (!readnext(1, 5))
      ...
      {
         if (((avail >= 5) && ((('0' <= next[1]) && (next[1] <= '9')) && ((('0' <= next[2]) && (next[2] <= '9')) && ((('0' <= next[3]) && (next[3] <= '9')) && ((next[4] == '-') && 1))))))
         {
            for(i = 0; i < 4; i++)
            {  outputconst(next[0 + i],8);
            }
      ...
      goto fail1;
l1_6: if (!readnext(3, 3))
      {
         goto fail1;
      }
      if (((avail >= 3) && ((next[0] == '0') && ((('1' <= next[1]) && (next[1] <= '9')) && ((next[2] == '-') && 1)))))
      {
         for(i = 0; i < 2; i++)
         {  outputconst(next[0 + i],8);
         }
         outputarray(const_1_1,48);
         consume(3);
         goto l1_7;
      }
      if (((avail >= 3) && ((next[0] == '1') && ((('0' <= next[1]) && (next[1] <= '2')) && ((next[2] == '-') && 1)))))
      {
         for(i = 0; i < 2; i++)
         {  outputconst(next[0 + i],8);
         }
      ...
      goto fail1;
l1_7: if (!readnext(3, 3))
      {
         goto fail1;
      }
      if (((avail >= 3) && ((next[0] == '0') && ((('1' <= next[1]) && (next[1] <= '9')) && ((next[2] == 'T') && 1)))))
      {
         for(i = 0; i < 2; i++)
         {  outputconst(next[0 + i],8);
         }
         outputarray(const_1_2,64);
         consume(3);
         goto l1_9;
      }
      if (((avail >= 3) && ((('1' <= next[0]) && (next[0] <= '2')) && ((('0' <= next[1]) && (next[1] <= '9')) && ((next[2] == 'T') && 1)))))
      {
         for(i = 0; i < 2; i++)
         {  outputconst(next[0 + i],8);
         }
      ...
      if (((avail >= 3) && ((next[0] == '3') && ((('0' <= next[1]) && (next[1] <= '1')) && ((next[2] == 'T') && 1)))))
      {
         for(i = 0; i < 2; i++)
         {  outputconst(next[0 + i],8);
         }
      ...
      goto fail1;
l1_8: if (!readnext(5, 5))
      {
         goto fail1;
      }
      if (((avail >= 5) && ((('0' <= next[0]) && (next[0] <= '1')) && ((('0' <= next[1]) && (next[1] <= '9')) && ((next[2] == ':') && ((('0' <= next[3]) && (next[3] <= '5')) && ((('0' <= next[4]) && (next[4] <= '9')) && 1)))))))
      {
         for(i = 0; i < 5; i++)
         {  outputconst(next[0 + i],8);
         }
      ...
      if (((avail >= 5) && ((next[0] == '2') && ((('0' <= next[1]) && (next[1] <= '3')) && ((next[2] == ':') && ((('0' <= next[3]) && (next[3] <= '5')) && ((('0' <= next[4]) && (next[4] <= '9')) && 1)))))))
      {
         for(i = 0; i < 5; i++)
         {  outputconst(next[0 + i],8);
         }
      ...
      goto fail1;
l1_9: if (!readnext(3, 3))
      {
         goto fail1;
      }
      if (((avail >= 3) && ((('0' <= next[0]) && (next[0] <= '1')) && ((('0' <= next[1]) && (next[1] <= '9')) && ((next[2] == ':') && 1)))))
      {
         for(i = 0; i < 2; i++)
         {  outputconst(next[0 + i],8);
         }
      ...
      if (((avail >= 3) && ((next[0] == '2') && ((('0' <= next[1]) && (next[1] <= '3')) && ((next[2] == ':') && 1)))))
      {
         for(i = 0; i < 2; i++)
         {  outputconst(next[0 + i],8);
         }
...
l1_12: if (!readnext(1, 5))
       ...
       if (((avail >= 1) && ((('0' <= next[0]) && (next[0] <= '9')) && 1)))
       {
          if (((avail >= 3) && ((('0' <= next[1]) && (next[1] <= '9')) && ((('0' <= next[2]) && (next[2] <= '9')) && 1))))
          {
             ...
             if (((avail >= 5) && ((('0' <= next[3]) && (next[3] <= '9')) && ((next[4] == '-') && 1))))
             {
                output(&buf_1);
                for(i = 0; i < 4; i++)
                {  outputconst(next[0 + i],8);
