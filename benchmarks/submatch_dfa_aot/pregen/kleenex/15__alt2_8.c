...
// A\xa
const buffer_unit_t const_1_1[2] = {0x41,0xa};
// AA\xa
const buffer_unit_t const_1_2[3] = {0x41,0x41,0xa};
// ABb
const buffer_unit_t const_1_3[3] = {0x41,0x42,0x62};
// ACc
const buffer_unit_t const_1_4[3] = {0x41,0x43,0x63};
// ADd
const buffer_unit_t const_1_5[3] = {0x41,0x44,0x64};
// AEe
const buffer_unit_t const_1_6[3] = {0x41,0x45,0x65};
// AFf
const buffer_unit_t const_1_7[3] = {0x41,0x46,0x66};
// AGg
const buffer_unit_t const_1_8[3] = {0x41,0x47,0x67};
// AHh
const buffer_unit_t const_1_9[3] = {0x41,0x48,0x68};
// Aa
const buffer_unit_t const_1_10[2] = {0x41,0x61};
// Bb
const buffer_unit_t const_1_11[2] = {0x42,0x62};
// Cc
const buffer_unit_t const_1_12[2] = {0x43,0x63};
// Dd
const buffer_unit_t const_1_13[2] = {0x44,0x64};
// Ee
const buffer_unit_t const_1_14[2] = {0x45,0x65};
// Ff
const buffer_unit_t const_1_15[2] = {0x46,0x66};
// Gg
const buffer_unit_t const_1_16[2] = {0x47,0x67};
// Hh
const buffer_unit_t const_1_17[2] = {0x48,0x68};
// a
const buffer_unit_t const_1_18[1] = {0x61};
// b
const buffer_unit_t const_1_19[1] = {0x62};
// c
const buffer_unit_t const_1_20[1] = {0x63};
// d
const buffer_unit_t const_1_21[1] = {0x64};
// e
const buffer_unit_t const_1_22[1] = {0x65};
// f
const buffer_unit_t const_1_23[1] = {0x66};
// g
const buffer_unit_t const_1_24[1] = {0x67};
// h
const buffer_unit_t const_1_25[1] = {0x68};
void printCompilationInfo()
{
  fprintf(stdout, "No object file generated!\nOptions:\nSST optimization level:  3\nWord size:               UInt8T\nIdentity tables removed: False\n\nSource file: ../../../benchmarks/submatch_dfa_aot/src/kleenex/15__alt2_8.kex\nSource md5:  431f973c2a 3f46ecfca e63146bd456\nSST states:  18\n");
}
...
l1_0: if (!readnext(1, 1))
      ...
      {
         outputarray(const_1_2,24);
         consume(1);
         goto l1_17;
      }
      if (((avail >= 1) && ((next[0] == 'a') && 1)))
      {
         outputarray(const_1_10,16);
         consume(1);
         goto l1_1;
      }
      ...
      {
         reset(&buf_2);
         appendarray(&buf_2,const_1_11,16);
         reset(&buf_1);
         appendarray(&buf_1,const_1_3,24);
         consume(1);
         goto l1_10;
      }
      if (((avail >= 1) && ((next[0] == 'c') && 1)))
      {
         ...
         reset(&buf_1);
         appendarray(&buf_1,const_1_4,24);
         consume(1);
         goto l1_11;
      }
      ...
      if (((avail >= 1) && ((next[0] == 'e') && 1)))
      {
         ...
         reset(&buf_1);
         appendarray(&buf_1,const_1_6,24);
         consume(1);
         goto l1_13;
      }
      if (((avail >= 1) && ((next[0] == 'f') && 1)))
      {
         ...
         reset(&buf_1);
         appendarray(&buf_1,const_1_7,24);
         consume(1);
         goto l1_14;
      }
      if (((avail >= 1) && ((next[0] == 'g') && 1)))
      {
         ...
         reset(&buf_1);
         appendarray(&buf_1,const_1_8,24);
         consume(1);
         goto l1_15;
      }
      if (((avail >= 1) && ((next[0] == 'h') && 1)))
      {
         ...
         reset(&buf_1);
         appendarray(&buf_1,const_1_9,24);
         consume(1);
         goto l1_16;
      }
      goto fail1;
...
l1_10: if (!readnext(1, 1))
       ...
       if (((avail >= 1) && ((next[0] == 'b') && 1)))
       {
          appendarray(&buf_2,const_1_19,8);
          appendarray(&buf_1,const_1_19,8);
          consume(1);
          goto l1_10;
       }
       if (((avail >= 1) && ((next[0] == 'c') && 1)))
