...
// aaaaaaaaaaaaaaaa.
const buffer_unit_t const_1_1[17] = {0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x2e};
void printCompilationInfo()
{
  fprintf(stdout, "No object file generated!\nOptions:\nSST optimization level:  3\nWord size:               UInt8T\nIdentity tables removed: False\n\nSource file: ../../../benchmarks/submatch_dfa_aot/src/kleenex/31__iter_16.kex\nSource md5:  8f93ecde48 27ca8243afd344c7f8ab7\nSST states:  3\n");
}
...
l1_0: if (!readnext(1, 16))
      ...
      if (((avail >= 16) && (cmp(&next[0],(unsigned char *) "aaaaaaaaaaaaaaaa",16) && 1)))
      {
         outputarray(const_1_1,136);
         consume(16);
         goto l1_1;
      }
      goto fail1;
l1_1: if (!readnext(1, 16))
      {
         goto fail1;
      }
      if (((avail >= 1) && ((next[0] == 10) && 1)))
