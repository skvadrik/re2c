...
// a
const buffer_unit_t const_1_2[1] = {0x61};
// a.
const buffer_unit_t const_1_3[2] = {0x61,0x2e};
// aa
const buffer_unit_t const_1_4[2] = {0x61,0x61};
// aa.
const buffer_unit_t const_1_5[3] = {0x61,0x61,0x2e};
// aa.\xa
const buffer_unit_t const_1_6[4] = {0x61,0x61,0x2e,0xa};
// aa.aa
const buffer_unit_t const_1_7[5] = {0x61,0x61,0x2e,0x61,0x61};
// aa.aa.
const buffer_unit_t const_1_8[6] = {0x61,0x61,0x2e,0x61,0x61,0x2e};
// aa.aa.aa
const buffer_unit_t const_1_9[8] = {0x61,0x61,0x2e,0x61,0x61,0x2e,0x61,0x61};
// aaa.
const buffer_unit_t const_1_10[4] = {0x61,0x61,0x61,0x2e};
// aaa.\xa
const buffer_unit_t const_1_11[5] = {0x61,0x61,0x61,0x2e,0xa};
// aaa.aa
const buffer_unit_t const_1_12[6] = {0x61,0x61,0x61,0x2e,0x61,0x61};
// aaa.aa.
const buffer_unit_t const_1_13[7] = {0x61,0x61,0x61,0x2e,0x61,0x61,0x2e};
// aaa.aaa.\xa
const buffer_unit_t const_1_14[9] = {0x61,0x61,0x61,0x2e,0x61,0x61,0x61,0x2e,0xa};
// aaaaa.
const buffer_unit_t const_1_15[6] = {0x61,0x61,0x61,0x61,0x61,0x2e};
// aaaaa.\xa
const buffer_unit_t const_1_16[7] = {0x61,0x61,0x61,0x61,0x61,0x2e,0xa};
// aaaaa.a
const buffer_unit_t const_1_17[7] = {0x61,0x61,0x61,0x61,0x61,0x2e,0x61};
// aaaaa.aa.
const buffer_unit_t const_1_18[9] = {0x61,0x61,0x61,0x61,0x61,0x2e,0x61,0x61,0x2e};
void printCompilationInfo()
{
  fprintf(stdout, "No object file generated!\nOptions:\nSST optimization level:  3\nWord size:               UInt8T\nIdentity tables removed: False\n\nSource file: ../../../benchmarks/submatch_dfa_aot/src/kleenex/33__rep_alt_5_3_2.kex\nSource md5:  f832418543 bcca51b128bc3 b7e1826\nSST states:  8\n");
}
      ...
      if (((avail >= 2) && (cmp(&next[0],(unsigned char *) "aa",2) && 1)))
      {
         if (((avail >= 3) && ((next[2] == 'a') && 1)))
         {
            if (((avail >= 5) && (cmp(&next[3],(unsigned char *) "aa",2) && 1)))
            {
               ...
               reset(&buf_3);
               appendarray(&buf_3,const_1_4,16);
               reset(&buf_2);
               appendarray(&buf_2,const_1_3,16);
               consume(5);
               goto l1_6;
            }
            reset(&buf_3);
            ...
            reset(&buf_1);
            appendarray(&buf_1,const_1_3,16);
      ...
      if (((avail >= 2) && (cmp(&next[0],(unsigned char *) "aa",2) && 1)))
      {
         if (((avail >= 3) && ((next[2] == 'a') && 1)))
         {
            if (((avail >= 5) && (cmp(&next[3],(unsigned char *) "aa",2) && 1)))
            {
               ...
               reset(&buf_3);
               reset(&buf_2);
               appendarray(&buf_2,const_1_10,32);
               consume(5);
               goto l1_6;
            }
            reset(&buf_3);
            ...
            reset(&buf_1);
            appendarray(&buf_1,const_1_10,32);
            consume(3);
            goto l1_5;
         }
         outputarray(const_1_5,24);
...
l1_2: if (!readnext(1, 5))
         ...
         if (((avail >= 2) && ((next[1] == 'a') && 1)))
         {
            if (((avail >= 3) && ((next[2] == 'a') && 1)))
            {
               if (((avail >= 4) && ((next[3] == 'a') && 1)))
               {
                  ...
                  reset(&buf_4);
                  appendarray(&buf_4,const_1_3,16);
                  reset(&buf_3);
                  appendarray(&buf_3,const_1_2,8);
                  reset(&buf_2);
               ...
               reset(&buf_3);
               appendarray(&buf_3,const_1_3,16);
               output(&buf_1);
               outputarray(const_1_2,8);
               reset(&buf_1);
      ...
      goto fail1;
l1_3: if (!readnext(1, 5))
      {
         goto fail1;
      }
      if (((avail >= 1) && ((next[0] == 10) && 1)))
      {
         outputarray(const_1_14,72);
         consume(1);
         goto l1_4;
      }
      if (((avail >= 1) && ((next[0] == 'a') && 1)))
      ...
      if (((avail >= 1) && ((next[0] == 'a') && 1)))
      {
         if (((avail >= 2) && ((next[1] == 'a') && 1)))
         {
            if (((avail >= 3) && ((next[2] == 'a') && 1)))
            {
               ...
               appendarray(&buf_3,const_1_7,40);
               consume(3);
               goto l1_7;
            }
            appendarray(&buf_3,const_1_5,24);
      ...
      if (((avail >= 1) && ((next[0] == 'a') && 1)))
      {
         if (((avail >= 2) && ((next[1] == 'a') && 1)))
         {
            if (((avail >= 3) && ((next[2] == 'a') && 1)))
            {
               ...
               concat(&buf_3,&buf_2);
               appendarray(&buf_3,const_1_12,48);
               reset(&buf_1);
            ...
            concat(&buf_3,&buf_2);
            appendarray(&buf_3,const_1_10,32);
            reset(&buf_1);
            appendarray(&buf_1,const_1_18,72);
            consume(2);
            goto l1_5;
         }
         output(&buf_3);
         output(&buf_2);
         outputarray(const_1_10,32);
         consume(1);
         goto l1_1;
      }
      goto fail1;
l1_7: if (!readnext(1, 5))
      {
         goto fail1;
      }
      if (((avail >= 1) && ((next[0] == 10) && 1)))
      ...
      if (((avail >= 1) && ((next[0] == 'a') && 1)))
      {
         if (((avail >= 2) && ((next[1] == 'a') && 1)))
         {
            if (((avail >= 3) && ((next[2] == 'a') && 1)))
            {
               ...
               reset(&buf_3);
               appendarray(&buf_3,const_1_9,64);
               output(&buf_1);
               reset(&buf_1);
               appendarray(&buf_1,const_1_10,32);
               consume(3);
            ...
            reset(&buf_3);
            appendarray(&buf_3,const_1_8,48);
            output(&buf_1);
            reset(&buf_1);
            appendarray(&buf_1,const_1_13,56);
            consume(2);
            goto l1_5;
         }
         output(&buf_1);
