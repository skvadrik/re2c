...
// ,
const buffer_unit_t const_1_1[1] = {0x2c};
void printCompilationInfo()
{
  fprintf(stdout, "No object file generated!\nOptions:\nSST optimization level:  3\nWord size:               UInt8T\nIdentity tables removed: False\n\nSource file: ../../../benchmarks/submatch_dfa_aot/src/kleenex/07__ipv4.kex\nSource md5:  c1c35f349c1fef94586727bc137db489\nSST states:  17\n");
}
...
l1_13: if (!readnext(1, 2))
       ...
       if (((avail >= 2) && ((('0' <= next[0]) && (next[0] <= '9')) && ((next[1] == 10) && 1))))
       {
          outputconst(next[0],8);
          outputarray(const_1_0,8);
          consume(2);
