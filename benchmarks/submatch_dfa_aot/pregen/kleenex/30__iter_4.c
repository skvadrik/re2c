...
// aaaa.
const buffer_unit_t const_1_1[5] = {0x61,0x61,0x61,0x61,0x2e};
void printCompilationInfo()
{
  fprintf(stdout, "No object file generated!\nOptions:\nSST optimization level:  3\nWord size:               UInt8T\nIdentity tables removed: False\n\nSource file: ../../../benchmarks/submatch_dfa_aot/src/kleenex/30__iter_4.kex\nSource md5:  3adb45e2225d 9ac8c811b35af95d1f9\nSST states:  3\n");
}
...
l1_0: if (!readnext(1, 4))
      ...
      if (((avail >= 4) && (cmp(&next[0],(unsigned char *) "aaaa",4) && 1)))
      {
         outputarray(const_1_1,40);
         consume(4);
         goto l1_1;
      }
      goto fail1;
