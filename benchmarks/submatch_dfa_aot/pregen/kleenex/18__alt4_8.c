...
// ACc
const buffer_unit_t const_1_6[3] = {0x41,0x43,0x63};
// ADd
const buffer_unit_t const_1_7[3] = {0x41,0x44,0x64};
// AEe
const buffer_unit_t const_1_8[3] = {0x41,0x45,0x65};
// AFf
const buffer_unit_t const_1_9[3] = {0x41,0x46,0x66};
// AGg
const buffer_unit_t const_1_10[3] = {0x41,0x47,0x67};
// AHh
const buffer_unit_t const_1_11[3] = {0x41,0x48,0x68};
// Aa
const buffer_unit_t const_1_12[2] = {0x41,0x61};
// Bb
const buffer_unit_t const_1_13[2] = {0x42,0x62};
// Cc
const buffer_unit_t const_1_14[2] = {0x43,0x63};
// Dd
const buffer_unit_t const_1_15[2] = {0x44,0x64};
// Ee
const buffer_unit_t const_1_16[2] = {0x45,0x65};
// Ff
const buffer_unit_t const_1_17[2] = {0x46,0x66};
// Gg
const buffer_unit_t const_1_18[2] = {0x47,0x67};
// Hh
const buffer_unit_t const_1_19[2] = {0x48,0x68};
// a
const buffer_unit_t const_1_20[1] = {0x61};
// b
const buffer_unit_t const_1_21[1] = {0x62};
// c
const buffer_unit_t const_1_22[1] = {0x63};
// d
const buffer_unit_t const_1_23[1] = {0x64};
// e
const buffer_unit_t const_1_24[1] = {0x65};
// f
const buffer_unit_t const_1_25[1] = {0x66};
// g
const buffer_unit_t const_1_26[1] = {0x67};
// h
const buffer_unit_t const_1_27[1] = {0x68};
void printCompilationInfo()
{
  fprintf(stdout, "No object file generated!\nOptions:\nSST optimization level:  3\nWord size:               UInt8T\nIdentity tables removed: False\n\nSource file: ../../../benchmarks/submatch_dfa_aot/src/kleenex/18__alt4_8.kex\nSource md5:  c759d39d809aa91140fbff351e3df05c\nSST states:  34\n");
}
...
l1_0: if (!readnext(1, 1))
      ...
      {
         reset(&buf_6);
         appendarray(&buf_6,const_1_13,16);
         reset(&buf_5);
         appendarray(&buf_5,const_1_13,16);
         reset(&buf_4);
         appendarray(&buf_4,const_1_13,16);
         reset(&buf_3);
      ...
      {
         reset(&buf_6);
         appendarray(&buf_6,const_1_14,16);
         reset(&buf_5);
         appendarray(&buf_5,const_1_14,16);
         reset(&buf_4);
         appendarray(&buf_4,const_1_14,16);
         reset(&buf_3);
         appendarray(&buf_3,const_1_6,24);
         consume(1);
         goto l1_28;
      }
      ...
      {
         reset(&buf_6);
         appendarray(&buf_6,const_1_15,16);
         reset(&buf_5);
         appendarray(&buf_5,const_1_15,16);
         reset(&buf_4);
         appendarray(&buf_4,const_1_15,16);
         reset(&buf_3);
         appendarray(&buf_3,const_1_7,24);
         consume(1);
         goto l1_29;
      }
      ...
      {
         reset(&buf_6);
         appendarray(&buf_6,const_1_16,16);
         reset(&buf_5);
         appendarray(&buf_5,const_1_16,16);
         reset(&buf_4);
         appendarray(&buf_4,const_1_16,16);
         reset(&buf_3);
         appendarray(&buf_3,const_1_8,24);
         consume(1);
         goto l1_30;
      }
      ...
      {
         reset(&buf_6);
         appendarray(&buf_6,const_1_17,16);
         reset(&buf_5);
         appendarray(&buf_5,const_1_17,16);
         reset(&buf_4);
         appendarray(&buf_4,const_1_17,16);
         reset(&buf_3);
         appendarray(&buf_3,const_1_9,24);
         consume(1);
         goto l1_31;
      }
      ...
      {
         reset(&buf_6);
         appendarray(&buf_6,const_1_18,16);
         reset(&buf_5);
         appendarray(&buf_5,const_1_18,16);
         reset(&buf_4);
         appendarray(&buf_4,const_1_18,16);
         reset(&buf_3);
         appendarray(&buf_3,const_1_10,24);
         consume(1);
         goto l1_32;
      }
      ...
      {
         reset(&buf_6);
         appendarray(&buf_6,const_1_19,16);
         reset(&buf_5);
         appendarray(&buf_5,const_1_19,16);
         reset(&buf_4);
         appendarray(&buf_4,const_1_19,16);
         reset(&buf_3);
         appendarray(&buf_3,const_1_11,24);
         consume(1);
         goto l1_33;
      }
      goto fail1;
l1_1: if (!readnext(1, 1))
      ...
      if (((avail >= 1) && ((next[0] == 'c') && 1)))
      {
         ...
         appendarray(&buf_4,const_1_14,16);
         reset(&buf_2);
         appendarray(&buf_2,const_1_6,24);
         consume(1);
         goto l1_21;
      }
      if (((avail >= 1) && ((next[0] == 'd') && 1)))
      {
         ...
         appendarray(&buf_4,const_1_15,16);
         reset(&buf_2);
         appendarray(&buf_2,const_1_7,24);
         consume(1);
         goto l1_22;
      }
      if (((avail >= 1) && ((next[0] == 'e') && 1)))
      {
         ...
         appendarray(&buf_4,const_1_16,16);
         reset(&buf_2);
         appendarray(&buf_2,const_1_8,24);
         consume(1);
         goto l1_23;
      }
      if (((avail >= 1) && ((next[0] == 'f') && 1)))
      {
         ...
         appendarray(&buf_4,const_1_17,16);
         reset(&buf_2);
         appendarray(&buf_2,const_1_9,24);
         consume(1);
         goto l1_24;
      }
      if (((avail >= 1) && ((next[0] == 'g') && 1)))
      {
         ...
         appendarray(&buf_4,const_1_18,16);
         reset(&buf_2);
         appendarray(&buf_2,const_1_10,24);
         consume(1);
         goto l1_25;
      }
      if (((avail >= 1) && ((next[0] == 'h') && 1)))
      {
         ...
         appendarray(&buf_4,const_1_19,16);
         reset(&buf_2);
         appendarray(&buf_2,const_1_11,24);
         consume(1);
         goto l1_26;
      }
      goto fail1;
...
l1_10: if (!readnext(1, 1))
       ...
       if (((avail >= 1) && ((next[0] == 'a') && 1)))
       {
          appendarray(&buf_4,const_1_20,8);
          appendarray(&buf_1,const_1_20,8);
          consume(1);
          goto l1_10;
       }
       if (((avail >= 1) && ((next[0] == 'b') && 1)))
...
l1_11: if (!readnext(1, 1))
       ...
       if (((avail >= 1) && ((next[0] == 'b') && 1)))
       {
          appendarray(&buf_4,const_1_21,8);
...
l1_12: if (!readnext(1, 1))
       ...
       if (((avail >= 1) && ((next[0] == 'c') && 1)))
       {
          appendarray(&buf_4,const_1_22,8);
          appendarray(&buf_1,const_1_22,8);
          consume(1);
          goto l1_12;
       }
       if (((avail >= 1) && ((next[0] == 'd') && 1)))
...
l1_13: if (!readnext(1, 1))
       ...
       if (((avail >= 1) && ((next[0] == 'd') && 1)))
       {
          appendarray(&buf_4,const_1_23,8);
          appendarray(&buf_1,const_1_23,8);
          consume(1);
          goto l1_13;
       }
       if (((avail >= 1) && ((next[0] == 'e') && 1)))
...
l1_14: if (!readnext(1, 1))
       ...
       if (((avail >= 1) && ((next[0] == 'e') && 1)))
       {
          appendarray(&buf_4,const_1_24,8);
          appendarray(&buf_1,const_1_24,8);
          consume(1);
          goto l1_14;
       }
       if (((avail >= 1) && ((next[0] == 'f') && 1)))
...
l1_15: if (!readnext(1, 1))
       ...
       if (((avail >= 1) && ((next[0] == 'f') && 1)))
       {
          appendarray(&buf_4,const_1_25,8);
          appendarray(&buf_1,const_1_25,8);
          consume(1);
          goto l1_15;
       }
       if (((avail >= 1) && ((next[0] == 'g') && 1)))
...
l1_16: if (!readnext(1, 1))
       ...
       if (((avail >= 1) && ((next[0] == 'g') && 1)))
       {
          appendarray(&buf_4,const_1_26,8);
          appendarray(&buf_1,const_1_26,8);
          consume(1);
          goto l1_16;
       }
       if (((avail >= 1) && ((next[0] == 'h') && 1)))
...
l1_17: if (!readnext(1, 1))
       ...
       if (((avail >= 1) && ((next[0] == 'h') && 1)))
       {
          appendarray(&buf_4,const_1_27,8);
          appendarray(&buf_1,const_1_27,8);
          consume(1);
          goto l1_17;
       }
       goto fail1;
...
l1_19: if (!readnext(1, 1))
       ...
       if (((avail >= 1) && ((next[0] == 'a') && 1)))
       {
          appendarray(&buf_5,const_1_20,8);
          appendarray(&buf_4,const_1_20,8);
          appendarray(&buf_2,const_1_20,8);
          consume(1);
          goto l1_19;
       }
       if (((avail >= 1) && ((next[0] == 'b') && 1)))
       {
          ...
          concat(&buf_1,&buf_5);
          appendarray(&buf_1,const_1_13,16);
          consume(1);
          goto l1_11;
       }
       if (((avail >= 1) && ((next[0] == 'c') && 1)))
       {
          ...
          appendarray(&buf_1,const_1_1,8);
          concat(&buf_1,&buf_5);
          appendarray(&buf_1,const_1_14,16);
          consume(1);
          goto l1_12;
       }
       if (((avail >= 1) && ((next[0] == 'd') && 1)))
       {
          ...
          appendarray(&buf_1,const_1_1,8);
          concat(&buf_1,&buf_5);
          appendarray(&buf_1,const_1_15,16);
          consume(1);
          goto l1_13;
       }
       if (((avail >= 1) && ((next[0] == 'e') && 1)))
       {
          ...
          appendarray(&buf_1,const_1_1,8);
          concat(&buf_1,&buf_5);
          appendarray(&buf_1,const_1_16,16);
          consume(1);
          goto l1_14;
       }
       if (((avail >= 1) && ((next[0] == 'f') && 1)))
       {
          ...
          appendarray(&buf_1,const_1_1,8);
          concat(&buf_1,&buf_5);
          appendarray(&buf_1,const_1_17,16);
          consume(1);
          goto l1_15;
       }
       if (((avail >= 1) && ((next[0] == 'g') && 1)))
       {
          ...
          appendarray(&buf_1,const_1_1,8);
          concat(&buf_1,&buf_5);
          appendarray(&buf_1,const_1_18,16);
          consume(1);
          goto l1_16;
       }
       if (((avail >= 1) && ((next[0] == 'h') && 1)))
...
l1_20: if (!readnext(1, 1))
       ...
       if (((avail >= 1) && ((next[0] == 'a') && 1)))
       {
          appendarray(&buf_4,const_1_12,16);
          reset(&buf_1);
          appendarray(&buf_1,const_1_1,8);
          concat(&buf_1,&buf_5);
       ...
       if (((avail >= 1) && ((next[0] == 'b') && 1)))
       {
          ...
          appendarray(&buf_4,const_1_21,8);
          appendarray(&buf_2,const_1_21,8);
          consume(1);
          goto l1_20;
       }
       if (((avail >= 1) && ((next[0] == 'c') && 1)))
...
l1_21: if (!readnext(1, 1))
       ...
       if (((avail >= 1) && ((next[0] == 'c') && 1)))
       {
          appendarray(&buf_5,const_1_22,8);
          appendarray(&buf_4,const_1_22,8);
          appendarray(&buf_2,const_1_22,8);
          consume(1);
          goto l1_21;
       }
       if (((avail >= 1) && ((next[0] == 'd') && 1)))
...
l1_22: if (!readnext(1, 1))
       ...
       if (((avail >= 1) && ((next[0] == 'd') && 1)))
       {
          appendarray(&buf_5,const_1_23,8);
          appendarray(&buf_4,const_1_23,8);
          appendarray(&buf_2,const_1_23,8);
          consume(1);
          goto l1_22;
       }
       if (((avail >= 1) && ((next[0] == 'e') && 1)))
...
l1_23: if (!readnext(1, 1))
       ...
       if (((avail >= 1) && ((next[0] == 'e') && 1)))
       {
          appendarray(&buf_5,const_1_24,8);
          appendarray(&buf_4,const_1_24,8);
          appendarray(&buf_2,const_1_24,8);
          consume(1);
          goto l1_23;
       }
       if (((avail >= 1) && ((next[0] == 'f') && 1)))
...
l1_24: if (!readnext(1, 1))
       ...
       if (((avail >= 1) && ((next[0] == 'f') && 1)))
       {
          appendarray(&buf_5,const_1_25,8);
          appendarray(&buf_4,const_1_25,8);
          appendarray(&buf_2,const_1_25,8);
          consume(1);
          goto l1_24;
       }
       if (((avail >= 1) && ((next[0] == 'g') && 1)))
...
l1_25: if (!readnext(1, 1))
       ...
       if (((avail >= 1) && ((next[0] == 'g') && 1)))
       {
          appendarray(&buf_5,const_1_26,8);
          appendarray(&buf_4,const_1_26,8);
          appendarray(&buf_2,const_1_26,8);
          consume(1);
          goto l1_25;
       }
       if (((avail >= 1) && ((next[0] == 'h') && 1)))
...
l1_26: if (!readnext(1, 1))
       ...
       if (((avail >= 1) && ((next[0] == 'h') && 1)))
       {
          appendarray(&buf_5,const_1_27,8);
          appendarray(&buf_4,const_1_27,8);
          appendarray(&buf_2,const_1_27,8);
          consume(1);
          goto l1_26;
       }
       goto fail1;
l1_27: if (!readnext(1, 1))
       ...
       if (((avail >= 1) && ((next[0] == 'a') && 1)))
       {
          ...
          concat(&buf_2,&buf_6);
          appendarray(&buf_2,const_1_12,16);
          consume(1);
          goto l1_19;
       }
       if (((avail >= 1) && ((next[0] == 'b') && 1)))
       {
          appendarray(&buf_6,const_1_21,8);
          appendarray(&buf_5,const_1_21,8);
          appendarray(&buf_4,const_1_21,8);
          appendarray(&buf_3,const_1_21,8);
          consume(1);
          goto l1_27;
       }
       if (((avail >= 1) && ((next[0] == 'c') && 1)))
       {
          ...
          appendarray(&buf_2,const_1_1,8);
          concat(&buf_2,&buf_6);
          appendarray(&buf_2,const_1_14,16);
          consume(1);
          goto l1_21;
       }
       if (((avail >= 1) && ((next[0] == 'd') && 1)))
       {
          ...
          appendarray(&buf_2,const_1_1,8);
          concat(&buf_2,&buf_6);
          appendarray(&buf_2,const_1_15,16);
          consume(1);
          goto l1_22;
       }
       if (((avail >= 1) && ((next[0] == 'e') && 1)))
       ...
       if (((avail >= 1) && ((next[0] == 'f') && 1)))
       {
          ...
          appendarray(&buf_2,const_1_1,8);
          concat(&buf_2,&buf_6);
          appendarray(&buf_2,const_1_17,16);
          consume(1);
          goto l1_24;
       }
       if (((avail >= 1) && ((next[0] == 'g') && 1)))
...
l1_28: if (!readnext(1, 1))
       ...
       if (((avail >= 1) && ((next[0] == 'b') && 1)))
       {
          ...
          appendarray(&buf_2,const_1_1,8);
          concat(&buf_2,&buf_6);
          appendarray(&buf_2,const_1_13,16);
          consume(1);
          goto l1_20;
       }
       if (((avail >= 1) && ((next[0] == 'c') && 1)))
       {
          appendarray(&buf_6,const_1_22,8);
          appendarray(&buf_5,const_1_22,8);
          appendarray(&buf_4,const_1_22,8);
          appendarray(&buf_3,const_1_22,8);
          consume(1);
          goto l1_28;
       }
       if (((avail >= 1) && ((next[0] == 'd') && 1)))
...
l1_29: if (!readnext(1, 1))
       ...
       if (((avail >= 1) && ((next[0] == 'd') && 1)))
       {
          appendarray(&buf_6,const_1_23,8);
          appendarray(&buf_5,const_1_23,8);
          appendarray(&buf_4,const_1_23,8);
          appendarray(&buf_3,const_1_23,8);
          consume(1);
          goto l1_29;
       }
       if (((avail >= 1) && ((next[0] == 'e') && 1)))
...
l1_30: if (!readnext(1, 1))
       ...
       if (((avail >= 1) && ((next[0] == 'e') && 1)))
       {
          appendarray(&buf_6,const_1_24,8);
          appendarray(&buf_5,const_1_24,8);
          appendarray(&buf_4,const_1_24,8);
          appendarray(&buf_3,const_1_24,8);
          consume(1);
          goto l1_30;
       }
       if (((avail >= 1) && ((next[0] == 'f') && 1)))
...
l1_31: if (!readnext(1, 1))
       ...
       if (((avail >= 1) && ((next[0] == 'f') && 1)))
       {
          appendarray(&buf_6,const_1_25,8);
          appendarray(&buf_5,const_1_25,8);
          appendarray(&buf_4,const_1_25,8);
          appendarray(&buf_3,const_1_25,8);
          consume(1);
          goto l1_31;
       }
       if (((avail >= 1) && ((next[0] == 'g') && 1)))
...
l1_32: if (!readnext(1, 1))
       ...
       if (((avail >= 1) && ((next[0] == 'g') && 1)))
       {
          appendarray(&buf_6,const_1_26,8);
          appendarray(&buf_5,const_1_26,8);
          appendarray(&buf_4,const_1_26,8);
          appendarray(&buf_3,const_1_26,8);
          consume(1);
          goto l1_32;
       }
       if (((avail >= 1) && ((next[0] == 'h') && 1)))
...
l1_33: if (!readnext(1, 1))
       ...
       if (((avail >= 1) && ((next[0] == 'h') && 1)))
       {
          appendarray(&buf_6,const_1_27,8);
          appendarray(&buf_5,const_1_27,8);
          appendarray(&buf_4,const_1_27,8);
          appendarray(&buf_3,const_1_27,8);
          consume(1);
          goto l1_33;
       }
       goto fail1;
