...
const buffer_unit_t const_1_1[65] = {0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x2e};
void printCompilationInfo()
{
  fprintf(stdout, "No object file generated!\nOptions:\nSST optimization level:  3\nWord size:               UInt8T\nIdentity tables removed: False\n\nSource file: ../../../benchmarks/submatch_dfa_aot/src/kleenex/32__iter_64.kex\nSource md5:  a9c24a1bb4ae8b 34398c6c0d8d8c732\nSST states:  3\n");
}
...
l1_0: if (!readnext(1, 64))
      ...
      if (((avail >= '@') && (cmp(&next[0],(unsigned char *) "aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa",64) && 1)))
      {
         outputarray(const_1_1,520);
         consume(64);
         goto l1_1;
      }
      goto fail1;
l1_1: if (!readnext(1, 64))
      {
         goto fail1;
      }
      if (((avail >= 1) && ((next[0] == 10) && 1)))
