...
yyFillLabel0:
	...
	switch (yych) {
		case '\n':
			in->yyt3 = in->yyt5 = in->yyt6 = in->yyt9 = in->yyt10 = in->yyt13 = in->yyt14 = in->yyt16 = NULL;
			in->yyt1 = in->yyt2 = in->yyt4 = in->yyt7 = in->yyt8 = in->yyt11 = in->yyt12 = in->yyt15 = in->cur;
			goto yy3;
		case 'a':
			in->yyt1 = in->cur;
			goto yy4;
		case 'b':
			in->yyt5 = in->yyt6 = in->yyt9 = in->yyt10 = in->yyt13 = in->yyt14 = NULL;
			in->yyt1 = in->yyt4 = in->yyt7 = in->yyt8 = in->yyt11 = in->yyt12 = in->yyt16 = in->cur;
			goto yy5;
		default:
			if (in->lim <= in->cur) {
...
#line 17 "../../../benchmarks/submatch_dfa_aot/src/re2c/16__alt4_2.re"
	{ return 1; }
#line 264 "gen/re2c/16__alt4_2-eof-tdfa1.c"
yy3:
	++in->cur;
	a1 = in->yyt1;
	a2 = in->yyt4;
...
#line 296 "gen/re2c/16__alt4_2-eof-tdfa1.c"
yy4:
	in->mar = ++in->cur;
yyFillLabel1:
	yych = *in->cur;
...
yy7:
	switch (yych) {
		case '\n':
			in->yyt3 = in->yyt5 = in->yyt6 = in->yyt9 = in->yyt10 = in->yyt13 = in->yyt14 = in->yyt16 = NULL;
			in->yyt2 = in->yyt4 = in->yyt7 = in->yyt8 = in->yyt11 = in->yyt12 = in->yyt15 = in->cur;
			goto yy3;
		case 'a': goto yy6;
		case 'b':
			in->yyt5 = in->yyt6 = in->yyt9 = in->yyt10 = in->yyt13 = in->yyt14 = NULL;
			in->yyt2 = in->yyt4 = in->yyt7 = in->yyt8 = in->yyt11 = in->yyt12 = in->yyt16 = in->cur;
			goto yy9;
		default:
			if (in->lim <= in->cur) {
...
yyFillLabel4:
	...
	switch (yych) {
		case '\n':
			in->yyt2 = in->yyt15 = NULL;
			in->yyt3 = in->cur;
			goto yy3;
		case 'a':
			in->yyt3 = in->yyt11 = in->yyt12 = NULL;
...
yyFillLabel5:
	...
	switch (yych) {
		case '\n':
			in->yyt13 = in->yyt1;
			in->yyt3 = in->yyt16 = NULL;
			in->yyt2 = in->cur;
			goto yy3;
		case 'a': goto yy10;
		case 'b':
			in->yyt9 = in->yyt10 = in->yyt13 = in->yyt14 = NULL;
			in->yyt7 = in->yyt8 = in->yyt12 = in->yyt16 = in->cur;
			goto yy14;
		default:
			if (in->lim <= in->cur) {
...
yy12:
	switch (yych) {
		case '\n':
			...
			goto yy3;
		case 'a':
			in->yyt2 = in->yyt11 = in->yyt12 = NULL;
...
#line 5 "../../../benchmarks/submatch_dfa_aot/src/re2c/include-eof/fill.re"
	{ return 0; }
#line 503 "gen/re2c/16__alt4_2-eof-tdfa1.c"
}
