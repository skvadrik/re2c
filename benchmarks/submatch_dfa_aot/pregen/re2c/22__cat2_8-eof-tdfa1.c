...
#line 252 "gen/re2c/22__cat2_8-eof-tdfa1.c"
{
	char yych;
yyFillLabel3_0:
	yych = *in->cur;
...
#line 11 "../../../benchmarks/submatch_dfa_aot/src/re2c/22__cat2_8.re"
	{ return 1; }
#line 273 "gen/re2c/22__cat2_8-eof-tdfa1.c"
yy4:
	in->mar = ++in->cur;
yyFillLabel3_1:
	yych = *in->cur;
...
#line 680 "gen/re2c/22__cat2_8-eof-tdfa1.c"
yy33:
	++in->cur;
yyFillLabel3_25:
	yych = *in->cur;
...
#line 5 "../../../benchmarks/submatch_dfa_aot/src/re2c/include-eof/fill.re"
	{ return 0; }
#line 737 "gen/re2c/22__cat2_8-eof-tdfa1.c"
}
