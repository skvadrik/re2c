...
#line 252 "gen/re2c/cat2_8-eof-tdfa1-es.c"
{
	char yych;
yyFillLabel3_0:
	yych = *in->cur;
...
#line 11 "../../../benchmarks/submatch_dfa_aot/src/re2c/cat2_8.re"
	{ return 1; }
#line 274 "gen/re2c/cat2_8-eof-tdfa1-es.c"
yy4:
	in->mar = in->cur;
yyFillLabel3_1:
	yych = *in->cur;
...
#line 694 "gen/re2c/cat2_8-eof-tdfa1-es.c"
yy33:
yyFillLabel3_25:
	yych = *in->cur;
	switch (yych) {
...
#line 5 "../../../benchmarks/submatch_dfa_aot/src/re2c/include_eof/fill.re"
	{ return 0; }
#line 762 "gen/re2c/cat2_8-eof-tdfa1-es.c"
}
