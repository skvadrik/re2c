...
#line 168 "gen/re2c/05__datetime-tdfa1.c"
{
	char yych;
...
#line 3 "../../../benchmarks/submatch_dfa_aot/src/re2c/include/fill.re"
	{ return 0; }
#line 195 "gen/re2c/05__datetime-tdfa1.c"
yy4:
	++in->cur;
yy5:
#line 20 "../../../benchmarks/submatch_dfa_aot/src/re2c/05__datetime.re"
	{ return 1; }
#line 201 "gen/re2c/05__datetime-tdfa1.c"
yy6:
	yych = *(in->mar = ++in->cur);
	switch (yych) {
	case '0':
...
#line 579 "gen/re2c/05__datetime-tdfa1.c"
yy41:
	yych = *++in->cur;
	switch (yych) {
	case ':':	goto yy42;
