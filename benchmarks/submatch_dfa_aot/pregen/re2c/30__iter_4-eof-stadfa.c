...
#line 1 "../../../benchmarks/submatch_dfa_aot/src/re2c/30__iter_4.re"
#include <assert.h>
#include <stdlib.h>
#include "common.h"
...
#line 172 "gen/re2c/30__iter_4-eof-stadfa.c"
{
	char yych;
yyFillLabel3_0:
	yych = *in->cur;
...
yy2:
	++in->cur;
yy3:
#line 23 "../../../benchmarks/submatch_dfa_aot/src/re2c/30__iter_4.re"
	{ return 1; }
#line 192 "gen/re2c/30__iter_4-eof-stadfa.c"
yy4:
	++in->cur;
	taglist(&in->yyt1, in->tok, in->tok - 1, &in->tlp);
yy5:
	t = in->yyt1;
#line 24 "../../../benchmarks/submatch_dfa_aot/src/re2c/30__iter_4.re"
	{
        print(out, in->tok, t);
        outc(out, '\n');
...
#line 205 "gen/re2c/30__iter_4-eof-stadfa.c"
yy6:
	in->mar = ++in->cur;
yyFillLabel3_1:
	yych = *in->cur;
...
#line 5 "../../../benchmarks/submatch_dfa_aot/src/re2c/include-eof/fill.re"
	{ return 0; }
#line 280 "gen/re2c/30__iter_4-eof-stadfa.c"
}
#line 30 "../../../benchmarks/submatch_dfa_aot/src/re2c/30__iter_4.re"
