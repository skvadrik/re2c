...
#line 207 "gen/re2c/cat2_4-bc-tdfa1-es.c"
{
	char yych;
...
#line 3 "../../../benchmarks/submatch_dfa_aot/src/re2c/include_bc/fill.re"
	{ return 0; }
#line 227 "gen/re2c/cat2_4-bc-tdfa1-es.c"
yy4:
yy5:
#line 11 "../../../benchmarks/submatch_dfa_aot/src/re2c/cat2_4.re"
	{ return 1; }
#line 232 "gen/re2c/cat2_4-bc-tdfa1-es.c"
yy6:
	yych = *(in->mar = in->cur);
	switch (yych) {
	case 'a':
...
#line 392 "gen/re2c/cat2_4-bc-tdfa1-es.c"
yy23:
	if ((in->lim - in->cur) < 4) if (fill(in, 4) != 0) return 1;
	yych = *in->cur;
	switch (yych) {
