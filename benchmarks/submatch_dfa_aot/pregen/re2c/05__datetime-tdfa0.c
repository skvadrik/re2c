...
#line 168 "gen/re2c/05__datetime-tdfa0.c"
{
	char yych;
	in->yyt1 = in->cur;
...
#line 3 "../../../benchmarks/submatch_dfa_aot/src/re2c/include/fill.re"
	{ return 0; }
#line 191 "gen/re2c/05__datetime-tdfa0.c"
yy4:
yy5:
#line 20 "../../../benchmarks/submatch_dfa_aot/src/re2c/05__datetime.re"
	{ return 1; }
#line 196 "gen/re2c/05__datetime-tdfa0.c"
yy6:
	yych = *(in->mar = in->cur);
	switch (yych) {
	case '0':
...
#line 645 "gen/re2c/05__datetime-tdfa0.c"
yy41:
	yych = *in->cur;
	switch (yych) {
	case ':':
