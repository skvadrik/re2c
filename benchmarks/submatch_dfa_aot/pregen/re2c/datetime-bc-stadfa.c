...
#line 174 "gen/re2c/datetime-bc-stadfa.c"
{
	char yych;
...
#line 3 "../../../benchmarks/submatch_dfa_aot/src/re2c/include_bc/fill.re"
	{ return 0; }
#line 197 "gen/re2c/datetime-bc-stadfa.c"
yy4:
	++in->cur;
yy5:
#line 20 "../../../benchmarks/submatch_dfa_aot/src/re2c/datetime.re"
	{ return 1; }
#line 203 "gen/re2c/datetime-bc-stadfa.c"
yy6:
	yych = *(in->mar = ++in->cur);
	in->yyt2 = in->cur - 1;
	switch (yych) {
...
#line 590 "gen/re2c/datetime-bc-stadfa.c"
yy41:
	yych = *++in->cur;
	switch (yych) {
	case ':':	goto yy42;
