...
#line 190 "gen/re2c/30__rep_cat_5_3_2-tdfa1.c"
{
	char yych;
...
#line 3 "../../../benchmarks/submatch_dfa_aot/src/re2c/include/fill.re"
	{ return 0; }
#line 209 "gen/re2c/30__rep_cat_5_3_2-tdfa1.c"
yy4:
	++in->cur;
yy5:
#line 32 "../../../benchmarks/submatch_dfa_aot/src/re2c/30__rep_cat_5_3_2.re"
	{ return 1; }
#line 215 "gen/re2c/30__rep_cat_5_3_2-tdfa1.c"
yy6:
	++in->cur;
	t1 = in->yyt1;
	t2 = in->yyt2;
...
#line 228 "gen/re2c/30__rep_cat_5_3_2-tdfa1.c"
yy8:
	yych = *(in->mar = ++in->cur);
	switch (yych) {
	case 'a':	goto yy9;
