...
#line 196 "gen/re2c/http_simple-bc-tdfa1.c"
{
	char yych;
...
#line 3 "../../../benchmarks/submatch_dfa_aot/src/re2c/include_bc/fill.re"
	{ return 0; }
#line 290 "gen/re2c/http_simple-bc-tdfa1.c"
yy4:
	++in->cur;
yy5:
#line 50 "../../../benchmarks/submatch_dfa_aot/src/re2c/http_simple.re"
	{ return 1; }
#line 296 "gen/re2c/http_simple-bc-tdfa1.c"
yy6:
	yych = *(in->mar = ++in->cur);
	switch (yych) {
	case ' ':
...
#line 1758 "gen/re2c/http_simple-bc-tdfa1.c"
yy56:
	++in->cur;
