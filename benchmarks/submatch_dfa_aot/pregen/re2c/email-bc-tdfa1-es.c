...
#line 6 "../../../benchmarks/submatch_dfa_aot/src/re2c/include_bc/fill_email.re"
...
#line 170 "gen/re2c/email-bc-tdfa1-es.c"
{
	char yych;
	goto yy0;
yy1:
...
#line 29 "../../../benchmarks/submatch_dfa_aot/src/re2c/email.re"
	{ goto loop; }
#line 249 "gen/re2c/email-bc-tdfa1-es.c"
yy6:
...
#line 546 "gen/re2c/email-bc-tdfa1-es.c"
yy18:
	if (in->lim <= in->cur) if (fill(in, 1) != 0) return 0;
	yych = *in->cur++;
	switch (yych) {
