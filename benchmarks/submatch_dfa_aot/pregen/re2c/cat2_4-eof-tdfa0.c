...
#line 1 "../../../benchmarks/submatch_dfa_aot/src/re2c/cat2_4.re"
#include <assert.h>
#include <stdlib.h>
#include "common.h"
...
#line 213 "gen/re2c/cat2_4-eof-tdfa0.c"
{
	char yych;
...
yy2:
yy3:
#line 11 "../../../benchmarks/submatch_dfa_aot/src/re2c/cat2_4.re"
	{ return 1; }
#line 236 "gen/re2c/cat2_4-eof-tdfa0.c"
yy4:
	in->mar = in->cur;
yyFillLabel3_1:
	yych = *in->cur;
...
yy19:
	...
	a1 = in->yyt3;
	b1 = in->yyt4;
#line 15 "../../../benchmarks/submatch_dfa_aot/src/re2c/cat2_4.re"
	{
        outs(out, a0, b0); outc(out, '.'); outs(out, b0, a1); outc(out, '.');
        outs(out, a1, b1); outc(out, '.'); outs(out, b1, in->cur);
        goto loop;
    }
#line 464 "gen/re2c/cat2_4-eof-tdfa0.c"
yy21:
yyFillLabel3_13:
	yych = *in->cur;
	switch (yych) {
...
#line 5 "../../../benchmarks/submatch_dfa_aot/src/re2c/include_eof/fill.re"
	{ return 0; }
#line 534 "gen/re2c/cat2_4-eof-tdfa0.c"
}
#line 20 "../../../benchmarks/submatch_dfa_aot/src/re2c/cat2_4.re"
