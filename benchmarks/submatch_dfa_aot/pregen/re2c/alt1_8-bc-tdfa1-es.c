...
#line 210 "gen/re2c/alt1_8-bc-tdfa1-es.c"
{
	char yych;
...
#line 3 "../../../benchmarks/submatch_dfa_aot/src/re2c/include_bc/fill.re"
	{ return 0; }
#line 263 "gen/re2c/alt1_8-bc-tdfa1-es.c"
yy4:
yy5:
#line 11 "../../../benchmarks/submatch_dfa_aot/src/re2c/alt1_8.re"
	{ return 1; }
#line 268 "gen/re2c/alt1_8-bc-tdfa1-es.c"
yy6:
	a1 = in->yyt1;
	a2 = in->yyt2;
	b1 = in->yyt10;
...
#line 299 "gen/re2c/alt1_8-bc-tdfa1-es.c"
yy8:
	yych = *(in->mar = in->cur);
	switch (yych) {
	case '\n':
