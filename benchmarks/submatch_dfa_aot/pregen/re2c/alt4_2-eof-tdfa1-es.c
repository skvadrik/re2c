...
#line 216 "gen/re2c/alt4_2-eof-tdfa1-es.c"
{
	char yych;
yyFillLabel3_0:
	yych = *in->cur;
	...
	case 'b':
		...
		in->yyt1 = in->yyt2 = in->yyt4 = in->yyt7 = in->yyt8 = in->yyt11 = in->yyt12 = in->yyt16 = in->cur;
		++in->cur;
		goto yy7;
	default:
		if (in->lim <= in->cur) {
...
#line 17 "../../../benchmarks/submatch_dfa_aot/src/re2c/alt4_2.re"
	{ return 1; }
#line 248 "gen/re2c/alt4_2-eof-tdfa1-es.c"
yy4:
	a1 = in->yyt1;
	a2 = in->yyt4;
	b1 = in->yyt5;
...
#line 279 "gen/re2c/alt4_2-eof-tdfa1-es.c"
yy6:
	in->mar = in->cur;
yyFillLabel3_1:
	yych = *in->cur;
...
yyFillLabel3_5:
	...
	case 'b':
		...
		in->yyt8 = in->yyt12 = in->yyt16 = in->cur;
		++in->cur;
		goto yy19;
	default:
		if (in->lim <= in->cur) {
...
#line 5 "../../../benchmarks/submatch_dfa_aot/src/re2c/include_eof/fill.re"
	{ return 0; }
#line 508 "gen/re2c/alt4_2-eof-tdfa1-es.c"
}
