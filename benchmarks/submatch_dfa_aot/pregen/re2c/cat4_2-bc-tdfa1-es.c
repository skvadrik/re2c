...
#line 252 "gen/re2c/cat4_2-bc-tdfa1-es.c"
{
	char yych;
...
#line 3 "../../../benchmarks/submatch_dfa_aot/src/re2c/include_bc/fill.re"
	{ return 0; }
#line 272 "gen/re2c/cat4_2-bc-tdfa1-es.c"
yy4:
yy5:
#line 11 "../../../benchmarks/submatch_dfa_aot/src/re2c/cat4_2.re"
	{ return 1; }
#line 277 "gen/re2c/cat4_2-bc-tdfa1-es.c"
yy6:
	yych = *(in->mar = in->cur);
	switch (yych) {
	case 'a':
...
#line 627 "gen/re2c/cat4_2-bc-tdfa1-es.c"
yy41:
	if ((in->lim - in->cur) < 6) if (fill(in, 6) != 0) return 1;
	yych = *in->cur;
	switch (yych) {
