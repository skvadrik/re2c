...
#line 171 "gen/re2c/20__cat2_0-eof-tdfa1.c"
{
	char yych;
yyFillLabel3_0:
	yych = *in->cur;
...
#line 11 "../../../benchmarks/submatch_dfa_aot/src/re2c/20__cat2_0.re"
	{ return 1; }
#line 198 "gen/re2c/20__cat2_0-eof-tdfa1.c"
yy4:
	++in->cur;
	a0 = in->yyt1;
	b0 = in->yyt4;
...
#line 211 "gen/re2c/20__cat2_0-eof-tdfa1.c"
yy6:
	in->mar = ++in->cur;
yyFillLabel3_1:
	yych = *in->cur;
...
#line 5 "../../../benchmarks/submatch_dfa_aot/src/re2c/include-eof/fill.re"
	{ return 0; }
#line 315 "gen/re2c/20__cat2_0-eof-tdfa1.c"
}
