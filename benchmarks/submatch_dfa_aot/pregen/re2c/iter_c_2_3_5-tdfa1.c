...
#line 198 "gen/re2c/iter_c_2_3_5-tdfa1.c"
{
	char yych;
...
#line 3 "../../../benchmarks/submatch_dfa_aot/src/re2c/include/fill.re"
	{ return 0; }
#line 224 "gen/re2c/iter_c_2_3_5-tdfa1.c"
yy4:
	++in->cur;
yy5:
#line 28 "../../../benchmarks/submatch_dfa_aot/src/re2c/iter_c_2_3_5.re"
	{ return 1; }
#line 230 "gen/re2c/iter_c_2_3_5-tdfa1.c"
yy6:
	++in->cur;
	t1 = in->yyt2;
	t2 = in->yyt3;
...
#line 246 "gen/re2c/iter_c_2_3_5-tdfa1.c"
yy8:
	yych = *(in->mar = ++in->cur);
	switch (yych) {
	case 'a':	goto yy9;
