...
#line 255 "gen/re2c/cat2_8-bc-tdfa1-es.c"
{
	char yych;
...
#line 3 "../../../benchmarks/submatch_dfa_aot/src/re2c/include_bc/fill.re"
	{ return 0; }
#line 275 "gen/re2c/cat2_8-bc-tdfa1-es.c"
yy4:
yy5:
#line 11 "../../../benchmarks/submatch_dfa_aot/src/re2c/cat2_8.re"
	{ return 1; }
#line 280 "gen/re2c/cat2_8-bc-tdfa1-es.c"
yy6:
	yych = *(in->mar = in->cur);
	switch (yych) {
	case 'a':
...
#line 580 "gen/re2c/cat2_8-bc-tdfa1-es.c"
yy35:
	if ((in->lim - in->cur) < 8) if (fill(in, 8) != 0) return 1;
	yych = *in->cur;
	switch (yych) {
