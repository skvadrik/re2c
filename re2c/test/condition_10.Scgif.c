...
int main ()
{
    if (lex_line126_Comment () != 0) return 1;
    if (lex_line126_Normal () != 0) return 1;
    if (lex_line126_Skiptoeol () != 0) return 1;
    if (lex_line126_String () != 0) return 1;
    return 0;
}
*/* *.*0*ÿ )+ÿ??(??)??<??>??=??/??'??!??-?? ?? ??"??&??*??,??.??0??;?????ÿ? ?>?@?ÿ///*/ /)/+/./0/ÿ'"''" '"&'"('"ÿ'\"''\" '\"&'\"('\"ÿ'\ '\!'\#'\ÿ' '!'#'[']'ÿ" !#&(.0>@ÿ 
	??/
??/ ??/	??/??/ÿ??/
??/ ??/	??/??/??/??/ÿ?? ??.??0??ÿ? ?>?@?ÿ\
\ \	\\ÿ\
