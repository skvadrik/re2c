...
yy18:
        YYSKIP ();
        status = action_line18_r2(i, keys, input, token, &cursor, 9);
        continue;
yy20:
        YYSKIP ();
        status = action_line18_r2(i, keys, input, token, &cursor, 8);
        continue;
yy22:
        YYSKIP ();
...
yy18:
        YYSKIP ();
        status = action_line28_r2(i, keys, input, token, &cursor, 9);
        continue;
yy20:
        YYSKIP ();
        status = action_line28_r2(i, keys, input, token, &cursor, 8);
        continue;
yy22:
        YYSKIP ();
