...
int lex_line18_r1()
{
    ...
    input = (YYCTYPE *) read_file
        ("repeat-03.cgir--skeleton.c.line18_r1.input"
        , sizeof (YYCTYPE)
        , padding
        , &input_len
        );
...
yy4:
        YYSKIP ();
        status = action_line18_r1(i, keys, input, token, &cursor, 4);
        continue;
yy6:
        YYSKIP ();
...
yy10:
        YYSKIP ();
        status = action_line18_r1(i, keys, input, token, &cursor, 0);
        continue;
yy12:
        YYSKIP ();
        status = action_line18_r1(i, keys, input, token, &cursor, 1);
        continue;
...
int lex_line18_r2()
{
    ...
    input = (YYCTYPE *) read_file
        ("repeat-03.cgir--skeleton.c.line18_r2.input"
        , sizeof (YYCTYPE)
        , padding
        , &input_len
        );
...
yy18:
        YYSKIP ();
        status = action_line18_r2(i, keys, input, token, &cursor, 2);
        continue;
yy20:
        YYSKIP ();
        status = action_line18_r2(i, keys, input, token, &cursor, 1);
        continue;
yy22:
        YYSKIP ();
        status = action_line18_r2(i, keys, input, token, &cursor, 0);
        continue;
...
int lex_line28_r1()
{
    ...
    input = (YYCTYPE *) read_file
        ("repeat-03.cgir--skeleton.c.line28_r1.input"
        , sizeof (YYCTYPE)
        , padding
        , &input_len
        );
...
yy4:
        YYSKIP ();
        status = action_line28_r1(i, keys, input, token, &cursor, 4);
        continue;
yy6:
        YYSKIP ();
...
yy10:
        YYSKIP ();
        status = action_line28_r1(i, keys, input, token, &cursor, 0);
        continue;
yy12:
        YYSKIP ();
        status = action_line28_r1(i, keys, input, token, &cursor, 1);
        continue;
...
int lex_line28_r2()
{
    ...
    input = (YYCTYPE *) read_file
        ("repeat-03.cgir--skeleton.c.line28_r2.input"
        , sizeof (YYCTYPE)
        , padding
        , &input_len
        );
...
yy18:
        YYSKIP ();
        status = action_line28_r2(i, keys, input, token, &cursor, 2);
        continue;
yy20:
        YYSKIP ();
        status = action_line28_r2(i, keys, input, token, &cursor, 1);
        continue;
yy22:
        YYSKIP ();
        status = action_line28_r2(i, keys, input, token, &cursor, 0);
        continue;
...
 	 !"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\]^_`defghijklmnopqrstuvwxyz{|}~€‚ƒ„…†‡ˆ‰Š‹Œ‘’“”•–—˜™š›œŸ ¡¢£¤¥¦§¨©ª«¬­®¯°±²³´µ¶·¸¹º»¼½¾¿ÀÁÂÃÄÅÆÇÈÉÊËÌÍÎÏĞÑÒÓÔÕÖ×ØÙÚÛÜİŞßàáâãäåæçèéêëìíîïğñòóôõö÷øùúûüışÿabc
...
  ÿ 	 !"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\]^_`bdefghijklmnopqrstuvwxyz{|}~€‚ƒ„…†‡ˆ‰Š‹Œ‘’“”•–—˜™š›œŸ ¡¢£¤¥¦§¨©ª«¬­®¯°±²³´µ¶·¸¹º»¼½¾¿ÀÁÂÃÄÅÆÇÈÉÊËÌÍÎÏĞÑÒÓÔÕÖ×ØÙÚÛÜİŞßàáâãäåæçèéêëìíîïğñòóôõö÷øùúûüışÿac
  ÿre2c: warning: line 18: control flow in condition 'r1' is undefined for strings that match '\xA', use default rule '*' [-Wundefined-control-flow]
