...
28 -> 29 [label="[c]"]
29 -> 30
30 [label="scanner_re2c_default.--emit-dot.re:86"]
31 -> 12 [label="[0x00-b][d-0xFF]"]
31 -> 32 [label="[c]"]
32 -> 33
33 [label="scanner_re2c_default.--emit-dot.re:67"]
...
39 -> 40 [label="[c]"]
40 -> 41
41 [label="scanner_re2c_default.--emit-dot.re:102"]
...
47 -> 48 [label="[c]"]
48 -> 49
49 [label="scanner_re2c_default.--emit-dot.re:120"]
...
60 -> 61 [label="[c]"]
61 -> 62
62 [label="scanner_re2c_default.--emit-dot.re:134"]
...
71 -> 72 [label="[c]"]
72 -> 73
73 [label="scanner_re2c_default.--emit-dot.re:140"]
...
81 -> 82 [label="[c]"]
82 -> 83
83 [label="scanner_re2c_default.--emit-dot.re:145"]
84 -> 85 [label="[0x00-0x09][0x0B-0x0C][0x0E-0xFF]"]
84 -> 87 [label="[0x0A]"]
84 -> 86 [label="[0x0D]"]
85 [label="scanner_re2c_default.--emit-dot.re:180"]
86 -> 12 [label="[0x00-0x09][0x0B-0xFF]"]
86 -> 87 [label="[0x0A]"]
87 -> 88
88 [label="scanner_re2c_default.--emit-dot.re:162"]
89 -> 90
...
102 -> 106 [label="[\"]"]
103 -> 104
104 [label="scanner_re2c_default.--emit-dot.re:197"]
...
146 -> 149 [label="[}]"]
147 -> 148
148 [label="scanner_re2c_default.--emit-dot.re:370"]
149 -> 150
150 [label="scanner_re2c_default.--emit-dot.re:352"]
151 -> 148 [label="[0x00-/][:-|][~-0xFF]"]
151 -> 154 [label="[0-9]"]
151 -> 152 [label="[}]"]
152 -> 153
153 [label="scanner_re2c_default.--emit-dot.re:364"]
154 -> 155
155 -> 143 [label="[0x00-/][:-|][~-0xFF]"]
155 -> 154 [label="[0-9]"]
155 -> 156 [label="[}]"]
156 -> 157
157 [label="scanner_re2c_default.--emit-dot.re:358"]
158 -> 148 [label="[0x00-/][:-|][~-0xFF]"]
158 -> 154 [label="[0-9]"]
158 -> 159 [label="[}]"]
159 -> 160
160 [label="scanner_re2c_default.--emit-dot.re:347"]
161 -> 162
162 [label="scanner_re2c_default.--emit-dot.re:374"]
163 -> 164
164 -> 167 [label="[0x00-0x08][0x0A-0x1F][!-+][--/][:-<][?-@][[-^][`][{-0xFF]"]
164 -> 168 [label="[0x09][ ]"]
164 -> 169 [label="[,][=->]"]
164 -> 163 [label="[0-9][A-Z][_][a-z]"]
165 [label="scanner_re2c_default.--emit-dot.re:403"]
166 -> 164 [label="[0x00-1][3-0xFF]"]
166 -> 176 [label="[2]"]
167 -> 165
168 -> 174
169 -> 170
170 [label="scanner_re2c_default.--emit-dot.re:397"]
171 -> 172
172 [label="scanner_re2c_default.--emit-dot.re:391"]
173 -> 174
...
180 -> 183 [label="[:]"]
180 -> 182 [label="[@]"]
181 [label="scanner_re2c_default.--emit-dot.re:383"]
...
190 -> 143 [label="[0x0A]"]
191 -> 192
192 [label="scanner_re2c_default.--emit-dot.re:318"]
193 -> 188 [label="[0x00-0x09][0x0B-0xFF]"]
193 -> 143 [label="[0x0A]"]
194 -> 195
195 [label="scanner_re2c_default.--emit-dot.re:312"]
196 -> 197
197 [label="scanner_re2c_default.--emit-dot.re:331"]
198 -> 200
199 -> 200
...
200 -> 201 [label="[{]"]
201 -> 202
202 [label="scanner_re2c_default.--emit-dot.re:328"]
...
205 -> 207 [label="[>]"]
206 [label="scanner_re2c_default.--emit-dot.re:258"]
207 -> 208
208 [label="scanner_re2c_default.--emit-dot.re:254"]
209 -> 210
210 [label="scanner_re2c_default.--emit-dot.re:268"]
211 -> 212
212 [label="scanner_re2c_default.--emit-dot.re:265"]
213 -> 214
214 [label="scanner_re2c_default.--emit-dot.re:274"]
215 -> 216
...
217 -> 143 [label="[0x0A]"]
218 -> 219
219 [label="scanner_re2c_default.--emit-dot.re:292"]
220 -> 221
...
222 -> 143 [label="[0x0A]"]
223 -> 224
224 [label="scanner_re2c_default.--emit-dot.re:279"]
...
239 -> 243 [label="[\"]"]
240 -> 241
241 [label="scanner_re2c_default.--emit-dot.re:433"]
...
266 -> 265 [label="[0x0A]"]
267 -> 268
268 [label="scanner_re2c_default.--emit-dot.re:528"]
269 -> 270
...
272 -> 294 [label="[0x09][ ]"]
272 -> 275 [label="[#]"]
273 [label="scanner_re2c_default.--emit-dot.re:484"]
274 -> 273
275 -> 276
...
286 -> 290 [label="[\"]"]
287 -> 288
288 [label="scanner_re2c_default.--emit-dot.re:480"]
...
303 -> 304 [label="[*]"]
304 -> 305
305 [label="scanner_re2c_default.--emit-dot.re:548"]
306 -> 307
...
386 -> 385 [label="[0x0A]"]
387 -> 388
388 [label="scanner_re2c_default.--emit-dot.re:633"]
}
