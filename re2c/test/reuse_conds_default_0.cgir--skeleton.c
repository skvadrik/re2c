...
yy19:
        YYSKIP ();
        status = action_line15_r2(i, keys, input, token, &cursor, 9);
        continue;
yy21:
        YYSKIP ();
        status = action_line15_r2(i, keys, input, token, &cursor, 8);
        continue;
yy23:
        YYSKIP ();
...
int lex_line20_r2()
{
    ...
    for (i = 0; status == 0 && i < keys_count; ++i) {
        ...
        YYSKIP ();
        status = action_line20_r2(i, keys, input, token, &cursor, 9);
        continue;
yy19:
        YYSKIP ();
...
yy21:
        YYSKIP ();
        status = action_line20_r2(i, keys, input, token, &cursor, 8);
        continue;
yy23:
        YYSKIP ();
