...
int main ()
{
    if (lex_line13_r1 () != 0) return 1;
    if (lex_line13_r2 () != 0) return 1;
    return 0;
}
21ab 03`cÿ ÿ ÿ ÿ ÿ ÿ ÿ21b 03acÿ ÿ ÿ ÿ ÿ ÿ ÿre2c: warning: line 13: control flow in condition 'r1' is undefined for strings that match '[\x0-\x30\x33-\x60\x63-\xFF]', use default rule '*' [-Wundefined-control-flow]
