...
#line 13 "encodings/unicode_group_Po.8--encoding-policy(substitute).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	switch (yych) {
...
#line 58 "encodings/unicode_group_Po.8--encoding-policy(substitute).c"
yy4:
	++YYCURSOR;
#line 12 "encodings/unicode_group_Po.8--encoding-policy(substitute).re"
	{ goto Po; }
#line 63 "encodings/unicode_group_Po.8--encoding-policy(substitute).c"
yy6:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0xA1:
