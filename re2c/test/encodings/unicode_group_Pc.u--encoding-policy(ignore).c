/* Generated by re2c */
#line 1 "encodings/unicode_group_Pc.u--encoding-policy(ignore).re"
#include <stdio.h>
...
#line 13 "encodings/unicode_group_Pc.u--encoding-policy(ignore).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x00002054) {
...
yy2:
	++YYCURSOR;
#line 13 "encodings/unicode_group_Pc.u--encoding-policy(ignore).re"
	{ return YYCURSOR == limit; }
#line 37 "encodings/unicode_group_Pc.u--encoding-policy(ignore).c"
yy4:
	++YYCURSOR;
#line 12 "encodings/unicode_group_Pc.u--encoding-policy(ignore).re"
	{ goto Pc; }
#line 42 "encodings/unicode_group_Pc.u--encoding-policy(ignore).c"
}
#line 14 "encodings/unicode_group_Pc.u--encoding-policy(ignore).re"
