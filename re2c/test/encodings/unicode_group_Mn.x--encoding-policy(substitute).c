/* Generated by re2c */
#line 1 "encodings/unicode_group_Mn.x--encoding-policy(substitute).re"
#include <stdio.h>
#include "utf16.h"
...
#line 13 "encodings/unicode_group_Mn.x--encoding-policy(substitute).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x103C) {
...
yy2:
	++YYCURSOR;
yy3:
#line 13 "encodings/unicode_group_Mn.x--encoding-policy(substitute).re"
	{ return YYCURSOR == limit; }
#line 627 "encodings/unicode_group_Mn.x--encoding-policy(substitute).c"
yy4:
	++YYCURSOR;
#line 12 "encodings/unicode_group_Mn.x--encoding-policy(substitute).re"
	{ goto Mn; }
#line 632 "encodings/unicode_group_Mn.x--encoding-policy(substitute).c"
yy6:
	yych = *++YYCURSOR;
...
#line 14 "encodings/unicode_group_Mn.x--encoding-policy(substitute).re"
