/* Generated by re2c */
#line 1 "encodings/unicode_group_Mc.x--encoding-policy(ignore).re"
#include <stdio.h>
#include "utf16.h"
...
#line 13 "encodings/unicode_group_Mc.x--encoding-policy(ignore).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x1084) {
...
yy2:
	++YYCURSOR;
yy3:
#line 13 "encodings/unicode_group_Mc.x--encoding-policy(ignore).re"
	{ return YYCURSOR == limit; }
#line 341 "encodings/unicode_group_Mc.x--encoding-policy(ignore).c"
yy4:
	++YYCURSOR;
#line 12 "encodings/unicode_group_Mc.x--encoding-policy(ignore).re"
	{ goto Mc; }
#line 346 "encodings/unicode_group_Mc.x--encoding-policy(ignore).c"
yy6:
	yych = *++YYCURSOR;
	if (yych <= 0xDC81) {
		if (yych <= 0xDC00) {
...
#line 14 "encodings/unicode_group_Mc.x--encoding-policy(ignore).re"
