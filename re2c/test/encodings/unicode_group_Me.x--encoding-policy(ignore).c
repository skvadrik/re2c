/* Generated by re2c */
#line 1 "encodings/unicode_group_Me.x--encoding-policy(ignore).re"
#include <stdio.h>
#include "utf16.h"
...
#line 13 "encodings/unicode_group_Me.x--encoding-policy(ignore).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x20E0) {
...
yy2:
	++YYCURSOR;
#line 13 "encodings/unicode_group_Me.x--encoding-policy(ignore).re"
	{ return YYCURSOR == limit; }
#line 33 "encodings/unicode_group_Me.x--encoding-policy(ignore).c"
yy4:
	++YYCURSOR;
#line 12 "encodings/unicode_group_Me.x--encoding-policy(ignore).re"
	{ goto Me; }
#line 38 "encodings/unicode_group_Me.x--encoding-policy(ignore).c"
}
#line 14 "encodings/unicode_group_Me.x--encoding-policy(ignore).re"
