/* Generated by re2c */
#line 1 "encodings/unicode_group_P.8--encoding-policy(fail).re"
#include <stdio.h>
#include "utf8.h"
...
#line 13 "encodings/unicode_group_P.8--encoding-policy(fail).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	switch (yych) {
...
yy2:
	++YYCURSOR;
yy3:
#line 13 "encodings/unicode_group_P.8--encoding-policy(fail).re"
	{ return YYCURSOR == limit; }
#line 66 "encodings/unicode_group_P.8--encoding-policy(fail).c"
yy4:
	++YYCURSOR;
#line 12 "encodings/unicode_group_P.8--encoding-policy(fail).re"
	{ goto P; }
#line 71 "encodings/unicode_group_P.8--encoding-policy(fail).c"
yy6:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0xA1:
...
#line 14 "encodings/unicode_group_P.8--encoding-policy(fail).re"
