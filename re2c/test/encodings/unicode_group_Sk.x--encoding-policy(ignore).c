...
#line 13 "encodings/unicode_group_Sk.x--encoding-policy(ignore).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x1FBD) {
...
#line 100 "encodings/unicode_group_Sk.x--encoding-policy(ignore).c"
yy4:
	++YYCURSOR;
#line 12 "encodings/unicode_group_Sk.x--encoding-policy(ignore).re"
	{ goto Sk; }
#line 105 "encodings/unicode_group_Sk.x--encoding-policy(ignore).c"
}
