/* Generated by re2c */
#line 1 "encodings/unicode_group_No.8--encoding-policy(substitute).re"
#include <stdio.h>
#include "utf8.h"
...
#line 13 "encodings/unicode_group_No.8--encoding-policy(substitute).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	switch (yych) {
...
yy2:
	++YYCURSOR;
yy3:
#line 13 "encodings/unicode_group_No.8--encoding-policy(substitute).re"
	{ return YYCURSOR == limit; }
#line 32 "encodings/unicode_group_No.8--encoding-policy(substitute).c"
yy4:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0xB2:
...
yy11:
	++YYCURSOR;
#line 12 "encodings/unicode_group_No.8--encoding-policy(substitute).re"
	{ goto No; }
#line 108 "encodings/unicode_group_No.8--encoding-policy(substitute).c"
yy13:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0xB4:
...
#line 14 "encodings/unicode_group_No.8--encoding-policy(substitute).re"
