/* Generated by re2c */
#line 1 "encodings/unicode_group_Nl.u--encoding-policy(substitute).re"
#include <stdio.h>
...
#line 13 "encodings/unicode_group_Nl.u--encoding-policy(substitute).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x0000303A) {
...
yy2:
	++YYCURSOR;
#line 13 "encodings/unicode_group_Nl.u--encoding-policy(substitute).re"
	{ return YYCURSOR == limit; }
#line 57 "encodings/unicode_group_Nl.u--encoding-policy(substitute).c"
yy4:
	++YYCURSOR;
#line 12 "encodings/unicode_group_Nl.u--encoding-policy(substitute).re"
	{ goto Nl; }
#line 62 "encodings/unicode_group_Nl.u--encoding-policy(substitute).c"
}
#line 14 "encodings/unicode_group_Nl.u--encoding-policy(substitute).re"
