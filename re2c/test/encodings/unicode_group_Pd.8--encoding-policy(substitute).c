/* Generated by re2c */
#line 1 "encodings/unicode_group_Pd.8--encoding-policy(substitute).re"
#include <stdio.h>
#include "utf8.h"
...
#line 13 "encodings/unicode_group_Pd.8--encoding-policy(substitute).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	switch (yych) {
...
yy2:
	++YYCURSOR;
yy3:
#line 13 "encodings/unicode_group_Pd.8--encoding-policy(substitute).re"
	{ return YYCURSOR == limit; }
#line 31 "encodings/unicode_group_Pd.8--encoding-policy(substitute).c"
yy4:
	++YYCURSOR;
#line 12 "encodings/unicode_group_Pd.8--encoding-policy(substitute).re"
	{ goto Pd; }
#line 36 "encodings/unicode_group_Pd.8--encoding-policy(substitute).c"
yy6:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0x8A:
