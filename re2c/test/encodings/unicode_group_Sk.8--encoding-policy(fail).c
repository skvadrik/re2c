/* Generated by re2c */
#line 1 "encodings/unicode_group_Sk.8--encoding-policy(fail).re"
#include <stdio.h>
#include "utf8.h"
...
#line 13 "encodings/unicode_group_Sk.8--encoding-policy(fail).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	switch (yych) {
...
yy2:
	++YYCURSOR;
yy3:
#line 13 "encodings/unicode_group_Sk.8--encoding-policy(fail).re"
	{ return YYCURSOR == limit; }
#line 35 "encodings/unicode_group_Sk.8--encoding-policy(fail).c"
yy4:
	++YYCURSOR;
#line 12 "encodings/unicode_group_Sk.8--encoding-policy(fail).re"
	{ goto Sk; }
#line 40 "encodings/unicode_group_Sk.8--encoding-policy(fail).c"
yy6:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0xA8:
