/* Generated by re2c */
#line 1 "encodings/unicode_group_Sc.u--encoding-policy(ignore).re"
#include <stdio.h>
...
#line 13 "encodings/unicode_group_Sc.u--encoding-policy(ignore).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x00000E3E) {
...
yy2:
	++YYCURSOR;
#line 13 "encodings/unicode_group_Sc.u--encoding-policy(ignore).re"
	{ return YYCURSOR == limit; }
#line 70 "encodings/unicode_group_Sc.u--encoding-policy(ignore).c"
yy4:
	++YYCURSOR;
#line 12 "encodings/unicode_group_Sc.u--encoding-policy(ignore).re"
	{ goto Sc; }
#line 75 "encodings/unicode_group_Sc.u--encoding-policy(ignore).c"
}
#line 14 "encodings/unicode_group_Sc.u--encoding-policy(ignore).re"
