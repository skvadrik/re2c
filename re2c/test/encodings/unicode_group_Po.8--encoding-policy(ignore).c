...
#line 13 "encodings/unicode_group_Po.8--encoding-policy(ignore).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	switch (yych) {
...
#line 58 "encodings/unicode_group_Po.8--encoding-policy(ignore).c"
yy4:
	++YYCURSOR;
#line 12 "encodings/unicode_group_Po.8--encoding-policy(ignore).re"
	{ goto Po; }
#line 63 "encodings/unicode_group_Po.8--encoding-policy(ignore).c"
yy6:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0xA1:
