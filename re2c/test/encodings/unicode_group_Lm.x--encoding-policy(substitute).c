/* Generated by re2c */
#line 1 "encodings/unicode_group_Lm.x--encoding-policy(substitute).re"
#include <stdio.h>
#include "utf16.h"
...
#line 13 "encodings/unicode_group_Lm.x--encoding-policy(substitute).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x1D77) {
...
yy2:
	++YYCURSOR;
#line 13 "encodings/unicode_group_Lm.x--encoding-policy(substitute).re"
	{ return YYCURSOR == limit; }
#line 168 "encodings/unicode_group_Lm.x--encoding-policy(substitute).c"
yy4:
	++YYCURSOR;
#line 12 "encodings/unicode_group_Lm.x--encoding-policy(substitute).re"
	{ goto Lm; }
#line 173 "encodings/unicode_group_Lm.x--encoding-policy(substitute).c"
}
#line 14 "encodings/unicode_group_Lm.x--encoding-policy(substitute).re"
