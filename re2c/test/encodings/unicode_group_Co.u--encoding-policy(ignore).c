/* Generated by re2c */
#line 1 "encodings/unicode_group_Co.u--encoding-policy(ignore).re"
#include <stdio.h>
...
#line 13 "encodings/unicode_group_Co.u--encoding-policy(ignore).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x000EFFFF) {
...
yy2:
	++YYCURSOR;
#line 13 "encodings/unicode_group_Co.u--encoding-policy(ignore).re"
	{ return YYCURSOR == limit; }
#line 29 "encodings/unicode_group_Co.u--encoding-policy(ignore).c"
yy4:
	++YYCURSOR;
#line 12 "encodings/unicode_group_Co.u--encoding-policy(ignore).re"
	{ goto Co; }
#line 34 "encodings/unicode_group_Co.u--encoding-policy(ignore).c"
}
#line 14 "encodings/unicode_group_Co.u--encoding-policy(ignore).re"
