...
#line 13 "encodings/unicode_group_No.x--encoding-policy(fail).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x215F) {
...
#line 115 "encodings/unicode_group_No.x--encoding-policy(fail).c"
yy4:
	++YYCURSOR;
#line 12 "encodings/unicode_group_No.x--encoding-policy(fail).re"
	{ goto No; }
#line 120 "encodings/unicode_group_No.x--encoding-policy(fail).c"
yy6:
	yych = *++YYCURSOR;
	if (yych <= 0xDD78) {
