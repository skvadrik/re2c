...
#line 13 "encodings/unicode_group_Po.x--encoding-policy(substitute).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x203A) {
...
#line 383 "encodings/unicode_group_Po.x--encoding-policy(substitute).c"
yy4:
	++YYCURSOR;
#line 12 "encodings/unicode_group_Po.x--encoding-policy(substitute).re"
	{ goto Po; }
#line 388 "encodings/unicode_group_Po.x--encoding-policy(substitute).c"
yy6:
	yych = *++YYCURSOR;
	if (yych <= 0xDF9E) {
