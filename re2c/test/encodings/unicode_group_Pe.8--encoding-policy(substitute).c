...
#line 13 "encodings/unicode_group_Pe.8--encoding-policy(substitute).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	switch (yych) {
...
#line 33 "encodings/unicode_group_Pe.8--encoding-policy(substitute).c"
yy4:
	++YYCURSOR;
#line 12 "encodings/unicode_group_Pe.8--encoding-policy(substitute).re"
	{ goto Pe; }
#line 38 "encodings/unicode_group_Pe.8--encoding-policy(substitute).c"
yy6:
