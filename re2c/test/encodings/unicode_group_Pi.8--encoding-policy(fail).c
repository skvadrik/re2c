...
#line 13 "encodings/unicode_group_Pi.8--encoding-policy(fail).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	switch (yych) {
...
#line 27 "encodings/unicode_group_Pi.8--encoding-policy(fail).c"
yy4:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0xAB:	goto yy6;
...
yy6:
	++YYCURSOR;
#line 12 "encodings/unicode_group_Pi.8--encoding-policy(fail).re"
	{ goto Pi; }
#line 45 "encodings/unicode_group_Pi.8--encoding-policy(fail).c"
yy8:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0x98:
