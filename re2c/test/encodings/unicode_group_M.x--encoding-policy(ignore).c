...
#line 13 "encodings/unicode_group_M.x--encoding-policy(ignore).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x0F36) {
...
#line 639 "encodings/unicode_group_M.x--encoding-policy(ignore).c"
yy4:
	++YYCURSOR;
#line 12 "encodings/unicode_group_M.x--encoding-policy(ignore).re"
	{ goto M; }
#line 644 "encodings/unicode_group_M.x--encoding-policy(ignore).c"
yy6:
	yych = *++YYCURSOR;
	if (yych <= 0xDEDF) {
