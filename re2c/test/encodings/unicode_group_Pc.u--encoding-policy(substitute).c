...
#line 13 "encodings/unicode_group_Pc.u--encoding-policy(substitute).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x00002054) {
...
#line 37 "encodings/unicode_group_Pc.u--encoding-policy(substitute).c"
yy4:
	++YYCURSOR;
#line 12 "encodings/unicode_group_Pc.u--encoding-policy(substitute).re"
	{ goto Pc; }
#line 42 "encodings/unicode_group_Pc.u--encoding-policy(substitute).c"
}
