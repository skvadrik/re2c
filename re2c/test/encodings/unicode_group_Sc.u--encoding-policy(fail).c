...
#line 13 "encodings/unicode_group_Sc.u--encoding-policy(fail).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x00000E3F) {
...
#line 62 "encodings/unicode_group_Sc.u--encoding-policy(fail).c"
yy4:
	++YYCURSOR;
#line 12 "encodings/unicode_group_Sc.u--encoding-policy(fail).re"
	{ goto Sc; }
#line 67 "encodings/unicode_group_Sc.u--encoding-policy(fail).c"
}
