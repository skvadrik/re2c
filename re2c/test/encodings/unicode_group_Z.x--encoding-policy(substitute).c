...
#line 13 "encodings/unicode_group_Z.x--encoding-policy(substitute).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x200A) {
...
#line 42 "encodings/unicode_group_Z.x--encoding-policy(substitute).c"
yy4:
	++YYCURSOR;
#line 12 "encodings/unicode_group_Z.x--encoding-policy(substitute).re"
	{ goto Z; }
#line 47 "encodings/unicode_group_Z.x--encoding-policy(substitute).c"
}
