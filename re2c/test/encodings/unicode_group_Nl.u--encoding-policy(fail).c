...
#line 13 "encodings/unicode_group_Nl.u--encoding-policy(fail).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x0000303A) {
...
#line 57 "encodings/unicode_group_Nl.u--encoding-policy(fail).c"
yy4:
	++YYCURSOR;
#line 12 "encodings/unicode_group_Nl.u--encoding-policy(fail).re"
	{ goto Nl; }
#line 62 "encodings/unicode_group_Nl.u--encoding-policy(fail).c"
}
