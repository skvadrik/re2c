...
#line 13 "encodings/unicode_group_Zs.8--encoding-policy(ignore).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	switch (yych) {
...
#line 30 "encodings/unicode_group_Zs.8--encoding-policy(ignore).c"
yy4:
	++YYCURSOR;
#line 12 "encodings/unicode_group_Zs.8--encoding-policy(ignore).re"
	{ goto Zs; }
#line 35 "encodings/unicode_group_Zs.8--encoding-policy(ignore).c"
yy6:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0xA0:	goto yy4;
