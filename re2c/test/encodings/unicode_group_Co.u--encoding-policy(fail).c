...
#line 13 "encodings/unicode_group_Co.u--encoding-policy(fail).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x000EFFFF) {
...
#line 29 "encodings/unicode_group_Co.u--encoding-policy(fail).c"
yy4:
	++YYCURSOR;
#line 12 "encodings/unicode_group_Co.u--encoding-policy(fail).re"
	{ goto Co; }
#line 34 "encodings/unicode_group_Co.u--encoding-policy(fail).c"
}
