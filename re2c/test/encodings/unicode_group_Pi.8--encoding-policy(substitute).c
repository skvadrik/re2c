/* Generated by re2c */
#line 1 "encodings/unicode_group_Pi.8--encoding-policy(substitute).re"
#include <stdio.h>
#include "utf8.h"
...
#line 13 "encodings/unicode_group_Pi.8--encoding-policy(substitute).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	switch (yych) {
...
yy2:
	++YYCURSOR;
yy3:
#line 13 "encodings/unicode_group_Pi.8--encoding-policy(substitute).re"
	{ return YYCURSOR == limit; }
#line 27 "encodings/unicode_group_Pi.8--encoding-policy(substitute).c"
yy4:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0xAB:	goto yy6;
...
yy6:
	++YYCURSOR;
#line 12 "encodings/unicode_group_Pi.8--encoding-policy(substitute).re"
	{ goto Pi; }
#line 45 "encodings/unicode_group_Pi.8--encoding-policy(substitute).c"
yy8:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0x98:
...
#line 14 "encodings/unicode_group_Pi.8--encoding-policy(substitute).re"
