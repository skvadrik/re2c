...
#line 13 "encodings/unicode_group_Mn.8--encoding-policy(fail).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	switch (yych) {
...
#line 45 "encodings/unicode_group_Mn.8--encoding-policy(fail).c"
yy4:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0x80:
...
yy24:
	++YYCURSOR;
#line 12 "encodings/unicode_group_Mn.8--encoding-policy(fail).re"
	{ goto Mn; }
#line 498 "encodings/unicode_group_Mn.8--encoding-policy(fail).c"
yy26:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0x96:
