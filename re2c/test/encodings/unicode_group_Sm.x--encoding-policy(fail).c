...
#line 13 "encodings/unicode_group_Sm.x--encoding-policy(fail).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x231F) {
...
#line 182 "encodings/unicode_group_Sm.x--encoding-policy(fail).c"
yy4:
	++YYCURSOR;
#line 12 "encodings/unicode_group_Sm.x--encoding-policy(fail).re"
	{ goto Sm; }
#line 187 "encodings/unicode_group_Sm.x--encoding-policy(fail).c"
yy6:
	yych = *++YYCURSOR;
	if (yych <= 0xDF35) {
		if (yych <= 0xDEFA) {
