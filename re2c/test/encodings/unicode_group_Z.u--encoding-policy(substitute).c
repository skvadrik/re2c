/* Generated by re2c */
#line 1 "encodings/unicode_group_Z.u--encoding-policy(substitute).re"
#include <stdio.h>
...
#line 13 "encodings/unicode_group_Z.u--encoding-policy(substitute).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x0000200A) {
...
yy2:
	++YYCURSOR;
#line 13 "encodings/unicode_group_Z.u--encoding-policy(substitute).re"
	{ return YYCURSOR == limit; }
#line 42 "encodings/unicode_group_Z.u--encoding-policy(substitute).c"
yy4:
	++YYCURSOR;
#line 12 "encodings/unicode_group_Z.u--encoding-policy(substitute).re"
	{ goto Z; }
#line 47 "encodings/unicode_group_Z.u--encoding-policy(substitute).c"
}
#line 14 "encodings/unicode_group_Z.u--encoding-policy(substitute).re"
