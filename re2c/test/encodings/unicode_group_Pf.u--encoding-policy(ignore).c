...
#line 13 "encodings/unicode_group_Pf.u--encoding-policy(ignore).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x00002E03) {
...
#line 51 "encodings/unicode_group_Pf.u--encoding-policy(ignore).c"
yy4:
	++YYCURSOR;
#line 12 "encodings/unicode_group_Pf.u--encoding-policy(ignore).re"
	{ goto Pf; }
#line 56 "encodings/unicode_group_Pf.u--encoding-policy(ignore).c"
}
