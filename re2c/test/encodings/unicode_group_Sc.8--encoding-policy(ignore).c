...
#line 13 "encodings/unicode_group_Sc.8--encoding-policy(ignore).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	switch (yych) {
...
#line 34 "encodings/unicode_group_Sc.8--encoding-policy(ignore).c"
yy4:
	++YYCURSOR;
#line 12 "encodings/unicode_group_Sc.8--encoding-policy(ignore).re"
	{ goto Sc; }
#line 39 "encodings/unicode_group_Sc.8--encoding-policy(ignore).c"
yy6:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0xA2:
