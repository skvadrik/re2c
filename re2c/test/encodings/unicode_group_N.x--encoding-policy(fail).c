/* Generated by re2c */
#line 1 "encodings/unicode_group_N.x--encoding-policy(fail).re"
#include <stdio.h>
#include "utf16.h"
...
#line 13 "encodings/unicode_group_N.x--encoding-policy(fail).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x1BB9) {
...
yy2:
	++YYCURSOR;
yy3:
#line 13 "encodings/unicode_group_N.x--encoding-policy(fail).re"
	{ return YYCURSOR == limit; }
#line 247 "encodings/unicode_group_N.x--encoding-policy(fail).c"
yy4:
	++YYCURSOR;
#line 12 "encodings/unicode_group_N.x--encoding-policy(fail).re"
	{ goto N; }
#line 252 "encodings/unicode_group_N.x--encoding-policy(fail).c"
yy6:
	yych = *++YYCURSOR;
	if (yych <= 0xDF1F) {
		if (yych <= 0xDD3F) {
...
#line 14 "encodings/unicode_group_N.x--encoding-policy(fail).re"
