...
#line 13 "encodings/unicode_group_Zl.x--encoding-policy(fail).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
...
#line 21 "encodings/unicode_group_Zl.x--encoding-policy(fail).c"
yy4:
	++YYCURSOR;
#line 12 "encodings/unicode_group_Zl.x--encoding-policy(fail).re"
	{ goto Zl; }
#line 26 "encodings/unicode_group_Zl.x--encoding-policy(fail).c"
}
