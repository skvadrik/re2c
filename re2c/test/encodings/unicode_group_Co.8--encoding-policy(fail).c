...
#line 13 "encodings/unicode_group_Co.8--encoding-policy(fail).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	switch (yych) {
...
#line 29 "encodings/unicode_group_Co.8--encoding-policy(fail).c"
yy4:
...
yy12:
	++YYCURSOR;
#line 12 "encodings/unicode_group_Co.8--encoding-policy(fail).re"
	{ goto Co; }
#line 396 "encodings/unicode_group_Co.8--encoding-policy(fail).c"
yy14:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0x80:
