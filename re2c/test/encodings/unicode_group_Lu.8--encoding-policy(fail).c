...
#line 13 "encodings/unicode_group_Lu.8--encoding-policy(fail).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	switch (yych) {
...
#line 72 "encodings/unicode_group_Lu.8--encoding-policy(fail).c"
yy4:
	++YYCURSOR;
#line 12 "encodings/unicode_group_Lu.8--encoding-policy(fail).re"
	{ goto Lu; }
#line 77 "encodings/unicode_group_Lu.8--encoding-policy(fail).c"
yy6:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0x80:
