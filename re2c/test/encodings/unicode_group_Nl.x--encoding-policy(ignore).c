/* Generated by re2c */
#line 1 "encodings/unicode_group_Nl.x--encoding-policy(ignore).re"
#include <stdio.h>
#include "utf16.h"
...
#line 13 "encodings/unicode_group_Nl.x--encoding-policy(ignore).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x3020) {
...
yy2:
	++YYCURSOR;
yy3:
#line 13 "encodings/unicode_group_Nl.x--encoding-policy(ignore).re"
	{ return YYCURSOR == limit; }
#line 50 "encodings/unicode_group_Nl.x--encoding-policy(ignore).c"
yy4:
	++YYCURSOR;
#line 12 "encodings/unicode_group_Nl.x--encoding-policy(ignore).re"
	{ goto Nl; }
#line 55 "encodings/unicode_group_Nl.x--encoding-policy(ignore).c"
yy6:
	yych = *++YYCURSOR;
	if (yych <= 0xDF41) {
