...
#line 13 "encodings/unicode_group_C.8--encoding-policy(ignore).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	switch (yych) {
...
yy2:
	++YYCURSOR;
#line 12 "encodings/unicode_group_C.8--encoding-policy(ignore).re"
	{ goto C; }
#line 85 "encodings/unicode_group_C.8--encoding-policy(ignore).c"
yy4:
	++YYCURSOR;
yy5:
#line 13 "encodings/unicode_group_C.8--encoding-policy(ignore).re"
	{ return YYCURSOR == limit; }
#line 91 "encodings/unicode_group_C.8--encoding-policy(ignore).c"
yy6:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0x80:
