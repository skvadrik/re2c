/* Generated by re2c */
#line 1 "encodings/unicode_group_No.x--encoding-policy(substitute).re"
#include <stdio.h>
#include "utf16.h"
...
#line 13 "encodings/unicode_group_No.x--encoding-policy(substitute).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x249B) {
...
yy2:
	++YYCURSOR;
yy3:
#line 13 "encodings/unicode_group_No.x--encoding-policy(substitute).re"
	{ return YYCURSOR == limit; }
#line 140 "encodings/unicode_group_No.x--encoding-policy(substitute).c"
yy4:
	++YYCURSOR;
#line 12 "encodings/unicode_group_No.x--encoding-policy(substitute).re"
	{ goto No; }
#line 145 "encodings/unicode_group_No.x--encoding-policy(substitute).c"
yy6:
	yych = *++YYCURSOR;
	if (yych <= 0xDD89) {
		if (yych <= 0xDD33) {
...
#line 14 "encodings/unicode_group_No.x--encoding-policy(substitute).re"
