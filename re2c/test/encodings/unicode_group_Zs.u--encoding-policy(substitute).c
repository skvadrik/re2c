...
#line 13 "encodings/unicode_group_Zs.u--encoding-policy(substitute).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x00001FFF) {
...
#line 36 "encodings/unicode_group_Zs.u--encoding-policy(substitute).c"
yy4:
	++YYCURSOR;
#line 12 "encodings/unicode_group_Zs.u--encoding-policy(substitute).re"
	{ goto Zs; }
#line 41 "encodings/unicode_group_Zs.u--encoding-policy(substitute).c"
}
