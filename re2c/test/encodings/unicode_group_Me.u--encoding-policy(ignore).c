...
#line 13 "encodings/unicode_group_Me.u--encoding-policy(ignore).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x000020E0) {
...
#line 33 "encodings/unicode_group_Me.u--encoding-policy(ignore).c"
yy4:
	++YYCURSOR;
#line 12 "encodings/unicode_group_Me.u--encoding-policy(ignore).re"
	{ goto Me; }
#line 38 "encodings/unicode_group_Me.u--encoding-policy(ignore).c"
}
