...
#line 13 "encodings/unicode_group_Me.8--encoding-policy(ignore).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	switch (yych) {
...
#line 29 "encodings/unicode_group_Me.8--encoding-policy(ignore).c"
yy4:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0x88:
...
yy8:
	++YYCURSOR;
#line 12 "encodings/unicode_group_Me.8--encoding-policy(ignore).re"
	{ goto Me; }
#line 59 "encodings/unicode_group_Me.8--encoding-policy(ignore).c"
yy10:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0xBE:	goto yy8;
