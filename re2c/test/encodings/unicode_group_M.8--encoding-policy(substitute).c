/* Generated by re2c */
#line 1 "encodings/unicode_group_M.8--encoding-policy(substitute).re"
#include <stdio.h>
#include "utf8.h"
...
#line 13 "encodings/unicode_group_M.8--encoding-policy(substitute).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	switch (yych) {
...
yy2:
	++YYCURSOR;
yy3:
#line 13 "encodings/unicode_group_M.8--encoding-policy(substitute).re"
	{ return YYCURSOR == limit; }
#line 45 "encodings/unicode_group_M.8--encoding-policy(substitute).c"
yy4:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0x80:
...
yy24:
	++YYCURSOR;
#line 12 "encodings/unicode_group_M.8--encoding-policy(substitute).re"
	{ goto M; }
#line 498 "encodings/unicode_group_M.8--encoding-policy(substitute).c"
yy26:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0x96:
...
#line 14 "encodings/unicode_group_M.8--encoding-policy(substitute).re"
