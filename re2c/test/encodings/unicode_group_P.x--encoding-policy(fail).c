...
#line 13 "encodings/unicode_group_P.x--encoding-policy(fail).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x1CD2) {
...
#line 406 "encodings/unicode_group_P.x--encoding-policy(fail).c"
yy4:
	++YYCURSOR;
#line 12 "encodings/unicode_group_P.x--encoding-policy(fail).re"
	{ goto P; }
#line 411 "encodings/unicode_group_P.x--encoding-policy(fail).c"
yy6:
	yych = *++YYCURSOR;
	if (yych <= 0xDF9E) {
