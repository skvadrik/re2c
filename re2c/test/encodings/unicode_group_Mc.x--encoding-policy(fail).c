...
#line 13 "encodings/unicode_group_Mc.x--encoding-policy(fail).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x1084) {
...
#line 341 "encodings/unicode_group_Mc.x--encoding-policy(fail).c"
yy4:
	++YYCURSOR;
#line 12 "encodings/unicode_group_Mc.x--encoding-policy(fail).re"
	{ goto Mc; }
#line 346 "encodings/unicode_group_Mc.x--encoding-policy(fail).c"
yy6:
	yych = *++YYCURSOR;
	if (yych <= 0xDC81) {
		if (yych <= 0xDC00) {
