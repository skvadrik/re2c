/* Generated by re2c */
#line 1 "encodings/unicode_group_Sk.x--encoding-policy(fail).re"
#include <stdio.h>
#include "utf16.h"
...
#line 13 "encodings/unicode_group_Sk.x--encoding-policy(fail).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x1FBD) {
...
yy2:
	++YYCURSOR;
#line 13 "encodings/unicode_group_Sk.x--encoding-policy(fail).re"
	{ return YYCURSOR == limit; }
#line 100 "encodings/unicode_group_Sk.x--encoding-policy(fail).c"
yy4:
	++YYCURSOR;
#line 12 "encodings/unicode_group_Sk.x--encoding-policy(fail).re"
	{ goto Sk; }
#line 105 "encodings/unicode_group_Sk.x--encoding-policy(fail).c"
}
#line 14 "encodings/unicode_group_Sk.x--encoding-policy(fail).re"
