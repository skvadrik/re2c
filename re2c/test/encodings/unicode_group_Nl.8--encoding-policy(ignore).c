...
#line 13 "encodings/unicode_group_Nl.8--encoding-policy(ignore).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	switch (yych) {
...
#line 30 "encodings/unicode_group_Nl.8--encoding-policy(ignore).c"
yy4:
...
yy17:
	++YYCURSOR;
#line 12 "encodings/unicode_group_Nl.8--encoding-policy(ignore).re"
	{ goto Nl; }
#line 175 "encodings/unicode_group_Nl.8--encoding-policy(ignore).c"
yy19:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0x80:
