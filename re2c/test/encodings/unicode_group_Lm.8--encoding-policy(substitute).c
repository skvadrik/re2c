...
#line 13 "encodings/unicode_group_Lm.8--encoding-policy(substitute).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	switch (yych) {
...
#line 39 "encodings/unicode_group_Lm.8--encoding-policy(substitute).c"
yy4:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0xB0:
...
yy18:
	++YYCURSOR;
#line 12 "encodings/unicode_group_Lm.8--encoding-policy(substitute).re"
	{ goto Lm; }
#line 196 "encodings/unicode_group_Lm.8--encoding-policy(substitute).c"
yy20:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0x9A:
