/* Generated by re2c */
#line 1 "encodings/unicode_group_L_.x--encoding-policy(substitute).re"
#include <stdio.h>
#include "utf16.h"
...
#line 13 "encodings/unicode_group_L_.x--encoding-policy(substitute).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x1FDB) {
...
yy2:
	++YYCURSOR;
yy3:
#line 13 "encodings/unicode_group_L_.x--encoding-policy(substitute).re"
	{ return YYCURSOR == limit; }
#line 309 "encodings/unicode_group_L_.x--encoding-policy(substitute).c"
yy4:
	++YYCURSOR;
#line 12 "encodings/unicode_group_L_.x--encoding-policy(substitute).re"
	{ goto L_; }
#line 314 "encodings/unicode_group_L_.x--encoding-policy(substitute).c"
yy6:
	yych = *++YYCURSOR;
...
#line 14 "encodings/unicode_group_L_.x--encoding-policy(substitute).re"
