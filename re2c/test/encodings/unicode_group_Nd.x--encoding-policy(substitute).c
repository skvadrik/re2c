...
#line 13 "encodings/unicode_group_Nd.x--encoding-policy(substitute).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x1819) {
...
#line 168 "encodings/unicode_group_Nd.x--encoding-policy(substitute).c"
yy4:
	++YYCURSOR;
#line 12 "encodings/unicode_group_Nd.x--encoding-policy(substitute).re"
	{ goto Nd; }
#line 173 "encodings/unicode_group_Nd.x--encoding-policy(substitute).c"
yy6:
	yych = *++YYCURSOR;
