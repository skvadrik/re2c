...
#line 13 "encodings/unicode_group_Nl.x--encoding-policy(fail).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x3020) {
...
#line 50 "encodings/unicode_group_Nl.x--encoding-policy(fail).c"
yy4:
	++YYCURSOR;
#line 12 "encodings/unicode_group_Nl.x--encoding-policy(fail).re"
	{ goto Nl; }
#line 55 "encodings/unicode_group_Nl.x--encoding-policy(fail).c"
yy6:
	yych = *++YYCURSOR;
	if (yych <= 0xDF41) {
