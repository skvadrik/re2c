/* Generated by re2c */
#line 1 "encodings/unicode_group_Lt.8--encoding-policy(ignore).re"
#include <stdio.h>
#include "utf8.h"
...
#line 13 "encodings/unicode_group_Lt.8--encoding-policy(ignore).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	switch (yych) {
...
yy2:
	++YYCURSOR;
yy3:
#line 13 "encodings/unicode_group_Lt.8--encoding-policy(ignore).re"
	{ return YYCURSOR == limit; }
#line 27 "encodings/unicode_group_Lt.8--encoding-policy(ignore).c"
yy4:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0x85:
...
yy6:
	++YYCURSOR;
#line 12 "encodings/unicode_group_Lt.8--encoding-policy(ignore).re"
	{ goto Lt; }
#line 48 "encodings/unicode_group_Lt.8--encoding-policy(ignore).c"
yy8:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0x88:
...
#line 14 "encodings/unicode_group_Lt.8--encoding-policy(ignore).re"
