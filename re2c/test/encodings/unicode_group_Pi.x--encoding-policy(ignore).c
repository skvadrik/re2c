/* Generated by re2c */
#line 1 "encodings/unicode_group_Pi.x--encoding-policy(ignore).re"
#include <stdio.h>
#include "utf16.h"
...
#line 13 "encodings/unicode_group_Pi.x--encoding-policy(ignore).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x2E01) {
	...
	++YYCURSOR;
#line 13 "encodings/unicode_group_Pi.x--encoding-policy(ignore).re"
	{ return YYCURSOR == limit; }
#line 51 "encodings/unicode_group_Pi.x--encoding-policy(ignore).c"
yy4:
	++YYCURSOR;
#line 12 "encodings/unicode_group_Pi.x--encoding-policy(ignore).re"
	{ goto Pi; }
#line 56 "encodings/unicode_group_Pi.x--encoding-policy(ignore).c"
}
#line 14 "encodings/unicode_group_Pi.x--encoding-policy(ignore).re"
