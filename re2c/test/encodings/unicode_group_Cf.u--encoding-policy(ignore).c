/* Generated by re2c */
#line 1 "encodings/unicode_group_Cf.u--encoding-policy(ignore).re"
#include <stdio.h>
...
#line 13 "encodings/unicode_group_Cf.u--encoding-policy(ignore).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x0000205F) {
...
yy2:
	++YYCURSOR;
#line 13 "encodings/unicode_group_Cf.u--encoding-policy(ignore).re"
	{ return YYCURSOR == limit; }
#line 63 "encodings/unicode_group_Cf.u--encoding-policy(ignore).c"
yy4:
	++YYCURSOR;
#line 12 "encodings/unicode_group_Cf.u--encoding-policy(ignore).re"
	{ goto Cf; }
#line 68 "encodings/unicode_group_Cf.u--encoding-policy(ignore).c"
}
#line 14 "encodings/unicode_group_Cf.u--encoding-policy(ignore).re"
