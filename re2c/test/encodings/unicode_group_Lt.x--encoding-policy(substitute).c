/* Generated by re2c */
#line 1 "encodings/unicode_group_Lt.x--encoding-policy(substitute).re"
#include <stdio.h>
#include "utf16.h"
...
#line 13 "encodings/unicode_group_Lt.x--encoding-policy(substitute).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x1F8F) {
...
yy2:
	++YYCURSOR;
#line 13 "encodings/unicode_group_Lt.x--encoding-policy(substitute).re"
	{ return YYCURSOR == limit; }
#line 53 "encodings/unicode_group_Lt.x--encoding-policy(substitute).c"
yy4:
	++YYCURSOR;
#line 12 "encodings/unicode_group_Lt.x--encoding-policy(substitute).re"
	{ goto Lt; }
#line 58 "encodings/unicode_group_Lt.x--encoding-policy(substitute).c"
}
#line 14 "encodings/unicode_group_Lt.x--encoding-policy(substitute).re"
