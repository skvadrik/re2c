...
#line 13 "encodings/unicode_group_Lt.8--encoding-policy(substitute).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	switch (yych) {
...
#line 27 "encodings/unicode_group_Lt.8--encoding-policy(substitute).c"
yy4:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0x85:
...
yy6:
	++YYCURSOR;
#line 12 "encodings/unicode_group_Lt.8--encoding-policy(substitute).re"
	{ goto Lt; }
#line 48 "encodings/unicode_group_Lt.8--encoding-policy(substitute).c"
yy8:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0x88:
