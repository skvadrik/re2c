...
#line 13 "encodings/unicode_group_So.x--encoding-policy(substitute).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x2321) {
...
#line 363 "encodings/unicode_group_So.x--encoding-policy(substitute).c"
yy4:
	++YYCURSOR;
#line 12 "encodings/unicode_group_So.x--encoding-policy(substitute).re"
	{ goto So; }
#line 368 "encodings/unicode_group_So.x--encoding-policy(substitute).c"
yy6:
	yych = *++YYCURSOR;
	if (yych <= 0xDD8C) {
		if (yych <= 0xDD78) {
