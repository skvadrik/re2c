...
#line 13 "encodings/unicode_group_Pe.8--encoding-policy(ignore).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	switch (yych) {
...
#line 33 "encodings/unicode_group_Pe.8--encoding-policy(ignore).c"
yy4:
	++YYCURSOR;
#line 12 "encodings/unicode_group_Pe.8--encoding-policy(ignore).re"
	{ goto Pe; }
#line 38 "encodings/unicode_group_Pe.8--encoding-policy(ignore).c"
yy6:
