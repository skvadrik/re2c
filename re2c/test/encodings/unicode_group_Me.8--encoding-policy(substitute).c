/* Generated by re2c */
#line 1 "encodings/unicode_group_Me.8--encoding-policy(substitute).re"
#include <stdio.h>
#include "utf8.h"
...
#line 13 "encodings/unicode_group_Me.8--encoding-policy(substitute).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	switch (yych) {
...
yy2:
	++YYCURSOR;
yy3:
#line 13 "encodings/unicode_group_Me.8--encoding-policy(substitute).re"
	{ return YYCURSOR == limit; }
#line 28 "encodings/unicode_group_Me.8--encoding-policy(substitute).c"
yy4:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0x88:
...
yy7:
	++YYCURSOR;
#line 12 "encodings/unicode_group_Me.8--encoding-policy(substitute).re"
	{ goto Me; }
#line 52 "encodings/unicode_group_Me.8--encoding-policy(substitute).c"
yy9:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0x9D:
...
#line 14 "encodings/unicode_group_Me.8--encoding-policy(substitute).re"
