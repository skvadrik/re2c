...
#line 13 "encodings/unicode_group_Pd.8--encoding-policy(fail).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	switch (yych) {
...
#line 31 "encodings/unicode_group_Pd.8--encoding-policy(fail).c"
yy4:
	++YYCURSOR;
#line 12 "encodings/unicode_group_Pd.8--encoding-policy(fail).re"
	{ goto Pd; }
#line 36 "encodings/unicode_group_Pd.8--encoding-policy(fail).c"
yy6:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0x8A:
