/* Generated by re2c */
#line 1 "encodings/unicode_group_Co.8--encoding-policy(substitute).re"
#include <stdio.h>
#include "utf8.h"
...
#line 13 "encodings/unicode_group_Co.8--encoding-policy(substitute).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	switch (yych) {
...
yy2:
	++YYCURSOR;
yy3:
#line 13 "encodings/unicode_group_Co.8--encoding-policy(substitute).re"
	{ return YYCURSOR == limit; }
#line 29 "encodings/unicode_group_Co.8--encoding-policy(substitute).c"
yy4:
...
yy12:
	++YYCURSOR;
#line 12 "encodings/unicode_group_Co.8--encoding-policy(substitute).re"
	{ goto Co; }
#line 396 "encodings/unicode_group_Co.8--encoding-policy(substitute).c"
yy14:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0x80:
...
#line 14 "encodings/unicode_group_Co.8--encoding-policy(substitute).re"
