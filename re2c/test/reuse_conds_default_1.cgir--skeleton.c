...
int lex_line22_r2()
{
    ...
    for (i = 0; status == 0 && i < keys_count; ++i) {
        ...
        YYSKIP ();
        status = action_line22_r2(i, keys, input, token, &cursor, 9);
        continue;
yy20:
        YYSKIP ();
...
yy22:
        YYSKIP ();
        status = action_line22_r2(i, keys, input, token, &cursor, 8);
        continue;
yy24:
        YYSKIP ();
...
yy19:
        YYSKIP ();
        status = action_line32_r2(i, keys, input, token, &cursor, 9);
        continue;
yy21:
        YYSKIP ();
        status = action_line32_r2(i, keys, input, token, &cursor, 8);
        continue;
yy23:
        YYSKIP ();
