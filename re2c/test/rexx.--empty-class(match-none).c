re2c: warning: empty character class at line 288 [-Wempty-character-class]
re2c: warning: naked default case (stray code units: [0x00-0x08][0x0A-0x0C][0x0E-0x1F][!-.][/][0-0xFF]), better add default rule * [-Wnaked-default]
/* Generated by re2c */
