...
std:
	s->tok = cursor;
	s->len = 0;
#line 845 "php/parse_date.g.re"



#line 743 "php/parse_date.g.c"
{
	YYCTYPE yych;
...
yy2:
	++YYCURSOR;
#line 1400 "php/parse_date.g.re"
	{
		s->pos = cursor; s->line++;
		goto std;
	}
#line 827 "php/parse_date.g.c"
yy4:
	++YYCURSOR;
yy5:
#line 1406 "php/parse_date.g.re"
	{
/*		printf("unexpected character: #%d, %c ", *s->tok, *s->tok); */
		s->errors++;
		goto std;
	}
#line 837 "php/parse_date.g.c"
yy6:
	yyaccept = 0;
	...
	if (yych <= '9') goto yy54;
yy7:
#line 1395 "php/parse_date.g.re"
	{
		goto std;
	}
#line 851 "php/parse_date.g.c"
yy8:
	yych = *++YYCURSOR;
	if (yych <= '@') goto yy5;
	if (yych <= 'Z') goto yy37;
