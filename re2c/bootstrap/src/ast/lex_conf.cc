/* Generated by re2c 1.1.1 on Mon Dec 31 12:29:59 2018 */
...
#line 3547 "src/ast/lex_conf.cc"
{
	...
	++cur;
yy766:
#line 230 "../src/ast/lex_conf.re"
	{ fatal_lc(get_line(), get_column(), "missing '=' in configuration"); }
#line 3596 "src/ast/lex_conf.cc"
yy767:
	yych = (unsigned char)*(mar = ++cur);
	if (yych <= 0x1F) {
		if (yych == '\t') goto yy771;
...
#line 231 "../src/ast/lex_conf.re"
	{ return; }
#line 3615 "src/ast/lex_conf.cc"
yy771:
	++cur;
	if (lim <= cur) YYFILL(1);
	yych = (unsigned char)*cur;
...
#line 287 "../src/ast/lex_conf.re"
	{
        s = getstr(tok, cur);
        goto end;
    }
#line 3881 "src/ast/lex_conf.cc"
yy799:
	++cur;
