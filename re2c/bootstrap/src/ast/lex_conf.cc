/* Generated by re2c 1.1.1 on Thu Nov 29 22:11:27 2018 */
...
yy857:
#line 297 "../src/ast/lex_conf.re"
	{ goto end; }
#line 4119 "src/ast/lex_conf.cc"
yy858:
	++cur;
	if (lim <= cur) fill(1);
	yych = (unsigned char)*cur;
