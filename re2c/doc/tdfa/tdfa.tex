...
usually algorithms that schedule nodes in LIFO order (e.g. Pape-Levit) have exponential complexity [ShiWit81].
...
%    \item \url{https://github.com/google/re2/issues/146}
