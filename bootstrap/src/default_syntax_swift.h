static constexpr const char* DEFAULT_SYNTAX_SWIFT =
    ...
    "\n"
    "code:array_local =\n"
    "    topindent \"let \" name \": [\" type \"] = [\" nl indent\n"
    ...
    "    \")\" (.type ? \" -> \" type) \" {\" nl\n"
    "        indent [stmt: stmt] dedent\n"
    "    \"}\" nl; // Can't specify throw\n"
    "\n"
    "code:fncall = topindent (.retval ? retval \" = \") name \"(\" [arg{0:-2}: arg \", \"] [arg{-1}: arg] \")\" nl;\n"
    "\n"
    "code:tailcall = topindent (.retval ? \"return \") name \"(\" [arg{0:-2}: arg \", \"] [arg{-1}: arg] \")\" nl;\n"
    "\n"
