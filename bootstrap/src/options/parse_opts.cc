...
#line 4504 "src/options/parse_opts.cc"
}
...
#line 4574 "src/options/parse_opts.cc"
yy952:
	yych = *(YYMARKER = ++YYCURSOR);
...
opt_fixed_tags: 
#line 4770 "src/options/parse_opts.cc"
{
	char yych;
	yych = *YYCURSOR;
	if (yych <= 'm') {
