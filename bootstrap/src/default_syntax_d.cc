...
const char* DEFAULT_SYNTAX_D =
    ...
    "    (api.generic\n"
    "        ? (fixed_on_cursor\n"
    "            ? topindent shift (api_style.functions ? \"(-\" offset \");\") nl\n"
    "            : topindent (tags\n"
    "                ? restoretag (api_style.functions ? \"(\" base \");\")\n"
    "                : restorectx (api_style.functions ? \"();\")) nl\n"
    "              (fixed ? topindent shift (api_style.functions ? \"(-\" offset \");\") nl))\n"
    "        : (fixed_on_cursor\n"
    "            ? topindent cursor \" -= \" offset \";\" nl\n"
    "            : topindent cursor \" = \" base (fixed ? \" - \" offset) \";\" nl));\n"
    ;
