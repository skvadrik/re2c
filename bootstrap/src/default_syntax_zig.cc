...
const char* DEFAULT_SYNTAX_ZIG =
    ...
    ":yych = \"yych\";\n"
    ":yych:conversion = 0;\n"
    ":yych:literals = hex; // zig does not recognize '\\f' escape sequence => use hex\n"
    ...
    ":tags:negative = (.api.generic ? \"@@\" : \"std.math.maxInt(usize)\");\n"
    ":cond:divider = \"/* *********************************** */\";\n"
    ...
    "// code templates --------------------------------------------------------------\n"
    "\n"
    "::var_local = topindent \"var \" name \": \" type \" = \" (.init ? init : \"0\") \";\" nl;\n"
