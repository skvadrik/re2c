...
yy6:
#line 290 "../src/parse/lexer.re"
	{
        next_line();
        goto loop;
    }
#line 152 "src/parse/lexer.cc"
yy7:
	yych = *++cur;
	if (yych == '\n') goto yy5;
	goto yy3;
...
yy190:
#line 320 "../src/parse/lexer.re"
	{
        RET_FAIL(error_at_cur(
                "ill-formed start of a block: expected a space, a newline, a colon followed by a"
                " list of colon-separated block names, or the end of block `*" "/`"));
    }
#line 1332 "src/parse/lexer.cc"
yy191:
	++cur;
	cur = yyt1;
#line 326 "../src/parse/lexer.re"
	{ *ptail = nullptr; return Ret::OK; }
#line 1338 "src/parse/lexer.cc"
yy192:
	yych = *++cur;
	if (yych == '/') goto yy191;
yy193:
...
#line 1376 "src/parse/lexer.cc"
}
#line 344 "../src/parse/lexer.re"
...
#line 398 "../src/parse/lexer.re"
	{ goto loop; }
#line 1554 "src/parse/lexer.cc"
yy206:
	++cur;
#line 400 "../src/parse/lexer.re"
	{ next_line(); goto loop; }
#line 1559 "src/parse/lexer.cc"
yy207:
	yych = *++cur;
	if (yych == '\n') goto yy206;
	goto yy204;
...
yy250:
	...
	if (yyaccept <= 3) {
		if (yyaccept <= 1) {
			if (yyaccept == 0) goto yy228;
			else goto yy231;
		} else {
			if (yyaccept == 2) goto yy248;
			else goto yy260;
		}
	} else {
		if (yyaccept <= 5) {
			if (yyaccept == 4) goto yy265;
			else goto yy280;
		} else {
			goto yy299;
		}
...
#line 2569 "src/parse/lexer.cc"
yy315:
	yych = *++cur;
	if (yych == '/') goto yy314;
	goto yy250;
}
#line 562 "../src/parse/lexer.re"
...
yy317:
#line 570 "../src/parse/lexer.re"
	{ yes = false; return Ret::OK; }
#line 2640 "src/parse/lexer.cc"
yy318:
	++cur;
	if ((lim - cur) < 2) if (!fill(2)) RET_FAIL(error_at_cur("unexpected end of input"));
	yych = *cur;
	if (yybm[0+yych] & 128) goto yy318;
	if (yych == '=') goto yy320;
yy319:
	cur = mar;
	goto yy317;
...
#line 578 "../src/parse/lexer.re"
	{ yes = false; return Ret::OK; }
#line 2714 "src/parse/lexer.cc"
yy322:
	++cur;
	if (lim <= cur) if (!fill(1)) RET_FAIL(error_at_cur("unexpected end of input"));
	yych = *cur;
	if (yybm[0+yych] & 128) goto yy322;
	if (yych <= '<') {
		if (yych == ':') goto yy323;
	} else {
		if (yych <= '=') goto yy323;
...
#line 577 "../src/parse/lexer.re"
	{ yes = true;  return Ret::OK; }
#line 2729 "src/parse/lexer.cc"
yy323:
	++cur;
	cur = yyt1;
#line 576 "../src/parse/lexer.re"
	{ yes = false; return Ret::OK; }
#line 2735 "src/parse/lexer.cc"
}
...
#line 2806 "src/parse/lexer.cc"
yy328:
	++cur;
#line 589 "../src/parse/lexer.re"
	{ token = TOKEN_CZERO;  goto end; }
#line 2811 "src/parse/lexer.cc"
}
...
#line 2877 "src/parse/lexer.cc"
yy332:
	++cur;
	if (lim <= cur) if (!fill(1)) RET_FAIL(error_at_cur("unexpected end of input"));
	yych = *cur;
	if (yybm[0+yych] & 128) goto yy332;
#line 595 "../src/parse/lexer.re"
	{ cl.insert(getstr(tok, cur)); goto next; }
#line 2885 "src/parse/lexer.cc"
}
#line 598 "../src/parse/lexer.re"

next: 
#line 2890 "src/parse/lexer.cc"
{
	uint8_t yych;
	static const unsigned char yybm[256] = {
		  0,   0,   0,   0,   0,   0,   0,   0,
...
yy336:
	...
	if (lim <= cur) if (!fill(1)) RET_FAIL(error_at_cur("unexpected end of input"));
	yych = *cur;
	if (yybm[0+yych] & 128) goto yy336;
#line 600 "../src/parse/lexer.re"
	{ goto cond; }
#line 2965 "src/parse/lexer.cc"
yy337:
	++cur;
#line 601 "../src/parse/lexer.re"
	{ goto end; }
#line 2970 "src/parse/lexer.cc"
yy338:
	++cur;
	if (lim <= cur) if (!fill(1)) RET_FAIL(error_at_cur("unexpected end of input"));
	yych = *cur;
...
#line 671 "../src/parse/lexer.re"
	{ goto code; }
#line 3081 "src/parse/lexer.cc"
yy341:
	++cur;
#line 666 "../src/parse/lexer.re"
	{ next_line(); goto indent; }
#line 3086 "src/parse/lexer.cc"
yy342:
	yych = *++cur;
	if (yych == '\n') goto yy341;
	goto yy340;
...
#line 3110 "src/parse/lexer.cc"
yy347:
	++cur;
#line 667 "../src/parse/lexer.re"
	{ CHECK_RET(lex_cpp_comment()); goto indent; }
#line 3115 "src/parse/lexer.cc"
}
#line 672 "../src/parse/lexer.re"

indent: 
#line 3120 "src/parse/lexer.cc"
{
	uint8_t yych;
	if (lim <= cur) if (!fill(1)) RET_FAIL(error_at_cur("unexpected end of input"));
	yych = *cur;
...
#line 3142 "src/parse/lexer.cc"
yy350:
	++cur;
	cur -= 1;
#line 674 "../src/parse/lexer.re"
	{ goto code; }
#line 3148 "src/parse/lexer.cc"
}
...
#line 711 "../src/parse/lexer.re"
	{ goto code; }
#line 3220 "src/parse/lexer.cc"
yy353:
	yych = *(mar = ++cur);
	if (yybm[0+yych] & 32) goto yy360;
	if (yych == '#') goto yy362;
yy354:
...
#line 730 "../src/parse/lexer.re"
	{ goto loop_backtick; }
#line 3451 "src/parse/lexer.cc"
yy383:
	++cur;
#line 729 "../src/parse/lexer.re"
	{ next_line(); goto loop_backtick; }
#line 3456 "src/parse/lexer.cc"
yy384:
	yych = *++cur;
	if (yych == '\n') goto yy383;
	goto yy382;
...
#line 761 "../src/parse/lexer.re"
	{ goto loop; }
#line 3823 "src/parse/lexer.cc"
yy421:
	++cur;
#line 760 "../src/parse/lexer.re"
	{ next_line(); goto loop; }
#line 3828 "src/parse/lexer.cc"
yy422:
	yych = *++cur;
	if (yych == '\n') goto yy421;
	goto yy420;
...
#line 819 "../src/parse/lexer.re"
	{ c = '\\'_u8; return Ret::OK; }
#line 4088 "src/parse/lexer.cc"
yy451:
	++cur;
#line 821 "../src/parse/lexer.re"
	{ c = ']'_u8; return Ret::OK; }
#line 4093 "src/parse/lexer.cc"
yy452:
	++cur;
#line 812 "../src/parse/lexer.re"
	{ c = '\a'_u8; return Ret::OK; }
#line 4098 "src/parse/lexer.cc"
yy453:
	++cur;
...
#line 809 "../src/parse/lexer.re"
	{ c = decode(tok); return Ret::OK; }
#line 4278 "src/parse/lexer.cc"
yy474:
	++cur;
#line 803 "../src/parse/lexer.re"
	{ RET_FAIL(error_at(loc, "newline in character class")); }
#line 4283 "src/parse/lexer.cc"
yy475:
	yych = *++cur;
	if (yych == '\n') goto yy474;
	goto yy473;
...
#line 819 "../src/parse/lexer.re"
	{ c = '\\'_u8; return Ret::OK; }
#line 4480 "src/parse/lexer.cc"
yy497:
	++cur;
#line 821 "../src/parse/lexer.re"
	{ c = ']'_u8; return Ret::OK; }
#line 4485 "src/parse/lexer.cc"
yy498:
	++cur;
#line 812 "../src/parse/lexer.re"
	{ c = '\a'_u8; return Ret::OK; }
...
#line 813 "../src/parse/lexer.re"
	{ c = '\b'_u8; return Ret::OK; }
#line 4495 "src/parse/lexer.cc"
yy500:
	++cur;
#line 814 "../src/parse/lexer.re"
	{ c = '\f'_u8; return Ret::OK; }
#line 4500 "src/parse/lexer.cc"
yy501:
	++cur;
#line 815 "../src/parse/lexer.re"
	{ c = '\n'_u8; return Ret::OK; }
#line 4505 "src/parse/lexer.cc"
yy502:
	++cur;
#line 816 "../src/parse/lexer.re"
	{ c = '\r'_u8; return Ret::OK; }
#line 4510 "src/parse/lexer.cc"
yy503:
	++cur;
#line 817 "../src/parse/lexer.re"
	{ c = '\t'_u8; return Ret::OK; }
#line 4515 "src/parse/lexer.cc"
yy504:
	++cur;
#line 818 "../src/parse/lexer.re"
	{ c = '\v'_u8; return Ret::OK; }
...
yy507:
	cur = mar;
	if (yyaccept <= 1) {
		if (yyaccept == 0) goto yy477;
		else goto yy479;
	} else {
		if (yyaccept == 2) goto yy491;
		else goto yy494;
	}
yy508:
	yych = *++cur;
...
#line 4839 "src/parse/lexer.cc"
yy543:
	++cur;
#line 851 "../src/parse/lexer.re"
	{ ast.chr = '\f'_u8; return Ret::OK; }
#line 4844 "src/parse/lexer.cc"
yy544:
	++cur;
#line 852 "../src/parse/lexer.re"
	{ ast.chr = '\n'_u8; return Ret::OK; }
#line 4849 "src/parse/lexer.cc"
yy545:
	++cur;
...
#line 854 "../src/parse/lexer.re"
	{ ast.chr = '\t'_u8; return Ret::OK; }
#line 4859 "src/parse/lexer.cc"
yy547:
	++cur;
#line 855 "../src/parse/lexer.re"
	{ ast.chr = '\v'_u8; return Ret::OK; }
#line 4864 "src/parse/lexer.cc"
yy548:
	yyaccept = 1;
	yych = *(mar = ++cur);
	if (yych <= '@') {
...
#line 852 "../src/parse/lexer.re"
	{ ast.chr = '\n'_u8; return Ret::OK; }
#line 5224 "src/parse/lexer.cc"
yy589:
	++cur;
#line 853 "../src/parse/lexer.re"
	{ ast.chr = '\r'_u8; return Ret::OK; }
#line 5229 "src/parse/lexer.cc"
yy590:
	++cur;
#line 854 "../src/parse/lexer.re"
	{ ast.chr = '\t'_u8; return Ret::OK; }
#line 5234 "src/parse/lexer.cc"
yy591:
	++cur;
#line 855 "../src/parse/lexer.re"
	{ ast.chr = '\v'_u8; return Ret::OK; }
...
yy594:
	cur = mar;
	if (yyaccept <= 1) {
		if (yyaccept == 0) goto yy566;
		else goto yy568;
	} else {
		if (yyaccept == 2) goto yy579;
		else goto yy582;
	}
yy595:
	yych = *++cur;
...
#line 907 "../src/parse/lexer.re"
	{ --cur; return Ret::OK; }
#line 5482 "src/parse/lexer.cc"
yy613:
	++cur;
yy614:
#line 908 "../src/parse/lexer.re"
	{ goto sourceline; }
#line 5488 "src/parse/lexer.cc"
yy615:
	++cur;
...
#line 5517 "src/parse/lexer.cc"
yy619:
	++cur;
	if (lim <= cur) if (!fill(1)) RET_FAIL(error_at_cur("unexpected end of input"));
	yych = *cur;
yy620:
	if (yybm[0+yych] & 128) goto yy619;
	if (yych <= '\n') goto yy621;
	if (yych <= '"') goto yy622;
	goto yy623;
yy621:
