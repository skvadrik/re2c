...
yy370:
	++cur;
	cur = yyt1;
#line 650 "../src/parse/lexer.re"
	{ CHECK_RET(set_sourceline()); goto code; }
#line 3360 "src/parse/lexer.cc"
yy371:
	yych = *++cur;
	if (yych == '\n') goto yy370;
	goto yy361;
