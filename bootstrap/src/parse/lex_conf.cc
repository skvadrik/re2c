/* Generated by re2c 3.0 on Wed Jun 22 23:37:39 2022 */
...
#line 159 "src/parse/lex_conf.cc"
yy2:
	++cur;
	if (lim <= cur) YYFILL(1);
	yych = (unsigned char)*cur;
...
#line 357 "src/parse/lex_conf.cc"
yy43:
	yych = (unsigned char)*++cur;
	if (yych == '-') goto yy68;
	goto yy3;
...
#line 401 "src/parse/lex_conf.cc"
yy53:
	yych = (unsigned char)*++cur;
	if (yych == 'g') goto yy77;
	goto yy3;
...
#line 798 "src/parse/lex_conf.cc"
yy138:
	yych = (unsigned char)*++cur;
	if (yych == ':') goto yy189;
	goto yy3;
...
#line 954 "src/parse/lex_conf.cc"
yy171:
	yych = (unsigned char)*++cur;
	if (yybm[0+yych] & 32) {
		goto yy2;
...
#line 145 "../src/parse/lex_conf.re"
	{ RET_CONF_BOOL(dFlag); }
#line 1007 "src/parse/lex_conf.cc"
yy177:
	yych = (unsigned char)*++cur;
	if (yych <= '_') {
		if (yych <= ':') {
...
#line 1122 "src/parse/lex_conf.cc"
yy188:
	yych = (unsigned char)*++cur;
	if (yybm[0+yych] & 32) {
		goto yy2;
...
#line 1359 "src/parse/lex_conf.cc"
yy240:
	yych = (unsigned char)*++cur;
...
#line 1391 "src/parse/lex_conf.cc"
yy247:
	yych = (unsigned char)*++cur;
...
#line 1419 "src/parse/lex_conf.cc"
yy253:
	yych = (unsigned char)*++cur;
	if (yybm[0+yych] & 32) {
		goto yy2;
...
#line 1466 "src/parse/lex_conf.cc"
yy263:
	yych = (unsigned char)*++cur;
...
#line 1813 "src/parse/lex_conf.cc"
yy335:
	yych = (unsigned char)*++cur;
...
#line 1866 "src/parse/lex_conf.cc"
yy344:
	yych = (unsigned char)*++cur;
...
#line 1924 "src/parse/lex_conf.cc"
yy357:
	yych = (unsigned char)*++cur;
...
#line 2100 "src/parse/lex_conf.cc"
yy398:
	yych = (unsigned char)*++cur;
...
#line 169 "../src/parse/lex_conf.re"
	{ RET_CONF_STR(yynext); }
#line 2356 "src/parse/lex_conf.cc"
yy448:
	yych = (unsigned char)*++cur;
	if (yybm[0+yych] & 32) {
		goto yy2;
...
#line 168 "../src/parse/lex_conf.re"
	{ RET_CONF_STR(yyloop); }
#line 2372 "src/parse/lex_conf.cc"
yy450:
	yych = (unsigned char)*++cur;
...
#line 94 "../src/parse/lex_conf.re"
	{ RET_CONF_STR(fill); }
#line 2524 "src/parse/lex_conf.cc"
yy481:
	yych = (unsigned char)*++cur;
...
#line 130 "../src/parse/lex_conf.re"
	{ RET_CONF_STR(yybm); }
#line 2672 "src/parse/lex_conf.cc"
yy510:
	yych = (unsigned char)*++cur;
	if (yych <= '@') {
		if (yych <= '/') {
...
#line 2718 "src/parse/lex_conf.cc"
yy517:
	yych = (unsigned char)*++cur;
...
#line 2769 "src/parse/lex_conf.cc"
yy524:
	yych = (unsigned char)*++cur;
...
#line 2829 "src/parse/lex_conf.cc"
yy536:
	yych = (unsigned char)*++cur;
...
#line 2996 "src/parse/lex_conf.cc"
yy565:
	yych = (unsigned char)*++cur;
...
#line 3040 "src/parse/lex_conf.cc"
yy574:
	yych = (unsigned char)*++cur;
...
#line 3196 "src/parse/lex_conf.cc"
yy604:
	yych = (unsigned char)*++cur;
...
#line 3248 "src/parse/lex_conf.cc"
yy615:
	++cur;
...
#line 3391 "src/parse/lex_conf.cc"
yy637:
	yych = (unsigned char)*++cur;
	if (yybm[0+yych] & 32) {
		goto yy2;
...
#line 3399 "src/parse/lex_conf.cc"
yy638:
	yych = (unsigned char)*++cur;
	if (yybm[0+yych] & 32) {
		goto yy2;
...
#line 3407 "src/parse/lex_conf.cc"
yy639:
	yych = (unsigned char)*++cur;
...
#line 3483 "src/parse/lex_conf.cc"
yy654:
	yych = (unsigned char)*++cur;
	if (yybm[0+yych] & 32) {
		goto yy2;
...
#line 3491 "src/parse/lex_conf.cc"
yy655:
	yych = (unsigned char)*++cur;
...
#line 3678 "src/parse/lex_conf.cc"
yy692:
	yych = (unsigned char)*++cur;
	if (yybm[0+yych] & 32) {
		goto yy2;
...
#line 3686 "src/parse/lex_conf.cc"
yy693:
	yych = (unsigned char)*++cur;
	if (yybm[0+yych] & 32) {
		goto yy2;
...
#line 3809 "src/parse/lex_conf.cc"
{
	unsigned char yych;
...
#line 3879 "src/parse/lex_conf.cc"
}
...
#line 3890 "src/parse/lex_conf.cc"
{
	unsigned char yych;
...
#line 3944 "src/parse/lex_conf.cc"
yy741:
	yych = (unsigned char)*++cur;
	if (yych != '-') goto yy734;
	yych = (unsigned char)*++cur;
...
#line 3984 "src/parse/lex_conf.cc"
yy750:
	++cur;
...
#line 4081 "src/parse/lex_conf.cc"
yy770:
	++cur;
...
#line 4096 "src/parse/lex_conf.cc"
{
	unsigned char yych;
	static const unsigned char yybm[] = {
		  0,   0,   0,   0,   0,   0,   0,   0, 
...
#line 245 "../src/parse/lex_conf.re"
	{ return; }
#line 4167 "src/parse/lex_conf.cc"
yy775:
	++cur;
	if (lim <= cur) YYFILL(1);
	yych = (unsigned char)*cur;
...
#line 4187 "src/parse/lex_conf.cc"
{
	unsigned char yych;
	static const unsigned char yybm[] = {
		  0,   0,   0,   0,   0,   0,   0,   0, 
...
#line 255 "../src/parse/lex_conf.re"
	{ return; }
#line 4250 "src/parse/lex_conf.cc"
yy780:
	++cur;
	if (lim <= cur) YYFILL(1);
	yych = (unsigned char)*cur;
...
#line 4270 "src/parse/lex_conf.cc"
{
	unsigned char yych;
	static const unsigned char yybm[] = {
		  0,   0,   0,   0,   0,   0,   0,   0, 
...
#line 4341 "src/parse/lex_conf.cc"
yy786:
	++cur;
	if (lim <= cur) YYFILL(1);
	yych = (unsigned char)*cur;
...
#line 4360 "src/parse/lex_conf.cc"
{
	unsigned char yych;
	static const unsigned char yybm[] = {
...
#line 4445 "src/parse/lex_conf.cc"
}
