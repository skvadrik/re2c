/* Generated by re2c 3.0 on Sun Jun 26 08:40:00 2022 */
...
#line 174 "src/parse/lex_conf.cc"
yy2:
	++cur;
	if (lim <= cur) YYFILL(1);
	yych = (unsigned char)*cur;
...
#line 372 "src/parse/lex_conf.cc"
yy43:
	yych = (unsigned char)*++cur;
	if (yych == '-') goto yy68;
	goto yy3;
...
#line 416 "src/parse/lex_conf.cc"
yy53:
	yych = (unsigned char)*++cur;
	if (yych == 'g') goto yy77;
	goto yy3;
...
#line 813 "src/parse/lex_conf.cc"
yy138:
	yych = (unsigned char)*++cur;
	if (yych == ':') goto yy189;
	goto yy3;
...
#line 867 "src/parse/lex_conf.cc"
yy149:
	yych = (unsigned char)*++cur;
...
#line 969 "src/parse/lex_conf.cc"
yy171:
	yych = (unsigned char)*++cur;
	if (yybm[0+yych] & 32) {
		goto yy2;
...
#line 161 "../src/parse/lex_conf.re"
	{ RET_CONF_BOOL(dFlag); }
#line 1022 "src/parse/lex_conf.cc"
yy177:
	yych = (unsigned char)*++cur;
	if (yych <= '_') {
		if (yych <= ':') {
...
#line 1048 "src/parse/lex_conf.cc"
yy179:
	yych = (unsigned char)*++cur;
	if (yybm[0+yych] & 32) {
		goto yy2;
...
#line 1116 "src/parse/lex_conf.cc"
yy186:
	yych = (unsigned char)*++cur;
	if (yych <= 'Z') {
		if (yych <= '/') {
...
#line 1137 "src/parse/lex_conf.cc"
yy188:
	yych = (unsigned char)*++cur;
	if (yybm[0+yych] & 32) {
		goto yy2;
...
#line 1145 "src/parse/lex_conf.cc"
yy189:
	yych = (unsigned char)*++cur;
	if (yych <= 'r') goto yy3;
...
#line 1406 "src/parse/lex_conf.cc"
yy247:
	yych = (unsigned char)*++cur;
...
#line 1442 "src/parse/lex_conf.cc"
yy254:
	yych = (unsigned char)*++cur;
...
#line 1481 "src/parse/lex_conf.cc"
yy263:
	yych = (unsigned char)*++cur;
...
#line 1713 "src/parse/lex_conf.cc"
yy311:
	yych = (unsigned char)*++cur;
...
#line 1828 "src/parse/lex_conf.cc"
yy335:
	yych = (unsigned char)*++cur;
...
#line 1881 "src/parse/lex_conf.cc"
yy344:
	yych = (unsigned char)*++cur;
...
#line 2041 "src/parse/lex_conf.cc"
yy381:
	yych = (unsigned char)*++cur;
...
#line 2173 "src/parse/lex_conf.cc"
yy405:
	yych = (unsigned char)*++cur;
	if (yych <= 'c') {
		if (yych <= '`') goto yy3;
...
#line 185 "../src/parse/lex_conf.re"
	{ RET_CONF_STR(yynext); }
#line 2371 "src/parse/lex_conf.cc"
yy448:
	yych = (unsigned char)*++cur;
	if (yybm[0+yych] & 32) {
		goto yy2;
...
#line 2379 "src/parse/lex_conf.cc"
yy449:
	yych = (unsigned char)*++cur;
	if (yybm[0+yych] & 32) {
		goto yy2;
...
#line 2472 "src/parse/lex_conf.cc"
yy468:
	yych = (unsigned char)*++cur;
...
#line 110 "../src/parse/lex_conf.re"
	{ RET_CONF_STR(fill); }
#line 2539 "src/parse/lex_conf.cc"
yy481:
	yych = (unsigned char)*++cur;
...
#line 122 "../src/parse/lex_conf.re"
	{ RET_CONF_STR(yypeek); }
#line 2572 "src/parse/lex_conf.cc"
yy488:
	yych = (unsigned char)*++cur;
...
#line 143 "../src/parse/lex_conf.re"
	{ RET_CONF_STR(yych); }
#line 2709 "src/parse/lex_conf.cc"
yy512:
	yych = (unsigned char)*++cur;
...
#line 2985 "src/parse/lex_conf.cc"
yy562:
	yych = (unsigned char)*++cur;
...
#line 3139 "src/parse/lex_conf.cc"
yy591:
	yych = (unsigned char)*++cur;
...
#line 3293 "src/parse/lex_conf.cc"
yy621:
	yych = (unsigned char)*++cur;
...
#line 3319 "src/parse/lex_conf.cc"
yy624:
	yych = (unsigned char)*++cur;
	if (yybm[0+yych] & 32) {
		goto yy2;
...
#line 3498 "src/parse/lex_conf.cc"
yy654:
	yych = (unsigned char)*++cur;
	if (yybm[0+yych] & 32) {
		goto yy2;
...
#line 3635 "src/parse/lex_conf.cc"
yy679:
	yych = (unsigned char)*++cur;
...
#line 3709 "src/parse/lex_conf.cc"
}
...
#line 3736 "src/parse/lex_conf.cc"
yy696:
	yych = (unsigned char)*(mar = ++cur);
...
#line 3958 "src/parse/lex_conf.cc"
yy741:
	yych = (unsigned char)*++cur;
	if (yych != '-') goto yy734;
	yych = (unsigned char)*++cur;
...
#line 4014 "src/parse/lex_conf.cc"
{
	unsigned char yych;
...
#line 4110 "src/parse/lex_conf.cc"
{
	unsigned char yych;
	static const unsigned char yybm[] = {
		  0,   0,   0,   0,   0,   0,   0,   0, 
...
#line 4159 "src/parse/lex_conf.cc"
yy773:
	yych = (unsigned char)*(mar = ++cur);
	if (yych <= 0x1F) {
		if (yych == '\t') goto yy775;
...
#line 256 "../src/parse/lex_conf.re"
	{ return Ret::OK; }
#line 4178 "src/parse/lex_conf.cc"
yy775:
	++cur;
	if (lim <= cur) YYFILL(1);
	yych = (unsigned char)*cur;
...
#line 4278 "src/parse/lex_conf.cc"
{
	unsigned char yych;
	static const unsigned char yybm[] = {
		  0,   0,   0,   0,   0,   0,   0,   0, 
...
#line 4344 "src/parse/lex_conf.cc"
yy786:
	++cur;
	if (lim <= cur) YYFILL(1);
	yych = (unsigned char)*cur;
...
#line 4370 "src/parse/lex_conf.cc"
{
	unsigned char yych;
	static const unsigned char yybm[] = {
...
#line 311 "../src/parse/lex_conf.re"
	{ goto end; }
#line 4428 "src/parse/lex_conf.cc"
yy789:
	++cur;
	if (lim <= cur) YYFILL(1);
	yych = (unsigned char)*cur;
...
#line 4438 "src/parse/lex_conf.cc"
yy790:
	++cur;
...
#line 4458 "src/parse/lex_conf.cc"
}
