/* Generated by re2c 1.3 on Wed May  6 23:38:13 2020 */
...
#line 555 "src/parse/lex_conf.cc"
yy102:
	yych = (unsigned char)*++cur;
	if (yybm[0+yych] & 32) {
		goto yy3;
...
#line 726 "src/parse/lex_conf.cc"
yy123:
	yych = (unsigned char)*++cur;
	if (yych <= '^') {
		if (yych <= '/') {
...
#line 750 "src/parse/lex_conf.cc"
yy125:
	yych = (unsigned char)*++cur;
	if (yych <= 'Z') {
		if (yych <= '/') {
...
#line 779 "src/parse/lex_conf.cc"
yy129:
	yych = (unsigned char)*++cur;
	if (yych <= 'r') goto yy4;
...
#line 960 "src/parse/lex_conf.cc"
yy172:
	yych = (unsigned char)*++cur;
...
#line 1180 "src/parse/lex_conf.cc"
yy223:
	yych = (unsigned char)*++cur;
...
#line 1238 "src/parse/lex_conf.cc"
yy233:
	yych = (unsigned char)*++cur;
...
#line 1409 "src/parse/lex_conf.cc"
yy266:
	yych = (unsigned char)*++cur;
...
#line 1649 "src/parse/lex_conf.cc"
yy322:
	yych = (unsigned char)*++cur;
...
#line 1709 "src/parse/lex_conf.cc"
yy334:
	yych = (unsigned char)*++cur;
...
#line 1869 "src/parse/lex_conf.cc"
yy373:
	++cur;
	if (lim <= cur) YYFILL(1);
	yych = (unsigned char)*cur;
...
#line 1918 "src/parse/lex_conf.cc"
yy385:
	yych = (unsigned char)*++cur;
...
#line 2022 "src/parse/lex_conf.cc"
yy407:
	yych = (unsigned char)*++cur;
...
#line 2042 "src/parse/lex_conf.cc"
yy412:
	yych = (unsigned char)*++cur;
...
#line 2138 "src/parse/lex_conf.cc"
yy435:
	yych = (unsigned char)*++cur;
...
#line 2422 "src/parse/lex_conf.cc"
yy498:
	yych = (unsigned char)*++cur;
...
#line 2448 "src/parse/lex_conf.cc"
yy501:
	yych = (unsigned char)*++cur;
...
#line 2464 "src/parse/lex_conf.cc"
yy505:
	yych = (unsigned char)*++cur;
...
#line 2580 "src/parse/lex_conf.cc"
yy534:
	yych = (unsigned char)*++cur;
	if (yybm[0+yych] & 32) {
		goto yy3;
...
#line 2612 "src/parse/lex_conf.cc"
yy542:
	yych = (unsigned char)*++cur;
...
#line 2758 "src/parse/lex_conf.cc"
yy574:
	++cur;
...
#line 2775 "src/parse/lex_conf.cc"
yy579:
	yych = (unsigned char)*++cur;
...
#line 2822 "src/parse/lex_conf.cc"
yy588:
	yych = (unsigned char)*++cur;
...
#line 2929 "src/parse/lex_conf.cc"
yy610:
	yych = (unsigned char)*++cur;
	if (yybm[0+yych] & 32) {
		goto yy3;
...
#line 3079 "src/parse/lex_conf.cc"
yy647:
	yych = (unsigned char)*++cur;
...
#line 3226 "src/parse/lex_conf.cc"
yy676:
	yych = (unsigned char)*++cur;
...
#line 3518 "src/parse/lex_conf.cc"
yy751:
	yych = (unsigned char)*(mar = ++cur);
...
#line 3760 "src/parse/lex_conf.cc"
yy790:
	yych = (unsigned char)*(mar = ++cur);
	if (yybm[0+yych] & 128) {
		goto yy793;
...
#line 239 "../src/parse/lex_conf.re"
	{ return; }
#line 3771 "src/parse/lex_conf.cc"
yy793:
	++cur;
	if (lim <= cur) YYFILL(1);
	yych = (unsigned char)*cur;
...
#line 3864 "src/parse/lex_conf.cc"
yy803:
	++cur;
	if (lim <= cur) YYFILL(1);
	yych = (unsigned char)*cur;
...
#line 3961 "src/parse/lex_conf.cc"
yy811:
	++cur;
...
#line 3981 "src/parse/lex_conf.cc"
}
