/* Generated by re2c 3.0 on Sun Jul  3 18:57:03 2022 */
...
#line 168 "src/parse/lex_conf.cc"
yy2:
	++cur;
	if (lim <= cur) YYFILL(1);
	yych = (unsigned char)*cur;
...
#line 80 "../src/parse/lex_conf.re"
	{ CHECK_RET(lex_conf_eof(u)); opts.set_eof(u);      return Ret::OK; }
...
#line 807 "src/parse/lex_conf.cc"
yy138:
	yych = (unsigned char)*++cur;
	if (yych == ':') goto yy189;
	goto yy3;
...
#line 861 "src/parse/lex_conf.cc"
yy149:
	yych = (unsigned char)*++cur;
...
#line 155 "../src/parse/lex_conf.re"
	{ RET_CONF_BOOL(dFlag); }
#line 1016 "src/parse/lex_conf.cc"
yy177:
	yych = (unsigned char)*++cur;
	if (yych <= '_') {
		if (yych <= ':') {
...
#line 1042 "src/parse/lex_conf.cc"
yy179:
	yych = (unsigned char)*++cur;
	if (yybm[0+yych] & 32) {
		goto yy2;
...
#line 158 "../src/parse/lex_conf.re"
	{ RET_CONF_BOOL(sFlag); }
#line 1063 "src/parse/lex_conf.cc"
yy183:
	yych = (unsigned char)*++cur;
	if (yych <= '^') {
		if (yych <= '/') {
...
#line 1139 "src/parse/lex_conf.cc"
yy189:
	yych = (unsigned char)*++cur;
	if (yych <= 'r') goto yy3;
...
#line 81 "../src/parse/lex_conf.re"
	{ CHECK_RET(lex_conf_eof(u)); opts.set_sentinel(u); return Ret::OK; }
#line 1368 "src/parse/lex_conf.cc"
yy240:
	yych = (unsigned char)*++cur;
...
#line 1436 "src/parse/lex_conf.cc"
yy254:
	yych = (unsigned char)*++cur;
...
#line 1822 "src/parse/lex_conf.cc"
yy335:
	yych = (unsigned char)*++cur;
...
#line 1933 "src/parse/lex_conf.cc"
yy357:
	yych = (unsigned char)*++cur;
...
#line 2466 "src/parse/lex_conf.cc"
yy468:
	yych = (unsigned char)*++cur;
...
#line 116 "../src/parse/lex_conf.re"
	{ RET_CONF_STR(yypeek); }
#line 2566 "src/parse/lex_conf.cc"
yy488:
	yych = (unsigned char)*++cur;
...
#line 129 "../src/parse/lex_conf.re"
	{ RET_CONF_STR(yyskip); }
#line 2590 "src/parse/lex_conf.cc"
yy493:
	yych = (unsigned char)*++cur;
...
#line 2639 "src/parse/lex_conf.cc"
yy503:
	yych = (unsigned char)*++cur;
...
#line 3005 "src/parse/lex_conf.cc"
yy565:
	yych = (unsigned char)*++cur;
...
#line 3274 "src/parse/lex_conf.cc"
yy618:
	yych = (unsigned char)*++cur;
...
#line 3321 "src/parse/lex_conf.cc"
yy625:
	yych = (unsigned char)*++cur;
...
#line 3629 "src/parse/lex_conf.cc"
yy679:
	yych = (unsigned char)*++cur;
...
#line 3645 "src/parse/lex_conf.cc"
yy682:
	++cur;
#line 125 "../src/parse/lex_conf.re"
	{ RET_CONF_STR(state_set_arg); }
#line 3650 "src/parse/lex_conf.cc"
yy683:
	yych = (unsigned char)*++cur;
...
#line 3773 "src/parse/lex_conf.cc"
yy707:
	yych = (unsigned char)*++cur;
...
#line 3794 "src/parse/lex_conf.cc"
yy712:
	yych = (unsigned char)*++cur;
...
#line 3833 "src/parse/lex_conf.cc"
yy716:
	yych = (unsigned char)*(mar = ++cur);
...
#line 211 "../src/parse/lex_conf.re"
	{ opts.set_input_api(Api::CUSTOM);  goto end; }
...
#line 210 "../src/parse/lex_conf.re"
	{ opts.set_input_api(Api::DEFAULT); goto end; }
...
#line 227 "../src/parse/lex_conf.re"
	{ opts.set_empty_class_policy(EmptyClassPolicy::ERROR);       goto end; }
...
#line 226 "../src/parse/lex_conf.re"
	{ opts.set_empty_class_policy(EmptyClassPolicy::MATCH_NONE);  goto end; }
#line 3992 "src/parse/lex_conf.cc"
yy750:
	++cur;
#line 225 "../src/parse/lex_conf.re"
	{ opts.set_empty_class_policy(EmptyClassPolicy::MATCH_EMPTY); goto end; }
...
#line 4153 "src/parse/lex_conf.cc"
yy773:
	yych = (unsigned char)*(mar = ++cur);
	if (yych <= 0x1F) {
		if (yych == '\t') goto yy775;
...
#line 4192 "src/parse/lex_conf.cc"
{
	unsigned char yych;
	static const unsigned char yybm[] = {
		  0,   0,   0,   0,   0,   0,   0,   0, 
...
#line 4241 "src/parse/lex_conf.cc"
yy778:
	yych = (unsigned char)*(mar = ++cur);
	if (yybm[0+yych] & 128) {
		goto yy780;
...
#line 257 "../src/parse/lex_conf.re"
	{ return Ret::OK; }
#line 4252 "src/parse/lex_conf.cc"
yy780:
	++cur;
	if (lim <= cur) YYFILL(1);
	yych = (unsigned char)*cur;
...
#line 4272 "src/parse/lex_conf.cc"
{
	unsigned char yych;
	static const unsigned char yybm[] = {
		  0,   0,   0,   0,   0,   0,   0,   0, 
...
#line 4321 "src/parse/lex_conf.cc"
yy783:
	yych = (unsigned char)*++cur;
...
#line 4338 "src/parse/lex_conf.cc"
yy786:
	++cur;
	if (lim <= cur) YYFILL(1);
	yych = (unsigned char)*cur;
...
#line 4364 "src/parse/lex_conf.cc"
{
	unsigned char yych;
	static const unsigned char yybm[] = {
...
#line 305 "../src/parse/lex_conf.re"
	{ goto end; }
#line 4422 "src/parse/lex_conf.cc"
yy789:
	++cur;
	if (lim <= cur) YYFILL(1);
	yych = (unsigned char)*cur;
...
#line 304 "../src/parse/lex_conf.re"
	{ s.assign(tok, cur); goto end; }
#line 4432 "src/parse/lex_conf.cc"
yy790:
	++cur;
...
#line 4452 "src/parse/lex_conf.cc"
}
