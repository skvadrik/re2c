/* Generated by re2c 2.1.1 on Tue Jul 13 23:34:12 2021 */
...
#line 145 "src/parse/lex_conf.cc"
yy3:
	++cur;
	if (lim <= cur) YYFILL(1);
	yych = (unsigned char)*cur;
...
#line 282 "src/parse/lex_conf.cc"
yy35:
	yych = (unsigned char)*++cur;
	if (yych == 'g') goto yy49;
	goto yy4;
...
#line 752 "src/parse/lex_conf.cc"
yy128:
	yych = (unsigned char)*++cur;
	if (yych <= '^') {
		if (yych <= '/') {
...
#line 781 "src/parse/lex_conf.cc"
yy130:
	yych = (unsigned char)*++cur;
	if (yych <= '^') {
		if (yych <= '/') {
...
#line 834 "src/parse/lex_conf.cc"
yy136:
	yych = (unsigned char)*++cur;
	if (yych <= 'r') goto yy4;
...
#line 1251 "src/parse/lex_conf.cc"
yy234:
	yych = (unsigned char)*++cur;
...
#line 1309 "src/parse/lex_conf.cc"
yy244:
	yych = (unsigned char)*++cur;
...
#line 1733 "src/parse/lex_conf.cc"
yy336:
	yych = (unsigned char)*++cur;
	if (yych <= 'c') {
		if (yych <= '`') goto yy4;
...
#line 1988 "src/parse/lex_conf.cc"
yy396:
	yych = (unsigned char)*++cur;
...
#line 2059 "src/parse/lex_conf.cc"
yy410:
	yych = (unsigned char)*++cur;
...
#line 2092 "src/parse/lex_conf.cc"
yy418:
	yych = (unsigned char)*++cur;
...
#line 2184 "src/parse/lex_conf.cc"
yy440:
	yych = (unsigned char)*++cur;
...
#line 2265 "src/parse/lex_conf.cc"
yy461:
	yych = (unsigned char)*++cur;
...
#line 2297 "src/parse/lex_conf.cc"
yy469:
	yych = (unsigned char)*++cur;
...
#line 2337 "src/parse/lex_conf.cc"
yy479:
	yych = (unsigned char)*++cur;
	if (yybm[0+yych] & 32) {
		goto yy3;
...
#line 2909 "src/parse/lex_conf.cc"
yy606:
	yych = (unsigned char)*++cur;
...
#line 3174 "src/parse/lex_conf.cc"
yy667:
	yych = (unsigned char)*++cur;
...
#line 3373 "src/parse/lex_conf.cc"
yy709:
	++cur;
...
#line 3537 "src/parse/lex_conf.cc"
}
...
#line 3566 "src/parse/lex_conf.cc"
yy757:
	yych = (unsigned char)*(mar = ++cur);
...
#line 3757 "src/parse/lex_conf.cc"
yy805:
	yych = (unsigned char)*(mar = ++cur);
...
#line 282 "../src/parse/lex_conf.re"
	{ return; }
#line 3921 "src/parse/lex_conf.cc"
yy833:
	++cur;
	if (lim <= cur) YYFILL(1);
	yych = (unsigned char)*cur;
...
#line 3942 "src/parse/lex_conf.cc"
{
	unsigned char yych;
	static const unsigned char yybm[] = {
		  0,   0,   0,   0,   0,   0,   0,   0, 
...
#line 293 "../src/parse/lex_conf.re"
	{ return; }
#line 4005 "src/parse/lex_conf.cc"
yy843:
	++cur;
	if (lim <= cur) YYFILL(1);
	yych = (unsigned char)*cur;
...
#line 4031 "src/parse/lex_conf.cc"
{
	unsigned char yych;
	static const unsigned char yybm[] = {
		  0,   0,   0,   0,   0,   0,   0,   0, 
...
#line 4083 "src/parse/lex_conf.cc"
yy850:
	yych = (unsigned char)*++cur;
...
#line 4102 "src/parse/lex_conf.cc"
yy853:
	++cur;
	if (lim <= cur) YYFILL(1);
	yych = (unsigned char)*cur;
...
#line 4128 "src/parse/lex_conf.cc"
{
	unsigned char yych;
	static const unsigned char yybm[] = {
...
#line 356 "../src/parse/lex_conf.re"
	{ goto end; }
#line 4186 "src/parse/lex_conf.cc"
yy858:
	++cur;
	if (lim <= cur) YYFILL(1);
	yych = (unsigned char)*cur;
...
#line 4199 "src/parse/lex_conf.cc"
yy861:
	++cur;
...
#line 4220 "src/parse/lex_conf.cc"
}
