/* Generated by re2c 1.3 on Fri Jun 19 22:11:38 2020 */
...
#line 1742 "src/parse/lex_conf.cc"
yy338:
	yych = (unsigned char)*++cur;
...
#line 1758 "src/parse/lex_conf.cc"
yy342:
	yych = (unsigned char)*++cur;
	if (yych <= 'c') {
		if (yych <= '`') goto yy4;
...
#line 1958 "src/parse/lex_conf.cc"
yy388:
	yych = (unsigned char)*++cur;
...
#line 2019 "src/parse/lex_conf.cc"
yy403:
	yych = (unsigned char)*++cur;
...
#line 2316 "src/parse/lex_conf.cc"
yy473:
	yych = (unsigned char)*++cur;
...
#line 2368 "src/parse/lex_conf.cc"
yy486:
	yych = (unsigned char)*++cur;
	if (yybm[0+yych] & 32) {
		goto yy3;
...
#line 2376 "src/parse/lex_conf.cc"
yy488:
	yych = (unsigned char)*++cur;
...
#line 2420 "src/parse/lex_conf.cc"
yy495:
	yych = (unsigned char)*++cur;
	if (yybm[0+yych] & 32) {
		goto yy3;
...
#line 2531 "src/parse/lex_conf.cc"
yy521:
	yych = (unsigned char)*++cur;
...
#line 2601 "src/parse/lex_conf.cc"
yy535:
	yych = (unsigned char)*++cur;
...
#line 2939 "src/parse/lex_conf.cc"
yy613:
	yych = (unsigned char)*++cur;
...
#line 3054 "src/parse/lex_conf.cc"
yy637:
	yych = (unsigned char)*++cur;
	if (yybm[0+yych] & 32) {
		goto yy3;
...
#line 3062 "src/parse/lex_conf.cc"
yy639:
	yych = (unsigned char)*++cur;
	if (yybm[0+yych] & 32) {
		goto yy3;
...
#line 3086 "src/parse/lex_conf.cc"
yy645:
	yych = (unsigned char)*++cur;
	if (yybm[0+yych] & 32) {
		goto yy3;
...
#line 3142 "src/parse/lex_conf.cc"
yy659:
	yych = (unsigned char)*++cur;
...
#line 3461 "src/parse/lex_conf.cc"
}
...
#line 3916 "src/parse/lex_conf.cc"
yy836:
	yych = (unsigned char)*(mar = ++cur);
	if (yych <= 0x1F) {
		if (yych == '\t') goto yy840;
...
#line 4091 "src/parse/lex_conf.cc"
yy857:
	yych = (unsigned char)*++cur;
...
#line 4109 "src/parse/lex_conf.cc"
yy860:
	++cur;
	if (lim <= cur) YYFILL(1);
	yych = (unsigned char)*cur;
...
#line 4226 "src/parse/lex_conf.cc"
}
