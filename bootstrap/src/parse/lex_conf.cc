/* Generated by re2c 3.0 on Mon Jun 20 07:57:22 2022 */
...
#line 3799 "src/parse/lex_conf.cc"
}
...
#line 3985 "src/parse/lex_conf.cc"
yy750:
	++cur;
...
#line 4001 "src/parse/lex_conf.cc"
{
	unsigned char yych;
...
#line 4149 "src/parse/lex_conf.cc"
yy773:
	yych = (unsigned char)*(mar = ++cur);
	if (yych <= 0x1F) {
		if (yych == '\t') goto yy775;
...
#line 246 "../src/parse/lex_conf.re"
	{ return; }
#line 4168 "src/parse/lex_conf.cc"
yy775:
	++cur;
	if (lim <= cur) YYFILL(1);
	yych = (unsigned char)*cur;
...
#line 4188 "src/parse/lex_conf.cc"
{
	unsigned char yych;
	static const unsigned char yybm[] = {
		  0,   0,   0,   0,   0,   0,   0,   0, 
...
#line 4323 "src/parse/lex_conf.cc"
yy783:
	yych = (unsigned char)*++cur;
...
#line 4342 "src/parse/lex_conf.cc"
yy786:
	++cur;
	if (lim <= cur) YYFILL(1);
	yych = (unsigned char)*cur;
...
#line 4361 "src/parse/lex_conf.cc"
{
	unsigned char yych;
	static const unsigned char yybm[] = {
...
#line 299 "../src/parse/lex_conf.re"
	{ goto end; }
#line 4419 "src/parse/lex_conf.cc"
yy789:
	++cur;
	if (lim <= cur) YYFILL(1);
	yych = (unsigned char)*cur;
...
#line 4429 "src/parse/lex_conf.cc"
yy790:
	++cur;
...
#line 4446 "src/parse/lex_conf.cc"
}
