/* Generated by re2c 1.3 on Sat Jul  4 09:28:37 2020 */
...
#line 829 "src/parse/lex_conf.cc"
yy136:
	yych = (unsigned char)*++cur;
	if (yych <= 'r') goto yy4;
...
#line 1014 "src/parse/lex_conf.cc"
yy180:
	yych = (unsigned char)*++cur;
...
#line 1074 "src/parse/lex_conf.cc"
yy195:
	yych = (unsigned char)*++cur;
	if (yybm[0+yych] & 32) {
		goto yy3;
...
#line 1246 "src/parse/lex_conf.cc"
yy234:
	yych = (unsigned char)*++cur;
...
#line 1304 "src/parse/lex_conf.cc"
yy244:
	yych = (unsigned char)*++cur;
...
#line 1433 "src/parse/lex_conf.cc"
yy271:
	yych = (unsigned char)*++cur;
...
#line 1470 "src/parse/lex_conf.cc"
yy276:
	yych = (unsigned char)*++cur;
...
#line 1625 "src/parse/lex_conf.cc"
yy314:
	yych = (unsigned char)*++cur;
...
#line 1673 "src/parse/lex_conf.cc"
yy326:
	++cur;
	if (lim <= cur) YYFILL(1);
	yych = (unsigned char)*cur;
...
#line 1727 "src/parse/lex_conf.cc"
yy336:
	yych = (unsigned char)*++cur;
	if (yych <= 'c') {
		if (yych <= '`') goto yy4;
...
#line 1921 "src/parse/lex_conf.cc"
yy381:
	yych = (unsigned char)*++cur;
...
#line 2053 "src/parse/lex_conf.cc"
yy410:
	yych = (unsigned char)*++cur;
...
#line 2086 "src/parse/lex_conf.cc"
yy418:
	yych = (unsigned char)*++cur;
...
#line 2291 "src/parse/lex_conf.cc"
yy469:
	yych = (unsigned char)*++cur;
...
#line 2339 "src/parse/lex_conf.cc"
yy481:
	yych = (unsigned char)*++cur;
...
#line 2656 "src/parse/lex_conf.cc"
yy551:
	yych = (unsigned char)*++cur;
...
#line 2680 "src/parse/lex_conf.cc"
yy557:
	yych = (unsigned char)*++cur;
...
#line 2744 "src/parse/lex_conf.cc"
yy569:
	yych = (unsigned char)*++cur;
...
#line 3159 "src/parse/lex_conf.cc"
yy665:
	yych = (unsigned char)*++cur;
	if (yybm[0+yych] & 32) {
		goto yy3;
...
#line 3306 "src/parse/lex_conf.cc"
yy694:
	yych = (unsigned char)*++cur;
...
#line 3669 "src/parse/lex_conf.cc"
yy788:
	yych = (unsigned char)*++cur;
	if (yych != '-') goto yy780;
	yych = (unsigned char)*++cur;
...
#line 3737 "src/parse/lex_conf.cc"
yy805:
	yych = (unsigned char)*(mar = ++cur);
...
#line 265 "../src/parse/lex_conf.re"
	{ return; }
#line 3979 "src/parse/lex_conf.cc"
yy843:
	++cur;
	if (lim <= cur) YYFILL(1);
	yych = (unsigned char)*cur;
...
#line 4072 "src/parse/lex_conf.cc"
yy853:
	++cur;
	if (lim <= cur) YYFILL(1);
	yych = (unsigned char)*cur;
...
yy857:
#line 323 "../src/parse/lex_conf.re"
	{ goto end; }
#line 4156 "src/parse/lex_conf.cc"
yy858:
	++cur;
	if (lim <= cur) YYFILL(1);
	yych = (unsigned char)*cur;
...
#line 4169 "src/parse/lex_conf.cc"
yy861:
	++cur;
...
#line 324 "../src/parse/lex_conf.re"
