/* Generated by re2c 2.0.3 on Sat Oct 17 12:30:25 2020 */
...
#line 748 "src/parse/lex_conf.cc"
yy128:
	yych = (unsigned char)*++cur;
	if (yych <= '^') {
		if (yych <= '/') {
...
#line 801 "src/parse/lex_conf.cc"
yy132:
	yych = (unsigned char)*++cur;
	if (yych <= 'Z') {
		if (yych <= '/') {
...
#line 822 "src/parse/lex_conf.cc"
yy134:
	yych = (unsigned char)*++cur;
	if (yybm[0+yych] & 32) {
		goto yy3;
...
#line 1015 "src/parse/lex_conf.cc"
yy180:
	yych = (unsigned char)*++cur;
...
#line 1047 "src/parse/lex_conf.cc"
yy188:
	yych = (unsigned char)*++cur;
...
#line 1247 "src/parse/lex_conf.cc"
yy234:
	yych = (unsigned char)*++cur;
...
#line 1435 "src/parse/lex_conf.cc"
yy271:
	yych = (unsigned char)*++cur;
...
#line 1472 "src/parse/lex_conf.cc"
yy276:
	yych = (unsigned char)*++cur;
...
#line 1627 "src/parse/lex_conf.cc"
yy314:
	yych = (unsigned char)*++cur;
...
#line 1935 "src/parse/lex_conf.cc"
yy384:
	++cur;
	if (lim <= cur) YYFILL(1);
	yych = (unsigned char)*cur;
...
#line 1984 "src/parse/lex_conf.cc"
yy396:
	yych = (unsigned char)*++cur;
...
#line 2055 "src/parse/lex_conf.cc"
yy410:
	yych = (unsigned char)*++cur;
...
#line 2321 "src/parse/lex_conf.cc"
yy476:
	yych = (unsigned char)*++cur;
...
#line 2333 "src/parse/lex_conf.cc"
yy479:
	yych = (unsigned char)*++cur;
	if (yybm[0+yych] & 32) {
		goto yy3;
...
#line 2377 "src/parse/lex_conf.cc"
yy486:
	yych = (unsigned char)*++cur;
	if (yybm[0+yych] & 32) {
		goto yy3;
...
#line 2385 "src/parse/lex_conf.cc"
yy488:
	yych = (unsigned char)*++cur;
	if (yybm[0+yych] & 32) {
		goto yy3;
...
#line 2497 "src/parse/lex_conf.cc"
yy514:
	yych = (unsigned char)*++cur;
...
#line 2651 "src/parse/lex_conf.cc"
yy549:
	yych = (unsigned char)*++cur;
	if (yybm[0+yych] & 32) {
		goto yy3;
...
#line 2659 "src/parse/lex_conf.cc"
yy551:
	yych = (unsigned char)*++cur;
...
#line 2747 "src/parse/lex_conf.cc"
yy569:
	yych = (unsigned char)*++cur;
...
#line 2846 "src/parse/lex_conf.cc"
yy594:
	yych = (unsigned char)*++cur;
...
#line 3020 "src/parse/lex_conf.cc"
yy630:
	yych = (unsigned char)*++cur;
	if (yybm[0+yych] & 32) {
		goto yy3;
...
#line 3170 "src/parse/lex_conf.cc"
yy667:
	yych = (unsigned char)*++cur;
...
#line 3194 "src/parse/lex_conf.cc"
yy673:
	yych = (unsigned char)*++cur;
...
#line 3499 "src/parse/lex_conf.cc"
yy741:
	yych = (unsigned char)*++cur;
...
#line 3682 "src/parse/lex_conf.cc"
yy788:
	yych = (unsigned char)*++cur;
	if (yych != '-') goto yy780;
	yych = (unsigned char)*++cur;
...
#line 3739 "src/parse/lex_conf.cc"
{
	unsigned char yych;
...
#line 3846 "src/parse/lex_conf.cc"
{
	unsigned char yych;
	static const unsigned char yybm[] = {
		  0,   0,   0,   0,   0,   0,   0,   0, 
...
#line 276 "../src/parse/lex_conf.re"
	{ return; }
#line 3917 "src/parse/lex_conf.cc"
yy833:
	++cur;
	if (lim <= cur) YYFILL(1);
	yych = (unsigned char)*cur;
...
#line 4098 "src/parse/lex_conf.cc"
yy853:
	++cur;
	if (lim <= cur) YYFILL(1);
	yych = (unsigned char)*cur;
...
#line 4124 "src/parse/lex_conf.cc"
{
	unsigned char yych;
	static const unsigned char yybm[] = {
...
yy857:
#line 350 "../src/parse/lex_conf.re"
	{ goto end; }
#line 4182 "src/parse/lex_conf.cc"
yy858:
	++cur;
	if (lim <= cur) YYFILL(1);
	yych = (unsigned char)*cur;
...
#line 346 "../src/parse/lex_conf.re"
	{
        s = getstr(tok, cur);
        goto end;
    }
#line 4195 "src/parse/lex_conf.cc"
yy861:
	++cur;
...
#line 4216 "src/parse/lex_conf.cc"
}
