...
#line 829 "../src/parse/lex.re"
	{ --cur; return Ret::OK; }
#line 5329 "src/parse/lex.cc"
yy596:
	++cur;
yy597:
#line 830 "../src/parse/lex.re"
	{ goto sourceline; }
#line 5335 "src/parse/lex.cc"
yy598:
	++cur;
#line 828 "../src/parse/lex.re"
	{ pos = tok = cur; return Ret::OK; }
#line 5340 "src/parse/lex.cc"
yy599:
	yych = *++cur;
	if (yych == '\n') goto yy598;
	goto yy597;
