/* Generated by re2c 3.0 on Fri Jun 24 22:45:52 2022 */
...
#line 4011 "src/parse/lex.cc"
yy448:
	++cur;
#line 758 "../src/parse/lex.re"
	{ return static_cast<uint8_t>('\f'); }
#line 4016 "src/parse/lex.cc"
yy449:
	++cur;
#line 759 "../src/parse/lex.re"
	{ return static_cast<uint8_t>('\n'); }
#line 4021 "src/parse/lex.cc"
yy450:
	++cur;
#line 760 "../src/parse/lex.re"
	{ return static_cast<uint8_t>('\r'); }
#line 4026 "src/parse/lex.cc"
yy451:
	++cur;
...
#line 751 "../src/parse/lex.re"
	{ fail_if_eof(); return 0; }
#line 4191 "src/parse/lex.cc"
yy467:
	++cur;
yy468:
#line 753 "../src/parse/lex.re"
	{ return decode(tok); }
#line 4197 "src/parse/lex.cc"
yy469:
	++cur;
#line 745 "../src/parse/lex.re"
	{ msg.error(loc, "newline in character class"); exit(1); }
...
#line 788 "../src/parse/lex.re"
	{ fail_if_eof(); ast.chr = 0; return true; }
#line 4951 "src/parse/lex.cc"
yy559:
	++cur;
yy560:
#line 790 "../src/parse/lex.re"
	{ ast.chr = decode(tok); return tok[0] != quote; }
#line 4957 "src/parse/lex.cc"
yy561:
	++cur;
#line 782 "../src/parse/lex.re"
	{ msg.error(ast.loc, "newline in character string"); exit(1); }
...
#line 800 "../src/parse/lex.re"
	{ ast.chr = static_cast<uint8_t>('\\'); return true; }
#line 5147 "src/parse/lex.cc"
yy583:
	++cur;
#line 793 "../src/parse/lex.re"
	{ ast.chr = static_cast<uint8_t>('\a'); return true; }
#line 5152 "src/parse/lex.cc"
yy584:
	++cur;
#line 794 "../src/parse/lex.re"
	{ ast.chr = static_cast<uint8_t>('\b'); return true; }
#line 5157 "src/parse/lex.cc"
yy585:
	++cur;
#line 795 "../src/parse/lex.re"
	{ ast.chr = static_cast<uint8_t>('\f'); return true; }
#line 5162 "src/parse/lex.cc"
yy586:
	++cur;
#line 796 "../src/parse/lex.re"
	{ ast.chr = static_cast<uint8_t>('\n'); return true; }
#line 5167 "src/parse/lex.cc"
yy587:
	++cur;
#line 797 "../src/parse/lex.re"
	{ ast.chr = static_cast<uint8_t>('\r'); return true; }
#line 5172 "src/parse/lex.cc"
yy588:
	++cur;
#line 798 "../src/parse/lex.re"
	{ ast.chr = static_cast<uint8_t>('\t'); return true; }
...
#line 5368 "src/parse/lex.cc"
{
	...
	++cur;
#line 849 "../src/parse/lex.re"
	{ --cur; return; }
#line 5428 "src/parse/lex.cc"
yy611:
	++cur;
yy612:
#line 850 "../src/parse/lex.re"
	{ goto sourceline; }
#line 5434 "src/parse/lex.cc"
yy613:
	++cur;
#line 848 "../src/parse/lex.re"
	{ pos = tok = cur; return; }
#line 5439 "src/parse/lex.cc"
yy614:
	yych = (unsigned char)*++cur;
	if (yych == '\n') goto yy613;
	goto yy612;
