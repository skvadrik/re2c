/* Generated by re2c 3.0 on Wed Jun 22 08:04:18 2022 */
...
#line 762 "../src/parse/lex.re"
	{ return static_cast<uint8_t>('\\'); }
#line 3995 "src/parse/lex.cc"
yy445:
	++cur;
#line 764 "../src/parse/lex.re"
	{ return static_cast<uint8_t>(']'); }
#line 4000 "src/parse/lex.cc"
yy446:
	++cur;
...
#line 750 "../src/parse/lex.re"
	{ fail_if_eof(); return 0; }
#line 4190 "src/parse/lex.cc"
yy467:
	++cur;
yy468:
#line 752 "../src/parse/lex.re"
	{ return decode(tok); }
#line 4196 "src/parse/lex.cc"
yy469:
	++cur;
#line 744 "../src/parse/lex.re"
	{ msg.error(loc, "newline in character class"); exit(1); }
...
#line 789 "../src/parse/lex.re"
	{ ast.chr = decode(tok); return tok[0] != quote; }
#line 4956 "src/parse/lex.cc"
yy561:
	++cur;
#line 781 "../src/parse/lex.re"
	{ msg.error(ast.loc, "newline in character string"); exit(1); }
#line 4961 "src/parse/lex.cc"
yy562:
	yych = (unsigned char)*++cur;
	if (yych == '\n') goto yy561;
	goto yy560;
...
#line 795 "../src/parse/lex.re"
	{ ast.chr = static_cast<uint8_t>('\n'); return true; }
#line 5166 "src/parse/lex.cc"
yy587:
	++cur;
#line 796 "../src/parse/lex.re"
	{ ast.chr = static_cast<uint8_t>('\r'); return true; }
#line 5171 "src/parse/lex.cc"
yy588:
	++cur;
#line 797 "../src/parse/lex.re"
	{ ast.chr = static_cast<uint8_t>('\t'); return true; }
...
#line 848 "../src/parse/lex.re"
	{ --cur; return; }
#line 5427 "src/parse/lex.cc"
yy611:
	++cur;
yy612:
#line 849 "../src/parse/lex.re"
	{ goto sourceline; }
#line 5433 "src/parse/lex.cc"
yy613:
	++cur;
