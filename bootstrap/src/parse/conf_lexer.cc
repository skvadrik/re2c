...
#line 98 "../src/parse/conf_lexer.re"
	{ goto input; }
#line 404 "src/parse/conf_lexer.cc"
yy44:
	yych = *++cur;
	if (yych == '-') goto yy71;
	goto yy3;
...
#line 446 "src/parse/conf_lexer.cc"
yy54:
	yych = *++cur;
	if (yych == 'g') goto yy80;
	goto yy3;
...
#line 122 "../src/parse/conf_lexer.re"
	{ RET_CONF_BOOL(tags); }
#line 624 "src/parse/conf_lexer.cc"
yy93:
	yych = *++cur;
...
#line 885 "src/parse/conf_lexer.cc"
yy148:
	yych = *++cur;
	if (yych == ':') goto yy205;
	goto yy3;
...
#line 945 "src/parse/conf_lexer.cc"
yy161:
	yych = *++cur;
...
#line 1055 "src/parse/conf_lexer.cc"
yy186:
	yych = *++cur;
	if (yybm[0+yych] & 32) goto yy2;
	goto yy92;
...
#line 1080 "src/parse/conf_lexer.cc"
yy189:
	yych = *++cur;
	if (yych == 'a') goto yy22;
...
#line 204 "../src/parse/conf_lexer.re"
	{ RET_CONF_BOOL(debug); }
#line 1106 "src/parse/conf_lexer.cc"
yy192:
	yych = *++cur;
	if (yych <= '_') {
		if (yych <= ':') {
...
#line 1132 "src/parse/conf_lexer.cc"
yy194:
	yych = *++cur;
	if (yybm[0+yych] & 32) goto yy2;
yy195:
...
#line 1139 "src/parse/conf_lexer.cc"
yy196:
	yych = *++cur;
...
#line 1227 "src/parse/conf_lexer.cc"
yy205:
	yych = *++cur;
	if (yych <= 'r') goto yy3;
...
#line 1512 "src/parse/conf_lexer.cc"
yy270:
	yych = *++cur;
...
#line 1548 "src/parse/conf_lexer.cc"
yy278:
	yych = *++cur;
	if (yybm[0+yych] & 32) goto yy2;
...
#line 1595 "src/parse/conf_lexer.cc"
yy289:
	yych = *++cur;
...
#line 1753 "src/parse/conf_lexer.cc"
yy325:
	yych = *++cur;
...
#line 1799 "src/parse/conf_lexer.cc"
yy336:
	yych = *++cur;
...
#line 1833 "src/parse/conf_lexer.cc"
yy341:
	yych = *++cur;
...
#line 2071 "src/parse/conf_lexer.cc"
yy390:
	yych = *++cur;
...
#line 2134 "src/parse/conf_lexer.cc"
yy403:
	yych = *++cur;
...
#line 2259 "src/parse/conf_lexer.cc"
yy433:
	yych = *++cur;
...
#line 2302 "src/parse/conf_lexer.cc"
yy438:
	yych = *++cur;
...
#line 2527 "src/parse/conf_lexer.cc"
yy488:
	yych = *++cur;
	if (yybm[0+yych] & 32) goto yy2;
...
#line 2553 "src/parse/conf_lexer.cc"
yy494:
	++cur;
	if (lim <= cur) YYFILL(1);
	yych = *cur;
	if (yybm[0+yych] & 128) goto yy494;
	goto yy493;
yy495:
	yych = *++cur;
...
#line 2687 "src/parse/conf_lexer.cc"
yy522:
	yych = *++cur;
...
#line 2748 "src/parse/conf_lexer.cc"
yy536:
	yych = *++cur;
...
#line 2791 "src/parse/conf_lexer.cc"
yy546:
	yych = *++cur;
...
#line 2863 "src/parse/conf_lexer.cc"
yy557:
	yych = *++cur;
...
#line 2994 "src/parse/conf_lexer.cc"
yy582:
	yych = *++cur;
...
#line 3311 "src/parse/conf_lexer.cc"
yy647:
	yych = *++cur;
...
#line 3461 "src/parse/conf_lexer.cc"
yy678:
	yych = *++cur;
...
#line 3487 "src/parse/conf_lexer.cc"
yy681:
	yych = *++cur;
	if (yybm[0+yych] & 32) goto yy2;
#line 148 "../src/parse/conf_lexer.re"
	{ RET_CONF_STR(api_less_than); }
#line 3493 "src/parse/conf_lexer.cc"
yy682:
	yych = *++cur;
...
#line 3574 "src/parse/conf_lexer.cc"
yy696:
	yych = *++cur;
	if (yybm[0+yych] & 32) goto yy2;
#line 135 "../src/parse/conf_lexer.re"
	{ RET_CONF_STR(api_backup_ctx); }
#line 3580 "src/parse/conf_lexer.cc"
yy697:
	yych = *++cur;
	if (yybm[0+yych] & 32) goto yy2;
...
#line 3604 "src/parse/conf_lexer.cc"
yy702:
	yych = *++cur;
...
#line 3636 "src/parse/conf_lexer.cc"
yy709:
	yych = *++cur;
...
#line 3724 "src/parse/conf_lexer.cc"
yy726:
	yych = *++cur;
...
#line 3807 "src/parse/conf_lexer.cc"
yy742:
	++cur;
...
#line 4300 "src/parse/conf_lexer.cc"
yy842:
	yych = *++cur;
...
#line 4389 "src/parse/conf_lexer.cc"
yy845:
	yych = *(mar = ++cur);
	if (yych <= '\r') {
		if (yych == '\t') goto yy847;
...
yy846:
	...
	if (lim <= cur) YYFILL(1);
	yych = *cur;
	if (yybm[0+yych] & 128) goto yy846;
#line 308 "../src/parse/conf_lexer.re"
	{ return Ret::OK; }
#line 4411 "src/parse/conf_lexer.cc"
yy847:
	++cur;
	if (lim <= cur) YYFILL(1);
	yych = *cur;
...
#line 4488 "src/parse/conf_lexer.cc"
yy850:
	yych = *(mar = ++cur);
...
#line 430 "../src/parse/conf_lexer.re"
	{ goto start; }
#line 4805 "src/parse/conf_lexer.cc"
yy862:
	++cur;
...
yy863:
	++cur;
#line 439 "../src/parse/conf_lexer.re"
	{
...
#line 447 "../src/parse/conf_lexer.re"
	{ RET_TOK(cur[-1]); }
#line 4837 "src/parse/conf_lexer.cc"
yy866:
	yych = *++cur;
...
#line 4883 "src/parse/conf_lexer.cc"
yy875:
	yych = *++cur;
...
#line 5183 "src/parse/conf_lexer.cc"
yy931:
	yych = *++cur;
...
#line 5303 "src/parse/conf_lexer.cc"
yy959:
	yych = *++cur;
...
#line 5333 "src/parse/conf_lexer.cc"
yy966:
	yych = *++cur;
	if (yybm[0+yych] & 64) goto yy872;
#line 539 "../src/parse/conf_lexer.re"
	{ RET_VAR(StxVarId::VAR); }
#line 5339 "src/parse/conf_lexer.cc"
yy967:
	yych = *++cur;
...
#line 5466 "src/parse/conf_lexer.cc"
yy993:
	yych = *++cur;
	if (yybm[0+yych] & 64) goto yy872;
#line 528 "../src/parse/conf_lexer.re"
	{ RET_VAR(StxVarId::PEEK); }
#line 5472 "src/parse/conf_lexer.cc"
yy994:
	yych = *++cur;
...
#line 5488 "src/parse/conf_lexer.cc"
yy997:
	yych = *++cur;
...
#line 5498 "src/parse/conf_lexer.cc"
yy999:
	yych = *++cur;
...
#line 5636 "src/parse/conf_lexer.cc"
yy1018:
	yych = *++cur;
	if (yybm[0+yych] & 64) goto yy872;
#line 521 "../src/parse/conf_lexer.re"
	{ RET_VAR(StxVarId::LABEL); }
#line 5642 "src/parse/conf_lexer.cc"
yy1019:
	yych = *++cur;
...
#line 5710 "src/parse/conf_lexer.cc"
yy1033:
	yych = *++cur;
	if (yych <= 'q') {
...
#line 5799 "src/parse/conf_lexer.cc"
yy1050:
	yych = *++cur;
...
#line 470 "../src/parse/conf_lexer.re"
	{ RET_CODE(code_loop); }
#line 6073 "src/parse/conf_lexer.cc"
yy1111:
	yych = *++cur;
...
#line 6120 "src/parse/conf_lexer.cc"
yy1122:
	yych = *++cur;
	if (yych <= '^') {
		if (yych <= '/') goto yy1123;
...
#line 6287 "src/parse/conf_lexer.cc"
yy1154:
	yych = *++cur;
	if (yych <= '^') {
		if (yych <= '/') goto yy1155;
...
#line 484 "../src/parse/conf_lexer.re"
	{ RET_CODE(code_skip); }
#line 6394 "src/parse/conf_lexer.cc"
yy1175:
	yych = *++cur;
...
#line 482 "../src/parse/conf_lexer.re"
	{ RET_CODE(code_debug); }
#line 6492 "src/parse/conf_lexer.cc"
yy1198:
	yych = *++cur;
...
#line 6612 "src/parse/conf_lexer.cc"
yy1224:
	yych = *++cur;
	if (yych <= '^') {
		if (yych <= '/') goto yy1225;
...
#line 6794 "src/parse/conf_lexer.cc"
yy1259:
	yych = *++cur;
...
yy1270:
#line 450 "../src/parse/conf_lexer.re"
	{ RET_CODE(code_var_global); }
#line 6847 "src/parse/conf_lexer.cc"
yy1271:
	yych = *++cur;
...
#line 7013 "src/parse/conf_lexer.cc"
yy1302:
	yych = *++cur;
...
#line 7370 "src/parse/conf_lexer.cc"
}
...
#line 7715 "src/parse/conf_lexer.cc"
yy1452:
	yych = *++cur;
...
#line 8158 "src/parse/conf_lexer.cc"
yy1557:
	yych = *++cur;
...
#line 8302 "src/parse/conf_lexer.cc"
{
	uint8_t yych;
	static const unsigned char yybm[256] = {
		  0, 128, 128, 128, 128, 128, 128, 128,
...
yy1590:
	...
	if (lim <= cur) YYFILL(1);
	yych = *cur;
	if (yybm[0+yych] & 128) goto yy1590;
...
#line 8525 "src/parse/conf_lexer.cc"
yy1617:
	++cur;
#line 640 "../src/parse/conf_lexer.re"
	{ CHECK_RET(lex_conf(opts)); goto start; }
#line 8530 "src/parse/conf_lexer.cc"
yy1618:
	yych = *++cur;
...
yy1641:
	yych = *++cur;
	if (yych == 'q') goto yy1647;
	goto yy1591;
yy1642:
	yych = *++cur;
	if (yych == 'b') goto yy1648;
	goto yy1591;
yy1643:
	yych = *++cur;
...
#line 8663 "src/parse/conf_lexer.cc"
yy1651:
	yych = *++cur;
...
yy1688:
	yych = *++cur;
	if (yych == 'l') goto yy1695;
	goto yy1591;
yy1689:
	yych = *++cur;
	if (yych == 'm') goto yy1696;
	goto yy1591;
yy1690:
	yych = *++cur;
