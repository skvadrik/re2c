static constexpr const char* DEFAULT_SYNTAX_ZIG =
    ...
    "\n"
    "code:loop = (.computed_continue\n"
    "    ? topindent var \": switch (@as(enum {\" nl\n"
    "        indent [state: topindent state \",\" nl] dedent\n"
    "      topindent \"}, .\" val \")) {\" nl\n"
    "        indent [state:\n"
    "            topindent \".\" state \" => {\" nl\n"
    "                indent [stmt: stmt] dedent\n"
    ...
    "    topindent \"}\" nl);\n"
    "\n"
    "code:continue = topindent \"continue\"\n"
    "    (.computed_continue ? \" :\" var \" .\" val : (.loop_label ? \" :\" label)) \";\" nl;\n"
    "\n"
