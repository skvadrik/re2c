static constexpr const char* DEFAULT_SYNTAX_PHP =
    ...
    "supported_code_models = [\"goto-label\", \"loop-switch\"];\n"
    ...
    "\n"
    "code:array_local =\n"
    "    topindent \"static \" name \" = [\" nl indent\n"
    ...
    "    topindent \"}\" nl;\n"
    "\n"
    "code:continue = topindent \"goto \" label \";\" nl;\n"
    "\n"
    ...
    "\n"
    "code:fingerprint =\n"
    "    \"// Generated by re2php\" (.version ? \" \" version) (.date ? \" on \" date) nl;\n"
    "\n"
