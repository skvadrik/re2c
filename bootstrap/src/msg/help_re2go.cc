...
"        (which must be supported by the compiler). re2go generates jump tables\n"
...
"    --ebcdic --ecb -e\n"
"\n"
"        Generate a lexer that reads input in EBCDIC encoding. re2go assumes\n"
"        that the character range is 0 -- 0xFF and character size is 1 byte.\n"
"\n"
"    --empty-class <match-empty | match-none | error>\n"
"\n"
"        Define the way re2go treats empty character classes. With match-empty\n"
...
"\n"
"        Define the way re2go treats Unicode surrogates. With fail re2go aborts\n"
"        with an error when a surrogate is encountered. With substitute re2go\n"
"        silently replaces surrogates with the error code point 0xFFFD. With\n"
"        ignore (the default) re2go treats surrogates as normal code points. The\n"
...
"        or directive. re2go looks for FILE in the directory of the parent file\n"
...
"        default) re2go handles input as ASCII-encoded: any sequence of code\n"
"        units is a sequence of standalone 1-byte characters. With utf8 re2go\n"
...
"\n"
"        Internal option: DFA minimization algorithm used by re2go. The moore\n"
...
"        fail. However, for backwards compatibility reasons re2go permits empty\n"
