...
"        (which must be supported by the compiler). re2d generates jump tables\n"
...
"        different re2d blocks connected with goto or function calls.\n"
"\n"
"    --depfile FILE\n"
"\n"
...
"    --ebcdic --ecb -e\n"
"\n"
"        Generate a lexer that reads input in EBCDIC encoding. re2d assumes that\n"
"        the character range is 0 -- 0xFF and character size is 1 byte.\n"
"\n"
"    --empty-class <match-empty | match-none | error>\n"
"\n"
"        Define the way re2d treats empty character classes. With match-empty\n"
...
"\n"
"        Define the way re2d treats Unicode surrogates. With fail re2d aborts\n"
"        with an error when a surrogate is encountered. With substitute re2d\n"
"        silently replaces surrogates with the error code point 0xFFFD. With\n"
"        ignore (the default) re2d treats surrogates as normal code points. The\n"
...
"        or directive. re2d looks for FILE in the directory of the parent file\n"
...
"\n"
"        Specify the way re2d parses regular expressions. With ascii (the\n"
"        default) re2d handles input as ASCII-encoded: any sequence of code\n"
"        units is a sequence of standalone 1-byte characters. With utf8 re2d\n"
...
"    --ucs2 --wide-chars -w\n"
"\n"
"        Generate a lexer that reads UCS2-encoded input. re2d assumes that the\n"
"        character range is 0 -- 0xFFFF and character size is 2 bytes. This\n"
"        option implies --nested-ifs.\n"
"\n"
"    --utf8 --utf-8 -8\n"
"\n"
"        Generate a lexer that reads input in UTF-8 encoding. re2d assumes that\n"
"        the character range is 0 -- 0x10FFFF and character size is 1 byte.\n"
"\n"
"    --utf16 --utf-16 -x\n"
"\n"
"        Generate a lexer that reads UTF16-encoded input. re2d assumes that the\n"
"        character range is 0 -- 0x10FFFF and character size is 2 bytes. This\n"
"        option implies --nested-ifs.\n"
"\n"
"    --utf32 --unicode -u\n"
"\n"
"        Generate a lexer that reads UTF32-encoded input. re2d assumes that the\n"
...
"\n"
"        Internal option: DFA minimization algorithm used by re2d. The moore\n"
...
"        fail. However, for backwards compatibility reasons re2d permits empty\n"
...
"    -Wuseless-escape\n"
"\n"
"        Warn if a symbol is escaped when it shouldn't be. By default, re2d\n"
