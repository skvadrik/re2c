...
"        (which must be supported by the compiler). re2ocaml generates jump\n"
...
"        configuration. Relative offsets can be enabled with cgoto:relative\n"
"        configuration. This option implies --bit-vectors. It is supported only\n"
"        for C.\n"
"\n"
...
"        implies --computed-gotos.  This flag is the same as specifying\n"
"        cgoto:relative as above and using --computed-gotos`. It is supported\n"
"        only for C.\n"
"\n"
...
"        different re2ocaml blocks connected with goto or function calls.\n"
"\n"
"    --depfile FILE\n"
"\n"
...
"    --ebcdic --ecb -e\n"
"\n"
"        Generate a lexer that reads input in EBCDIC encoding. re2ocaml assumes\n"
"        that the character range is 0 -- 0xFF and character size is 1 byte.\n"
"\n"
"    --empty-class <match-empty | match-none | error>\n"
"\n"
"        Define the way re2ocaml treats empty character classes. With match-\n"
"        empty (the default) empty class matches empty input (which is\n"
...
"\n"
"        Define the way re2ocaml treats Unicode surrogates. With fail re2ocaml\n"
"        aborts with an error when a surrogate is encountered. With substitute\n"
"        re2ocaml silently replaces surrogates with the error code point 0xFFFD.\n"
"        With ignore (the default) re2ocaml treats surrogates as normal code\n"
...
"        or directive. re2ocaml looks for FILE in the directory of the parent\n"
"        file and in the include locations specified with -I option.\n"
"\n"
...
"\n"
"        Specify the way re2ocaml parses regular expressions. With ascii (the\n"
"        default) re2ocaml handles input as ASCII-encoded: any sequence of code\n"
"        units is a sequence of standalone 1-byte characters. With utf8 re2ocaml\n"
...
"    --ucs2 --wide-chars -w\n"
"\n"
"        Generate a lexer that reads UCS2-encoded input. re2ocaml assumes that\n"
"        the character range is 0 -- 0xFFFF and character size is 2 bytes. This\n"
"        option implies --nested-ifs.\n"
"\n"
"    --utf8 --utf-8 -8\n"
"\n"
"        Generate a lexer that reads input in UTF-8 encoding. re2ocaml assumes\n"
"        that the character range is 0 -- 0x10FFFF and character size is 1 byte.\n"
"\n"
"    --utf16 --utf-16 -x\n"
"\n"
"        Generate a lexer that reads UTF16-encoded input. re2ocaml assumes that\n"
"        the character range is 0 -- 0x10FFFF and character size is 2 bytes.\n"
"        This option implies --nested-ifs.\n"
"\n"
"    --utf32 --unicode -u\n"
"\n"
"        Generate a lexer that reads UTF32-encoded input. re2ocaml assumes that\n"
...
"\n"
"        Internal option: DFA minimization algorithm used by re2ocaml. The moore\n"
...
"        fail. However, for backwards compatibility reasons re2ocaml permits\n"
"        empty character classes and treats them as empty strings. Use the\n"
...
"    -Wuseless-escape\n"
"\n"
"        Warn if a symbol is escaped when it shouldn't be. By default, re2ocaml\n"
