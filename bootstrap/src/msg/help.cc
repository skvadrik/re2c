...
"\n"
"DEBUG OPTIONS\n"
"       The following options allow to visualize and debug re2c-generated programs.  Most of these options are enabled only in debug builds.\n"
"\n"
"       -D --emit-dot\n"
...
"\n"
"INTERNAL OPTIONS\n"
"       The following options are unstable and intended to be used by re2c developers; they control various internal aspects of re2c.\n"
"\n"
"       --dfa-minimization <moore | table>\n"
"              Internal  option.   The  internal algorithm used by re2c to minimize the DFA: moore (the default) is Moore algorithm, and table is the \"table filling\" algorithm.  Both algorithms should produce the same DFA up to states\n"
"              relabeling; table filling is simpler and much slower and serves as a reference implementation.\n"
"\n"
"       --eager-skip\n"
"              Internal option.  Make the generated lexer advance the input position \"eagerly\": immediately after reading input symbol.  By default this happens after transition to the next state.  Implied by --no-lookahead.\n"
"\n"
"       --no-lookahead\n"
...
"              Internal option.  Specify shortest-path algorithm used for construction of epsilon-closure with POSIX disambiguation semantics: gor1 (the default) stands for Goldberg-Radzik algorithm, and gtop stands for \"global  topo‐\n"
"              logical order\" algorithm.\n"
"\n"
