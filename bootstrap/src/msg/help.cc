...
"\n"
"       --case-ranges\n"
"              Collapse  consecutive  cases in a swithch statemens into a range of the form case low ... high:. This syntax is an extension of the C/C++ language, supported by compilers like GCC, Clang and Tcc. The main advantage over\n"
"              using single cases is smaller generated C code and faster generation time, although for some compilers like Tcc it also results in smaller binary size.  This option doesn't work for the Go backend.\n"
"\n"
"       -e --ecb\n"
...
"              threshold can be configured with cgoto:threshold configuration. This option implies -b. This option doesn't work for the Go backend.\n"
"\n"
"       -I PATH\n"
...
"              \"skeleton\" behavior on all inputs. This option is useful for finding bugs in optimizations and code generation. This option doesn't work for the Go backend.\n"
"\n"
"       -s --nested-ifs\n"
