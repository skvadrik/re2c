...
"\n"
"       The following options are unstable and intended to be used by re2c developers.  These options control various aspects of the internal algorithms used by re2c.\n"
"\n"
"       --dfa-minimization <moore | table> (internal option)\n"
...
"              rithm.\n"
"\n"
"       --posix-prectable <complex | naive> (internal option)\n"
"              Specify  the  algorithm  used  to compute POSIX precedence table. The complex algorithm computes precedence table in one traversal of tag history tree and has quadratic complexity in the number of TNFA states; it is the\n"
"              default. The naive algorithm has worst-case cubic complexity in the number of TNFA states, but it is much simpler than complex and may be slightly faster in non-pathological cases.\n"
"\n"
"       --stadfa (internal option)\n"
