...
"              default. The naive algorithm has worst-case cubic complexity in the number of TNFA states, but it is much simpler than complex and may be slightly faster faster in non-pathological cases.\n"
"\n"
"       -r --reusable\n"
