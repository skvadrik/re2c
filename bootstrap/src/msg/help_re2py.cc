...
"        different re2py blocks connected with goto or function calls.\n"
"\n"
"    --depfile FILE\n"
"\n"
...
"    --ebcdic --ecb -e\n"
"\n"
"        Generate a lexer that reads input in EBCDIC encoding. re2py assumes\n"
"        that the character range is 0 -- 0xFF and character size is 1 byte.\n"
"\n"
"    --empty-class <match-empty | match-none | error>\n"
"\n"
"        Define the way re2py treats empty character classes. With match-empty\n"
...
"\n"
"        Define the way re2py treats Unicode surrogates. With fail re2py aborts\n"
"        with an error when a surrogate is encountered. With substitute re2py\n"
"        silently replaces surrogates with the error code point 0xFFFD. With\n"
"        ignore (the default) re2py treats surrogates as normal code points. The\n"
...
"        or directive. re2py looks for FILE in the directory of the parent file\n"
...
"\n"
"        Specify the way re2py parses regular expressions. With ascii (the\n"
"        default) re2py handles input as ASCII-encoded: any sequence of code\n"
"        units is a sequence of standalone 1-byte characters. With utf8 re2py\n"
...
"    --utf8 --utf-8 -8\n"
"\n"
"        Generate a lexer that reads input in UTF-8 encoding. re2py assumes that\n"
...
"\n"
"        Internal option: DFA minimization algorithm used by re2py. The moore\n"
...
"        fail. However, for backwards compatibility reasons re2py permits empty\n"
...
"    -Wuseless-escape\n"
"\n"
"        Warn if a symbol is escaped when it shouldn't be. By default, re2py\n"
