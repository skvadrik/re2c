...
sys.path.insert(0, os.path.abspath('./manual/fill/'))
sys.path.insert(0, os.path.abspath('./src/manual/fill/'))
...
exclude_patterns = [
    ...
    'manual/basics/warnings/condition_order/how_it_works.rst',
    'manual/basics/warnings/condition_order/real_world.rst',
    'manual/basics/warnings/condition_order/simple_example.rst',
    'manual/basics/warnings/match_empty_string/false_alarm.rst',
    'manual/basics/warnings/match_empty_string/real_world.rst',
    'manual/basics/warnings/match_empty_string/simple_example.rst',
    'manual/basics/warnings/undefined_control_flow/default_vs_any.rst',
    'manual/basics/warnings/undefined_control_flow/how_it_works.rst',
    'manual/basics/warnings/undefined_control_flow/real_world.rst',
    'manual/basics/warnings/undefined_control_flow/simple_example.rst',
    'manual/basics/warnings/unreachable_rules/how_it_works.rst',
    'manual/basics/warnings/unreachable_rules/infinite_rules.rst',
    'manual/basics/warnings/unreachable_rules/real_world.rst',
    'manual/basics/warnings/unreachable_rules/simple_example.rst',
    'manual/basics/warnings/useless_escape/how_it_works.rst',
    'manual/basics/warnings/useless_escape/real_world.rst',
    'manual/basics/warnings/useless_escape/simple_example.rst',
    'manual/basics/warnings/warnings_general.rst',
    'manual/basics/warnings/warnings_list.rst',
...
#html_sidebars = {}
html_sidebars = {
   'index': ['sidebar-home.html'], # 'searchbox.html'
