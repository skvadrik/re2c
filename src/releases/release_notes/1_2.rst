...
First and foremost, :ref:`end of input rule <manual/manual_c:sentinel with bounds checks>` has been added to
...
by :ref:`using the generic API <manual/manual_c:custom checks>`. However, such
