...
#line 50 "c/fill/01_fill.--lang(c).c"
{
	char yych;
yyFillLabel0:
	yych = *in->cur;
...
yy2:
	++in->cur;
yy3:
#line 55 "c/fill/01_fill.--lang(c).re"
	{ return -1; }
#line 70 "c/fill/01_fill.--lang(c).c"
yy4:
	++in->cur;
yyFillLabel1:
	yych = *in->cur;
...
#line 58 "c/fill/01_fill.--lang(c).re"
	{ goto loop; }
#line 86 "c/fill/01_fill.--lang(c).c"
yy7:
	in->mar = ++in->cur;
yyFillLabel2:
	yych = *in->cur;
...
#line 57 "c/fill/01_fill.--lang(c).re"
	{ ++count; goto loop; }
#line 115 "c/fill/01_fill.--lang(c).c"
yy12:
	++in->cur;
yyFillLabel4:
	yych = *in->cur;
...
#line 56 "c/fill/01_fill.--lang(c).re"
	{ return count; }
#line 134 "c/fill/01_fill.--lang(c).c"
}
#line 60 "c/fill/01_fill.--lang(c).re"
