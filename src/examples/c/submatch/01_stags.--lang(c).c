...
#line 22 "c/submatch/01_stags.--lang(c).c"
{
	char yych;
	yych = *YYCURSOR;
	switch (yych) {
...
yy2:
	++YYCURSOR;
yy3:
#line 33 "c/submatch/01_stags.--lang(c).re"
	{ return ERROR; }
#line 52 "c/submatch/01_stags.--lang(c).c"
yy4:
...
yy29:
	...
	o3 = yyt3;
	o4 = yyt4;
#line 27 "c/submatch/01_stags.--lang(c).re"
	{
...
#line 410 "c/submatch/01_stags.--lang(c).c"
yy31:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0x00:	goto yy29;
