...
.. code-block:: bash
    ...
    $ cd ${BUILD_DIR}/benchmarks/c/submatch
...
.. code-block:: bash
    ...
    $ cd ${BUILD_DIR}/benchmarks/c/submatch_libre2c/jit
...
.. code-block:: bash
    ...
    $ cd ${BUILD_DIR}/benchmarks/c/submatch_libre2c/nfa
...
.. include:: c/submatch_libre2c/jit/env.rst

Compile time and run time is shown relative to the first row.

.. figure:: c/submatch_libre2c/jit/results_1.svg
    :class: benchmark
...
.. include:: c/submatch_libre2c/nfa/env.rst

Simulation time is shown relative to the first row.

.. figure:: c/submatch_libre2c/nfa/results_1.svg
    :class: benchmark
