...
git archive --remote=. "remotes/$remote/$branch" benchmarks/c/submatch/results | tar --directory=src -xpf -
git archive --remote=. "remotes/$remote/$branch" benchmarks/c/submatch_libre2c/{jit,nfa}/results | tar --directory=src -xpf -
...
if [[ "$gen_svg" -ne 0 ]]; then
    gen_bar_charts_for_benchmark "aot" "c/submatch" ""
    gen_bar_charts_for_benchmark "jit" "c/submatch_libre2c/jit" "--relative-to ''"
    gen_bar_charts_for_benchmark "nfa" "c/submatch_libre2c/nfa" "--relative-to LG"
fi
