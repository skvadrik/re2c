...
//line "codegen/loop_switch/v/advanced.re":1
...
//line "codegen/loop_switch/v/advanced.v":10
const yycmedia_type = 0
const yycheader = 22
//line "codegen/loop_switch/v/advanced.re":7
...
//line "codegen/loop_switch/v/advanced.v":77

	yyt1 int
	yyt2 int
//line "codegen/loop_switch/v/advanced.re":69

    
//line "codegen/loop_switch/v/advanced.v":84
	...
	yytm8 int
	yytm9 int
//line "codegen/loop_switch/v/advanced.re":70
...
//line "codegen/loop_switch/v/advanced.v":124

	if st.yyt1 != tag_none { st.yyt1 -= shift };
	if st.yyt2 != tag_none { st.yyt2 -= shift };
//line "codegen/loop_switch/v/advanced.re":96
...
//line "codegen/loop_switch/v/advanced.v":153
...
//line "codegen/loop_switch/v/advanced.re":188
                return .lex_bad_packet
//line "codegen/loop_switch/v/advanced.v":186
            }
            3 {
                st.mar = st.cur
                yych = st.buf[st.cur]
            ...
            13 {
                ...
                p4 = st.yytm6
                st.state = yycmedia_type
//line "codegen/loop_switch/v/advanced.re":166
...
//line "codegen/loop_switch/v/advanced.v":403
            }
            14 {
                yych = st.buf[st.cur]
                match yych {
            ...
            21 {
                st.state = yycmedia_type
//line "codegen/loop_switch/v/advanced.re":189
                unsafe { goto end }
//line "codegen/loop_switch/v/advanced.v":611
            }
            22 {
                yych = st.buf[st.cur]
                match yych {
...
//line "codegen/loop_switch/v/advanced.re":188
                return .lex_bad_packet
//line "codegen/loop_switch/v/advanced.v":646
            }
            25 {
                st.accept = 0
                st.mar = st.cur
            ...
            37 {
                ...
                f2 = st.yytm3
                st.state = yycheader
//line "codegen/loop_switch/v/advanced.re":180
...
//line "codegen/loop_switch/v/advanced.v":939
            }
            38 {
                yych = st.buf[st.cur]
                match yych {
...
//line "codegen/loop_switch/v/advanced.re":189
                unsafe { goto end }
//line "codegen/loop_switch/v/advanced.v":1053
            }
            44 {
                if st.lim <= st.cur {
                    yystate = 21
...
//line "codegen/loop_switch/v/advanced.re":190
...
//line "codegen/loop_switch/v/advanced.v":1332

		yyt1: tag_none,
		yyt2: tag_none,
//line "codegen/loop_switch/v/advanced.re":214

        
//line "codegen/loop_switch/v/advanced.v":1339
		...
		yytm8: mtag_root,
		yytm9: mtag_root,
//line "codegen/loop_switch/v/advanced.re":215
