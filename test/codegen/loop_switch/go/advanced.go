...
//line "codegen/loop_switch/go/advanced.re":1
...
//line "codegen/loop_switch/go/advanced.go":12
const (
	yycmedia_type = 0
	yycheader = 22
)
//line "codegen/loop_switch/go/advanced.re":9
...
//line "codegen/loop_switch/go/advanced.go":83

	yyt1 int
	yyt2 int
//line "codegen/loop_switch/go/advanced.re":73

	
//line "codegen/loop_switch/go/advanced.go":90
	...
	yytm8 int
	yytm9 int
//line "codegen/loop_switch/go/advanced.re":74
...
//line "codegen/loop_switch/go/advanced.go":130

	if st.yyt1 != tagNone { st.yyt1 -= shift };
	if st.yyt2 != tagNone { st.yyt2 -= shift };
//line "codegen/loop_switch/go/advanced.re":100
...
//line "codegen/loop_switch/go/advanced.go":150
{
	yystate := st.state
yyl:
	for {
...
//line "codegen/loop_switch/go/advanced.re":184
			{ return lexBadPacket }
//line "codegen/loop_switch/go/advanced.go":196
		case 3:
			st.mar = st.cur
			yych = st.data[st.cur]
			switch (yych) {
		...
		case 13:
			...
			p4 = st.yytm6
			st.state = yycmedia_type
//line "codegen/loop_switch/go/advanced.re":162
			{
...
//line "codegen/loop_switch/go/advanced.go":456
		case 14:
			yych = st.data[st.cur]
			switch (yych) {
			case '!':
		...
		case 21:
			st.state = yycmedia_type
//line "codegen/loop_switch/go/advanced.re":183
			{ return lexEnd }
//line "codegen/loop_switch/go/advanced.go":697
		case 22:
			yych = st.data[st.cur]
			switch (yych) {
			case 0x00:
...
//line "codegen/loop_switch/go/advanced.re":184
			{ return lexBadPacket }
//line "codegen/loop_switch/go/advanced.go":732
		case 25:
			st.accept = 0
			st.mar = st.cur
			yych = st.data[st.cur]
		...
		case 37:
			...
			f2 = st.yytm3
			st.state = yycheader
//line "codegen/loop_switch/go/advanced.re":175
			{
...
//line "codegen/loop_switch/go/advanced.go":1029
		case 38:
			yych = st.data[st.cur]
			switch (yych) {
			case 0x00:
...
//line "codegen/loop_switch/go/advanced.re":183
			{ return lexEnd }
//line "codegen/loop_switch/go/advanced.go":1141
		case 44:
			if (st.cur >= st.lim) {
				yystate = 21
				continue yyl
...
//line "codegen/loop_switch/go/advanced.re":185
...
//line "codegen/loop_switch/go/advanced.go":1384

		yyt1: tagNone,
		yyt2: tagNone,
//line "codegen/loop_switch/go/advanced.re":203

		
//line "codegen/loop_switch/go/advanced.go":1391
		...
		yytm8: mtagRoot,
		yytm9: mtagRoot,
//line "codegen/loop_switch/go/advanced.re":204
