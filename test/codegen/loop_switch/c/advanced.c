/* Generated by re2c */
#line 1 "codegen/loop_switch/c/advanced.re"
...
#line 10 "codegen/loop_switch/c/advanced.c"
enum YYCONDTYPE {
	yycmedia_type = 0,
	yycheader = 22
};
#line 7 "codegen/loop_switch/c/advanced.re"
...
#line 46 "codegen/loop_switch/c/advanced.c"
	unsigned char*		yyt1;
	unsigned char*		yyt2;
#line 36 "codegen/loop_switch/c/advanced.re"

    
#line 52 "codegen/loop_switch/c/advanced.c"
	struct mtag				*yytm1;
	struct mtag				*yytm10;
	struct mtag				*yytm2;
	struct mtag				*yytm3;
	...
	struct mtag				*yytm8;
	struct mtag				*yytm9;
#line 37 "codegen/loop_switch/c/advanced.re"
...
#line 118 "codegen/loop_switch/c/advanced.c"
{
	int yystate = c->state;
	for (;;) {
		switch (yystate) {
...
#line 171 "codegen/loop_switch/c/advanced.re"
				{ return CON_STATUS_ERROR; }
#line 224 "codegen/loop_switch/c/advanced.c"
			case 3:
				c->mar = c->cur;
				yych = *c->cur;
				switch (yych) {
			...
			case 13:
				...
				p4 = c->yytm6;
				c->state = yycmedia_type;
#line 135 "codegen/loop_switch/c/advanced.re"
				{
...
#line 729 "codegen/loop_switch/c/advanced.c"
			case 14:
				yych = *c->cur;
				switch (yych) {
					case '!':
			...
			case 21:
				c->state = yycmedia_type;
#line 170 "codegen/loop_switch/c/advanced.re"
				{ return CON_STATUS_END; }
#line 1196 "codegen/loop_switch/c/advanced.c"
			case 22:
				yych = *c->cur;
				switch (yych) {
					case 0x00:
...
#line 171 "codegen/loop_switch/c/advanced.re"
				{ return CON_STATUS_ERROR; }
#line 1255 "codegen/loop_switch/c/advanced.c"
			case 25:
				yyaccept = 0;
				c->mar = c->cur;
				yych = *c->cur;
			...
			case 37:
				...
				f2 = c->yytm3;
				c->state = yycheader;
#line 157 "codegen/loop_switch/c/advanced.re"
				{
...
#line 1686 "codegen/loop_switch/c/advanced.c"
			case 38:
				yych = *c->cur;
				switch (yych) {
					case 0x00:
...
#line 170 "codegen/loop_switch/c/advanced.re"
				{ return CON_STATUS_END; }
#line 1839 "codegen/loop_switch/c/advanced.c"
			case 44:
				if (c->lim <= c->cur) {
					yystate = 21;
					continue;
...
#line 172 "codegen/loop_switch/c/advanced.re"
...
#line 2081 "codegen/loop_switch/c/advanced.c"
			if (c->yyt1) c->yyt1 -= shift;
			if (c->yyt2) c->yyt2 -= shift;
#line 191 "codegen/loop_switch/c/advanced.re"
...
#line 2119 "codegen/loop_switch/c/advanced.c"
	c->yyt1 = 0;
	c->yyt2 = 0;
#line 224 "codegen/loop_switch/c/advanced.re"

    
#line 2125 "codegen/loop_switch/c/advanced.c"
	c->yytm1 = NULL;
	c->yytm10 = NULL;
	c->yytm2 = NULL;
	c->yytm3 = NULL;
	...
	c->yytm8 = NULL;
	c->yytm9 = NULL;
#line 225 "codegen/loop_switch/c/advanced.re"
