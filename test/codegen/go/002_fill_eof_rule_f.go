...
//line "codegen/go/002_fill_eof_rule_f.re":1
...
//line "codegen/go/002_fill_eof_rule_f.go":73
	switch (in.state) {
	case 0:
...
yy2:
	in.cursor += 1
	in.state = -1
//line "codegen/go/002_fill_eof_rule_f.re":80
	{
		fmt.Println("error")
		return lexError
	}
//line "codegen/go/002_fill_eof_rule_f.go":126
yy3:
	in.cursor += 1
yyFillLabel1:
	yych = YYCTYPE(in.data[in.cursor])
...
yy4:
	in.state = -1
//line "codegen/go/002_fill_eof_rule_f.re":100
	{
		return lexSpace
	}
//line "codegen/go/002_fill_eof_rule_f.go":147
yy5:
	in.cursor += 1
	in.marker = in.cursor
yyFillLabel2:
...
yy6:
	in.state = -1
//line "codegen/go/002_fill_eof_rule_f.re":90
	{
		fmt.Printf("number-1: %v\n", string(in.data[in.token:in.cursor]))
		return lexNumber1
	}
//line "codegen/go/002_fill_eof_rule_f.go":172
yy7:
	in.cursor += 1
yyFillLabel3:
	yych = YYCTYPE(in.data[in.cursor])
...
yy10:
	in.state = -1
//line "codegen/go/002_fill_eof_rule_f.re":95
	{
		fmt.Printf("number-2: %v\n", string(in.data[in.token:in.cursor]))
		return lexNumber2
	}
//line "codegen/go/002_fill_eof_rule_f.go":211
yy11:
	in.state = -1
//line "codegen/go/002_fill_eof_rule_f.re":85
	{
		fmt.Println("end")
		return lexEnd
	}
//line "codegen/go/002_fill_eof_rule_f.go":219
//line "codegen/go/002_fill_eof_rule_f.re":103
