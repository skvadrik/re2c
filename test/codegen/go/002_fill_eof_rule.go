...
//line "codegen/go/002_fill_eof_rule.re":1
...
//line "codegen/go/002_fill_eof_rule.go":65
{
	var yych YYCTYPE
yyFillLabel0:
...
yy1:
	in.cursor += 1
//line "codegen/go/002_fill_eof_rule.re":70
	{
		fmt.Println("error")
		return -1
	}
//line "codegen/go/002_fill_eof_rule.go":91
yy2:
	in.cursor += 1
//line "codegen/go/002_fill_eof_rule.re":90
	{
		return 3
	}
//line "codegen/go/002_fill_eof_rule.go":98
yy3:
	in.cursor += 1
	in.marker = in.cursor
yyFillLabel1:
...
yy4:
//line "codegen/go/002_fill_eof_rule.re":80
	{
		fmt.Printf("number-1: %v\n", string(in.data[in.token:in.cursor]))
		return 1
	}
//line "codegen/go/002_fill_eof_rule.go":123
yy5:
	in.cursor += 1
yyFillLabel2:
	yych = YYCTYPE(in.data[in.cursor])
...
yy8:
//line "codegen/go/002_fill_eof_rule.re":85
	{
		fmt.Printf("number-2: %v\n", string(in.data[in.token:in.cursor]))
		return 2
	}
//line "codegen/go/002_fill_eof_rule.go":163
yy9:
//line "codegen/go/002_fill_eof_rule.re":75
	{
		fmt.Println("end")
		return 0
	}
//line "codegen/go/002_fill_eof_rule.go":170
}
//line "codegen/go/002_fill_eof_rule.re":93
