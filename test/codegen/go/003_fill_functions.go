...
//line "codegen/go/003_fill_functions.re":1
...
//line "codegen/go/003_fill_functions.go":10
const YYMAXFILL = 2
//line "codegen/go/003_fill_functions.re":7
...
//line "codegen/go/003_fill_functions.go":81
{
	var yych YYCTYPE
	if (YYLESSTHAN(1)) {
...
yy1:
	YYSKIP()
//line "codegen/go/003_fill_functions.re":84
	{
		fmt.Println("end")
		return 0
	}
//line "codegen/go/003_fill_functions.go":105
yy2:
	YYSKIP()
//line "codegen/go/003_fill_functions.re":79
	{
		fmt.Println("error")
		return -1
	}
//line "codegen/go/003_fill_functions.go":113
yy3:
	YYSKIP()
//line "codegen/go/003_fill_functions.re":99
	{
		return 3
	}
//line "codegen/go/003_fill_functions.go":120
yy4:
	YYSKIP()
	YYBACKUP()
	if (YYLESSTHAN(2)) {
...
yy5:
//line "codegen/go/003_fill_functions.re":89
	{
		fmt.Printf("number-1: %v\n", string(in.data[in.token:in.cursor]))
		return 1
	}
//line "codegen/go/003_fill_functions.go":142
yy6:
	YYSKIP()
	yych = YYPEEK()
	switch (yych) {
...
yy9:
//line "codegen/go/003_fill_functions.re":94
	{
		fmt.Printf("number-2: %v\n", string(in.data[in.token:in.cursor]))
		return 2
	}
//line "codegen/go/003_fill_functions.go":173
}
//line "codegen/go/003_fill_functions.re":102
