...
//line "codegen/recursive_functions/v/advanced.re":1
...
//line "codegen/recursive_functions/v/advanced.v":10
enum YYCONDTYPE {
    yycmedia_type = 1
    yycheader = 23
}
//line "codegen/recursive_functions/v/advanced.re":7
...
//line "codegen/recursive_functions/v/advanced.v":79

	yyt1 int
	yyt2 int
//line "codegen/recursive_functions/v/advanced.re":69

    
//line "codegen/recursive_functions/v/advanced.v":86
	...
	yytm8 int
	yytm9 int
//line "codegen/recursive_functions/v/advanced.re":70
...
//line "codegen/recursive_functions/v/advanced.v":134

	if st.yyt1 != tag_none { st.yyt1 -= shift };
	if st.yyt2 != tag_none { st.yyt2 -= shift };
//line "codegen/recursive_functions/v/advanced.re":104
...
//line "codegen/recursive_functions/v/advanced.v":152
...
fn yy3(mut st State) Status {
    st.state = -1
//line "codegen/recursive_functions/v/advanced.re":187
    return .lex_bad_packet
//line "codegen/recursive_functions/v/advanced.v":181
}
...
fn yy14(mut st State) Status {
    ...
    st.p4 = st.yytm6
    st.state = -1
//line "codegen/recursive_functions/v/advanced.re":165
...
//line "codegen/recursive_functions/v/advanced.v":388
}
...
fn yy22(mut st State) Status {
    st.state = -1
//line "codegen/recursive_functions/v/advanced.re":188
    return .lex_end
//line "codegen/recursive_functions/v/advanced.v":586
}
...
//line "codegen/recursive_functions/v/advanced.re":187
    return .lex_bad_packet
//line "codegen/recursive_functions/v/advanced.v":625
}
...
fn yy38(mut st State) Status {
    ...
    st.f2 = st.yytm3
    st.state = -1
//line "codegen/recursive_functions/v/advanced.re":179
...
//line "codegen/recursive_functions/v/advanced.v":907
}
...
//line "codegen/recursive_functions/v/advanced.re":188
    return .lex_end
//line "codegen/recursive_functions/v/advanced.v":1016
}
...
//line "codegen/recursive_functions/v/advanced.re":189
...
//line "codegen/recursive_functions/v/advanced.v":1277

		yyt1: tag_none,
		yyt2: tag_none,
//line "codegen/recursive_functions/v/advanced.re":210

        
//line "codegen/recursive_functions/v/advanced.v":1284
		...
		yytm8: mtag_root,
		yytm9: mtag_root,
//line "codegen/recursive_functions/v/advanced.re":211
