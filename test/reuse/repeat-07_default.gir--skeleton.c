...
int lex_line28()
{
    ...
    input = (YYCTYPE *) read_file
        ("reuse/repeat-07_default.gir--skeleton.c.line28.input"
        , sizeof (YYCTYPE)
        , padding
        , &input_len
        );
    ...
    keys = (YYKEYTYPE *) read_file
        ("reuse/repeat-07_default.gir--skeleton.c.line28.keys"
        , sizeof (YYKEYTYPE)
        , 0
        , &keys_count
        );
...
int lex_line46()
{
    ...
    input = (YYCTYPE *) read_file
        ("reuse/repeat-07_default.gir--skeleton.c.line46.input"
        , sizeof (YYCTYPE)
        , padding
        , &input_len
        );
    ...
    keys = (YYKEYTYPE *) read_file
        ("reuse/repeat-07_default.gir--skeleton.c.line46.keys"
        , sizeof (YYKEYTYPE)
        , 0
        , &keys_count
        );
...
int lex_line64()
{
    ...
    input = (YYCTYPE *) read_file
        ("reuse/repeat-07_default.gir--skeleton.c.line64.input"
        , sizeof (YYCTYPE)
        , padding
        , &input_len
        );
    ...
    keys = (YYKEYTYPE *) read_file
        ("reuse/repeat-07_default.gir--skeleton.c.line64.keys"
        , sizeof (YYKEYTYPE)
        , 0
        , &keys_count
        );
