...
xx2:
	++s.cur;
xx3:
#line 67 "config/config10.re"
	{
		return UNEXPECTED;
	}
#line 76 "config/config10.c"
xx4:
	++s.cur;
#line 60 "config/config10.re"
	{
		if(s.cur == s.lim)
			return EOI;
		cursor = s.cur;
...
xx14:
	s.cur -= 1;
#line 55 "config/config10.re"
	{ return KEYWORD; }
#line 168 "config/config10.c"
}
#line 70 "config/config10.re"
