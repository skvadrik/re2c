/* Generated by re2c */
// re2c $INPUT -o $OUTPUT -i --posix-captures --dump-dfa-min
...
debug/dfa_min.i--posix-captures--dump-dfa-min.re:3:11: warning: rule matches empty string [-Wmatch-empty-string]
digraph DFA {
  rankdir=LR
