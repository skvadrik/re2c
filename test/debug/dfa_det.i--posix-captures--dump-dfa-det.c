/* Generated by re2c */
// re2c $INPUT -o $OUTPUT -i --posix-captures --dump-dfa-det
...
debug/dfa_det.i--posix-captures--dump-dfa-det.re:3:11: warning: rule matches empty string [-Wmatch-empty-string]
digraph DFA {
  rankdir=LR
