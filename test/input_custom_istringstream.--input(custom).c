...
#line 21 "input_custom_istringstream.--input(custom).c"
{
	YYCTYPE yych;
...
#line 19 "input_custom_istringstream.--input(custom).re"
	{ return false; }
#line 35 "input_custom_istringstream.--input(custom).c"
yy4:
	YYSKIP();
	YYBACKUP();
	yych = YYPEEK();
...
#line 18 "input_custom_istringstream.--input(custom).re"
	{ return true; }
#line 158 "input_custom_istringstream.--input(custom).c"
}
#line 20 "input_custom_istringstream.--input(custom).re"
