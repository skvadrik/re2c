...
captures/noncapturing/implicit1_posix.re:35:9: warning: rule matches empty string [-Wmatch-empty-string]
captures/noncapturing/implicit1_posix.re:40:9: warning: rule matches empty string [-Wmatch-empty-string]
