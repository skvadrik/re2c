...
captures/noncapturing/explicit3_leftmost.re:35:14: warning: rule matches empty string [-Wmatch-empty-string]
captures/noncapturing/explicit3_leftmost.re:40:14: warning: rule matches empty string [-Wmatch-empty-string]
