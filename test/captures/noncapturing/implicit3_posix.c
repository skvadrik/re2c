...
captures/noncapturing/implicit3_posix.re:35:13: warning: rule matches empty string [-Wmatch-empty-string]
captures/noncapturing/implicit3_posix.re:40:13: warning: rule matches empty string [-Wmatch-empty-string]
