...
captures/noncapturing/implicit2_leftmost.re:35:9: warning: rule matches empty string [-Wmatch-empty-string]
captures/noncapturing/implicit2_leftmost.re:40:9: warning: rule matches empty string [-Wmatch-empty-string]
