...
std:
	s->tok = cursor;
	s->len = 0;
#line 846 "real_world/parse_date.g.re"



#line 744 "real_world/parse_date.g.c"
{
	YYCTYPE yych;
...
yy2:
	++YYCURSOR;
#line 1401 "real_world/parse_date.g.re"
	{
		s->pos = cursor; s->line++;
		goto std;
	}
#line 828 "real_world/parse_date.g.c"
yy4:
	++YYCURSOR;
yy5:
#line 1407 "real_world/parse_date.g.re"
	{
/*		printf("unexpected character: #%d, %c ", *s->tok, *s->tok); */
		s->errors++;
		goto std;
	}
#line 838 "real_world/parse_date.g.c"
yy6:
	yyaccept = 0;
	...
	if (yych <= '9') goto yy54;
yy7:
#line 1396 "real_world/parse_date.g.re"
	{
		goto std;
	}
#line 852 "real_world/parse_date.g.c"
yy8:
	yych = *++YYCURSOR;
	if (yych <= '@') goto yy5;
	if (yych <= 'Z') goto yy37;
...
yy18:
#line 1341 "real_world/parse_date.g.re"
	{
		int tz_not_found;
...
#line 1131 "real_world/parse_date.g.c"
yy19:
	yych = *++YYCURSOR;
	if (yych <= '@') {
		if (yych == ')') goto yy102;
...
yy74:
#line 1140 "real_world/parse_date.g.re"
	{
...
#line 2498 "real_world/parse_date.g.c"
yy75:
	yych = *++YYCURSOR;
	if (yych <= 'U') {
...
yy99:
	...
	if (yych <= '9') goto yy99;
yy101:
#line 906 "real_world/parse_date.g.re"
	{
		timelib_ull i;
...
#line 2845 "real_world/parse_date.g.c"
yy102:
	++YYCURSOR;
	goto yy18;
yy103:
...
yy128:
	...
	goto yy282;
yy129:
#line 1127 "real_world/parse_date.g.re"
	{
...
#line 3399 "real_world/parse_date.g.c"
yy130:
	yych = *++YYCURSOR;
	if (yych <= '/') goto yy282;
...
yy192:
#line 947 "real_world/parse_date.g.re"
	{
		int tz_not_found;
...
#line 4791 "real_world/parse_date.g.c"
yy193:
	yyaccept = 4;
	yych = *(YYMARKER = ++YYCURSOR);
	if (yych <= '/') {
...
yy197:
#line 1034 "real_world/parse_date.g.re"
	{
...
#line 4854 "real_world/parse_date.g.c"
yy198:
	yyaccept = 5;
	yych = *(YYMARKER = ++YYCURSOR);
	if (yych <= 'n') {
...
yy223:
#line 1074 "real_world/parse_date.g.re"
	{
...
#line 5049 "real_world/parse_date.g.c"
yy224:
	yyaccept = 3;
	yych = *(YYMARKER = ++YYCURSOR);
	if (yych <= '/') {
...
yy250:
	...
	if (yych == '.') goto yy388;
yy251:
#line 930 "real_world/parse_date.g.re"
	{
...
#line 5314 "real_world/parse_date.g.c"
yy252:
	yych = *++YYCURSOR;
	if (yych <= '/') goto yy62;
...
yy256:
#line 1293 "real_world/parse_date.g.re"
	{
		DEBUG_OUTPUT("ago");
		TIMELIB_INIT;
...
#line 5396 "real_world/parse_date.g.c"
yy257:
	yyaccept = 2;
	yych = *(YYMARKER = ++YYCURSOR);
	{
...
yy275:
#line 1308 "real_world/parse_date.g.re"
	{
		const timelib_relunit* relunit;
...
#line 5921 "real_world/parse_date.g.c"
yy276:
	yyaccept = 2;
	yych = *(YYMARKER = ++YYCURSOR);
	{
...
yy304:
#line 863 "real_world/parse_date.g.re"
	{
		DEBUG_OUTPUT("now");
		TIMELIB_INIT;
...
#line 6643 "real_world/parse_date.g.c"
yy305:
	yyaccept = 2;
	yych = *(YYMARKER = ++YYCURSOR);
	if (yych <= 'N') {
...
yy357:
#line 971 "real_world/parse_date.g.re"
	{
...
#line 7622 "real_world/parse_date.g.c"
yy358:
	yyaccept = 11;
	yych = *(YYMARKER = ++YYCURSOR);
	{
...
yy359:
#line 1284 "real_world/parse_date.g.re"
	{
		DEBUG_OUTPUT("year4");
		TIMELIB_INIT;
		s->time->y = timelib_get_nr((char **) &ptr, 4);
...
#line 7672 "real_world/parse_date.g.c"
yy360:
	yyaccept = 3;
	yych = *(YYMARKER = ++YYCURSOR);
	if (yych <= '9') {
...
yy362:
	...
	if (yych == 's') goto yy520;
yy363:
#line 1380 "real_world/parse_date.g.re"
	{
		timelib_ull i;
...
#line 7727 "real_world/parse_date.g.c"
yy364:
	yyaccept = 3;
	yych = *(YYMARKER = ++YYCURSOR);
	if (yych <= '9') {
...
yy442:
	...
	if (yych == ')') goto yy102;
yy443:
#line 872 "real_world/parse_date.g.re"
	{
		DEBUG_OUTPUT("noon");
		TIMELIB_INIT;
		TIMELIB_UNHAVE_TIME();
...
#line 8760 "real_world/parse_date.g.c"
yy444:
	yyaccept = 13;
	yych = *(YYMARKER = ++YYCURSOR);
	if (yych <= '/') {
...
yy474:
#line 1061 "real_world/parse_date.g.re"
	{
...
#line 9297 "real_world/parse_date.g.c"
yy475:
	yyaccept = 14;
	yych = *(YYMARKER = ++YYCURSOR);
	if (yych <= 'n') {
...
yy505:
#line 1114 "real_world/parse_date.g.re"
	{
...
#line 9644 "real_world/parse_date.g.c"
yy506:
	yych = *++YYCURSOR;
	if (yych <= 'U') {
...
yy583:
#line 1101 "real_world/parse_date.g.re"
	{
...
#line 10263 "real_world/parse_date.g.c"
yy584:
	yych = *++YYCURSOR;
	if (yych <= '/') goto yy583;
	if (yych <= '9') goto yy706;
...
yy586:
#line 1352 "real_world/parse_date.g.re"
	{
		int tz_not_found;
...
#line 10306 "real_world/parse_date.g.c"
yy587:
	yyaccept = 16;
	yych = *(YYMARKER = ++YYCURSOR);
	if (yych == '.') goto yy710;
...
yy621:
	++YYCURSOR;
yy622:
#line 884 "real_world/parse_date.g.re"
	{
...
#line 10582 "real_world/parse_date.g.c"
yy623:
	yych = *++YYCURSOR;
...
yy637:
	...
	if (yych <= '9') goto yy753;
yy638:
#line 1088 "real_world/parse_date.g.re"
	{
...
#line 10676 "real_world/parse_date.g.c"
yy639:
	yych = *++YYCURSOR;
	if (yych <= '/') goto yy197;
...
yy663:
#line 1016 "real_world/parse_date.g.re"
	{
		int tz_not_found;
...
#line 10879 "real_world/parse_date.g.c"
yy664:
	yyaccept = 18;
	yych = *(YYMARKER = ++YYCURSOR);
	{
...
yy775:
#line 1188 "real_world/parse_date.g.re"
	{
...
#line 11756 "real_world/parse_date.g.c"
yy776:
	yyaccept = 19;
	yych = *(YYMARKER = ++YYCURSOR);
	{
...
yy791:
#line 1220 "real_world/parse_date.g.re"
	{
		timelib_sll w, d;
...
#line 11961 "real_world/parse_date.g.c"
yy792:
	yych = *++YYCURSOR;
...
yy802:
	...
	if (yych == 's') goto yy879;
yy803:
#line 1324 "real_world/parse_date.g.re"
	{
		timelib_sll i;
		int         behavior;
...
#line 12044 "real_world/parse_date.g.c"
yy804:
	yych = *++YYCURSOR;
...
yy855:
#line 1049 "real_world/parse_date.g.re"
	{
...
#line 12624 "real_world/parse_date.g.c"
yy856:
	yyaccept = 22;
	yych = *(YYMARKER = ++YYCURSOR);
	if (yych <= 'n') {
...
yy860:
#line 1152 "real_world/parse_date.g.re"
	{
...
#line 12718 "real_world/parse_date.g.c"
yy861:
	yych = *++YYCURSOR;
	if (yych <= '/') goto yy53;
...
yy869:
	++YYCURSOR;
#line 1201 "real_world/parse_date.g.re"
	{
		timelib_sll w, d;
...
#line 12780 "real_world/parse_date.g.c"
yy871:
	yych = *++YYCURSOR;
...
yy876:
#line 1239 "real_world/parse_date.g.re"
	{
...
#line 12818 "real_world/parse_date.g.c"
yy877:
	yyaccept = 16;
	yych = *(YYMARKER = ++YYCURSOR);
	{
...
yy899:
	++YYCURSOR;
yy900:
#line 894 "real_world/parse_date.g.re"
	{
...
#line 13019 "real_world/parse_date.g.c"
yy901:
	yyaccept = 24;
	yych = *(YYMARKER = ++YYCURSOR);
	if (yych <= '^') {
...
yy927:
	++YYCURSOR;
#line 1252 "real_world/parse_date.g.re"
	{
...
#line 13296 "real_world/parse_date.g.c"
yy929:
	yych = *++YYCURSOR;
	if (yych <= '/') goto yy876;
...
yy946:
	++YYCURSOR;
yy947:
#line 851 "real_world/parse_date.g.re"
	{
...
#line 13424 "real_world/parse_date.g.c"
yy948:
	yyaccept = 25;
	yych = *(YYMARKER = ++YYCURSOR);
	if (yych <= '^') {
...
yy1019:
	...
	if (yych <= '9') goto yy1022;
yy1020:
#line 1164 "real_world/parse_date.g.re"
	{
		int tz_not_found;
...
#line 13931 "real_world/parse_date.g.c"
yy1021:
	yych = *++YYCURSOR;
...
yy1042:
	...
	if (yych <= ':') goto yy1047;
yy1043:
#line 1265 "real_world/parse_date.g.re"
	{
		int tz_not_found;
		DEBUG_OUTPUT("clf");
		TIMELIB_INIT;
...
#line 14065 "real_world/parse_date.g.c"
yy1044:
	yych = *++YYCURSOR;
	if (yych <= '5') {
		if (yych <= '/') goto yy1043;
...
#line 1412 "real_world/parse_date.g.re"
