...
real_world/php20150211_zend_ini_scanner.igcd--flex-syntax--case-inverted.re:384:13: warning: escape has no effect: '\.' [-Wuseless-escape]
real_world/php20150211_zend_ini_scanner.igcd--flex-syntax--case-inverted.re:384:32: warning: escape has no effect: '\.' [-Wuseless-escape]
real_world/php20150211_zend_ini_scanner.igcd--flex-syntax--case-inverted.re:391:27: warning: escape has no effect: '\[' [-Wuseless-escape]
real_world/php20150211_zend_ini_scanner.igcd--flex-syntax--case-inverted.re:392:11: warning: escape has no effect: '\[' [-Wuseless-escape]
real_world/php20150211_zend_ini_scanner.igcd--flex-syntax--case-inverted.re:648:7: warning: unreachable rule in condition 'INITIAL' (shadowed by rules at lines 406, 481, 491, 555, 627, 632, 637) [-Wunreachable-rules]
real_world/php20150211_zend_ini_scanner.igcd--flex-syntax--case-inverted.re:623:50: warning: unreachable rule in condition 'ST_OFFSET' (shadowed by rule at line 573) [-Wunreachable-rules]
real_world/php20150211_zend_ini_scanner.igcd--flex-syntax--case-inverted.re:623:50: warning: unreachable rule in condition 'ST_SECTION_VALUE' (shadowed by rule at line 573) [-Wunreachable-rules]
real_world/php20150211_zend_ini_scanner.igcd--flex-syntax--case-inverted.re:648:7: warning: unreachable rule in condition 'ST_VALUE' (shadowed by rules at lines 541, 547, 551, 559, 563, 569, 577, 623, 643) [-Wunreachable-rules]
real_world/php20150211_zend_ini_scanner.igcd--flex-syntax--case-inverted.re:648:7: warning: unreachable rule in condition 'ST_DOUBLE_QUOTES' (shadowed by rules at lines 582, 587) [-Wunreachable-rules]
real_world/php20150211_zend_ini_scanner.igcd--flex-syntax--case-inverted.re:648:7: warning: unreachable rule in condition 'ST_RAW' (shadowed by rules at lines 500, 541, 643) [-Wunreachable-rules]
real_world/php20150211_zend_ini_scanner.igcd--flex-syntax--case-inverted.re:652:2: warning: looks like you use hardcoded numbers instead of autogenerated condition names: better add '/*!types:re2c*/' directive or '-t, --type-header' option and don't rely on fixed condition order. [-Wcondition-order]
