...
std:
	s->tok = cursor;
	s->len = 0;
#line 846 "real_world/parse_date.s.re"



#line 744 "real_world/parse_date.s.c"
{
	YYCTYPE yych;
...
yy2:
	++YYCURSOR;
#line 1401 "real_world/parse_date.s.re"
	{
		s->pos = cursor; s->line++;
		goto std;
	}
#line 831 "real_world/parse_date.s.c"
yy4:
	++YYCURSOR;
yy5:
#line 1407 "real_world/parse_date.s.re"
	{
/*		printf("unexpected character: #%d, %c ", *s->tok, *s->tok); */
		s->errors++;
		goto std;
	}
#line 841 "real_world/parse_date.s.c"
yy6:
	yyaccept = 0;
	...
	if (yych <= '9') goto yy54;
yy7:
#line 1396 "real_world/parse_date.s.re"
	{
		goto std;
	}
#line 853 "real_world/parse_date.s.c"
yy8:
	yych = *++YYCURSOR;
	if (yych <= '@') goto yy5;
	if (yych <= 'Z') goto yy37;
...
yy18:
#line 1341 "real_world/parse_date.s.re"
	{
		int tz_not_found;
...
#line 1241 "real_world/parse_date.s.c"
yy19:
	yych = *++YYCURSOR;
	if (yych <= '@') {
		if (yych == ')') goto yy102;
...
yy74:
#line 1140 "real_world/parse_date.s.re"
	{
...
#line 2648 "real_world/parse_date.s.c"
yy75:
	yych = *++YYCURSOR;
	if (yych <= 'U') {
...
yy99:
	...
	if (yych <= '9') goto yy99;
yy101:
#line 906 "real_world/parse_date.s.re"
	{
		timelib_ull i;
...
#line 3005 "real_world/parse_date.s.c"
yy102:
	++YYCURSOR;
	goto yy18;
yy103:
...
yy128:
	...
	goto yy282;
yy129:
#line 1127 "real_world/parse_date.s.re"
	{
...
#line 3558 "real_world/parse_date.s.c"
yy130:
	yych = *++YYCURSOR;
	if (yych <= '/') goto yy282;
...
yy192:
#line 947 "real_world/parse_date.s.re"
	{
		int tz_not_found;
...
#line 4912 "real_world/parse_date.s.c"
yy193:
	yyaccept = 4;
	yych = *(YYMARKER = ++YYCURSOR);
	if (yych <= '/') {
...
yy197:
#line 1034 "real_world/parse_date.s.re"
	{
...
#line 4975 "real_world/parse_date.s.c"
yy198:
	yyaccept = 5;
	yych = *(YYMARKER = ++YYCURSOR);
	if (yych <= 'n') {
...
yy223:
#line 1074 "real_world/parse_date.s.re"
	{
...
#line 5170 "real_world/parse_date.s.c"
yy224:
	yyaccept = 3;
	yych = *(YYMARKER = ++YYCURSOR);
	if (yych <= '/') {
...
yy250:
	...
	if (yych == '.') goto yy388;
yy251:
#line 930 "real_world/parse_date.s.re"
	{
...
#line 5417 "real_world/parse_date.s.c"
yy252:
	yych = *++YYCURSOR;
	if (yych <= '/') goto yy62;
...
yy256:
#line 1293 "real_world/parse_date.s.re"
	{
		DEBUG_OUTPUT("ago");
		TIMELIB_INIT;
...
#line 5491 "real_world/parse_date.s.c"
yy257:
	yyaccept = 2;
	yych = *(YYMARKER = ++YYCURSOR);
	if (yych <= '9') {
...
yy275:
#line 1308 "real_world/parse_date.s.re"
	{
		const timelib_relunit* relunit;
...
#line 5969 "real_world/parse_date.s.c"
yy276:
	yyaccept = 2;
	yych = *(YYMARKER = ++YYCURSOR);
	if (yych <= '@') {
...
yy304:
#line 863 "real_world/parse_date.s.re"
	{
		DEBUG_OUTPUT("now");
		TIMELIB_INIT;
...
#line 6670 "real_world/parse_date.s.c"
yy305:
	yyaccept = 2;
	yych = *(YYMARKER = ++YYCURSOR);
	if (yych <= 'N') {
...
yy357:
#line 971 "real_world/parse_date.s.re"
	{
...
#line 7635 "real_world/parse_date.s.c"
yy358:
	yyaccept = 11;
	yych = *(YYMARKER = ++YYCURSOR);
	switch (yych) {
...
yy359:
#line 1284 "real_world/parse_date.s.re"
	{
		DEBUG_OUTPUT("year4");
		TIMELIB_INIT;
		s->time->y = timelib_get_nr((char **) &ptr, 4);
...
#line 7705 "real_world/parse_date.s.c"
yy360:
	yyaccept = 3;
	yych = *(YYMARKER = ++YYCURSOR);
	if (yych <= '9') {
...
yy362:
	...
	if (yych == 's') goto yy520;
yy363:
#line 1380 "real_world/parse_date.s.re"
	{
		timelib_ull i;
...
#line 7760 "real_world/parse_date.s.c"
yy364:
	yyaccept = 3;
	yych = *(YYMARKER = ++YYCURSOR);
	if (yych <= '9') {
...
yy442:
	...
	if (yych == ')') goto yy102;
yy443:
#line 872 "real_world/parse_date.s.re"
	{
		DEBUG_OUTPUT("noon");
		TIMELIB_INIT;
		TIMELIB_UNHAVE_TIME();
...
#line 8780 "real_world/parse_date.s.c"
yy444:
	yyaccept = 13;
	yych = *(YYMARKER = ++YYCURSOR);
	if (yych <= '/') {
...
yy474:
#line 1061 "real_world/parse_date.s.re"
	{
...
#line 9306 "real_world/parse_date.s.c"
yy475:
	yyaccept = 14;
	yych = *(YYMARKER = ++YYCURSOR);
	if (yych <= 'n') {
...
yy505:
#line 1114 "real_world/parse_date.s.re"
	{
...
#line 9653 "real_world/parse_date.s.c"
yy506:
	yych = *++YYCURSOR;
	if (yych <= 'U') {
...
yy583:
#line 1101 "real_world/parse_date.s.re"
	{
...
#line 10261 "real_world/parse_date.s.c"
yy584:
	yych = *++YYCURSOR;
	if (yych <= '/') goto yy583;
	if (yych <= '9') goto yy706;
...
yy586:
#line 1352 "real_world/parse_date.s.re"
	{
		int tz_not_found;
...
#line 10304 "real_world/parse_date.s.c"
yy587:
	yyaccept = 16;
	yych = *(YYMARKER = ++YYCURSOR);
	if (yych == '.') goto yy710;
...
yy621:
	++YYCURSOR;
yy622:
#line 884 "real_world/parse_date.s.re"
	{
...
#line 10580 "real_world/parse_date.s.c"
yy623:
	yych = *++YYCURSOR;
...
yy637:
	...
	if (yych <= '9') goto yy753;
yy638:
#line 1088 "real_world/parse_date.s.re"
	{
...
#line 10674 "real_world/parse_date.s.c"
yy639:
	yych = *++YYCURSOR;
	if (yych <= '/') goto yy197;
...
yy663:
#line 1016 "real_world/parse_date.s.re"
	{
		int tz_not_found;
...
#line 10870 "real_world/parse_date.s.c"
yy664:
	yyaccept = 18;
	yych = *(YYMARKER = ++YYCURSOR);
	switch (yych) {
...
yy775:
#line 1188 "real_world/parse_date.s.re"
	{
...
#line 11712 "real_world/parse_date.s.c"
yy776:
	yyaccept = 19;
	yych = *(YYMARKER = ++YYCURSOR);
	switch (yych) {
...
yy791:
#line 1220 "real_world/parse_date.s.re"
	{
		timelib_sll w, d;
...
#line 11896 "real_world/parse_date.s.c"
yy792:
	yych = *++YYCURSOR;
...
yy802:
	...
	if (yych == 's') goto yy879;
yy803:
#line 1324 "real_world/parse_date.s.re"
	{
		timelib_sll i;
		int         behavior;
...
#line 11979 "real_world/parse_date.s.c"
yy804:
	yych = *++YYCURSOR;
...
yy855:
#line 1049 "real_world/parse_date.s.re"
	{
...
#line 12559 "real_world/parse_date.s.c"
yy856:
	yyaccept = 22;
	yych = *(YYMARKER = ++YYCURSOR);
	if (yych <= 'n') {
...
yy860:
#line 1152 "real_world/parse_date.s.re"
	{
...
#line 12646 "real_world/parse_date.s.c"
yy861:
	yych = *++YYCURSOR;
	if (yych <= '/') goto yy53;
...
yy869:
	++YYCURSOR;
#line 1201 "real_world/parse_date.s.re"
	{
		timelib_sll w, d;
...
#line 12708 "real_world/parse_date.s.c"
yy871:
	yych = *++YYCURSOR;
...
yy876:
#line 1239 "real_world/parse_date.s.re"
	{
...
#line 12746 "real_world/parse_date.s.c"
yy877:
	yyaccept = 16;
	yych = *(YYMARKER = ++YYCURSOR);
	if (yych <= '-') {
...
yy899:
	++YYCURSOR;
yy900:
#line 894 "real_world/parse_date.s.re"
	{
...
#line 12932 "real_world/parse_date.s.c"
yy901:
	yyaccept = 24;
	yych = *(YYMARKER = ++YYCURSOR);
	if (yych <= '^') {
...
yy927:
	++YYCURSOR;
#line 1252 "real_world/parse_date.s.re"
	{
...
#line 13209 "real_world/parse_date.s.c"
yy929:
	yych = *++YYCURSOR;
	if (yych <= '/') goto yy876;
...
yy946:
	++YYCURSOR;
yy947:
#line 851 "real_world/parse_date.s.re"
	{
...
#line 13337 "real_world/parse_date.s.c"
yy948:
	yyaccept = 25;
	yych = *(YYMARKER = ++YYCURSOR);
	if (yych <= '^') {
...
yy1019:
	...
	if (yych <= '9') goto yy1022;
yy1020:
#line 1164 "real_world/parse_date.s.re"
	{
		int tz_not_found;
...
#line 13844 "real_world/parse_date.s.c"
yy1021:
	yych = *++YYCURSOR;
...
yy1042:
	...
	if (yych <= ':') goto yy1047;
yy1043:
#line 1265 "real_world/parse_date.s.re"
	{
		int tz_not_found;
		DEBUG_OUTPUT("clf");
		TIMELIB_INIT;
...
#line 13978 "real_world/parse_date.s.c"
yy1044:
	yych = *++YYCURSOR;
	if (yych <= '5') {
		if (yych <= '/') goto yy1043;
...
#line 1412 "real_world/parse_date.s.re"
