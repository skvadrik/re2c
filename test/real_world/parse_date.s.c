/* Generated by re2c */
#line 1 "real_world/parse_date.s.re"
/*
   +----------------------------------------------------------------------+
   | PHP Version 5                                                        |
   +----------------------------------------------------------------------+
...
std:
	s->tok = cursor;
	s->len = 0;
#line 845 "real_world/parse_date.s.re"



#line 743 "real_world/parse_date.s.c"
{
	YYCTYPE yych;
...
yy2:
	++YYCURSOR;
#line 1400 "real_world/parse_date.s.re"
	{
		s->pos = cursor; s->line++;
		goto std;
	}
#line 830 "real_world/parse_date.s.c"
yy4:
	++YYCURSOR;
yy5:
#line 1406 "real_world/parse_date.s.re"
	{
/*		printf("unexpected character: #%d, %c ", *s->tok, *s->tok); */
		s->errors++;
		goto std;
	}
#line 840 "real_world/parse_date.s.c"
yy6:
	yyaccept = 0;
	...
	if (yych <= '9') goto yy54;
yy7:
#line 1395 "real_world/parse_date.s.re"
	{
		goto std;
	}
#line 852 "real_world/parse_date.s.c"
yy8:
	yych = *++YYCURSOR;
	if (yych <= '@') goto yy5;
	if (yych <= 'Z') goto yy37;
...
yy18:
#line 1340 "real_world/parse_date.s.re"
	{
		int tz_not_found;
...
#line 1240 "real_world/parse_date.s.c"
yy19:
	yych = *++YYCURSOR;
	if (yych <= '@') {
		if (yych == ')') goto yy102;
...
yy74:
#line 1139 "real_world/parse_date.s.re"
	{
...
#line 2647 "real_world/parse_date.s.c"
yy75:
	yych = *++YYCURSOR;
	if (yych <= 'U') {
...
yy99:
	...
	if (yych <= '9') goto yy99;
yy101:
#line 905 "real_world/parse_date.s.re"
	{
		timelib_ull i;
...
#line 3004 "real_world/parse_date.s.c"
yy102:
	++YYCURSOR;
	goto yy18;
yy103:
...
yy128:
	...
	goto yy282;
yy129:
#line 1126 "real_world/parse_date.s.re"
	{
...
#line 3557 "real_world/parse_date.s.c"
yy130:
	yych = *++YYCURSOR;
	if (yych <= '/') goto yy282;
...
yy192:
#line 946 "real_world/parse_date.s.re"
	{
		int tz_not_found;
...
#line 4911 "real_world/parse_date.s.c"
yy193:
	yyaccept = 4;
	yych = *(YYMARKER = ++YYCURSOR);
	if (yych <= '/') {
...
yy197:
#line 1033 "real_world/parse_date.s.re"
	{
...
#line 4974 "real_world/parse_date.s.c"
yy198:
	yyaccept = 5;
	yych = *(YYMARKER = ++YYCURSOR);
	if (yych <= 'n') {
...
yy223:
#line 1073 "real_world/parse_date.s.re"
	{
...
#line 5169 "real_world/parse_date.s.c"
yy224:
	yyaccept = 3;
	yych = *(YYMARKER = ++YYCURSOR);
	if (yych <= '/') {
...
yy250:
	...
	if (yych == '.') goto yy388;
yy251:
#line 929 "real_world/parse_date.s.re"
	{
...
#line 5416 "real_world/parse_date.s.c"
yy252:
	yych = *++YYCURSOR;
	if (yych <= '/') goto yy62;
...
yy256:
#line 1292 "real_world/parse_date.s.re"
	{
		DEBUG_OUTPUT("ago");
		TIMELIB_INIT;
...
#line 5490 "real_world/parse_date.s.c"
yy257:
	yyaccept = 2;
	yych = *(YYMARKER = ++YYCURSOR);
	if (yych <= '9') {
...
yy275:
#line 1307 "real_world/parse_date.s.re"
	{
		const timelib_relunit* relunit;
...
#line 5968 "real_world/parse_date.s.c"
yy276:
	yyaccept = 2;
	yych = *(YYMARKER = ++YYCURSOR);
	if (yych <= '@') {
...
yy304:
#line 862 "real_world/parse_date.s.re"
	{
		DEBUG_OUTPUT("now");
		TIMELIB_INIT;
...
#line 6669 "real_world/parse_date.s.c"
yy305:
	yyaccept = 2;
	yych = *(YYMARKER = ++YYCURSOR);
	if (yych <= 'N') {
...
yy357:
#line 970 "real_world/parse_date.s.re"
	{
...
#line 7634 "real_world/parse_date.s.c"
yy358:
	yyaccept = 11;
	yych = *(YYMARKER = ++YYCURSOR);
	switch (yych) {
...
yy359:
#line 1283 "real_world/parse_date.s.re"
	{
		DEBUG_OUTPUT("year4");
		TIMELIB_INIT;
		s->time->y = timelib_get_nr((char **) &ptr, 4);
...
#line 7704 "real_world/parse_date.s.c"
yy360:
	yyaccept = 3;
	yych = *(YYMARKER = ++YYCURSOR);
	if (yych <= '9') {
...
yy362:
	...
	if (yych == 's') goto yy520;
yy363:
#line 1379 "real_world/parse_date.s.re"
	{
		timelib_ull i;
...
#line 7759 "real_world/parse_date.s.c"
yy364:
	yyaccept = 3;
	yych = *(YYMARKER = ++YYCURSOR);
	if (yych <= '9') {
...
yy442:
	...
	if (yych == ')') goto yy102;
yy443:
#line 871 "real_world/parse_date.s.re"
	{
		DEBUG_OUTPUT("noon");
		TIMELIB_INIT;
		TIMELIB_UNHAVE_TIME();
...
#line 8779 "real_world/parse_date.s.c"
yy444:
	yyaccept = 13;
	yych = *(YYMARKER = ++YYCURSOR);
	if (yych <= '/') {
...
yy474:
#line 1060 "real_world/parse_date.s.re"
	{
...
#line 9305 "real_world/parse_date.s.c"
yy475:
	yyaccept = 14;
	yych = *(YYMARKER = ++YYCURSOR);
	if (yych <= 'n') {
...
yy505:
#line 1113 "real_world/parse_date.s.re"
	{
...
#line 9652 "real_world/parse_date.s.c"
yy506:
	yych = *++YYCURSOR;
	if (yych <= 'U') {
...
yy583:
#line 1100 "real_world/parse_date.s.re"
	{
...
#line 10260 "real_world/parse_date.s.c"
yy584:
	yych = *++YYCURSOR;
	if (yych <= '/') goto yy583;
	if (yych <= '9') goto yy706;
...
yy586:
#line 1351 "real_world/parse_date.s.re"
	{
		int tz_not_found;
...
#line 10303 "real_world/parse_date.s.c"
yy587:
	yyaccept = 16;
	yych = *(YYMARKER = ++YYCURSOR);
	if (yych == '.') goto yy710;
...
yy621:
	++YYCURSOR;
yy622:
#line 883 "real_world/parse_date.s.re"
	{
...
#line 10579 "real_world/parse_date.s.c"
yy623:
	yych = *++YYCURSOR;
...
yy637:
	...
	if (yych <= '9') goto yy753;
yy638:
#line 1087 "real_world/parse_date.s.re"
	{
...
#line 10673 "real_world/parse_date.s.c"
yy639:
	yych = *++YYCURSOR;
	if (yych <= '/') goto yy197;
...
yy663:
#line 1015 "real_world/parse_date.s.re"
	{
		int tz_not_found;
...
#line 10869 "real_world/parse_date.s.c"
yy664:
	yyaccept = 18;
	yych = *(YYMARKER = ++YYCURSOR);
	switch (yych) {
...
yy775:
#line 1187 "real_world/parse_date.s.re"
	{
...
#line 11711 "real_world/parse_date.s.c"
yy776:
	yyaccept = 19;
	yych = *(YYMARKER = ++YYCURSOR);
	switch (yych) {
...
yy791:
#line 1219 "real_world/parse_date.s.re"
	{
		timelib_sll w, d;
...
#line 11895 "real_world/parse_date.s.c"
yy792:
	yych = *++YYCURSOR;
...
yy802:
	...
	if (yych == 's') goto yy879;
yy803:
#line 1323 "real_world/parse_date.s.re"
	{
		timelib_sll i;
		int         behavior;
...
#line 11978 "real_world/parse_date.s.c"
yy804:
	yych = *++YYCURSOR;
...
yy855:
#line 1048 "real_world/parse_date.s.re"
	{
...
#line 12558 "real_world/parse_date.s.c"
yy856:
	yyaccept = 22;
	yych = *(YYMARKER = ++YYCURSOR);
	if (yych <= 'n') {
...
yy860:
#line 1151 "real_world/parse_date.s.re"
	{
...
#line 12645 "real_world/parse_date.s.c"
yy861:
	yych = *++YYCURSOR;
	if (yych <= '/') goto yy53;
...
yy869:
	++YYCURSOR;
#line 1200 "real_world/parse_date.s.re"
	{
		timelib_sll w, d;
...
#line 12707 "real_world/parse_date.s.c"
yy871:
	yych = *++YYCURSOR;
...
yy876:
#line 1238 "real_world/parse_date.s.re"
	{
...
#line 12745 "real_world/parse_date.s.c"
yy877:
	yyaccept = 16;
	yych = *(YYMARKER = ++YYCURSOR);
	if (yych <= '-') {
...
yy899:
	++YYCURSOR;
yy900:
#line 893 "real_world/parse_date.s.re"
	{
...
#line 12931 "real_world/parse_date.s.c"
yy901:
	yyaccept = 24;
	yych = *(YYMARKER = ++YYCURSOR);
	if (yych <= '^') {
...
yy927:
	++YYCURSOR;
#line 1251 "real_world/parse_date.s.re"
	{
...
#line 13208 "real_world/parse_date.s.c"
yy929:
	yych = *++YYCURSOR;
	if (yych <= '/') goto yy876;
...
yy946:
	++YYCURSOR;
yy947:
#line 850 "real_world/parse_date.s.re"
	{
...
#line 13336 "real_world/parse_date.s.c"
yy948:
	yyaccept = 25;
	yych = *(YYMARKER = ++YYCURSOR);
	if (yych <= '^') {
...
yy1019:
	...
	if (yych <= '9') goto yy1022;
yy1020:
#line 1163 "real_world/parse_date.s.re"
	{
		int tz_not_found;
...
#line 13843 "real_world/parse_date.s.c"
yy1021:
	yych = *++YYCURSOR;
...
yy1042:
	...
	if (yych <= ':') goto yy1047;
yy1043:
#line 1264 "real_world/parse_date.s.re"
	{
		int tz_not_found;
		DEBUG_OUTPUT("clf");
		TIMELIB_INIT;
...
#line 13977 "real_world/parse_date.s.c"
yy1044:
	yych = *++YYCURSOR;
	if (yych <= '5') {
		if (yych <= '/') goto yy1043;
...
#line 1411 "real_world/parse_date.s.re"
