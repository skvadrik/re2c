...
std:
	s->tok = cursor;
	s->len = 0;
#line 846 "real_world/parse_date.b.re"



#line 744 "real_world/parse_date.b.c"
{
	YYCTYPE yych;
...
yy2:
	++YYCURSOR;
#line 1401 "real_world/parse_date.b.re"
	{
		s->pos = cursor; s->line++;
		goto std;
	}
#line 865 "real_world/parse_date.b.c"
yy4:
	++YYCURSOR;
yy5:
#line 1407 "real_world/parse_date.b.re"
	{
/*		printf("unexpected character: #%d, %c ", *s->tok, *s->tok); */
		s->errors++;
		goto std;
	}
#line 875 "real_world/parse_date.b.c"
yy6:
	yyaccept = 0;
	...
	if (yych <= '9') goto yy54;
yy7:
#line 1396 "real_world/parse_date.b.re"
	{
		goto std;
	}
#line 889 "real_world/parse_date.b.c"
yy8:
	yych = *++YYCURSOR;
	if (yych <= '@') goto yy5;
	if (yych <= 'Z') goto yy37;
...
yy18:
#line 1341 "real_world/parse_date.b.re"
	{
		int tz_not_found;
...
#line 1276 "real_world/parse_date.b.c"
yy19:
	yych = *++YYCURSOR;
	if (yych <= '@') {
		if (yych == ')') goto yy102;
...
yy74:
#line 1140 "real_world/parse_date.b.re"
	{
...
#line 2666 "real_world/parse_date.b.c"
yy75:
	yych = *++YYCURSOR;
	if (yych <= 'U') {
...
yy99:
	...
	if (yych <= '9') goto yy99;
yy101:
#line 906 "real_world/parse_date.b.re"
	{
		timelib_ull i;
...
#line 3023 "real_world/parse_date.b.c"
yy102:
	++YYCURSOR;
	goto yy18;
yy103:
...
yy128:
	...
	goto yy282;
yy129:
#line 1127 "real_world/parse_date.b.re"
	{
...
#line 3576 "real_world/parse_date.b.c"
yy130:
	yych = *++YYCURSOR;
	if (yych <= '/') goto yy282;
...
yy192:
#line 947 "real_world/parse_date.b.re"
	{
		int tz_not_found;
...
#line 4948 "real_world/parse_date.b.c"
yy193:
	yyaccept = 4;
	yych = *(YYMARKER = ++YYCURSOR);
	if (yych <= '/') {
...
yy197:
#line 1034 "real_world/parse_date.b.re"
	{
...
#line 5011 "real_world/parse_date.b.c"
yy198:
	yyaccept = 5;
	yych = *(YYMARKER = ++YYCURSOR);
	if (yych <= 'n') {
...
yy223:
#line 1074 "real_world/parse_date.b.re"
	{
...
#line 5206 "real_world/parse_date.b.c"
yy224:
	yyaccept = 3;
	yych = *(YYMARKER = ++YYCURSOR);
	if (yych <= '/') {
...
yy250:
	...
	if (yych == '.') goto yy388;
yy251:
#line 930 "real_world/parse_date.b.re"
	{
...
#line 5453 "real_world/parse_date.b.c"
yy252:
	yych = *++YYCURSOR;
	if (yych <= '/') goto yy62;
...
yy256:
#line 1293 "real_world/parse_date.b.re"
	{
		DEBUG_OUTPUT("ago");
		TIMELIB_INIT;
...
#line 5527 "real_world/parse_date.b.c"
yy257:
	yyaccept = 2;
	yych = *(YYMARKER = ++YYCURSOR);
	if (yych <= '9') {
...
yy275:
#line 1308 "real_world/parse_date.b.re"
	{
		const timelib_relunit* relunit;
...
#line 6005 "real_world/parse_date.b.c"
yy276:
	yyaccept = 2;
	yych = *(YYMARKER = ++YYCURSOR);
	if (yych <= '@') {
...
yy304:
#line 863 "real_world/parse_date.b.re"
	{
		DEBUG_OUTPUT("now");
		TIMELIB_INIT;
...
#line 6678 "real_world/parse_date.b.c"
yy305:
	yyaccept = 2;
	yych = *(YYMARKER = ++YYCURSOR);
	if (yych <= 'N') {
...
yy357:
#line 971 "real_world/parse_date.b.re"
	{
...
#line 7643 "real_world/parse_date.b.c"
yy358:
	yyaccept = 11;
	yych = *(YYMARKER = ++YYCURSOR);
	switch (yych) {
...
yy359:
#line 1284 "real_world/parse_date.b.re"
	{
		DEBUG_OUTPUT("year4");
		TIMELIB_INIT;
		s->time->y = timelib_get_nr((char **) &ptr, 4);
...
#line 7713 "real_world/parse_date.b.c"
yy360:
	yyaccept = 3;
	yych = *(YYMARKER = ++YYCURSOR);
	if (yych <= '9') {
...
yy362:
	...
	if (yych == 's') goto yy520;
yy363:
#line 1380 "real_world/parse_date.b.re"
	{
		timelib_ull i;
...
#line 7768 "real_world/parse_date.b.c"
yy364:
	yyaccept = 3;
	yych = *(YYMARKER = ++YYCURSOR);
	if (yych <= '9') {
...
yy442:
	...
	if (yych == ')') goto yy102;
yy443:
#line 872 "real_world/parse_date.b.re"
	{
		DEBUG_OUTPUT("noon");
		TIMELIB_INIT;
		TIMELIB_UNHAVE_TIME();
...
#line 8789 "real_world/parse_date.b.c"
yy444:
	yyaccept = 13;
	yych = *(YYMARKER = ++YYCURSOR);
	if (yych <= '/') {
...
yy474:
#line 1061 "real_world/parse_date.b.re"
	{
...
#line 9315 "real_world/parse_date.b.c"
yy475:
	yyaccept = 14;
	yych = *(YYMARKER = ++YYCURSOR);
	if (yych <= 'n') {
...
yy505:
#line 1114 "real_world/parse_date.b.re"
	{
...
#line 9662 "real_world/parse_date.b.c"
yy506:
	yych = *++YYCURSOR;
	if (yych <= 'U') {
...
yy583:
#line 1101 "real_world/parse_date.b.re"
	{
...
#line 10267 "real_world/parse_date.b.c"
yy584:
	yych = *++YYCURSOR;
	if (yych <= '/') goto yy583;
	if (yych <= '9') goto yy706;
...
yy586:
#line 1352 "real_world/parse_date.b.re"
	{
		int tz_not_found;
...
#line 10310 "real_world/parse_date.b.c"
yy587:
	yyaccept = 16;
	yych = *(YYMARKER = ++YYCURSOR);
	if (yych == '.') goto yy710;
...
yy621:
	++YYCURSOR;
yy622:
#line 884 "real_world/parse_date.b.re"
	{
...
#line 10586 "real_world/parse_date.b.c"
yy623:
	yych = *++YYCURSOR;
...
yy637:
	...
	if (yych <= '9') goto yy753;
yy638:
#line 1088 "real_world/parse_date.b.re"
	{
...
#line 10680 "real_world/parse_date.b.c"
yy639:
	yych = *++YYCURSOR;
	if (yych <= '/') goto yy197;
...
yy663:
#line 1016 "real_world/parse_date.b.re"
	{
		int tz_not_found;
...
#line 10876 "real_world/parse_date.b.c"
yy664:
	yyaccept = 18;
	yych = *(YYMARKER = ++YYCURSOR);
	switch (yych) {
...
yy775:
#line 1188 "real_world/parse_date.b.re"
	{
...
#line 11746 "real_world/parse_date.b.c"
yy776:
	yyaccept = 19;
	yych = *(YYMARKER = ++YYCURSOR);
	switch (yych) {
...
yy791:
#line 1220 "real_world/parse_date.b.re"
	{
		timelib_sll w, d;
...
#line 11930 "real_world/parse_date.b.c"
yy792:
	yych = *++YYCURSOR;
...
yy802:
	...
	if (yych == 's') goto yy879;
yy803:
#line 1324 "real_world/parse_date.b.re"
	{
		timelib_sll i;
		int         behavior;
...
#line 12013 "real_world/parse_date.b.c"
yy804:
	yych = *++YYCURSOR;
...
yy855:
#line 1049 "real_world/parse_date.b.re"
	{
...
#line 12593 "real_world/parse_date.b.c"
yy856:
	yyaccept = 22;
	yych = *(YYMARKER = ++YYCURSOR);
	if (yych <= 'n') {
...
yy860:
#line 1152 "real_world/parse_date.b.re"
	{
...
#line 12673 "real_world/parse_date.b.c"
yy861:
	yych = *++YYCURSOR;
	if (yych <= '/') goto yy53;
...
yy869:
	++YYCURSOR;
#line 1201 "real_world/parse_date.b.re"
	{
		timelib_sll w, d;
...
#line 12735 "real_world/parse_date.b.c"
yy871:
	yych = *++YYCURSOR;
...
yy876:
#line 1239 "real_world/parse_date.b.re"
	{
...
#line 12773 "real_world/parse_date.b.c"
yy877:
	yyaccept = 16;
	yych = *(YYMARKER = ++YYCURSOR);
	if (yych <= '-') {
...
yy899:
	++YYCURSOR;
yy900:
#line 894 "real_world/parse_date.b.re"
	{
...
#line 12959 "real_world/parse_date.b.c"
yy901:
	yyaccept = 24;
	yych = *(YYMARKER = ++YYCURSOR);
	if (yych <= '^') {
...
yy927:
	++YYCURSOR;
#line 1252 "real_world/parse_date.b.re"
	{
...
#line 13236 "real_world/parse_date.b.c"
yy929:
	yych = *++YYCURSOR;
	if (yych <= '/') goto yy876;
...
yy946:
	++YYCURSOR;
yy947:
#line 851 "real_world/parse_date.b.re"
	{
...
#line 13364 "real_world/parse_date.b.c"
yy948:
	yyaccept = 25;
	yych = *(YYMARKER = ++YYCURSOR);
	if (yych <= '^') {
...
yy1019:
	...
	if (yych <= '9') goto yy1022;
yy1020:
#line 1164 "real_world/parse_date.b.re"
	{
		int tz_not_found;
...
#line 13871 "real_world/parse_date.b.c"
yy1021:
	yych = *++YYCURSOR;
...
yy1042:
	...
	if (yych <= ':') goto yy1047;
yy1043:
#line 1265 "real_world/parse_date.b.re"
	{
		int tz_not_found;
		DEBUG_OUTPUT("clf");
		TIMELIB_INIT;
...
#line 14005 "real_world/parse_date.b.c"
yy1044:
	yych = *++YYCURSOR;
	if (yych <= '5') {
		if (yych <= '/') goto yy1043;
...
#line 1412 "real_world/parse_date.b.re"
