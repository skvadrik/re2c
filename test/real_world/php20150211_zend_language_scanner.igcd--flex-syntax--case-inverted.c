...
real_world/php20150211_zend_language_scanner.igcd--flex-syntax--case-inverted.re:1095:12: warning: escape has no effect: '\[' [-Wuseless-escape]
real_world/php20150211_zend_language_scanner.igcd--flex-syntax--case-inverted.re:1476:19: warning: escape has no effect: '\*' [-Wuseless-escape]
real_world/php20150211_zend_language_scanner.igcd--flex-syntax--case-inverted.re:1480:19: warning: escape has no effect: '\*' [-Wuseless-escape]
real_world/php20150211_zend_language_scanner.igcd--flex-syntax--case-inverted.re:2358:2: warning: looks like you use hardcoded numbers instead of autogenerated condition names: better add '/*!types:re2c*/' directive or '-t, --type-header' option and don't rely on fixed condition order. [-Wcondition-order]
