...
real_world/php20140822_zend_language_scanner.igcd--flex-syntax.re:1016:12: warning: escape has no effect: '\[' [-Wuseless-escape]
real_world/php20140822_zend_language_scanner.igcd--flex-syntax.re:2441:2: warning: looks like you use hardcoded numbers instead of autogenerated condition names: better add '/*!types:re2c*/' directive or '-t, --type-header' option and don't rely on fixed condition order. [-Wcondition-order]
