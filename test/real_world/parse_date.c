...
std:
	s->tok = cursor;
	s->len = 0;
#line 845 "real_world/parse_date.re"



#line 743 "real_world/parse_date.c"
{
	YYCTYPE yych;
...
yy2:
	++YYCURSOR;
#line 1400 "real_world/parse_date.re"
	{
		s->pos = cursor; s->line++;
		goto std;
	}
#line 830 "real_world/parse_date.c"
yy4:
	++YYCURSOR;
yy5:
#line 1406 "real_world/parse_date.re"
	{
/*		printf("unexpected character: #%d, %c ", *s->tok, *s->tok); */
		s->errors++;
		goto std;
	}
#line 840 "real_world/parse_date.c"
yy6:
	yyaccept = 0;
...
yy7:
#line 1395 "real_world/parse_date.re"
	{
		goto std;
	}
#line 863 "real_world/parse_date.c"
yy8:
	yych = *++YYCURSOR;
	switch (yych) {
	case 'A':
...
yy18:
#line 1340 "real_world/parse_date.re"
	{
		int tz_not_found;
...
#line 1339 "real_world/parse_date.c"
yy19:
	yych = *++YYCURSOR;
	switch (yych) {
	case ')':	goto yy102;
...
yy74:
#line 1139 "real_world/parse_date.re"
	{
...
#line 3752 "real_world/parse_date.c"
yy75:
	yych = *++YYCURSOR;
	switch (yych) {
	case 'A':
...
yy101:
#line 905 "real_world/parse_date.re"
	{
		timelib_ull i;
...
#line 4138 "real_world/parse_date.c"
yy102:
	++YYCURSOR;
	goto yy18;
yy103:
...
yy129:
#line 1126 "real_world/parse_date.re"
	{
...
#line 5543 "real_world/parse_date.c"
yy130:
	yych = *++YYCURSOR;
	switch (yych) {
	case '0':
...
yy192:
#line 946 "real_world/parse_date.re"
	{
		int tz_not_found;
...
#line 8446 "real_world/parse_date.c"
yy193:
	yyaccept = 4;
	yych = *(YYMARKER = ++YYCURSOR);
	switch (yych) {
...
yy197:
#line 1033 "real_world/parse_date.re"
	{
...
#line 8527 "real_world/parse_date.c"
yy198:
	yyaccept = 5;
	yych = *(YYMARKER = ++YYCURSOR);
	switch (yych) {
...
yy223:
#line 1073 "real_world/parse_date.re"
	{
...
#line 8787 "real_world/parse_date.c"
yy224:
	yyaccept = 3;
	yych = *(YYMARKER = ++YYCURSOR);
	switch (yych) {
...
yy251:
#line 929 "real_world/parse_date.re"
	{
...
#line 9112 "real_world/parse_date.c"
yy252:
	yych = *++YYCURSOR;
	switch (yych) {
	case '0':	goto yy389;
...
yy256:
#line 1292 "real_world/parse_date.re"
	{
		DEBUG_OUTPUT("ago");
		TIMELIB_INIT;
...
#line 9290 "real_world/parse_date.c"
yy257:
	yyaccept = 2;
	yych = *(YYMARKER = ++YYCURSOR);
	switch (yych) {
...
yy275:
#line 1307 "real_world/parse_date.re"
	{
		const timelib_relunit* relunit;
...
#line 10519 "real_world/parse_date.c"
yy276:
	yyaccept = 2;
	yych = *(YYMARKER = ++YYCURSOR);
	switch (yych) {
...
yy304:
#line 862 "real_world/parse_date.re"
	{
		DEBUG_OUTPUT("now");
		TIMELIB_INIT;
...
#line 12234 "real_world/parse_date.c"
yy305:
	yyaccept = 2;
	yych = *(YYMARKER = ++YYCURSOR);
	switch (yych) {
...
yy357:
#line 970 "real_world/parse_date.re"
	{
...
#line 14467 "real_world/parse_date.c"
yy358:
	yyaccept = 11;
	yych = *(YYMARKER = ++YYCURSOR);
	switch (yych) {
...
yy359:
#line 1283 "real_world/parse_date.re"
	{
		DEBUG_OUTPUT("year4");
		TIMELIB_INIT;
		s->time->y = timelib_get_nr((char **) &ptr, 4);
...
#line 14537 "real_world/parse_date.c"
yy360:
	yyaccept = 3;
	yych = *(YYMARKER = ++YYCURSOR);
	switch (yych) {
...
yy363:
#line 1379 "real_world/parse_date.re"
	{
		timelib_ull i;
...
#line 14627 "real_world/parse_date.c"
yy364:
	yyaccept = 3;
	yych = *(YYMARKER = ++YYCURSOR);
	switch (yych) {
...
yy443:
#line 871 "real_world/parse_date.re"
	{
		DEBUG_OUTPUT("noon");
		TIMELIB_INIT;
		TIMELIB_UNHAVE_TIME();
...
#line 16118 "real_world/parse_date.c"
yy444:
	yyaccept = 13;
	yych = *(YYMARKER = ++YYCURSOR);
	switch (yych) {
...
yy474:
#line 1060 "real_world/parse_date.re"
	{
...
#line 16864 "real_world/parse_date.c"
yy475:
	yyaccept = 14;
	yych = *(YYMARKER = ++YYCURSOR);
	switch (yych) {
...
yy505:
#line 1113 "real_world/parse_date.re"
	{
...
#line 17300 "real_world/parse_date.c"
yy506:
	yych = *++YYCURSOR;
	switch (yych) {
	case 'A':
...
yy583:
#line 1100 "real_world/parse_date.re"
	{
...
#line 18151 "real_world/parse_date.c"
yy584:
	yych = *++YYCURSOR;
	switch (yych) {
	case '0':
...
yy586:
#line 1351 "real_world/parse_date.re"
	{
		int tz_not_found;
...
#line 18213 "real_world/parse_date.c"
yy587:
	yyaccept = 16;
	yych = *(YYMARKER = ++YYCURSOR);
	switch (yych) {
...
yy621:
	++YYCURSOR;
yy622:
#line 883 "real_world/parse_date.re"
	{
...
#line 18493 "real_world/parse_date.c"
yy623:
	yych = *++YYCURSOR;
	switch (yych) {
	case 'R':
...
yy638:
#line 1087 "real_world/parse_date.re"
	{
...
#line 18662 "real_world/parse_date.c"
yy639:
	yych = *++YYCURSOR;
	switch (yych) {
	case '0':
...
yy663:
#line 1015 "real_world/parse_date.re"
	{
		int tz_not_found;
...
#line 18936 "real_world/parse_date.c"
yy664:
	yyaccept = 18;
	yych = *(YYMARKER = ++YYCURSOR);
	switch (yych) {
...
yy775:
#line 1187 "real_world/parse_date.re"
	{
...
#line 20081 "real_world/parse_date.c"
yy776:
	yyaccept = 19;
	yych = *(YYMARKER = ++YYCURSOR);
	switch (yych) {
...
yy791:
#line 1219 "real_world/parse_date.re"
	{
		timelib_sll w, d;
...
#line 20296 "real_world/parse_date.c"
yy792:
	yych = *++YYCURSOR;
	switch (yych) {
	case 'G':
...
yy803:
#line 1323 "real_world/parse_date.re"
	{
		timelib_sll i;
		int         behavior;
...
#line 20417 "real_world/parse_date.c"
yy804:
	yych = *++YYCURSOR;
	switch (yych) {
	case 'T':
...
yy855:
#line 1048 "real_world/parse_date.re"
	{
...
#line 21117 "real_world/parse_date.c"
yy856:
	yyaccept = 22;
	yych = *(YYMARKER = ++YYCURSOR);
	switch (yych) {
...
yy860:
#line 1151 "real_world/parse_date.re"
	{
...
#line 21200 "real_world/parse_date.c"
yy861:
	yych = *++YYCURSOR;
	switch (yych) {
	case '0':	goto yy920;
...
yy869:
	++YYCURSOR;
#line 1200 "real_world/parse_date.re"
	{
		timelib_sll w, d;
...
#line 21279 "real_world/parse_date.c"
yy871:
	yych = *++YYCURSOR;
	switch (yych) {
	case 'H':
...
yy876:
#line 1238 "real_world/parse_date.re"
	{
...
#line 21351 "real_world/parse_date.c"
yy877:
	yyaccept = 16;
	yych = *(YYMARKER = ++YYCURSOR);
	switch (yych) {
...
yy899:
	++YYCURSOR;
yy900:
#line 893 "real_world/parse_date.re"
	{
...
#line 21659 "real_world/parse_date.c"
yy901:
	yyaccept = 24;
	yych = *(YYMARKER = ++YYCURSOR);
	switch (yych) {
...
yy927:
	++YYCURSOR;
#line 1251 "real_world/parse_date.re"
	{
...
#line 21997 "real_world/parse_date.c"
yy929:
	yych = *++YYCURSOR;
	switch (yych) {
	case '0':
...
yy946:
	++YYCURSOR;
yy947:
#line 850 "real_world/parse_date.re"
	{
...
#line 22348 "real_world/parse_date.c"
yy948:
	yyaccept = 25;
	yych = *(YYMARKER = ++YYCURSOR);
	switch (yych) {
...
yy1020:
#line 1163 "real_world/parse_date.re"
	{
		int tz_not_found;
...
#line 23467 "real_world/parse_date.c"
yy1021:
	yych = *++YYCURSOR;
	switch (yych) {
	case '0':	goto yy1022;
...
yy1043:
#line 1264 "real_world/parse_date.re"
	{
		int tz_not_found;
		DEBUG_OUTPUT("clf");
		TIMELIB_INIT;
...
#line 23712 "real_world/parse_date.c"
yy1044:
	yych = *++YYCURSOR;
	switch (yych) {
	case '0':
...
#line 1411 "real_world/parse_date.re"
