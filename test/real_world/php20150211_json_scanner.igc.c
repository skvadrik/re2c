...
real_world/php20150211_json_scanner.igc.re:337:26: warning: unreachable rule in condition 'STR_P1' (shadowed by rules at lines 205, 229, 233, 255, 256) [-Wunreachable-rules]
real_world/php20150211_json_scanner.igc.re:337:26: warning: unreachable rule in condition 'STR_P2' (shadowed by rules at lines 298, 331, 335) [-Wunreachable-rules]
real_world/php20150211_json_scanner.igc.re:341:2: warning: looks like you use hardcoded numbers instead of autogenerated condition names: better add '/*!types:re2c*/' directive or '-t, --type-header' option and don't rely on fixed condition order. [-Wcondition-order]
