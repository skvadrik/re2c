...
real_world/php20150211_phar_path_check.ig.re:109:2: warning: control flow is undefined for strings that match '\xA', use default rule '*' [-Wundefined-control-flow]
