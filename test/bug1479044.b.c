...
yy2:
	++YYCURSOR;
#line 38 "bug1479044.b.re"
	{
		return NULL;
	}
#line 101 "bug1479044.b.c"
yy4:
	++YYCURSOR;
yy5:
#line 33 "bug1479044.b.re"
	{
		goto start;
	}
#line 109 "bug1479044.b.c"
yy6:
	yyaccept = 0;
...
yy120:
	...
	if (yych >= '\v') goto yy72;
yy121:
#line 18 "bug1479044.b.re"
	{
		return "dsl";
	}
#line 836 "bug1479044.b.c"
yy122:
	++YYCURSOR;
	if (YYLIMIT <= YYCURSOR) YYFILL(1);
	yych = *YYCURSOR;
...
yy134:
	...
	goto yy74;
yy135:
#line 23 "bug1479044.b.re"
	{
		return "resnet";
	}
#line 994 "bug1479044.b.c"
yy136:
	++YYCURSOR;
	if (YYLIMIT <= YYCURSOR) YYFILL(1);
	yych = *YYCURSOR;
	...
	goto yy96;
yy139:
#line 28 "bug1479044.b.re"
	{
		return "edu";
	}
#line 1028 "bug1479044.b.c"
}
#line 41 "bug1479044.b.re"
