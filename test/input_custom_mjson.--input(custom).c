...
#line 492 "input_custom_mjson.--input(custom).re"
...
#line 492 "input_custom_mjson.--input(custom).c"
        {
            YYCTYPE yych;
...
yy2:
            YYSKIP();
#line 613 "input_custom_mjson.--input(custom).re"
            { 
                context->token = TOK_NONE;
                return;
            }
#line 587 "input_custom_mjson.--input(custom).c"
yy4:
            YYSKIP();
yy5:
#line 623 "input_custom_mjson.--input(custom).re"
            {
                context->token = TOK_INVALID;
                return;
            }
#line 596 "input_custom_mjson.--input(custom).c"
yy6:
            YYSKIP();
            yych = YYPEEK();
            switch (yych) {
...
yy8:
#line 516 "input_custom_mjson.--input(custom).re"
            {
                continue; 
            }
#line 612 "input_custom_mjson.--input(custom).c"
yy9:
            yyaccept = 0;
            YYSKIP();
            YYBACKUP();
...
yy11:
            YYSKIP();
#line 558 "input_custom_mjson.--input(custom).re"
            {
                token = TOK_COMMA;
                goto done;
            }
#line 646 "input_custom_mjson.--input(custom).c"
yy13:
            YYSKIP();
            yych = YYPEEK();
            switch (yych) {
...
yy16:
#line 573 "input_custom_mjson.--input(custom).re"
            {
                token = TOK_DEC_NUMBER;
                goto done;
            }
#line 749 "input_custom_mjson.--input(custom).c"
yy17:
            YYSKIP();
            yych = YYPEEK();
            switch (yych) {
...
yy19:
            YYSKIP();
#line 548 "input_custom_mjson.--input(custom).re"
            {
                token = TOK_COLON;
                goto done;
            }
#line 827 "input_custom_mjson.--input(custom).c"
yy21:
            YYSKIP();
#line 553 "input_custom_mjson.--input(custom).re"
            {
                token = TOK_EQUAL;
                goto done;
            }
#line 835 "input_custom_mjson.--input(custom).c"
yy23:
            YYSKIP();
            yych = YYPEEK();
yy24:
...
yy25:
#line 598 "input_custom_mjson.--input(custom).re"
            {
                token = TOK_IDENTIFIER;
                goto done;
            }
#line 912 "input_custom_mjson.--input(custom).c"
yy26:
            YYSKIP();
#line 538 "input_custom_mjson.--input(custom).re"
            {
                token = TOK_LEFT_BRACKET;
                goto done;
            }
#line 920 "input_custom_mjson.--input(custom).c"
yy28:
            YYSKIP();
#line 543 "input_custom_mjson.--input(custom).re"
            {
                token = TOK_RIGHT_BRACKET;
                goto done;
            }
#line 928 "input_custom_mjson.--input(custom).c"
yy30:
            YYSKIP();
            yych = YYPEEK();
            switch (yych) {
...
yy33:
            YYSKIP();
#line 528 "input_custom_mjson.--input(custom).re"
            {
                token = TOK_LEFT_CURLY_BRACKET;
                goto done;
            }
#line 957 "input_custom_mjson.--input(custom).c"
yy35:
            YYSKIP();
#line 533 "input_custom_mjson.--input(custom).re"
            {
                token = TOK_RIGHT_CURLY_BRACKET;
                goto done;
            }
#line 965 "input_custom_mjson.--input(custom).c"
yy37:
            YYSKIP();
            yych = YYPEEK();
yy38:
...
yy40:
            YYSKIP();
#line 603 "input_custom_mjson.--input(custom).re"
            {
                token = TOK_NOESC_STRING;
                goto done;
            }
#line 997 "input_custom_mjson.--input(custom).c"
yy42:
            YYSKIP();
            yych = YYPEEK();
            switch (yych) {
...
yy49:
#line 578 "input_custom_mjson.--input(custom).re"
            {
                token = TOK_FLOAT_NUMBER;
                goto done;
            }
#line 1097 "input_custom_mjson.--input(custom).c"
yy50:
            YYSKIP();
            yych = YYPEEK();
            switch (yych) {
...
yy56:
#line 563 "input_custom_mjson.--input(custom).re"
            {
                token = TOK_OCT_NUMBER;
                goto done;
            }
#line 1191 "input_custom_mjson.--input(custom).c"
yy57:
            YYSKIP();
            yych = YYPEEK();
            switch (yych) {
...
yy59:
#line 618 "input_custom_mjson.--input(custom).re"
            {
                context->token = TOK_INVALID;
                return;
            }
#line 1268 "input_custom_mjson.--input(custom).c"
yy60:
            YYSKIP();
            yych = YYPEEK();
yy61:
...
yy74:
            YYSKIP();
#line 520 "input_custom_mjson.--input(custom).re"
            {
                continue; 
            }
#line 1538 "input_custom_mjson.--input(custom).c"
yy76:
            YYSKIP();
            yych = YYPEEK();
            switch (yych) {
...
yy81:
#line 568 "input_custom_mjson.--input(custom).re"
            {
                token = TOK_HEX_NUMBER;
                goto done;
            }
#line 1700 "input_custom_mjson.--input(custom).c"
yy82:
            YYSKIP();
            yych = YYPEEK();
            switch (yych) {
...
yy85:
            YYSKIP();
#line 608 "input_custom_mjson.--input(custom).re"
            {
                token = TOK_STRING;
                goto done;
            }
#line 1729 "input_custom_mjson.--input(custom).c"
yy87:
            YYSKIP();
            yych = YYPEEK();
            switch (yych) {
...
yy92:
            YYSKIP();
yy93:
#line 524 "input_custom_mjson.--input(custom).re"
            {
                continue; 
            }
#line 1790 "input_custom_mjson.--input(custom).c"
yy94:
            YYSKIP();
            yych = YYPEEK();
            switch (yych) {
...
yy96:
#line 593 "input_custom_mjson.--input(custom).re"
            {
                token = TOK_NULL;
                goto done;
            }
#line 1873 "input_custom_mjson.--input(custom).c"
yy97:
            YYSKIP();
            yych = YYPEEK();
            switch (yych) {
...
yy98:
#line 583 "input_custom_mjson.--input(custom).re"
            {
                token = TOK_TRUE;
                goto done;
            }
#line 1949 "input_custom_mjson.--input(custom).c"
yy99:
            YYSKIP();
            yych = YYPEEK();
            switch (yych) {
...
yy102:
#line 588 "input_custom_mjson.--input(custom).re"
            {
                token = TOK_FALSE;
                goto done;
            }
#line 2063 "input_custom_mjson.--input(custom).c"
yy103:
            YYSKIP();
            yych = YYPEEK();
            switch (yych) {
...
#line 627 "input_custom_mjson.--input(custom).re"
...
#line 2213 "input_custom_mjson.--input(custom).c"
        {
            YYCTYPE yych;
            yych = YYPEEK();
            switch (yych) {
...
yy106:
            YYSKIP();
yy107:
#line 811 "input_custom_mjson.--input(custom).re"
            { 
                assert(!"reachable");
            }
#line 2230 "input_custom_mjson.--input(custom).c"
yy108:
            YYSKIP();
            yych = YYPEEK();
            switch (yych) {
...
yy110:
#line 746 "input_custom_mjson.--input(custom).re"
            {
...
#line 2251 "input_custom_mjson.--input(custom).c"
yy111:
            YYSKIP();
#line 802 "input_custom_mjson.--input(custom).re"
            {
...
#line 2263 "input_custom_mjson.--input(custom).c"
yy113:
            YYSKIP();
            YYBACKUP();
            yych = YYPEEK();
...
yy114:
            YYSKIP();
#line 757 "input_custom_mjson.--input(custom).re"
            {
                char decoded = s[1];
...
#line 2313 "input_custom_mjson.--input(custom).c"
yy116:
            YYSKIP();
            yych = YYPEEK();
            switch (yych) {
...
yy121:
            YYSKIP();
#line 788 "input_custom_mjson.--input(custom).re"
            {
...
#line 2445 "input_custom_mjson.--input(custom).c"
        }
#line 814 "input_custom_mjson.--input(custom).re"
...
input_custom_mjson.--input(custom).re:491:26: warning: escape has no effect: '\/' [-Wuseless-escape]
input_custom_mjson.--input(custom).re:491:50: warning: escape has no effect: '\/' [-Wuseless-escape]
input_custom_mjson.--input(custom).re:491:77: warning: escape has no effect: '\/' [-Wuseless-escape]
