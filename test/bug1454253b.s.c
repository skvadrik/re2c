...
#line 24 "bug1454253b.s.c"
{
	...
	if (yych == '?') goto yy4;
	++YYCURSOR;
#line 34 "bug1454253b.s.re"
	{
		*r++ = '0';
		*r++ = '\0';
		return p - s;
	}
#line 37 "bug1454253b.s.c"
yy4:
	yych = *++YYCURSOR;
	if (yych <= '9') {
		if (yych == '!') goto yy6;
...
yy8:
#line 24 "bug1454253b.s.re"
	{
		*r++ = '1';
		continue;
	}
#line 70 "bug1454253b.s.c"
yy9:
	++YYCURSOR;
	if (YYLIMIT <= YYCURSOR) YYFILL(1);
	yych = *YYCURSOR;
...
yy11:
#line 29 "bug1454253b.s.re"
	{
		*r++ = '2';
		continue;
	}
#line 89 "bug1454253b.s.c"
}
#line 39 "bug1454253b.s.re"
...
bug1454253b.s.re:39:2: warning: control flow is undefined for strings that match '\x3F [\x0-\x20\x22-\x2F\x3A-\x40\x5B-\x60\x7B-\xFF]', use default rule '*' [-Wundefined-control-flow]
