...
posix_captures/non_capturing_explicit_3.re:35:14: warning: rule matches empty string [-Wmatch-empty-string]
posix_captures/non_capturing_explicit_3.re:40:14: warning: rule matches empty string [-Wmatch-empty-string]
