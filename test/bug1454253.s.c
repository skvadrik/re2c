...
#line 24 "bug1454253.s.c"
{
	...
	goto yy5;
yy2:
#line 41 "bug1454253.s.re"
	{
		*r++ = '0';
		*r++ = '\0';
		return p - s;
	}
#line 39 "bug1454253.s.c"
yy3:
	++YYCURSOR;
#line 35 "bug1454253.s.re"
	{
		*r++ = '3';
		*r++ = '\0';
		return p - s;
	}
#line 48 "bug1454253.s.c"
yy5:
	++YYCURSOR;
...
yy11:
#line 25 "bug1454253.s.re"
	{
		*r++ = '1';
		continue;
	}
#line 90 "bug1454253.s.c"
yy12:
	++YYCURSOR;
	if (YYLIMIT <= YYCURSOR) YYFILL(1);
	yych = *YYCURSOR;
...
yy14:
#line 30 "bug1454253.s.re"
	{
		*r++ = '2';
		continue;
	}
#line 109 "bug1454253.s.c"
}
#line 46 "bug1454253.s.re"
...
bug1454253.s.re:41:6: warning: rule matches empty string [-Wmatch-empty-string]
