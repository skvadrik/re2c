...
std:
	s->tok = cursor;
	s->len = 0;
#line 845 "php/parse_date.re"



#line 743 "php/parse_date.c"
{
	YYCTYPE yych;
...
yy2:
	++YYCURSOR;
#line 1400 "php/parse_date.re"
	{
		s->pos = cursor; s->line++;
		goto std;
	}
#line 830 "php/parse_date.c"
yy4:
	++YYCURSOR;
yy5:
#line 1406 "php/parse_date.re"
	{
/*		printf("unexpected character: #%d, %c ", *s->tok, *s->tok); */
		s->errors++;
		goto std;
	}
#line 840 "php/parse_date.c"
yy6:
	yyaccept = 0;
...
yy7:
#line 1395 "php/parse_date.re"
	{
		goto std;
	}
#line 863 "php/parse_date.c"
yy8:
	yych = *++YYCURSOR;
	switch (yych) {
	case 'A':
