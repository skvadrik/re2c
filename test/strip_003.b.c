...
#line 130 "strip_003.b.re"
			{ goto comment; }
#line 136 "strip_003.b.c"
yy12:
			++YYCURSOR;
#line 128 "strip_003.b.re"
			{ goto cppcomment; }
#line 141 "strip_003.b.c"
yy14:
			++YYCURSOR;
			YYCURSOR -= 2;
...
#line 136 "strip_003.b.re"
			{ goto commentws; }
#line 171 "strip_003.b.c"
		}
#line 138 "strip_003.b.re"

commentws:
		s.tok = s.cur;

#line 178 "strip_003.b.c"
		{
			YYCTYPE yych;
			if ((YYLIMIT - YYCURSOR) < 4) YYFILL(4);
			yych = *YYCURSOR;
...
#line 153 "strip_003.b.re"

cppcomment:
		s.tok = s.cur;

#line 246 "strip_003.b.c"
		{
			YYCTYPE yych;
			if ((YYLIMIT - YYCURSOR) < 2) YYFILL(2);
			yych = *YYCURSOR;
