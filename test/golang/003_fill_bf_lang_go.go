...
//line "golang/003_fill_bf_lang_go.re":1
...
//line "golang/003_fill_bf_lang_go.go":84
{
...
yy3:
	in.cursor += 1
//line "golang/003_fill_bf_lang_go.re":94
	{
		fmt.Println("end")
		return lexEnd, 0
	}
//line "golang/003_fill_bf_lang_go.go":160
yy5:
	in.cursor += 1
//line "golang/003_fill_bf_lang_go.re":89
	{
		fmt.Println("error")
		return lexError, 0
	}
//line "golang/003_fill_bf_lang_go.go":168
yy7:
	in.cursor += 1
	in.state = 1
	if (in.limit-in.cursor < 1) {
...
//line "golang/003_fill_bf_lang_go.re":109
	{
		return lexSpace, 0
	}
//line "golang/003_fill_bf_lang_go.go":184
yy10:
	in.cursor += 1
	in.marker = in.cursor
	in.state = 2
...
yy12:
//line "golang/003_fill_bf_lang_go.re":99
	{
		fmt.Printf("number-1: %v\n", string(in.data[in.token:in.cursor]))
		return lexNumber1, 0
	}
//line "golang/003_fill_bf_lang_go.go":206
yy13:
	in.cursor += 1
	yych = YYCTYPE(in.data[in.cursor])
	if (yych <= '/') {
...
yy17:
//line "golang/003_fill_bf_lang_go.re":104
	{
		fmt.Printf("number-2: %v\n", string(in.data[in.token:in.cursor]))
		return lexNumber2, 0
	}
//line "golang/003_fill_bf_lang_go.go":239
}
//line "golang/003_fill_bf_lang_go.re":112
