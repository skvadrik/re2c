...
//line "golang/003_fill__lang_go.re":1
...
//line "golang/003_fill__lang_go.go":72
{
	var yych YYCTYPE
...
yy2:
	in.cursor += 1
//line "golang/003_fill__lang_go.re":80
	{
		fmt.Println("end")
		return 0
	}
//line "golang/003_fill__lang_go.go":114
yy4:
	in.cursor += 1
//line "golang/003_fill__lang_go.re":75
	{
		fmt.Println("error")
		return -1
	}
//line "golang/003_fill__lang_go.go":122
yy6:
	in.cursor += 1
//line "golang/003_fill__lang_go.re":95
	{
		return 3
	}
//line "golang/003_fill__lang_go.go":129
yy8:
	in.cursor += 1
	in.marker = in.cursor
...
yy10:
//line "golang/003_fill__lang_go.re":85
	{
		fmt.Printf("number-1: %v\n", string(in.data[in.token:in.cursor]))
		return 1
	}
//line "golang/003_fill__lang_go.go":169
yy11:
	in.cursor += 1
	yych = YYCTYPE(in.data[in.cursor])
	switch (yych) {
...
yy15:
//line "golang/003_fill__lang_go.re":90
	{
		fmt.Printf("number-2: %v\n", string(in.data[in.token:in.cursor]))
		return 2
	}
//line "golang/003_fill__lang_go.go":236
}
//line "golang/003_fill__lang_go.re":98
