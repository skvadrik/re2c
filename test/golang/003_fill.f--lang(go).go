...
//line "golang/003_fill.f--lang(go).re":1
...
//line "golang/003_fill.f--lang(go).go":84
...
yy3:
	in.cursor += 1
//line "golang/003_fill.f--lang(go).re":94
	{
		fmt.Println("end")
		return lexEnd, 0
	}
//line "golang/003_fill.f--lang(go).go":140
yy5:
	in.cursor += 1
//line "golang/003_fill.f--lang(go).re":89
	{
		fmt.Println("error")
		return lexError, 0
	}
//line "golang/003_fill.f--lang(go).go":148
yy7:
	in.cursor += 1
	in.state = 1
	if (in.limit-in.cursor < 1) {
...
yy9:
//line "golang/003_fill.f--lang(go).re":109
	{
		return lexSpace, 0
	}
//line "golang/003_fill.f--lang(go).go":168
yy10:
	in.cursor += 1
	in.marker = in.cursor
	in.state = 2
...
yy12:
//line "golang/003_fill.f--lang(go).re":99
	{
		fmt.Printf("number-1: %v\n", string(in.data[in.token:in.cursor]))
		return lexNumber1, 0
	}
//line "golang/003_fill.f--lang(go).go":210
yy13:
	in.cursor += 1
	yych = YYCTYPE(in.data[in.cursor])
	switch (yych) {
...
yy17:
//line "golang/003_fill.f--lang(go).re":104
	{
		fmt.Printf("number-2: %v\n", string(in.data[in.token:in.cursor]))
		return lexNumber2, 0
	}
//line "golang/003_fill.f--lang(go).go":279
//line "golang/003_fill.f--lang(go).re":112
