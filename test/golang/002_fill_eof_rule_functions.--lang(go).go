...
//line "golang/002_fill_eof_rule_functions.--lang(go).re":1
package main
...
//line "golang/002_fill_eof_rule_functions.--lang(go).go":102
{
	var yych YYCTYPE
yyFillLabel0:
	yych = YYPEEK()
...
yy2:
	YYSKIP()
//line "golang/002_fill_eof_rule_functions.--lang(go).re":102
	{
		fmt.Println("error")
		return -1
	}
//line "golang/002_fill_eof_rule_functions.--lang(go).go":146
yy4:
	YYSKIP()
//line "golang/002_fill_eof_rule_functions.--lang(go).re":122
	{
		return 3
	}
//line "golang/002_fill_eof_rule_functions.--lang(go).go":153
yy6:
	YYSKIP()
	YYBACKUP()
yyFillLabel1:
...
yy8:
//line "golang/002_fill_eof_rule_functions.--lang(go).re":112
	{
		fmt.Printf("number-1: %v\n", string(in.data[in.token:in.cursor]))
		return 1
	}
//line "golang/002_fill_eof_rule_functions.--lang(go).go":196
yy9:
	YYSKIP()
yyFillLabel2:
	yych = YYPEEK()
...
yy13:
//line "golang/002_fill_eof_rule_functions.--lang(go).re":117
	{
		fmt.Printf("number-2: %v\n", string(in.data[in.token:in.cursor]))
		return 2
	}
//line "golang/002_fill_eof_rule_functions.--lang(go).go":272
yyeof1:
//line "golang/002_fill_eof_rule_functions.--lang(go).re":107
	{
		fmt.Println("end")
		return 0
	}
//line "golang/002_fill_eof_rule_functions.--lang(go).go":279
}
//line "golang/002_fill_eof_rule_functions.--lang(go).re":125
