...
//line "golang/002_fill_eof_rule_functions.--lang(go).go":103
{
	var yych YYCTYPE
yyFillLabel0:
	yych = YYPEEK()
...
yy2:
	YYSKIP()
//line "golang/002_fill_eof_rule_functions.--lang(go).re":103
	{
		fmt.Println("error")
		return -1
	}
//line "golang/002_fill_eof_rule_functions.--lang(go).go":147
yy4:
	YYSKIP()
//line "golang/002_fill_eof_rule_functions.--lang(go).re":123
	{
		return 3
	}
//line "golang/002_fill_eof_rule_functions.--lang(go).go":154
yy6:
	YYSKIP()
	YYBACKUP()
yyFillLabel1:
...
yy8:
//line "golang/002_fill_eof_rule_functions.--lang(go).re":113
	{
		fmt.Printf("number-1: %v\n", string(in.data[in.token:in.cursor]))
		return 1
	}
//line "golang/002_fill_eof_rule_functions.--lang(go).go":197
yy9:
	YYSKIP()
yyFillLabel2:
	yych = YYPEEK()
...
yy13:
//line "golang/002_fill_eof_rule_functions.--lang(go).re":118
	{
		fmt.Printf("number-2: %v\n", string(in.data[in.token:in.cursor]))
		return 2
	}
//line "golang/002_fill_eof_rule_functions.--lang(go).go":273
yyeof1:
//line "golang/002_fill_eof_rule_functions.--lang(go).re":108
	{
		fmt.Println("end")
		return 0
	}
//line "golang/002_fill_eof_rule_functions.--lang(go).go":280
}
//line "golang/002_fill_eof_rule_functions.--lang(go).re":126
