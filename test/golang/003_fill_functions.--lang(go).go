...
//line "golang/003_fill_functions.--lang(go).go":109
{
	var yych YYCTYPE
	if (YYLESSTHAN(1)) {
...
yy2:
	YYSKIP()
//line "golang/003_fill_functions.--lang(go).re":114
	{
		fmt.Println("end")
		return 0
	}
//line "golang/003_fill_functions.--lang(go).go":151
yy4:
	YYSKIP()
//line "golang/003_fill_functions.--lang(go).re":109
	{
		fmt.Println("error")
		return -1
	}
//line "golang/003_fill_functions.--lang(go).go":159
yy6:
	YYSKIP()
//line "golang/003_fill_functions.--lang(go).re":129
	{
		return 3
	}
//line "golang/003_fill_functions.--lang(go).go":166
yy8:
	YYSKIP()
	YYBACKUP()
	if (YYLESSTHAN(2)) {
...
yy10:
//line "golang/003_fill_functions.--lang(go).re":119
	{
		fmt.Printf("number-1: %v\n", string(in.data[in.token:in.cursor]))
		return 1
	}
//line "golang/003_fill_functions.--lang(go).go":206
yy11:
	YYSKIP()
	yych = YYPEEK()
	switch (yych) {
...
yy15:
//line "golang/003_fill_functions.--lang(go).re":124
	{
		fmt.Printf("number-2: %v\n", string(in.data[in.token:in.cursor]))
		return 2
	}
//line "golang/003_fill_functions.--lang(go).go":273
}
//line "golang/003_fill_functions.--lang(go).re":132
