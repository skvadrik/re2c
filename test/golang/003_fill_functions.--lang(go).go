...
//line "golang/003_fill_functions.--lang(go).re":1
...
//line "golang/003_fill_functions.--lang(go).go":110
{
	var yych YYCTYPE
	if (YYLESSTHAN(1)) {
...
yy2:
	YYSKIP()
//line "golang/003_fill_functions.--lang(go).re":115
	{
		fmt.Println("end")
		return 0
	}
//line "golang/003_fill_functions.--lang(go).go":152
yy4:
	YYSKIP()
//line "golang/003_fill_functions.--lang(go).re":110
	{
		fmt.Println("error")
		return -1
	}
//line "golang/003_fill_functions.--lang(go).go":160
yy6:
	YYSKIP()
//line "golang/003_fill_functions.--lang(go).re":130
	{
		return 3
	}
//line "golang/003_fill_functions.--lang(go).go":167
yy8:
	YYSKIP()
	YYBACKUP()
	if (YYLESSTHAN(2)) {
...
yy10:
//line "golang/003_fill_functions.--lang(go).re":120
	{
		fmt.Printf("number-1: %v\n", string(in.data[in.token:in.cursor]))
		return 1
	}
//line "golang/003_fill_functions.--lang(go).go":207
yy11:
	YYSKIP()
	yych = YYPEEK()
	switch (yych) {
...
yy15:
//line "golang/003_fill_functions.--lang(go).re":125
	{
		fmt.Printf("number-2: %v\n", string(in.data[in.token:in.cursor]))
		return 2
	}
//line "golang/003_fill_functions.--lang(go).go":274
}
//line "golang/003_fill_functions.--lang(go).re":133
