...
//line "golang/002_fill_eof_rule.--lang(go).go":65
{
	var yych YYCTYPE
yyFillLabel0:
...
//line "golang/002_fill_eof_rule.--lang(go).go":109
yy4:
	in.cursor += 1
...
//line "golang/002_fill_eof_rule.--lang(go).go":116
yy6:
	in.cursor += 1
	in.marker = in.cursor
yyFillLabel1:
...
//line "golang/002_fill_eof_rule.--lang(go).go":159
yy9:
	in.cursor += 1
yyFillLabel2:
	yych = YYCTYPE(in.data[in.cursor])
...
//line "golang/002_fill_eof_rule.--lang(go).go":235
yyeof1:
