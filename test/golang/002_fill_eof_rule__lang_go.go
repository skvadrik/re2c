...
//line "golang/002_fill_eof_rule__lang_go.re":1
...
//line "golang/002_fill_eof_rule__lang_go.go":65
{
	var yych YYCTYPE
yyFillLabel0:
...
yy2:
	in.cursor += 1
//line "golang/002_fill_eof_rule__lang_go.re":70
	{
		fmt.Println("error")
		return -1
	}
//line "golang/002_fill_eof_rule__lang_go.go":109
yy4:
	in.cursor += 1
//line "golang/002_fill_eof_rule__lang_go.re":90
	{
		return 3
	}
//line "golang/002_fill_eof_rule__lang_go.go":116
yy6:
	in.cursor += 1
	in.marker = in.cursor
yyFillLabel1:
...
yy8:
//line "golang/002_fill_eof_rule__lang_go.re":80
	{
		fmt.Printf("number-1: %v\n", string(in.data[in.token:in.cursor]))
		return 1
	}
//line "golang/002_fill_eof_rule__lang_go.go":159
yy9:
	in.cursor += 1
yyFillLabel2:
	yych = YYCTYPE(in.data[in.cursor])
...
yy13:
//line "golang/002_fill_eof_rule__lang_go.re":85
	{
...
//line "golang/002_fill_eof_rule__lang_go.go":242
}
//line "golang/002_fill_eof_rule__lang_go.re":93
