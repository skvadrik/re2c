...
yy3:
	in.cursor += 1
//line "golang/003_fill.re":94
	{
		fmt.Println("end")
		return lexEnd, 0
	}
//line "golang/003_fill.go":140
yy5:
	in.cursor += 1
//line "golang/003_fill.re":89
	{
		fmt.Println("error")
		return lexError, 0
	}
//line "golang/003_fill.go":148
yy7:
	in.cursor += 1
	in.state = 1
	if (in.limit-in.cursor < 1) {
...
yy9:
//line "golang/003_fill.re":109
	{
		return lexSpace, 0
	}
//line "golang/003_fill.go":168
yy10:
	in.cursor += 1
	in.marker = in.cursor
	in.state = 2
...
yy17:
//line "golang/003_fill.re":104
	{
		fmt.Printf("number-2: %v\n", string(in.data[in.token:in.cursor]))
		return lexNumber2, 0
	}
//line "golang/003_fill.go":279
//line "golang/003_fill.re":112
