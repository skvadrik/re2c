...
//line "golang/003_fill.--lang(go).go":71
{
	var yych YYCTYPE
...
yy2:
	in.cursor += 1
//line "golang/003_fill.--lang(go).re":79
	{
		fmt.Println("end")
		return 0
	}
//line "golang/003_fill.--lang(go).go":113
yy4:
	in.cursor += 1
//line "golang/003_fill.--lang(go).re":74
	{
		fmt.Println("error")
		return -1
	}
//line "golang/003_fill.--lang(go).go":121
yy6:
	in.cursor += 1
//line "golang/003_fill.--lang(go).re":94
	{
		return 3
	}
//line "golang/003_fill.--lang(go).go":128
yy8:
	in.cursor += 1
	in.marker = in.cursor
...
yy10:
//line "golang/003_fill.--lang(go).re":84
	{
...
yy15:
//line "golang/003_fill.--lang(go).re":89
	{
		fmt.Printf("number-2: %v\n", string(in.data[in.token:in.cursor]))
		return 2
	}
//line "golang/003_fill.--lang(go).go":235
}
//line "golang/003_fill.--lang(go).re":97
