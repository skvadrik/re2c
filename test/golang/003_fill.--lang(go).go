/* Generated by re2c */
//line "golang/003_fill.--lang(go).re":1
//line "golang/003_fill.--lang(go).re":3
...
//line "golang/003_fill.--lang(go).go":118
{
	var yych YYCTYPE
	if (YYLESSTHAN (1)) {
...
yy2:
	YYSKIP ()
//line "golang/003_fill.--lang(go).re":123
	{
		fmt.Println("end")
		return 0
	}
//line "golang/003_fill.--lang(go).go":160
yy4:
	YYSKIP ()
//line "golang/003_fill.--lang(go).re":118
	{
		fmt.Println("error")
		return -1
	}
//line "golang/003_fill.--lang(go).go":168
yy6:
	YYSKIP ()
//line "golang/003_fill.--lang(go).re":138
	{
		return 3
	}
//line "golang/003_fill.--lang(go).go":175
yy8:
	YYSKIP ()
	YYBACKUP ()
	if (YYLESSTHAN (2)) {
...
yy10:
//line "golang/003_fill.--lang(go).re":128
	{
		fmt.Printf("number-1: %v\n", string(in.data[in.token:in.cursor]))
		return 1
	}
//line "golang/003_fill.--lang(go).go":215
yy11:
	YYSKIP ()
	yych = YYPEEK ()
	switch (yych) {
...
yy15:
//line "golang/003_fill.--lang(go).re":133
	{
		fmt.Printf("number-2: %v\n", string(in.data[in.token:in.cursor]))
		return 2
	}
//line "golang/003_fill.--lang(go).go":282
}
//line "golang/003_fill.--lang(go).re":141
