...
//line "golang/005_posix_captures.go":27
{
	var yych byte
	yych = str[cursor]
	switch (yych) {
...
//line "golang/005_posix_captures.go":83
yy4:
	cursor += 1
yy5:
...
//line "golang/005_posix_captures.go":91
yy6:
	cursor += 1
	marker = cursor
	yych = str[cursor]
...
//line "golang/005_posix_captures.go":163
yy11:
	cursor += 1
	yych = str[cursor]
	switch (yych) {
...
//line "golang/005_posix_captures.go":304
yy27:
	cursor += 1
	yych = str[cursor]
	switch (yych) {
