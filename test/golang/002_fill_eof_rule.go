...
//line "golang/002_fill_eof_rule.go":73
...
//line "golang/002_fill_eof_rule.go":144
yy5:
	in.cursor += 1
yyFillLabel1:
	yych = YYCTYPE(in.data[in.cursor])
...
yy7:
//line "golang/002_fill_eof_rule.re":100
	{
		return lexSpace
	}
//line "golang/002_fill_eof_rule.go":164
yy8:
	in.cursor += 1
	in.marker = in.cursor
yyFillLabel2:
...
//line "golang/002_fill_eof_rule.go":206
yy11:
	in.cursor += 1
yyFillLabel3:
	yych = YYCTYPE(in.data[in.cursor])
...
yy15:
//line "golang/002_fill_eof_rule.re":95
	{
...
//line "golang/002_fill_eof_rule.go":287
//line "golang/002_fill_eof_rule.re":103
