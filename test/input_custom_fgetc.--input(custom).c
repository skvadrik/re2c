...
#line 28 "input_custom_fgetc.--input(custom).c"
{
	YYCTYPE yych;
...
#line 26 "input_custom_fgetc.--input(custom).re"
	{ return false; }
#line 42 "input_custom_fgetc.--input(custom).c"
yy4:
	YYSKIP();
	YYBACKUP();
	yych = YYPEEK();
...
#line 25 "input_custom_fgetc.--input(custom).re"
	{ return true; }
#line 165 "input_custom_fgetc.--input(custom).c"
}
#line 27 "input_custom_fgetc.--input(custom).re"
