...
#line 14 "encodings/unicode_group_Lt.8--encoding-policy(fail).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	switch (yych) {
...
#line 28 "encodings/unicode_group_Lt.8--encoding-policy(fail).c"
yy4:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0x85:
...
#line 13 "encodings/unicode_group_Lt.8--encoding-policy(fail).re"
	{ goto Lt; }
#line 49 "encodings/unicode_group_Lt.8--encoding-policy(fail).c"
yy8:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0x88:
...
#line 15 "encodings/unicode_group_Lt.8--encoding-policy(fail).re"
