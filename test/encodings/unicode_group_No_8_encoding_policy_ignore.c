...
#line 15 "encodings/unicode_group_No_8_encoding_policy_ignore.c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	switch (yych) {
...
#line 34 "encodings/unicode_group_No_8_encoding_policy_ignore.c"
yy3:
	yych = *++YYCURSOR;
	switch (yych) {
		case 0xB2:
...
#line 14 "encodings/unicode_group_No_8_encoding_policy_ignore.re"
	{ goto No; }
#line 110 "encodings/unicode_group_No_8_encoding_policy_ignore.c"
yy11:
	yych = *++YYCURSOR;
	switch (yych) {
		case 0xB4:
...
#line 16 "encodings/unicode_group_No_8_encoding_policy_ignore.re"
