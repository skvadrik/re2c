...
#line 14 "encodings/unicode_group_Pd.x--encoding-policy(substitute).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x2E39) {
...
#line 70 "encodings/unicode_group_Pd.x--encoding-policy(substitute).c"
yy4:
	++YYCURSOR;
#line 13 "encodings/unicode_group_Pd.x--encoding-policy(substitute).re"
	{ goto Pd; }
#line 75 "encodings/unicode_group_Pd.x--encoding-policy(substitute).c"
}
#line 15 "encodings/unicode_group_Pd.x--encoding-policy(substitute).re"
