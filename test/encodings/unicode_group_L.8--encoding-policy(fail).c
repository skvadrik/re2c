...
#line 13 "encodings/unicode_group_L.8--encoding-policy(fail).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	switch (yych) {
...
#line 122 "encodings/unicode_group_L.8--encoding-policy(fail).c"
yy4:
	++YYCURSOR;
#line 12 "encodings/unicode_group_L.8--encoding-policy(fail).re"
	{ goto L; }
#line 127 "encodings/unicode_group_L.8--encoding-policy(fail).c"
yy6:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0xAA:
