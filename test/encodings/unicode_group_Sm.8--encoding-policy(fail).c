...
#line 13 "encodings/unicode_group_Sm.8--encoding-policy(fail).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	switch (yych) {
...
#line 38 "encodings/unicode_group_Sm.8--encoding-policy(fail).c"
yy4:
	++YYCURSOR;
#line 12 "encodings/unicode_group_Sm.8--encoding-policy(fail).re"
	{ goto Sm; }
#line 43 "encodings/unicode_group_Sm.8--encoding-policy(fail).c"
yy6:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0xAC:
