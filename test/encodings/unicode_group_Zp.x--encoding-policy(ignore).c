/* Generated by re2c */
#line 1 "encodings/unicode_group_Zp.x--encoding-policy(ignore).re"
...
#line 14 "encodings/unicode_group_Zp.x--encoding-policy(ignore).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych == 0x2029) goto yy4;
	++YYCURSOR;
#line 14 "encodings/unicode_group_Zp.x--encoding-policy(ignore).re"
	{ return YYCURSOR == limit; }
#line 22 "encodings/unicode_group_Zp.x--encoding-policy(ignore).c"
yy4:
	++YYCURSOR;
#line 13 "encodings/unicode_group_Zp.x--encoding-policy(ignore).re"
	{ goto Zp; }
#line 27 "encodings/unicode_group_Zp.x--encoding-policy(ignore).c"
}
#line 15 "encodings/unicode_group_Zp.x--encoding-policy(ignore).re"
