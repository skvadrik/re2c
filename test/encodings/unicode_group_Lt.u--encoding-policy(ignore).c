...
#line 13 "encodings/unicode_group_Lt.u--encoding-policy(ignore).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x00001F8F) {
...
#line 53 "encodings/unicode_group_Lt.u--encoding-policy(ignore).c"
yy4:
	++YYCURSOR;
#line 12 "encodings/unicode_group_Lt.u--encoding-policy(ignore).re"
	{ goto Lt; }
#line 58 "encodings/unicode_group_Lt.u--encoding-policy(ignore).c"
}
