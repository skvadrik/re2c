...
#line 14 "encodings/unicode_group_Z.x--encoding-policy(fail).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x200A) {
...
#line 43 "encodings/unicode_group_Z.x--encoding-policy(fail).c"
yy4:
	++YYCURSOR;
#line 13 "encodings/unicode_group_Z.x--encoding-policy(fail).re"
	{ goto Z; }
#line 48 "encodings/unicode_group_Z.x--encoding-policy(fail).c"
}
#line 15 "encodings/unicode_group_Z.x--encoding-policy(fail).re"
