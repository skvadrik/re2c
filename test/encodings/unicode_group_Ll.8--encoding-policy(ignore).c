...
#line 13 "encodings/unicode_group_Ll.8--encoding-policy(ignore).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	switch (yych) {
...
#line 75 "encodings/unicode_group_Ll.8--encoding-policy(ignore).c"
yy4:
	++YYCURSOR;
#line 12 "encodings/unicode_group_Ll.8--encoding-policy(ignore).re"
	{ goto Ll; }
#line 80 "encodings/unicode_group_Ll.8--encoding-policy(ignore).c"
yy6:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0xB5:	goto yy4;
