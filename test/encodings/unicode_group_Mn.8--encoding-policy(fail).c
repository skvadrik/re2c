/* Generated by re2c */
#line 1 "encodings/unicode_group_Mn.8--encoding-policy(fail).re"
...
#line 14 "encodings/unicode_group_Mn.8--encoding-policy(fail).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	switch (yych) {
...
yy2:
	++YYCURSOR;
yy3:
#line 14 "encodings/unicode_group_Mn.8--encoding-policy(fail).re"
	{ return YYCURSOR == limit; }
#line 46 "encodings/unicode_group_Mn.8--encoding-policy(fail).c"
yy4:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0x80:
...
yy24:
	++YYCURSOR;
#line 13 "encodings/unicode_group_Mn.8--encoding-policy(fail).re"
	{ goto Mn; }
#line 499 "encodings/unicode_group_Mn.8--encoding-policy(fail).c"
yy26:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0x96:
...
#line 15 "encodings/unicode_group_Mn.8--encoding-policy(fail).re"
