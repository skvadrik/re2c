...
#line 15 "encodings/unicode_group_Sm_x_encoding_policy_substitute.c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x231F) {
...
#line 184 "encodings/unicode_group_Sm_x_encoding_policy_substitute.c"
yy3:
	++YYCURSOR;
#line 14 "encodings/unicode_group_Sm_x_encoding_policy_substitute.re"
	{ goto Sm; }
#line 189 "encodings/unicode_group_Sm_x_encoding_policy_substitute.c"
yy4:
	yych = *++YYCURSOR;
	if (yych <= 0xDF35) {
		if (yych <= 0xDEFA) {
...
#line 16 "encodings/unicode_group_Sm_x_encoding_policy_substitute.re"
