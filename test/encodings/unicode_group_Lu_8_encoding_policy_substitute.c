...
#line 14 "encodings/unicode_group_Lu_8_encoding_policy_substitute.c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	switch (yych) {
...
#line 73 "encodings/unicode_group_Lu_8_encoding_policy_substitute.c"
yy3:
	++YYCURSOR;
#line 13 "encodings/unicode_group_Lu_8_encoding_policy_substitute.re"
	{ goto Lu; }
#line 78 "encodings/unicode_group_Lu_8_encoding_policy_substitute.c"
yy4:
	yych = *++YYCURSOR;
	switch (yych) {
		case 0x80:
...
int main ()
{
	unsigned int * buffer_Lu = new unsigned int [7156];
