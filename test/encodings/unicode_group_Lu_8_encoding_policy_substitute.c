/* Generated by re2c */
#line 1 "encodings/unicode_group_Lu_8_encoding_policy_substitute.re"
...
#line 15 "encodings/unicode_group_Lu_8_encoding_policy_substitute.c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	switch (yych) {
...
yy1:
	++YYCURSOR;
yy2:
#line 15 "encodings/unicode_group_Lu_8_encoding_policy_substitute.re"
	{ return YYCURSOR - 1 == limit; }
#line 74 "encodings/unicode_group_Lu_8_encoding_policy_substitute.c"
yy3:
	++YYCURSOR;
#line 14 "encodings/unicode_group_Lu_8_encoding_policy_substitute.re"
	{ goto Lu; }
#line 79 "encodings/unicode_group_Lu_8_encoding_policy_substitute.c"
yy4:
	yych = *++YYCURSOR;
	switch (yych) {
		case 0x80:
...
#line 16 "encodings/unicode_group_Lu_8_encoding_policy_substitute.re"
...
int main() {
	YYCTYPE* buffer_Lu = new YYCTYPE[10992];
	uint32_t buffer_Lu_len = encode_utf8(chars_Lu, sizeof(chars_Lu) / sizeof(uint32_t), buffer_Lu);
