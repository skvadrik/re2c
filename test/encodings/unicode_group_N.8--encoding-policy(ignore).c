...
#line 13 "encodings/unicode_group_N.8--encoding-policy(ignore).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	switch (yych) {
...
#line 46 "encodings/unicode_group_N.8--encoding-policy(ignore).c"
yy4:
	++YYCURSOR;
#line 12 "encodings/unicode_group_N.8--encoding-policy(ignore).re"
	{ goto N; }
#line 51 "encodings/unicode_group_N.8--encoding-policy(ignore).c"
yy6:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0xB2:
