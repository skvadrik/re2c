...
#line 14 "encodings/unicode_group_Pi_8_encoding_policy_substitute.c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	switch (yych) {
...
#line 28 "encodings/unicode_group_Pi_8_encoding_policy_substitute.c"
yy4:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0xAB:	goto yy6;
...
yy6:
	++YYCURSOR;
#line 13 "encodings/unicode_group_Pi_8_encoding_policy_substitute.re"
	{ goto Pi; }
#line 46 "encodings/unicode_group_Pi_8_encoding_policy_substitute.c"
yy8:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0x98:
