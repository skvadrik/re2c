...
#line 13 "encodings/unicode_group_Pd.x--encoding-policy(fail).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x2E39) {
...
#line 69 "encodings/unicode_group_Pd.x--encoding-policy(fail).c"
yy4:
	++YYCURSOR;
#line 12 "encodings/unicode_group_Pd.x--encoding-policy(fail).re"
	{ goto Pd; }
#line 74 "encodings/unicode_group_Pd.x--encoding-policy(fail).c"
}
