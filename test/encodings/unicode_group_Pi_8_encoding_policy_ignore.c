...
#line 15 "encodings/unicode_group_Pi_8_encoding_policy_ignore.c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	switch (yych) {
...
#line 29 "encodings/unicode_group_Pi_8_encoding_policy_ignore.c"
yy3:
	yych = *++YYCURSOR;
	switch (yych) {
		case 0xAB: goto yy5;
...
#line 14 "encodings/unicode_group_Pi_8_encoding_policy_ignore.re"
	{ goto Pi; }
#line 47 "encodings/unicode_group_Pi_8_encoding_policy_ignore.c"
yy6:
	yych = *++YYCURSOR;
	switch (yych) {
		case 0x98:
...
#line 16 "encodings/unicode_group_Pi_8_encoding_policy_ignore.re"
