...
#line 14 "encodings/unicode_group_So.x--encoding-policy(fail).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x2321) {
...
#line 364 "encodings/unicode_group_So.x--encoding-policy(fail).c"
yy4:
	++YYCURSOR;
#line 13 "encodings/unicode_group_So.x--encoding-policy(fail).re"
	{ goto So; }
#line 369 "encodings/unicode_group_So.x--encoding-policy(fail).c"
yy6:
	yych = *++YYCURSOR;
	if (yych <= 0xDD8C) {
		if (yych <= 0xDD78) {
...
#line 15 "encodings/unicode_group_So.x--encoding-policy(fail).re"
