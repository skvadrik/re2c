/* Generated by re2c */
#line 1 "encodings/unicode_group_Ll_8.re"
...
#line 15 "encodings/unicode_group_Ll_8.c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	switch (yych) {
...
yy1:
	++YYCURSOR;
yy2:
#line 15 "encodings/unicode_group_Ll_8.re"
	{ return YYCURSOR - 1 == limit; }
#line 77 "encodings/unicode_group_Ll_8.c"
yy3:
	++YYCURSOR;
#line 14 "encodings/unicode_group_Ll_8.re"
	{ goto Ll; }
#line 82 "encodings/unicode_group_Ll_8.c"
yy4:
	yych = *++YYCURSOR;
	switch (yych) {
		case 0xB5: goto yy3;
...
#line 16 "encodings/unicode_group_Ll_8.re"
...
int main() {
	YYCTYPE* buffer_Ll = new YYCTYPE[13704];
	uint32_t buffer_Ll_len = encode_utf8(chars_Ll, sizeof(chars_Ll) / sizeof(uint32_t), buffer_Ll);
