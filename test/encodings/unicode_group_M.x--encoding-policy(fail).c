/* Generated by re2c */
#line 1 "encodings/unicode_group_M.x--encoding-policy(fail).re"
#include <stdio.h>
#include "utf16.h"
...
#line 13 "encodings/unicode_group_M.x--encoding-policy(fail).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x0F36) {
...
yy2:
	++YYCURSOR;
yy3:
#line 13 "encodings/unicode_group_M.x--encoding-policy(fail).re"
	{ return YYCURSOR == limit; }
#line 639 "encodings/unicode_group_M.x--encoding-policy(fail).c"
yy4:
	++YYCURSOR;
#line 12 "encodings/unicode_group_M.x--encoding-policy(fail).re"
	{ goto M; }
#line 644 "encodings/unicode_group_M.x--encoding-policy(fail).c"
yy6:
	yych = *++YYCURSOR;
	if (yych <= 0xDEDF) {
...
#line 14 "encodings/unicode_group_M.x--encoding-policy(fail).re"
