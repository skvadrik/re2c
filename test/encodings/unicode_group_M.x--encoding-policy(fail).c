...
#line 14 "encodings/unicode_group_M.x--encoding-policy(fail).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x0F36) {
...
#line 640 "encodings/unicode_group_M.x--encoding-policy(fail).c"
yy4:
	++YYCURSOR;
#line 13 "encodings/unicode_group_M.x--encoding-policy(fail).re"
	{ goto M; }
#line 645 "encodings/unicode_group_M.x--encoding-policy(fail).c"
yy6:
	yych = *++YYCURSOR;
	if (yych <= 0xDEDF) {
...
#line 15 "encodings/unicode_group_M.x--encoding-policy(fail).re"
