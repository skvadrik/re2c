/* Generated by re2c */
#line 1 "encodings/unicode_group_Sm_x_encoding_policy_fail.re"
...
#line 15 "encodings/unicode_group_Sm_x_encoding_policy_fail.c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x231F) {
...
yy1:
	++YYCURSOR;
yy2:
#line 15 "encodings/unicode_group_Sm_x_encoding_policy_fail.re"
	{ return YYCURSOR - 1 == limit; }
#line 184 "encodings/unicode_group_Sm_x_encoding_policy_fail.c"
yy3:
	++YYCURSOR;
#line 14 "encodings/unicode_group_Sm_x_encoding_policy_fail.re"
	{ goto Sm; }
#line 189 "encodings/unicode_group_Sm_x_encoding_policy_fail.c"
yy4:
	yych = *++YYCURSOR;
	if (yych <= 0xDF35) {
		if (yych <= 0xDEFA) {
...
#line 16 "encodings/unicode_group_Sm_x_encoding_policy_fail.re"
