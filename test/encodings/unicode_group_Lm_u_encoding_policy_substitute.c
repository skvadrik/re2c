/* Generated by re2c */
#line 1 "encodings/unicode_group_Lm_u_encoding_policy_substitute.re"
...
#line 14 "encodings/unicode_group_Lm_u_encoding_policy_substitute.c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x0000303A) {
			...
			if (yych <= 0x00001D9A) {
				if (yych <= 0x00001843) {
					...
					if (yych <= 0x00001C7D) {
						...
						if (yych >= 0x00001C78) goto yy2;
					} else {
						if (yych <= 0x00001D6A) {
							if (yych >= 0x00001D2C) goto yy2;
						} else {
		...
		if (yych <= 0x0000AB5B) {
			if (yych <= 0x0000A76F) {
				if (yych <= 0x0000A4FD) {
					if (yych <= 0x000030FB) {
						...
						if (yych <= 0x0000309C) goto yy1;
						if (yych <= 0x0000309E) goto yy2;
					} else {
						if (yych <= 0x0000A014) {
							if (yych <= 0x000030FE) goto yy2;
						} else {
							if (yych <= 0x0000A015) goto yy2;
							if (yych >= 0x0000A4F8) goto yy2;
						}
					}
				} else {
					if (yych <= 0x0000A67F) {
			...
			if (yych <= 0x00016FDF) {
				...
				if (yych <= 0x0001AFFE) {
					if (yych <= 0x0001AFEF) {
						if (yych == 0x00016FE2) goto yy1;
						if (yych <= 0x00016FE3) goto yy2;
					} else {
						if (yych <= 0x0001AFF4) {
							if (yych <= 0x0001AFF3) goto yy2;
						} else {
...
yy1:
	++YYCURSOR;
#line 14 "encodings/unicode_group_Lm_u_encoding_policy_substitute.re"
	{ return YYCURSOR - 1 == limit; }
#line 239 "encodings/unicode_group_Lm_u_encoding_policy_substitute.c"
yy2:
	++YYCURSOR;
#line 13 "encodings/unicode_group_Lm_u_encoding_policy_substitute.re"
	{ goto Lm; }
#line 244 "encodings/unicode_group_Lm_u_encoding_policy_substitute.c"
}
#line 15 "encodings/unicode_group_Lm_u_encoding_policy_substitute.re"
...
int main() {
	YYCTYPE* buffer_Lm = new YYCTYPE[398];
