...
#line 14 "encodings/unicode_group_Nd_8_encoding_policy_ignore.c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	switch (yych) {
...
#line 44 "encodings/unicode_group_Nd_8_encoding_policy_ignore.c"
yy3:
	++YYCURSOR;
#line 13 "encodings/unicode_group_Nd_8_encoding_policy_ignore.re"
	{ goto Nd; }
#line 49 "encodings/unicode_group_Nd_8_encoding_policy_ignore.c"
yy4:
	yych = *++YYCURSOR;
	switch (yych) {
		case 0xA0:
