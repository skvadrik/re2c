...
#line 14 "encodings/unicode_group_Pi_x_encoding_policy_substitute.c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x2E01) {
...
#line 52 "encodings/unicode_group_Pi_x_encoding_policy_substitute.c"
yy4:
	++YYCURSOR;
#line 13 "encodings/unicode_group_Pi_x_encoding_policy_substitute.re"
	{ goto Pi; }
#line 57 "encodings/unicode_group_Pi_x_encoding_policy_substitute.c"
}
