...
#line 14 "encodings/unicode_group_Cf.8--encoding-policy(substitute).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	switch (yych) {
...
#line 35 "encodings/unicode_group_Cf.8--encoding-policy(substitute).c"
yy4:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0xAD:	goto yy13;
...
#line 13 "encodings/unicode_group_Cf.8--encoding-policy(substitute).re"
	{ goto Cf; }
#line 104 "encodings/unicode_group_Cf.8--encoding-policy(substitute).c"
yy15:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0x8E:	goto yy13;
...
#line 15 "encodings/unicode_group_Cf.8--encoding-policy(substitute).re"
