...
#line 13 "encodings/unicode_group_M_8_encoding_policy_substitute.re"
	{ goto M; }
#line 504 "encodings/unicode_group_M_8_encoding_policy_substitute.c"
yy24:
	yych = *++YYCURSOR;
	switch (yych) {
		case 0x96:
...
yy95:
	yych = *++YYCURSOR;
	switch (yych) {
		case 0x87: goto yy102;
		case 0x8B: goto yy103;
		case 0x8D: goto yy104;
		case 0xA8: goto yy105;
		case 0xAB: goto yy106;
		case 0xB4: goto yy107;
...
int main ()
{
	unsigned int * buffer_M = new unsigned int [9076];
