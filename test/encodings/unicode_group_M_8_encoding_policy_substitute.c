...
#line 14 "encodings/unicode_group_M_8_encoding_policy_substitute.c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	switch (yych) {
...
#line 46 "encodings/unicode_group_M_8_encoding_policy_substitute.c"
yy3:
	yych = *++YYCURSOR;
	switch (yych) {
		case 0x80:
...
yy23:
	++YYCURSOR;
#line 13 "encodings/unicode_group_M_8_encoding_policy_substitute.re"
	{ goto M; }
#line 508 "encodings/unicode_group_M_8_encoding_policy_substitute.c"
yy24:
	yych = *++YYCURSOR;
	switch (yych) {
		case 0x96:
...
int main ()
{
	unsigned int * buffer_M = new unsigned int [9804];
