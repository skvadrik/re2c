...
#line 14 "encodings/unicode_group_Lt.x--encoding-policy(substitute).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x1F8F) {
...
#line 54 "encodings/unicode_group_Lt.x--encoding-policy(substitute).c"
yy4:
	++YYCURSOR;
#line 13 "encodings/unicode_group_Lt.x--encoding-policy(substitute).re"
	{ goto Lt; }
#line 59 "encodings/unicode_group_Lt.x--encoding-policy(substitute).c"
}
#line 15 "encodings/unicode_group_Lt.x--encoding-policy(substitute).re"
