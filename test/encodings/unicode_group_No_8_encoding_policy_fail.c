...
#line 14 "encodings/unicode_group_No_8_encoding_policy_fail.c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	switch (yych) {
...
#line 33 "encodings/unicode_group_No_8_encoding_policy_fail.c"
yy3:
	yych = *++YYCURSOR;
	switch (yych) {
		case 0xB2:
...
yy10:
	++YYCURSOR;
#line 13 "encodings/unicode_group_No_8_encoding_policy_fail.re"
	{ goto No; }
#line 109 "encodings/unicode_group_No_8_encoding_policy_fail.c"
yy11:
	yych = *++YYCURSOR;
	switch (yych) {
		case 0xB4:
