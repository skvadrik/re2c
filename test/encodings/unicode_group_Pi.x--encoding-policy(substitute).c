...
#line 13 "encodings/unicode_group_Pi.x--encoding-policy(substitute).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x2E01) {
...
#line 51 "encodings/unicode_group_Pi.x--encoding-policy(substitute).c"
yy4:
	++YYCURSOR;
#line 12 "encodings/unicode_group_Pi.x--encoding-policy(substitute).re"
	{ goto Pi; }
#line 56 "encodings/unicode_group_Pi.x--encoding-policy(substitute).c"
}
