/* Generated by re2c */
#line 1 "encodings/unicode_group_Pi.x--encoding-policy(substitute).re"
...
#line 14 "encodings/unicode_group_Pi.x--encoding-policy(substitute).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x2E01) {
	...
	++YYCURSOR;
#line 14 "encodings/unicode_group_Pi.x--encoding-policy(substitute).re"
	{ return YYCURSOR == limit; }
#line 52 "encodings/unicode_group_Pi.x--encoding-policy(substitute).c"
yy4:
	++YYCURSOR;
#line 13 "encodings/unicode_group_Pi.x--encoding-policy(substitute).re"
	{ goto Pi; }
#line 57 "encodings/unicode_group_Pi.x--encoding-policy(substitute).c"
}
#line 15 "encodings/unicode_group_Pi.x--encoding-policy(substitute).re"
