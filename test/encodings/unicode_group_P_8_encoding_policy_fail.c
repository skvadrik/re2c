...
#line 14 "encodings/unicode_group_P_8_encoding_policy_fail.c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	switch (yych) {
...
#line 67 "encodings/unicode_group_P_8_encoding_policy_fail.c"
yy3:
	++YYCURSOR;
#line 13 "encodings/unicode_group_P_8_encoding_policy_fail.re"
	{ goto P; }
#line 72 "encodings/unicode_group_P_8_encoding_policy_fail.c"
yy4:
	yych = *++YYCURSOR;
	switch (yych) {
		case 0xA1:
