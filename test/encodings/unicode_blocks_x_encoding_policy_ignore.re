...
int main()
{
	...
	unsigned int * buffer_Latin_1_Supplement = new unsigned int [258];
	YYCTYPE * s_Latin_1_Supplement = (YYCTYPE *) buffer_Latin_1_Supplement;
	unsigned int buffer_Latin_1_Supplement_len = encode_utf16 (chars_Latin_1_Supplement, sizeof (chars_Latin_1_Supplement) / sizeof (unsigned int), buffer_Latin_1_Supplement);
	/* convert 32-bit code units to YYCTYPE; reuse the same buffer */
