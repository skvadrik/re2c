/* Generated by re2c */
#line 1 "encodings/unicode_group_Cf.x--encoding-policy(ignore).re"
#include <stdio.h>
#include "utf16.h"
...
#line 13 "encodings/unicode_group_Cf.x--encoding-policy(ignore).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x202E) {
...
yy2:
	++YYCURSOR;
yy3:
#line 13 "encodings/unicode_group_Cf.x--encoding-policy(ignore).re"
	{ return YYCURSOR == limit; }
#line 64 "encodings/unicode_group_Cf.x--encoding-policy(ignore).c"
yy4:
	++YYCURSOR;
#line 12 "encodings/unicode_group_Cf.x--encoding-policy(ignore).re"
	{ goto Cf; }
#line 69 "encodings/unicode_group_Cf.x--encoding-policy(ignore).c"
yy6:
	yych = *++YYCURSOR;
...
#line 14 "encodings/unicode_group_Cf.x--encoding-policy(ignore).re"
