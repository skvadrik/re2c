...
#line 15 "encodings/unicode_group_Mc_8_encoding_policy_substitute.c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	switch (yych) {
...
#line 32 "encodings/unicode_group_Mc_8_encoding_policy_substitute.c"
yy3:
...
#line 14 "encodings/unicode_group_Mc_8_encoding_policy_substitute.re"
	{ goto Mc; }
#line 617 "encodings/unicode_group_Mc_8_encoding_policy_substitute.c"
yy55:
	yych = *++YYCURSOR;
	switch (yych) {
		case 0x80:
...
#line 16 "encodings/unicode_group_Mc_8_encoding_policy_substitute.re"
...
int main() {
	YYCTYPE* buffer_Mc = new YYCTYPE[2718];
	uint32_t buffer_Mc_len = encode_utf8(chars_Mc, sizeof(chars_Mc) / sizeof(uint32_t), buffer_Mc);
