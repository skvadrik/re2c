...
#line 14 "encodings/unicode_group_Cc.8--encoding-policy(fail).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	switch (yych) {
...
#line 13 "encodings/unicode_group_Cc.8--encoding-policy(fail).re"
	{ goto Cc; }
#line 59 "encodings/unicode_group_Cc.8--encoding-policy(fail).c"
yy4:
	++YYCURSOR;
yy5:
#line 14 "encodings/unicode_group_Cc.8--encoding-policy(fail).re"
	{ return YYCURSOR == limit; }
#line 65 "encodings/unicode_group_Cc.8--encoding-policy(fail).c"
yy6:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0x80:
...
#line 15 "encodings/unicode_group_Cc.8--encoding-policy(fail).re"
