...
#line 14 "encodings/unicode_group_Cc.x--encoding-policy(ignore).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
...
#line 13 "encodings/unicode_group_Cc.x--encoding-policy(ignore).re"
	{ goto Cc; }
#line 25 "encodings/unicode_group_Cc.x--encoding-policy(ignore).c"
yy4:
	++YYCURSOR;
#line 14 "encodings/unicode_group_Cc.x--encoding-policy(ignore).re"
	{ return YYCURSOR == limit; }
#line 30 "encodings/unicode_group_Cc.x--encoding-policy(ignore).c"
}
#line 15 "encodings/unicode_group_Cc.x--encoding-policy(ignore).re"
