/* Generated by re2c */
#line 1 "encodings/unicode_group_Me.u--encoding-policy(ignore).re"
...
#line 14 "encodings/unicode_group_Me.u--encoding-policy(ignore).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x000020DC) {
...
yy2:
	++YYCURSOR;
#line 14 "encodings/unicode_group_Me.u--encoding-policy(ignore).re"
	{ return YYCURSOR == limit; }
#line 36 "encodings/unicode_group_Me.u--encoding-policy(ignore).c"
yy4:
	++YYCURSOR;
#line 13 "encodings/unicode_group_Me.u--encoding-policy(ignore).re"
	{ goto Me; }
#line 41 "encodings/unicode_group_Me.u--encoding-policy(ignore).c"
}
#line 15 "encodings/unicode_group_Me.u--encoding-policy(ignore).re"
