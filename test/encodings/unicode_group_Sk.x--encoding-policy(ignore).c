/* Generated by re2c */
#line 1 "encodings/unicode_group_Sk.x--encoding-policy(ignore).re"
...
#line 14 "encodings/unicode_group_Sk.x--encoding-policy(ignore).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x1FBD) {
...
yy2:
	++YYCURSOR;
#line 14 "encodings/unicode_group_Sk.x--encoding-policy(ignore).re"
	{ return YYCURSOR == limit; }
#line 101 "encodings/unicode_group_Sk.x--encoding-policy(ignore).c"
yy4:
	++YYCURSOR;
#line 13 "encodings/unicode_group_Sk.x--encoding-policy(ignore).re"
	{ goto Sk; }
#line 106 "encodings/unicode_group_Sk.x--encoding-policy(ignore).c"
}
#line 15 "encodings/unicode_group_Sk.x--encoding-policy(ignore).re"
