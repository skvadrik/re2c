...
#line 15 "encodings/unicode_group_P_x_encoding_policy_ignore.c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x1CD3) {
...
#line 487 "encodings/unicode_group_P_x_encoding_policy_ignore.c"
yy3:
	++YYCURSOR;
#line 14 "encodings/unicode_group_P_x_encoding_policy_ignore.re"
	{ goto P; }
#line 492 "encodings/unicode_group_P_x_encoding_policy_ignore.c"
yy4:
	yych = *++YYCURSOR;
	if (yych <= 0xDF9E) {
...
#line 16 "encodings/unicode_group_P_x_encoding_policy_ignore.re"
...
int main() {
	YYCTYPE* buffer_P = new YYCTYPE[1686];
