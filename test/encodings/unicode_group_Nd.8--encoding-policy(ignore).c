...
#line 14 "encodings/unicode_group_Nd.8--encoding-policy(ignore).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	switch (yych) {
...
#line 44 "encodings/unicode_group_Nd.8--encoding-policy(ignore).c"
yy4:
	++YYCURSOR;
#line 13 "encodings/unicode_group_Nd.8--encoding-policy(ignore).re"
	{ goto Nd; }
#line 49 "encodings/unicode_group_Nd.8--encoding-policy(ignore).c"
yy6:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0xA0:
...
#line 15 "encodings/unicode_group_Nd.8--encoding-policy(ignore).re"
