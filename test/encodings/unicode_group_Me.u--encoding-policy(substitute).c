/* Generated by re2c */
#line 1 "encodings/unicode_group_Me.u--encoding-policy(substitute).re"
...
#line 14 "encodings/unicode_group_Me.u--encoding-policy(substitute).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x000020DC) {
...
#line 36 "encodings/unicode_group_Me.u--encoding-policy(substitute).c"
yy4:
	++YYCURSOR;
#line 13 "encodings/unicode_group_Me.u--encoding-policy(substitute).re"
	{ goto Me; }
#line 41 "encodings/unicode_group_Me.u--encoding-policy(substitute).c"
}
#line 15 "encodings/unicode_group_Me.u--encoding-policy(substitute).re"
