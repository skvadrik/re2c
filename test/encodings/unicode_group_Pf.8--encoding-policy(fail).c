...
#line 14 "encodings/unicode_group_Pf.8--encoding-policy(fail).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	switch (yych) {
...
#line 28 "encodings/unicode_group_Pf.8--encoding-policy(fail).c"
yy4:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0xBB:	goto yy6;
...
#line 13 "encodings/unicode_group_Pf.8--encoding-policy(fail).re"
	{ goto Pf; }
#line 46 "encodings/unicode_group_Pf.8--encoding-policy(fail).c"
yy8:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0x99:
...
#line 15 "encodings/unicode_group_Pf.8--encoding-policy(fail).re"
