/* Generated by re2c */
#line 1 "encodings/unicode_group_Nl.x--encoding-policy(fail).re"
...
#line 14 "encodings/unicode_group_Nl.x--encoding-policy(fail).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x3020) {
...
yy2:
	++YYCURSOR;
yy3:
#line 14 "encodings/unicode_group_Nl.x--encoding-policy(fail).re"
	{ return YYCURSOR == limit; }
#line 51 "encodings/unicode_group_Nl.x--encoding-policy(fail).c"
yy4:
	++YYCURSOR;
#line 13 "encodings/unicode_group_Nl.x--encoding-policy(fail).re"
	{ goto Nl; }
#line 56 "encodings/unicode_group_Nl.x--encoding-policy(fail).c"
yy6:
	yych = *++YYCURSOR;
	if (yych <= 0xDF41) {
...
#line 15 "encodings/unicode_group_Nl.x--encoding-policy(fail).re"
