...
#line 14 "encodings/unicode_group_Zs.u--encoding-policy(ignore).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x00001FFF) {
...
#line 37 "encodings/unicode_group_Zs.u--encoding-policy(ignore).c"
yy4:
	++YYCURSOR;
#line 13 "encodings/unicode_group_Zs.u--encoding-policy(ignore).re"
	{ goto Zs; }
#line 42 "encodings/unicode_group_Zs.u--encoding-policy(ignore).c"
}
#line 15 "encodings/unicode_group_Zs.u--encoding-policy(ignore).re"
