...
#line 14 "encodings/unicode_group_Sk.x--encoding-policy(fail).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x1FBD) {
...
#line 101 "encodings/unicode_group_Sk.x--encoding-policy(fail).c"
yy4:
	++YYCURSOR;
#line 13 "encodings/unicode_group_Sk.x--encoding-policy(fail).re"
	{ goto Sk; }
#line 106 "encodings/unicode_group_Sk.x--encoding-policy(fail).c"
}
#line 15 "encodings/unicode_group_Sk.x--encoding-policy(fail).re"
