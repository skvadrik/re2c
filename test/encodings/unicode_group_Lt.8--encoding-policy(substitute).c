/* Generated by re2c */
#line 1 "encodings/unicode_group_Lt.8--encoding-policy(substitute).re"
...
#line 14 "encodings/unicode_group_Lt.8--encoding-policy(substitute).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	switch (yych) {
...
yy2:
	++YYCURSOR;
yy3:
#line 14 "encodings/unicode_group_Lt.8--encoding-policy(substitute).re"
	{ return YYCURSOR == limit; }
#line 28 "encodings/unicode_group_Lt.8--encoding-policy(substitute).c"
yy4:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0x85:
...
yy6:
	++YYCURSOR;
#line 13 "encodings/unicode_group_Lt.8--encoding-policy(substitute).re"
	{ goto Lt; }
#line 49 "encodings/unicode_group_Lt.8--encoding-policy(substitute).c"
yy8:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0x88:
...
#line 15 "encodings/unicode_group_Lt.8--encoding-policy(substitute).re"
