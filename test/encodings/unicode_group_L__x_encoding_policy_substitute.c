...
#line 15 "encodings/unicode_group_L__x_encoding_policy_substitute.c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x1FD5) {
...
#line 335 "encodings/unicode_group_L__x_encoding_policy_substitute.c"
yy3:
	++YYCURSOR;
#line 14 "encodings/unicode_group_L__x_encoding_policy_substitute.re"
	{ goto L_; }
#line 340 "encodings/unicode_group_L__x_encoding_policy_substitute.c"
yy4:
	yych = *++YYCURSOR;
	if (yych <= 0xDD8B) {
		if (yych <= 0xDCD7) {
...
#line 16 "encodings/unicode_group_L__x_encoding_policy_substitute.re"
