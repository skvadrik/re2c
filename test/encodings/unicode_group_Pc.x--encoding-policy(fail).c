...
#line 14 "encodings/unicode_group_Pc.x--encoding-policy(fail).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x2054) {
...
#line 38 "encodings/unicode_group_Pc.x--encoding-policy(fail).c"
yy4:
	++YYCURSOR;
#line 13 "encodings/unicode_group_Pc.x--encoding-policy(fail).re"
	{ goto Pc; }
#line 43 "encodings/unicode_group_Pc.x--encoding-policy(fail).c"
}
#line 15 "encodings/unicode_group_Pc.x--encoding-policy(fail).re"
