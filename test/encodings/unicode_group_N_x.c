/* Generated by re2c */
#line 1 "encodings/unicode_group_N_x.re"
...
#line 15 "encodings/unicode_group_N_x.c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x2073) {
				...
				if (yych <= 0x0669) {
					if (yych <= 0x00B8) {
						...
						if (yych <= 0x00BB) {
							...
							if (yych >= 0x0660) goto yy3;
						}
					}
				} else {
					if (yych <= 0x0965) {
						if (yych <= 0x06F9) {
							if (yych >= 0x06F0) goto yy3;
						} else {
							if (yych <= 0x07BF) goto yy1;
							if (yych <= 0x07C9) goto yy3;
						}
					} else {
						if (yych <= 0x09E5) {
				...
				if (yych <= 0x1A99) {
					...
					if (yych <= 0x1C3F) {
						if (yych <= 0x1B59) {
							...
							if (yych <= 0x1BAF) goto yy1;
							if (yych <= 0x1BB9) goto yy3;
						}
					} else {
						if (yych <= 0x1C59) {
							if (yych <= 0x1C49) goto yy3;
							if (yych >= 0x1C50) goto yy3;
						} else {
				...
				if (yych <= 0x24E9) {
					if (yych <= 0x2182) {
						if (yych <= 0x207F) {
							...
							if (yych >= 0x2150) goto yy3;
						}
					} else {
						if (yych <= 0x2189) {
							if (yych >= 0x2185) goto yy3;
						} else {
							if (yych <= 0x245F) goto yy1;
				...
				if (yych <= 0x327F) {
					if (yych <= 0x3229) {
						if (yych <= 0x3191) {
							...
							if (yych >= 0x3220) goto yy3;
						}
					} else {
						if (yych <= 0x324F) {
							if (yych >= 0x3248) goto yy3;
						} else {
							if (yych <= 0x3250) goto yy1;
					...
					if (yych <= 0xA629) {
						...
						if (yych <= 0xA82F) {
							if (yych <= 0xA6E5) goto yy1;
							if (yych <= 0xA6EF) goto yy3;
						} else {
...
yy1:
	++YYCURSOR;
yy2:
#line 15 "encodings/unicode_group_N_x.re"
	{ return YYCURSOR - 1 == limit; }
#line 315 "encodings/unicode_group_N_x.c"
yy3:
	++YYCURSOR;
#line 14 "encodings/unicode_group_N_x.re"
	{ goto N; }
#line 320 "encodings/unicode_group_N_x.c"
yy4:
	yych = *++YYCURSOR;
	if (yych <= 0xDEFB) {
		if (yych <= 0xDD78) {
...
#line 16 "encodings/unicode_group_N_x.re"
...
int main() {
	YYCTYPE* buffer_N = new YYCTYPE[3850];
	uint32_t buffer_N_len = encode_utf16(chars_N, sizeof(chars_N) / sizeof(uint32_t), buffer_N);
