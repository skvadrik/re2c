/* Generated by re2c */
#line 1 "encodings/unicode_group_Co.x--encoding-policy(ignore).re"
...
#line 14 "encodings/unicode_group_Co.x--encoding-policy(ignore).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0xDBFE) {
...
yy2:
	++YYCURSOR;
yy3:
#line 14 "encodings/unicode_group_Co.x--encoding-policy(ignore).re"
	{ return YYCURSOR == limit; }
#line 32 "encodings/unicode_group_Co.x--encoding-policy(ignore).c"
yy4:
	yych = *++YYCURSOR;
...
yy6:
	++YYCURSOR;
#line 13 "encodings/unicode_group_Co.x--encoding-policy(ignore).re"
	{ goto Co; }
#line 46 "encodings/unicode_group_Co.x--encoding-policy(ignore).c"
}
#line 15 "encodings/unicode_group_Co.x--encoding-policy(ignore).re"
