...
#line 13 "encodings/unicode_group_Co.x--encoding-policy(ignore).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0xDBFE) {
...
#line 31 "encodings/unicode_group_Co.x--encoding-policy(ignore).c"
yy4:
	yych = *++YYCURSOR;
...
yy6:
	++YYCURSOR;
#line 12 "encodings/unicode_group_Co.x--encoding-policy(ignore).re"
	{ goto Co; }
#line 45 "encodings/unicode_group_Co.x--encoding-policy(ignore).c"
}
