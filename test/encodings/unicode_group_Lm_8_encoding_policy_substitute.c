...
#line 15 "encodings/unicode_group_Lm_8_encoding_policy_substitute.c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	switch (yych) {
...
#line 41 "encodings/unicode_group_Lm_8_encoding_policy_substitute.c"
yy3:
	yych = *++YYCURSOR;
	switch (yych) {
		case 0xB0:
...
#line 14 "encodings/unicode_group_Lm_8_encoding_policy_substitute.re"
	{ goto Lm; }
#line 202 "encodings/unicode_group_Lm_8_encoding_policy_substitute.c"
yy18:
	yych = *++YYCURSOR;
	switch (yych) {
		case 0x9A:
...
#line 16 "encodings/unicode_group_Lm_8_encoding_policy_substitute.re"
...
int main() {
	YYCTYPE* buffer_Lm = new YYCTYPE[2388];
