...
#line 14 "encodings/unicode_group_Cc.8--encoding-policy(ignore).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	switch (yych) {
...
#line 13 "encodings/unicode_group_Cc.8--encoding-policy(ignore).re"
	{ goto Cc; }
#line 59 "encodings/unicode_group_Cc.8--encoding-policy(ignore).c"
yy4:
	++YYCURSOR;
yy5:
#line 14 "encodings/unicode_group_Cc.8--encoding-policy(ignore).re"
	{ return YYCURSOR == limit; }
#line 65 "encodings/unicode_group_Cc.8--encoding-policy(ignore).c"
yy6:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0x80:
...
#line 15 "encodings/unicode_group_Cc.8--encoding-policy(ignore).re"
