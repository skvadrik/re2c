...
#line 15 "encodings/unicode_group_Cn_8_encoding_policy_substitute.c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	switch (yych) {
...
#line 49 "encodings/unicode_group_Cn_8_encoding_policy_substitute.c"
yy3:
	yych = *++YYCURSOR;
	switch (yych) {
		case 0xB8:
...
#line 14 "encodings/unicode_group_Cn_8_encoding_policy_substitute.re"
	{ goto Cn; }
#line 482 "encodings/unicode_group_Cn_8_encoding_policy_substitute.c"
yy25:
	yych = *++YYCURSOR;
	switch (yych) {
		case 0xAE:
...
#line 16 "encodings/unicode_group_Cn_8_encoding_policy_substitute.re"
...
int main() {
	YYCTYPE* buffer_Cn = new YYCTYPE[4948314];
	uint32_t buffer_Cn_len = encode_utf8(chars_Cn, sizeof(chars_Cn) / sizeof(uint32_t), buffer_Cn);
