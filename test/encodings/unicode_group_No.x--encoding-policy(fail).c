/* Generated by re2c */
#line 1 "encodings/unicode_group_No.x--encoding-policy(fail).re"
...
#line 14 "encodings/unicode_group_No.x--encoding-policy(fail).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x249B) {
...
yy2:
	++YYCURSOR;
yy3:
#line 14 "encodings/unicode_group_No.x--encoding-policy(fail).re"
	{ return YYCURSOR == limit; }
#line 141 "encodings/unicode_group_No.x--encoding-policy(fail).c"
yy4:
	++YYCURSOR;
#line 13 "encodings/unicode_group_No.x--encoding-policy(fail).re"
	{ goto No; }
#line 146 "encodings/unicode_group_No.x--encoding-policy(fail).c"
yy6:
	yych = *++YYCURSOR;
	if (yych <= 0xDD89) {
		if (yych <= 0xDD33) {
...
#line 15 "encodings/unicode_group_No.x--encoding-policy(fail).re"
