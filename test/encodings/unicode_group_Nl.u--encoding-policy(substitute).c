...
#line 14 "encodings/unicode_group_Nl.u--encoding-policy(substitute).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x0000303A) {
...
#line 58 "encodings/unicode_group_Nl.u--encoding-policy(substitute).c"
yy4:
	++YYCURSOR;
#line 13 "encodings/unicode_group_Nl.u--encoding-policy(substitute).re"
	{ goto Nl; }
#line 63 "encodings/unicode_group_Nl.u--encoding-policy(substitute).c"
}
#line 15 "encodings/unicode_group_Nl.u--encoding-policy(substitute).re"
