...
#line 14 "encodings/unicode_group_Sm_8_encoding_policy_substitute.c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	switch (yych) {
...
#line 39 "encodings/unicode_group_Sm_8_encoding_policy_substitute.c"
yy4:
	++YYCURSOR;
#line 13 "encodings/unicode_group_Sm_8_encoding_policy_substitute.re"
	{ goto Sm; }
#line 44 "encodings/unicode_group_Sm_8_encoding_policy_substitute.c"
yy6:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0xAC:
