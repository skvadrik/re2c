...
#line 14 "encodings/unicode_group_Cf.x--encoding-policy(fail).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x202E) {
...
#line 65 "encodings/unicode_group_Cf.x--encoding-policy(fail).c"
yy4:
	++YYCURSOR;
#line 13 "encodings/unicode_group_Cf.x--encoding-policy(fail).re"
	{ goto Cf; }
#line 70 "encodings/unicode_group_Cf.x--encoding-policy(fail).c"
yy6:
	yych = *++YYCURSOR;
...
#line 15 "encodings/unicode_group_Cf.x--encoding-policy(fail).re"
