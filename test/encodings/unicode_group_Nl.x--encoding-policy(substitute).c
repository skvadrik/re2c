...
#line 14 "encodings/unicode_group_Nl.x--encoding-policy(substitute).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x3020) {
...
#line 51 "encodings/unicode_group_Nl.x--encoding-policy(substitute).c"
yy4:
	++YYCURSOR;
#line 13 "encodings/unicode_group_Nl.x--encoding-policy(substitute).re"
	{ goto Nl; }
#line 56 "encodings/unicode_group_Nl.x--encoding-policy(substitute).c"
yy6:
	yych = *++YYCURSOR;
	if (yych <= 0xDF41) {
...
#line 15 "encodings/unicode_group_Nl.x--encoding-policy(substitute).re"
