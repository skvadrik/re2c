/* Generated by re2c */
#line 1 "encodings/unicode_group_Nl.x--encoding-policy(substitute).re"
#include <stdio.h>
#include "utf16.h"
...
#line 13 "encodings/unicode_group_Nl.x--encoding-policy(substitute).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x3020) {
...
yy2:
	++YYCURSOR;
yy3:
#line 13 "encodings/unicode_group_Nl.x--encoding-policy(substitute).re"
	{ return YYCURSOR == limit; }
#line 50 "encodings/unicode_group_Nl.x--encoding-policy(substitute).c"
yy4:
	++YYCURSOR;
#line 12 "encodings/unicode_group_Nl.x--encoding-policy(substitute).re"
	{ goto Nl; }
#line 55 "encodings/unicode_group_Nl.x--encoding-policy(substitute).c"
yy6:
	yych = *++YYCURSOR;
	if (yych <= 0xDF41) {
...
#line 14 "encodings/unicode_group_Nl.x--encoding-policy(substitute).re"
