...
#line 13 "encodings/unicode_group_Sm.8--encoding-policy(substitute).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	switch (yych) {
...
#line 38 "encodings/unicode_group_Sm.8--encoding-policy(substitute).c"
yy4:
	++YYCURSOR;
#line 12 "encodings/unicode_group_Sm.8--encoding-policy(substitute).re"
	{ goto Sm; }
#line 43 "encodings/unicode_group_Sm.8--encoding-policy(substitute).c"
yy6:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0xAC:
