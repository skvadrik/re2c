...
#line 14 "encodings/unicode_group_Zs.8--encoding-policy(substitute).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	switch (yych) {
...
#line 31 "encodings/unicode_group_Zs.8--encoding-policy(substitute).c"
yy4:
	++YYCURSOR;
#line 13 "encodings/unicode_group_Zs.8--encoding-policy(substitute).re"
	{ goto Zs; }
#line 36 "encodings/unicode_group_Zs.8--encoding-policy(substitute).c"
yy6:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0xA0:	goto yy4;
...
#line 15 "encodings/unicode_group_Zs.8--encoding-policy(substitute).re"
