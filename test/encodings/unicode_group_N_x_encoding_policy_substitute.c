/* Generated by re2c */
#line 1 "encodings/unicode_group_N_x_encoding_policy_substitute.re"
...
#line 15 "encodings/unicode_group_N_x_encoding_policy_substitute.c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x2070) {
		...
		if (yych <= 0xA835) {
			if (yych <= 0x3029) {
				if (yych <= 0x249B) {
					...
					if (yych <= 0x2CFC) {
						if (yych <= 0x24FF) {
							if (yych >= 0x24EA) goto yy3;
						} else {
							if (yych <= 0x2775) goto yy1;
				...
				if (yych <= 0xD837) {
					...
					if (yych <= 0xD83C) {
						if (yych <= 0xD839) {
							...
							if (yych <= 0xD83B) goto yy20;
							goto yy21;
						}
					} else {
						if (yych <= 0xD83E) {
							if (yych >= 0xD83E) goto yy22;
						} else {
...
yy1:
	++YYCURSOR;
yy2:
#line 15 "encodings/unicode_group_N_x_encoding_policy_substitute.re"
	{ return YYCURSOR - 1 == limit; }
#line 313 "encodings/unicode_group_N_x_encoding_policy_substitute.c"
yy3:
	++YYCURSOR;
#line 14 "encodings/unicode_group_N_x_encoding_policy_substitute.re"
	{ goto N; }
#line 318 "encodings/unicode_group_N_x_encoding_policy_substitute.c"
yy4:
	yych = *++YYCURSOR;
	if (yych <= 0xDEFB) {
		if (yych <= 0xDD78) {
...
#line 16 "encodings/unicode_group_N_x_encoding_policy_substitute.re"
...
int main() {
	YYCTYPE* buffer_N = new YYCTYPE[3664];
