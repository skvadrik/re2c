...
#line 14 "encodings/unicode_group_N_x_encoding_policy_substitute.c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x1C59) {
			...
			if (yych <= 0x3006) {
				if (yych <= 0x2184) {
					if (yych <= 0x2079) {
						...
						if (yych <= 0x2089) {
							if (yych >= 0x2080) goto yy3;
						} else {
							if (yych <= 0x214F) goto yy1;
				...
				if (yych <= 0xD81A) {
					...
					if (yych <= 0xD83A) {
						if (yych <= 0xD834) {
							...
							if (yych <= 0xD835) goto yy14;
							if (yych >= 0xD83A) goto yy15;
						}
					} else {
						if (yych <= 0xD83C) {
...
#line 284 "encodings/unicode_group_N_x_encoding_policy_substitute.c"
yy3:
	++YYCURSOR;
#line 13 "encodings/unicode_group_N_x_encoding_policy_substitute.re"
	{ goto N; }
#line 289 "encodings/unicode_group_N_x_encoding_policy_substitute.c"
yy4:
	yych = *++YYCURSOR;
	if (yych <= 0xDEFB) {
		if (yych <= 0xDD78) {
