...
#line 14 "encodings/unicode_group_Mc.x--encoding-policy(ignore).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x17B5) {
...
#line 349 "encodings/unicode_group_Mc.x--encoding-policy(ignore).c"
yy4:
	++YYCURSOR;
#line 13 "encodings/unicode_group_Mc.x--encoding-policy(ignore).re"
	{ goto Mc; }
#line 354 "encodings/unicode_group_Mc.x--encoding-policy(ignore).c"
yy6:
	yych = *++YYCURSOR;
	if (yych <= 0xDE2E) {
		if (yych <= 0xDCB8) {
...
#line 15 "encodings/unicode_group_Mc.x--encoding-policy(ignore).re"
