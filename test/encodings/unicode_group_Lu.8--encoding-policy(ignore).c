...
#line 14 "encodings/unicode_group_Lu.8--encoding-policy(ignore).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	switch (yych) {
...
#line 73 "encodings/unicode_group_Lu.8--encoding-policy(ignore).c"
yy4:
	++YYCURSOR;
#line 13 "encodings/unicode_group_Lu.8--encoding-policy(ignore).re"
	{ goto Lu; }
#line 78 "encodings/unicode_group_Lu.8--encoding-policy(ignore).c"
yy6:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0x80:
...
#line 15 "encodings/unicode_group_Lu.8--encoding-policy(ignore).re"
