...
#line 14 "encodings/unicode_group_Nd.x--encoding-policy(fail).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x1819) {
...
#line 169 "encodings/unicode_group_Nd.x--encoding-policy(fail).c"
yy4:
	++YYCURSOR;
#line 13 "encodings/unicode_group_Nd.x--encoding-policy(fail).re"
	{ goto Nd; }
#line 174 "encodings/unicode_group_Nd.x--encoding-policy(fail).c"
yy6:
	yych = *++YYCURSOR;
...
#line 15 "encodings/unicode_group_Nd.x--encoding-policy(fail).re"
