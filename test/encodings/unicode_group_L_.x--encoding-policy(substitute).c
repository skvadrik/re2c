...
#line 14 "encodings/unicode_group_L_.x--encoding-policy(substitute).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x1FDB) {
...
#line 310 "encodings/unicode_group_L_.x--encoding-policy(substitute).c"
yy4:
	++YYCURSOR;
#line 13 "encodings/unicode_group_L_.x--encoding-policy(substitute).re"
	{ goto L_; }
#line 315 "encodings/unicode_group_L_.x--encoding-policy(substitute).c"
yy6:
	yych = *++YYCURSOR;
...
#line 15 "encodings/unicode_group_L_.x--encoding-policy(substitute).re"
