...
#line 14 "encodings/unicode_group_Cc.x--encoding-policy(fail).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
...
#line 13 "encodings/unicode_group_Cc.x--encoding-policy(fail).re"
	{ goto Cc; }
#line 25 "encodings/unicode_group_Cc.x--encoding-policy(fail).c"
yy4:
	++YYCURSOR;
#line 14 "encodings/unicode_group_Cc.x--encoding-policy(fail).re"
	{ return YYCURSOR == limit; }
#line 30 "encodings/unicode_group_Cc.x--encoding-policy(fail).c"
}
#line 15 "encodings/unicode_group_Cc.x--encoding-policy(fail).re"
