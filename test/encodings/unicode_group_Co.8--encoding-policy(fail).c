/* Generated by re2c */
#line 1 "encodings/unicode_group_Co.8--encoding-policy(fail).re"
...
#line 14 "encodings/unicode_group_Co.8--encoding-policy(fail).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	switch (yych) {
...
yy2:
	++YYCURSOR;
yy3:
#line 14 "encodings/unicode_group_Co.8--encoding-policy(fail).re"
	{ return YYCURSOR == limit; }
#line 30 "encodings/unicode_group_Co.8--encoding-policy(fail).c"
yy4:
...
yy12:
	++YYCURSOR;
#line 13 "encodings/unicode_group_Co.8--encoding-policy(fail).re"
	{ goto Co; }
#line 397 "encodings/unicode_group_Co.8--encoding-policy(fail).c"
yy14:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0x80:
...
#line 15 "encodings/unicode_group_Co.8--encoding-policy(fail).re"
