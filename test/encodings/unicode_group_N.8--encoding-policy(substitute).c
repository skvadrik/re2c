...
#line 14 "encodings/unicode_group_N.8--encoding-policy(substitute).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	switch (yych) {
...
#line 47 "encodings/unicode_group_N.8--encoding-policy(substitute).c"
yy4:
	++YYCURSOR;
#line 13 "encodings/unicode_group_N.8--encoding-policy(substitute).re"
	{ goto N; }
#line 52 "encodings/unicode_group_N.8--encoding-policy(substitute).c"
yy6:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0xB2:
...
#line 15 "encodings/unicode_group_N.8--encoding-policy(substitute).re"
