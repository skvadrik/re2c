...
#line 14 "encodings/unicode_group_S_8_encoding_policy_fail.c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	switch (yych) {
...
#line 54 "encodings/unicode_group_S_8_encoding_policy_fail.c"
yy3:
	++YYCURSOR;
#line 13 "encodings/unicode_group_S_8_encoding_policy_fail.re"
	{ goto S; }
#line 59 "encodings/unicode_group_S_8_encoding_policy_fail.c"
yy4:
	yych = *++YYCURSOR;
	switch (yych) {
		case 0xA2:
