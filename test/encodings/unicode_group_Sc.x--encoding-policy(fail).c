...
#line 13 "encodings/unicode_group_Sc.x--encoding-policy(fail).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x0E3E) {
...
#line 70 "encodings/unicode_group_Sc.x--encoding-policy(fail).c"
yy4:
	++YYCURSOR;
#line 12 "encodings/unicode_group_Sc.x--encoding-policy(fail).re"
	{ goto Sc; }
#line 75 "encodings/unicode_group_Sc.x--encoding-policy(fail).c"
}
