...
#line 14 "encodings/unicode_group_Cf.u--encoding-policy(substitute).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x0000205F) {
...
#line 72 "encodings/unicode_group_Cf.u--encoding-policy(substitute).c"
yy4:
	++YYCURSOR;
#line 13 "encodings/unicode_group_Cf.u--encoding-policy(substitute).re"
	{ goto Cf; }
#line 77 "encodings/unicode_group_Cf.u--encoding-policy(substitute).c"
}
#line 15 "encodings/unicode_group_Cf.u--encoding-policy(substitute).re"
