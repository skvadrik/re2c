/* Generated by re2c */
#line 1 "encodings/unicode_group_Lu.8--encoding-policy(fail).re"
...
#line 14 "encodings/unicode_group_Lu.8--encoding-policy(fail).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	switch (yych) {
...
yy2:
	++YYCURSOR;
yy3:
#line 14 "encodings/unicode_group_Lu.8--encoding-policy(fail).re"
	{ return YYCURSOR == limit; }
#line 73 "encodings/unicode_group_Lu.8--encoding-policy(fail).c"
yy4:
	++YYCURSOR;
#line 13 "encodings/unicode_group_Lu.8--encoding-policy(fail).re"
	{ goto Lu; }
#line 78 "encodings/unicode_group_Lu.8--encoding-policy(fail).c"
yy6:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0x80:
...
#line 15 "encodings/unicode_group_Lu.8--encoding-policy(fail).re"
