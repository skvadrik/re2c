/* Generated by re2c */
#line 1 "encodings/unicode_group_Cc.x--encoding-policy(substitute).re"
...
#line 14 "encodings/unicode_group_Cc.x--encoding-policy(substitute).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
...
yy2:
	++YYCURSOR;
#line 13 "encodings/unicode_group_Cc.x--encoding-policy(substitute).re"
	{ goto Cc; }
#line 25 "encodings/unicode_group_Cc.x--encoding-policy(substitute).c"
yy4:
	++YYCURSOR;
#line 14 "encodings/unicode_group_Cc.x--encoding-policy(substitute).re"
	{ return YYCURSOR == limit; }
#line 30 "encodings/unicode_group_Cc.x--encoding-policy(substitute).c"
}
#line 15 "encodings/unicode_group_Cc.x--encoding-policy(substitute).re"
