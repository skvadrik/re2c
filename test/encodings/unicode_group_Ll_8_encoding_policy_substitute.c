...
#line 14 "encodings/unicode_group_Ll_8_encoding_policy_substitute.c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	switch (yych) {
...
#line 76 "encodings/unicode_group_Ll_8_encoding_policy_substitute.c"
yy3:
	++YYCURSOR;
#line 13 "encodings/unicode_group_Ll_8_encoding_policy_substitute.re"
	{ goto Ll; }
#line 81 "encodings/unicode_group_Ll_8_encoding_policy_substitute.c"
yy4:
	yych = *++YYCURSOR;
	switch (yych) {
		case 0xB5: goto yy3;
...
int main ()
{
	unsigned int * buffer_Ll = new unsigned int [8608];
