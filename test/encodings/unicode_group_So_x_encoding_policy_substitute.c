...
#line 14 "encodings/unicode_group_So_x_encoding_policy_substitute.c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x232A) {
...
#line 373 "encodings/unicode_group_So_x_encoding_policy_substitute.c"
yy3:
	++YYCURSOR;
#line 13 "encodings/unicode_group_So_x_encoding_policy_substitute.re"
	{ goto So; }
#line 378 "encodings/unicode_group_So_x_encoding_policy_substitute.c"
yy4:
	yych = *++YYCURSOR;
	if (yych <= 0xDD8E) {
		if (yych <= 0xDD78) {
...
int main ()
{
	unsigned int * buffer_So = new unsigned int [13280];
