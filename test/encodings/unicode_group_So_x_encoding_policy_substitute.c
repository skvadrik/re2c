/* Generated by re2c */
#line 1 "encodings/unicode_group_So_x_encoding_policy_substitute.re"
...
#line 15 "encodings/unicode_group_So_x_encoding_policy_substitute.c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x232A) {
				...
				if (yych <= 0x0F35) {
					if (yych <= 0x0F12) {
						if (yych <= 0x0D78) {
							...
							if (yych <= 0x0F00) goto yy1;
							if (yych <= 0x0F03) goto yy3;
						}
					} else {
						if (yych <= 0x0F19) {
							if (yych == 0x0F14) goto yy1;
					...
					if (yych <= 0x0FCD) {
						...
						if (yych <= 0x109D) {
							...
							if (yych <= 0x0FD4) goto yy1;
							if (yych <= 0x0FD8) goto yy3;
						} else {
							if (yych <= 0x109F) goto yy3;
							if (yych <= 0x138F) goto yy1;
				...
				if (yych <= 0x2113) {
					...
					if (yych <= 0x2126) {
						if (yych <= 0x211D) {
							...
							if (yych == 0x2124) goto yy1;
							if (yych <= 0x2125) goto yy3;
						}
					} else {
						if (yych <= 0x212D) {
							if (yych == 0x2128) goto yy1;
		...
		if (yych <= 0x31EE) {
			if (yych <= 0x2B75) {
				if (yych <= 0x25C1) {
					if (yych <= 0x243F) {
						if (yych <= 0x23B3) {
							if (yych == 0x237C) goto yy1;
							if (yych <= 0x239A) goto yy3;
						} else {
							if (yych <= 0x23DB) goto yy3;
							if (yych <= 0x23E1) goto yy1;
							if (yych <= 0x2426) goto yy3;
						}
					} else {
						if (yych <= 0x24FF) {
							if (yych <= 0x244A) goto yy3;
							if (yych <= 0x249B) goto yy1;
							if (yych <= 0x24E9) goto yy3;
						} else {
							if (yych == 0x25B7) goto yy1;
							if (yych <= 0x25C0) goto yy3;
						}
					}
				} else {
					if (yych <= 0x27FF) {
						if (yych <= 0x266F) {
							...
							if (yych <= 0x25FF) goto yy1;
							if (yych <= 0x266E) goto yy3;
						} else {
							if (yych <= 0x2767) goto yy3;
							if (yych <= 0x2793) goto yy1;
							if (yych <= 0x27BF) goto yy3;
						}
					} else {
						if (yych <= 0x2B44) {
							if (yych <= 0x28FF) goto yy3;
							if (yych <= 0x2AFF) goto yy1;
				...
				if (yych <= 0x3003) {
					if (yych <= 0x2E7F) {
						if (yych <= 0x2CE4) {
							...
							if (yych <= 0x2E4F) goto yy1;
							if (yych <= 0x2E51) goto yy3;
						}
					} else {
						if (yych <= 0x2EFF) {
					...
					if (yych <= 0x303D) {
						if (yych <= 0x301F) {
							...
							if (yych <= 0x3011) goto yy1;
							if (yych <= 0x3013) goto yy3;
						} else {
							if (yych <= 0x3020) goto yy3;
							if (yych <= 0x3035) goto yy1;
			...
			if (yych <= 0xD806) {
				...
				if (yych <= 0xD83D) {
					if (yych <= 0xD834) {
						...
						if (yych <= 0xD838) {
							if (yych == 0xD836) goto yy12;
							if (yych >= 0xD838) goto yy13;
						} else {
							if (yych <= 0xD83A) goto yy1;
							if (yych <= 0xD83B) goto yy14;
							if (yych <= 0xD83C) goto yy15;
							goto yy16;
						}
					}
				} else {
...
yy1:
	++YYCURSOR;
yy2:
#line 15 "encodings/unicode_group_So_x_encoding_policy_substitute.re"
	{ return YYCURSOR - 1 == limit; }
#line 374 "encodings/unicode_group_So_x_encoding_policy_substitute.c"
yy3:
	++YYCURSOR;
#line 14 "encodings/unicode_group_So_x_encoding_policy_substitute.re"
	{ goto So; }
#line 379 "encodings/unicode_group_So_x_encoding_policy_substitute.c"
yy4:
	yych = *++YYCURSOR;
	if (yych <= 0xDD8E) {
		if (yych <= 0xDD78) {
...
#line 16 "encodings/unicode_group_So_x_encoding_policy_substitute.re"
...
int main() {
	YYCTYPE* buffer_So = new YYCTYPE[13280];
	uint32_t buffer_So_len = encode_utf16(chars_So, sizeof(chars_So) / sizeof(uint32_t), buffer_So);
