/* Generated by re2c */
#line 1 "encodings/unicode_group_Pe.8--encoding-policy(ignore).re"
...
#line 14 "encodings/unicode_group_Pe.8--encoding-policy(ignore).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	switch (yych) {
...
yy2:
	++YYCURSOR;
yy3:
#line 14 "encodings/unicode_group_Pe.8--encoding-policy(ignore).re"
	{ return YYCURSOR == limit; }
#line 34 "encodings/unicode_group_Pe.8--encoding-policy(ignore).c"
yy4:
	++YYCURSOR;
#line 13 "encodings/unicode_group_Pe.8--encoding-policy(ignore).re"
	{ goto Pe; }
#line 39 "encodings/unicode_group_Pe.8--encoding-policy(ignore).c"
yy6:
...
#line 15 "encodings/unicode_group_Pe.8--encoding-policy(ignore).re"
