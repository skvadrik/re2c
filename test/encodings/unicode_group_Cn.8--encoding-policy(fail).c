/* Generated by re2c */
#line 1 "encodings/unicode_group_Cn.8--encoding-policy(fail).re"
...
#line 14 "encodings/unicode_group_Cn.8--encoding-policy(fail).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	switch (yych) {
...
yy2:
	++YYCURSOR;
yy3:
#line 14 "encodings/unicode_group_Cn.8--encoding-policy(fail).re"
	{ return YYCURSOR == limit; }
#line 51 "encodings/unicode_group_Cn.8--encoding-policy(fail).c"
yy4:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0xB8:
...
yy28:
	++YYCURSOR;
#line 13 "encodings/unicode_group_Cn.8--encoding-policy(fail).re"
	{ goto Cn; }
#line 522 "encodings/unicode_group_Cn.8--encoding-policy(fail).c"
yy30:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0xAE:
...
#line 15 "encodings/unicode_group_Cn.8--encoding-policy(fail).re"
