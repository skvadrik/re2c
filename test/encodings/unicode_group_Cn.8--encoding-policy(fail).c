...
#line 13 "encodings/unicode_group_Cn.8--encoding-policy(fail).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	switch (yych) {
...
#line 50 "encodings/unicode_group_Cn.8--encoding-policy(fail).c"
yy4:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0xB8:
...
yy28:
	++YYCURSOR;
#line 12 "encodings/unicode_group_Cn.8--encoding-policy(fail).re"
	{ goto Cn; }
#line 521 "encodings/unicode_group_Cn.8--encoding-policy(fail).c"
yy30:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0xAE:
