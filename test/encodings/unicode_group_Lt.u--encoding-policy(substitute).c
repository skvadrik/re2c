/* Generated by re2c */
#line 1 "encodings/unicode_group_Lt.u--encoding-policy(substitute).re"
...
#line 14 "encodings/unicode_group_Lt.u--encoding-policy(substitute).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x00001F8F) {
...
yy2:
	++YYCURSOR;
#line 14 "encodings/unicode_group_Lt.u--encoding-policy(substitute).re"
	{ return YYCURSOR == limit; }
#line 54 "encodings/unicode_group_Lt.u--encoding-policy(substitute).c"
yy4:
	++YYCURSOR;
#line 13 "encodings/unicode_group_Lt.u--encoding-policy(substitute).re"
	{ goto Lt; }
#line 59 "encodings/unicode_group_Lt.u--encoding-policy(substitute).c"
}
#line 15 "encodings/unicode_group_Lt.u--encoding-policy(substitute).re"
