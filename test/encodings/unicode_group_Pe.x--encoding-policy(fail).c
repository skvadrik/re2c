/* Generated by re2c */
#line 1 "encodings/unicode_group_Pe.x--encoding-policy(fail).re"
...
#line 14 "encodings/unicode_group_Pe.x--encoding-policy(fail).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x2998) {
...
yy2:
	++YYCURSOR;
#line 14 "encodings/unicode_group_Pe.x--encoding-policy(fail).re"
	{ return YYCURSOR == limit; }
#line 233 "encodings/unicode_group_Pe.x--encoding-policy(fail).c"
yy4:
	++YYCURSOR;
#line 13 "encodings/unicode_group_Pe.x--encoding-policy(fail).re"
	{ goto Pe; }
#line 238 "encodings/unicode_group_Pe.x--encoding-policy(fail).c"
}
#line 15 "encodings/unicode_group_Pe.x--encoding-policy(fail).re"
