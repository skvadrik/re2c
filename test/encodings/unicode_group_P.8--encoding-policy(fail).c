...
#line 14 "encodings/unicode_group_P.8--encoding-policy(fail).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	switch (yych) {
...
#line 67 "encodings/unicode_group_P.8--encoding-policy(fail).c"
yy4:
	++YYCURSOR;
#line 13 "encodings/unicode_group_P.8--encoding-policy(fail).re"
	{ goto P; }
#line 72 "encodings/unicode_group_P.8--encoding-policy(fail).c"
yy6:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0xA1:
...
#line 15 "encodings/unicode_group_P.8--encoding-policy(fail).re"
