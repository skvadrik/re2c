...
#line 13 "encodings/unicode_group_Lo.8--encoding-policy(fail).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	switch (yych) {
...
#line 54 "encodings/unicode_group_Lo.8--encoding-policy(fail).c"
yy4:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0xAA:
...
yy28:
	++YYCURSOR;
#line 12 "encodings/unicode_group_Lo.8--encoding-policy(fail).re"
	{ goto Lo; }
#line 989 "encodings/unicode_group_Lo.8--encoding-policy(fail).c"
yy30:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0x80:
