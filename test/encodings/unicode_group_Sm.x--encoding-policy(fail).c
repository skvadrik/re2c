/* Generated by re2c */
#line 1 "encodings/unicode_group_Sm.x--encoding-policy(fail).re"
...
#line 14 "encodings/unicode_group_Sm.x--encoding-policy(fail).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x231F) {
...
yy2:
	++YYCURSOR;
yy3:
#line 14 "encodings/unicode_group_Sm.x--encoding-policy(fail).re"
	{ return YYCURSOR == limit; }
#line 183 "encodings/unicode_group_Sm.x--encoding-policy(fail).c"
yy4:
	++YYCURSOR;
#line 13 "encodings/unicode_group_Sm.x--encoding-policy(fail).re"
	{ goto Sm; }
#line 188 "encodings/unicode_group_Sm.x--encoding-policy(fail).c"
yy6:
	yych = *++YYCURSOR;
	if (yych <= 0xDF35) {
		if (yych <= 0xDEFA) {
...
#line 15 "encodings/unicode_group_Sm.x--encoding-policy(fail).re"
