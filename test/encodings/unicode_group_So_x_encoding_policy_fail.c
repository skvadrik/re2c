...
#line 15 "encodings/unicode_group_So_x_encoding_policy_fail.c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x232A) {
...
#line 374 "encodings/unicode_group_So_x_encoding_policy_fail.c"
yy3:
	++YYCURSOR;
#line 14 "encodings/unicode_group_So_x_encoding_policy_fail.re"
	{ goto So; }
#line 379 "encodings/unicode_group_So_x_encoding_policy_fail.c"
yy4:
	yych = *++YYCURSOR;
	if (yych <= 0xDD8E) {
		if (yych <= 0xDD78) {
...
#line 16 "encodings/unicode_group_So_x_encoding_policy_fail.re"
