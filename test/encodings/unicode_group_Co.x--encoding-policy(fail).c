/* Generated by re2c */
#line 1 "encodings/unicode_group_Co.x--encoding-policy(fail).re"
...
#line 14 "encodings/unicode_group_Co.x--encoding-policy(fail).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0xDBFE) {
...
yy2:
	++YYCURSOR;
yy3:
#line 14 "encodings/unicode_group_Co.x--encoding-policy(fail).re"
	{ return YYCURSOR == limit; }
#line 32 "encodings/unicode_group_Co.x--encoding-policy(fail).c"
yy4:
	yych = *++YYCURSOR;
...
yy6:
	++YYCURSOR;
#line 13 "encodings/unicode_group_Co.x--encoding-policy(fail).re"
	{ goto Co; }
#line 46 "encodings/unicode_group_Co.x--encoding-policy(fail).c"
}
#line 15 "encodings/unicode_group_Co.x--encoding-policy(fail).re"
