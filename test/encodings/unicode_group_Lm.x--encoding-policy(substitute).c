...
#line 14 "encodings/unicode_group_Lm.x--encoding-policy(substitute).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x207F) {
...
#line 181 "encodings/unicode_group_Lm.x--encoding-policy(substitute).c"
yy4:
	++YYCURSOR;
#line 13 "encodings/unicode_group_Lm.x--encoding-policy(substitute).re"
	{ goto Lm; }
#line 186 "encodings/unicode_group_Lm.x--encoding-policy(substitute).c"
yy6:
	yych = *++YYCURSOR;
...
#line 15 "encodings/unicode_group_Lm.x--encoding-policy(substitute).re"
