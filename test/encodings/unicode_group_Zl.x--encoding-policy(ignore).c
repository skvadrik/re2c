...
#line 14 "encodings/unicode_group_Zl.x--encoding-policy(ignore).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
...
#line 22 "encodings/unicode_group_Zl.x--encoding-policy(ignore).c"
yy4:
	++YYCURSOR;
#line 13 "encodings/unicode_group_Zl.x--encoding-policy(ignore).re"
	{ goto Zl; }
#line 27 "encodings/unicode_group_Zl.x--encoding-policy(ignore).c"
}
#line 15 "encodings/unicode_group_Zl.x--encoding-policy(ignore).re"
