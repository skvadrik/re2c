/* Generated by re2c */
#line 1 "encodings/unicode_group_Cf.8--encoding-policy(fail).re"
#include <stdio.h>
#include "utf8.h"
...
#line 13 "encodings/unicode_group_Cf.8--encoding-policy(fail).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	switch (yych) {
...
yy2:
	++YYCURSOR;
yy3:
#line 13 "encodings/unicode_group_Cf.8--encoding-policy(fail).re"
	{ return YYCURSOR == limit; }
#line 34 "encodings/unicode_group_Cf.8--encoding-policy(fail).c"
yy4:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0xAD:	goto yy13;
...
yy13:
	++YYCURSOR;
#line 12 "encodings/unicode_group_Cf.8--encoding-policy(fail).re"
	{ goto Cf; }
#line 103 "encodings/unicode_group_Cf.8--encoding-policy(fail).c"
yy15:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0x8E:	goto yy13;
...
#line 14 "encodings/unicode_group_Cf.8--encoding-policy(fail).re"
