...
#line 13 "encodings/unicode_group_Mn_8_encoding_policy_substitute.re"
	{ goto Mn; }
#line 500 "encodings/unicode_group_Mn_8_encoding_policy_substitute.c"
yy24:
	yych = *++YYCURSOR;
	switch (yych) {
		case 0x96:
...
yy100:
	yych = *++YYCURSOR;
	switch (yych) {
		case 0x85: goto yy146;
		case 0x86: goto yy147;
		case 0x89: goto yy148;
		case 0xA8: goto yy149;
...
yy101:
	...
	switch (yych) {
		...
		case 0x84: goto yy142;
		case 0x8B: goto yy153;
		case 0xA3: goto yy154;
...
int main ()
{
	unsigned int * buffer_Mn = new unsigned int [7308];
