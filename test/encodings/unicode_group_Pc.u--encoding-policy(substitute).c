/* Generated by re2c */
#line 1 "encodings/unicode_group_Pc.u--encoding-policy(substitute).re"
...
#line 14 "encodings/unicode_group_Pc.u--encoding-policy(substitute).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x00002054) {
...
yy2:
	++YYCURSOR;
#line 14 "encodings/unicode_group_Pc.u--encoding-policy(substitute).re"
	{ return YYCURSOR == limit; }
#line 38 "encodings/unicode_group_Pc.u--encoding-policy(substitute).c"
yy4:
	++YYCURSOR;
#line 13 "encodings/unicode_group_Pc.u--encoding-policy(substitute).re"
	{ goto Pc; }
#line 43 "encodings/unicode_group_Pc.u--encoding-policy(substitute).c"
}
#line 15 "encodings/unicode_group_Pc.u--encoding-policy(substitute).re"
