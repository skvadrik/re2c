...
#line 13 "encodings/unicode_group_Zs.x--encoding-policy(fail).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x1FFF) {
...
#line 36 "encodings/unicode_group_Zs.x--encoding-policy(fail).c"
yy4:
	++YYCURSOR;
#line 12 "encodings/unicode_group_Zs.x--encoding-policy(fail).re"
	{ goto Zs; }
#line 41 "encodings/unicode_group_Zs.x--encoding-policy(fail).c"
}
