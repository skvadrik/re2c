/* Generated by re2c */
#line 1 "encodings/unicode_group_Zs.x--encoding-policy(fail).re"
...
#line 14 "encodings/unicode_group_Zs.x--encoding-policy(fail).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x1FFF) {
	...
	++YYCURSOR;
#line 14 "encodings/unicode_group_Zs.x--encoding-policy(fail).re"
	{ return YYCURSOR == limit; }
#line 37 "encodings/unicode_group_Zs.x--encoding-policy(fail).c"
yy4:
	++YYCURSOR;
#line 13 "encodings/unicode_group_Zs.x--encoding-policy(fail).re"
	{ goto Zs; }
#line 42 "encodings/unicode_group_Zs.x--encoding-policy(fail).c"
}
#line 15 "encodings/unicode_group_Zs.x--encoding-policy(fail).re"
