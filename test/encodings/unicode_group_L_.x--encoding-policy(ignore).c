/* Generated by re2c */
#line 1 "encodings/unicode_group_L_.x--encoding-policy(ignore).re"
...
#line 14 "encodings/unicode_group_L_.x--encoding-policy(ignore).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x1FDB) {
...
yy2:
	++YYCURSOR;
yy3:
#line 14 "encodings/unicode_group_L_.x--encoding-policy(ignore).re"
	{ return YYCURSOR == limit; }
#line 310 "encodings/unicode_group_L_.x--encoding-policy(ignore).c"
yy4:
	++YYCURSOR;
#line 13 "encodings/unicode_group_L_.x--encoding-policy(ignore).re"
	{ goto L_; }
#line 315 "encodings/unicode_group_L_.x--encoding-policy(ignore).c"
yy6:
	yych = *++YYCURSOR;
...
#line 15 "encodings/unicode_group_L_.x--encoding-policy(ignore).re"
