...
#line 13 "encodings/unicode_group_L_.x--encoding-policy(ignore).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x1FDB) {
...
#line 309 "encodings/unicode_group_L_.x--encoding-policy(ignore).c"
yy4:
	++YYCURSOR;
#line 12 "encodings/unicode_group_L_.x--encoding-policy(ignore).re"
	{ goto L_; }
#line 314 "encodings/unicode_group_L_.x--encoding-policy(ignore).c"
yy6:
	yych = *++YYCURSOR;
