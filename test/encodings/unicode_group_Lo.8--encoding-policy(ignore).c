...
#line 14 "encodings/unicode_group_Lo.8--encoding-policy(ignore).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	switch (yych) {
...
#line 55 "encodings/unicode_group_Lo.8--encoding-policy(ignore).c"
yy4:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0xAA:
...
#line 13 "encodings/unicode_group_Lo.8--encoding-policy(ignore).re"
	{ goto Lo; }
#line 990 "encodings/unicode_group_Lo.8--encoding-policy(ignore).c"
yy30:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0x80:
...
#line 15 "encodings/unicode_group_Lo.8--encoding-policy(ignore).re"
