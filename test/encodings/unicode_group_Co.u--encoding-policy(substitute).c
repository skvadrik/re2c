...
#line 14 "encodings/unicode_group_Co.u--encoding-policy(substitute).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x000EFFFF) {
...
#line 30 "encodings/unicode_group_Co.u--encoding-policy(substitute).c"
yy4:
	++YYCURSOR;
#line 13 "encodings/unicode_group_Co.u--encoding-policy(substitute).re"
	{ goto Co; }
#line 35 "encodings/unicode_group_Co.u--encoding-policy(substitute).c"
}
#line 15 "encodings/unicode_group_Co.u--encoding-policy(substitute).re"
