...
#line 14 "encodings/unicode_group_L_.8--encoding-policy(fail).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	switch (yych) {
...
#line 102 "encodings/unicode_group_L_.8--encoding-policy(fail).c"
yy4:
	++YYCURSOR;
#line 13 "encodings/unicode_group_L_.8--encoding-policy(fail).re"
	{ goto L_; }
#line 107 "encodings/unicode_group_L_.8--encoding-policy(fail).c"
yy6:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0xB5:	goto yy4;
...
#line 15 "encodings/unicode_group_L_.8--encoding-policy(fail).re"
