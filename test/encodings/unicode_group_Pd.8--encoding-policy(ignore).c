...
#line 14 "encodings/unicode_group_Pd.8--encoding-policy(ignore).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	switch (yych) {
...
#line 32 "encodings/unicode_group_Pd.8--encoding-policy(ignore).c"
yy4:
	++YYCURSOR;
#line 13 "encodings/unicode_group_Pd.8--encoding-policy(ignore).re"
	{ goto Pd; }
#line 37 "encodings/unicode_group_Pd.8--encoding-policy(ignore).c"
yy6:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0x8A:
...
#line 15 "encodings/unicode_group_Pd.8--encoding-policy(ignore).re"
