...
#line 14 "encodings/unicode_group_Z.u--encoding-policy(substitute).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x0000200A) {
...
#line 43 "encodings/unicode_group_Z.u--encoding-policy(substitute).c"
yy4:
	++YYCURSOR;
#line 13 "encodings/unicode_group_Z.u--encoding-policy(substitute).re"
	{ goto Z; }
#line 48 "encodings/unicode_group_Z.u--encoding-policy(substitute).c"
}
#line 15 "encodings/unicode_group_Z.u--encoding-policy(substitute).re"
