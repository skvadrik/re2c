...
#line 14 "encodings/unicode_group_Sk.8--encoding-policy(fail).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	switch (yych) {
...
#line 36 "encodings/unicode_group_Sk.8--encoding-policy(fail).c"
yy4:
	++YYCURSOR;
#line 13 "encodings/unicode_group_Sk.8--encoding-policy(fail).re"
	{ goto Sk; }
#line 41 "encodings/unicode_group_Sk.8--encoding-policy(fail).c"
yy6:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0xA8:
...
#line 15 "encodings/unicode_group_Sk.8--encoding-policy(fail).re"
