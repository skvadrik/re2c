...
#line 14 "encodings/unicode_group_Mn.x--encoding-policy(substitute).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x108C) {
...
#line 652 "encodings/unicode_group_Mn.x--encoding-policy(substitute).c"
yy4:
	++YYCURSOR;
#line 13 "encodings/unicode_group_Mn.x--encoding-policy(substitute).re"
	{ goto Mn; }
#line 657 "encodings/unicode_group_Mn.x--encoding-policy(substitute).c"
yy6:
	yych = *++YYCURSOR;
	if (yych <= 0xDEDF) {
...
#line 15 "encodings/unicode_group_Mn.x--encoding-policy(substitute).re"
