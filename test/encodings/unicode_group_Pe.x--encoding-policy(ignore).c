...
#line 13 "encodings/unicode_group_Pe.x--encoding-policy(ignore).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x2998) {
...
#line 232 "encodings/unicode_group_Pe.x--encoding-policy(ignore).c"
yy4:
	++YYCURSOR;
#line 12 "encodings/unicode_group_Pe.x--encoding-policy(ignore).re"
	{ goto Pe; }
#line 237 "encodings/unicode_group_Pe.x--encoding-policy(ignore).c"
}
