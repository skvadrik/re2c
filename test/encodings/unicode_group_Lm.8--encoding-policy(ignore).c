/* Generated by re2c */
#line 1 "encodings/unicode_group_Lm.8--encoding-policy(ignore).re"
#include <stdio.h>
#include "utf8.h"
...
#line 13 "encodings/unicode_group_Lm.8--encoding-policy(ignore).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	switch (yych) {
...
yy2:
	++YYCURSOR;
yy3:
#line 13 "encodings/unicode_group_Lm.8--encoding-policy(ignore).re"
	{ return YYCURSOR == limit; }
#line 39 "encodings/unicode_group_Lm.8--encoding-policy(ignore).c"
yy4:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0xB0:
...
yy18:
	++YYCURSOR;
#line 12 "encodings/unicode_group_Lm.8--encoding-policy(ignore).re"
	{ goto Lm; }
#line 196 "encodings/unicode_group_Lm.8--encoding-policy(ignore).c"
yy20:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0x9A:
...
#line 14 "encodings/unicode_group_Lm.8--encoding-policy(ignore).re"
