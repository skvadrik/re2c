...
#line 14 "encodings/unicode_group_Lm.8--encoding-policy(ignore).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	switch (yych) {
...
#line 40 "encodings/unicode_group_Lm.8--encoding-policy(ignore).c"
yy4:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0xB0:
...
#line 13 "encodings/unicode_group_Lm.8--encoding-policy(ignore).re"
	{ goto Lm; }
#line 197 "encodings/unicode_group_Lm.8--encoding-policy(ignore).c"
yy20:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0x9A:
...
#line 15 "encodings/unicode_group_Lm.8--encoding-policy(ignore).re"
