...
#line 15 "encodings/unicode_group_Nl_x_encoding_policy_ignore.c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x3020) {
...
#line 52 "encodings/unicode_group_Nl_x_encoding_policy_ignore.c"
yy3:
	++YYCURSOR;
#line 14 "encodings/unicode_group_Nl_x_encoding_policy_ignore.re"
	{ goto Nl; }
#line 57 "encodings/unicode_group_Nl_x_encoding_policy_ignore.c"
yy4:
	yych = *++YYCURSOR;
	if (yych <= 0xDF41) {
...
#line 16 "encodings/unicode_group_Nl_x_encoding_policy_ignore.re"
