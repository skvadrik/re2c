...
#line 462 "encodings/unicode_group_Po_x_encoding_policy_substitute.c"
yy3:
	++YYCURSOR;
#line 13 "encodings/unicode_group_Po_x_encoding_policy_substitute.re"
	{ goto Po; }
#line 467 "encodings/unicode_group_Po_x_encoding_policy_substitute.c"
yy4:
	yych = *++YYCURSOR;
	if (yych <= 0xDF9E) {
...
int main ()
{
	unsigned int * buffer_Po = new unsigned int [1258];
