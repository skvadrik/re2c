...
#line 14 "encodings/unicode_group_L__x_encoding_policy_fail.c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x1FD5) {
...
#line 334 "encodings/unicode_group_L__x_encoding_policy_fail.c"
yy3:
	++YYCURSOR;
#line 13 "encodings/unicode_group_L__x_encoding_policy_fail.re"
	{ goto L_; }
#line 339 "encodings/unicode_group_L__x_encoding_policy_fail.c"
yy4:
	yych = *++YYCURSOR;
	if (yych <= 0xDD8B) {
		if (yych <= 0xDCD7) {
