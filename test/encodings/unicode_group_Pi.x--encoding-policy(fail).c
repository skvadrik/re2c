...
#line 14 "encodings/unicode_group_Pi.x--encoding-policy(fail).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x2E01) {
...
#line 52 "encodings/unicode_group_Pi.x--encoding-policy(fail).c"
yy4:
	++YYCURSOR;
#line 13 "encodings/unicode_group_Pi.x--encoding-policy(fail).re"
	{ goto Pi; }
#line 57 "encodings/unicode_group_Pi.x--encoding-policy(fail).c"
}
#line 15 "encodings/unicode_group_Pi.x--encoding-policy(fail).re"
