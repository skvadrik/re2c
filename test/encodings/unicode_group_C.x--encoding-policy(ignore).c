/* Generated by re2c */
#line 1 "encodings/unicode_group_C.x--encoding-policy(ignore).re"
...
#line 14 "encodings/unicode_group_C.x--encoding-policy(ignore).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x137F) {
...
yy2:
	++YYCURSOR;
yy3:
#line 13 "encodings/unicode_group_C.x--encoding-policy(ignore).re"
	{ goto C; }
#line 1265 "encodings/unicode_group_C.x--encoding-policy(ignore).c"
yy4:
	++YYCURSOR;
#line 14 "encodings/unicode_group_C.x--encoding-policy(ignore).re"
	{ return YYCURSOR == limit; }
#line 1270 "encodings/unicode_group_C.x--encoding-policy(ignore).c"
yy6:
	yych = *++YYCURSOR;
	if (yych <= 0xDD9F) {
		if (yych <= 0xDC5D) {
...
#line 15 "encodings/unicode_group_C.x--encoding-policy(ignore).re"
