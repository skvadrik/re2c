...
#line 13 "encodings/unicode_group_C.x--encoding-policy(ignore).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x137F) {
...
yy2:
	++YYCURSOR;
yy3:
#line 12 "encodings/unicode_group_C.x--encoding-policy(ignore).re"
	{ goto C; }
#line 1264 "encodings/unicode_group_C.x--encoding-policy(ignore).c"
yy4:
	++YYCURSOR;
#line 13 "encodings/unicode_group_C.x--encoding-policy(ignore).re"
	{ return YYCURSOR == limit; }
#line 1269 "encodings/unicode_group_C.x--encoding-policy(ignore).c"
yy6:
	yych = *++YYCURSOR;
	if (yych <= 0xDD9F) {
		if (yych <= 0xDC5D) {
