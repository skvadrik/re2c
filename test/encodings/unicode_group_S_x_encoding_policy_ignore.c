					...
					if (yych <= 0x00F6) {
						...
						if (yych <= 0x02DF) {
							if (yych <= 0x02C1) {
								...
								if (yych >= 0x02D2) goto yy3;
							}
						} else {
							if (yych <= 0x02EB) {
								if (yych >= 0x02E5) goto yy3;
							} else {
			...
			if (yych <= 0x19FF) {
				...
				if (yych <= 0x2052) {
					if (yych <= 0x1FCF) {
						if (yych <= 0x1FBC) {
							if (yych <= 0x1B6A) {
								if (yych >= 0x1B61) goto yy3;
							} else {
								if (yych <= 0x1B73) goto yy1;
...
#line 565 "encodings/unicode_group_S_x_encoding_policy_ignore.c"
yy3:
	++YYCURSOR;
#line 13 "encodings/unicode_group_S_x_encoding_policy_ignore.re"
	{ goto S; }
#line 570 "encodings/unicode_group_S_x_encoding_policy_ignore.c"
yy4:
	yych = *++YYCURSOR;
	if (yych <= 0xDD8E) {
		if (yych <= 0xDD78) {
...
int main ()
{
	unsigned int * buffer_S = new unsigned int [14586];
