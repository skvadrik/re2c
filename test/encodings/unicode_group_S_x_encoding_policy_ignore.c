/* Generated by re2c */
#line 1 "encodings/unicode_group_S_x_encoding_policy_ignore.re"
...
#line 15 "encodings/unicode_group_S_x_encoding_policy_ignore.c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x2129) {
					...
					if (yych <= 0x2113) {
						if (yych <= 0x2101) {
							if (yych <= 0x209F) {
								...
								if (yych >= 0x2100) goto yy3;
							}
						} else {
							if (yych <= 0x2106) {
								if (yych >= 0x2103) goto yy3;
							} else {
					...
					if (yych <= 0x2FEF) {
						if (yych <= 0x2E99) {
							if (yych <= 0x2E4F) {
								...
								if (yych >= 0x2E80) goto yy3;
							}
						} else {
							if (yych <= 0x2EF3) {
								if (yych >= 0x2E9B) goto yy3;
							} else {
...
yy1:
	++YYCURSOR;
yy2:
#line 15 "encodings/unicode_group_S_x_encoding_policy_ignore.re"
	{ return YYCURSOR - 1 == limit; }
#line 586 "encodings/unicode_group_S_x_encoding_policy_ignore.c"
yy3:
	++YYCURSOR;
#line 14 "encodings/unicode_group_S_x_encoding_policy_ignore.re"
	{ goto S; }
#line 591 "encodings/unicode_group_S_x_encoding_policy_ignore.c"
yy4:
	yych = *++YYCURSOR;
	if (yych <= 0xDD8E) {
		if (yych <= 0xDD78) {
...
#line 16 "encodings/unicode_group_S_x_encoding_policy_ignore.re"
...
int main() {
	YYCTYPE* buffer_S = new YYCTYPE[15552];
	uint32_t buffer_S_len = encode_utf16(chars_S, sizeof(chars_S) / sizeof(uint32_t), buffer_S);
