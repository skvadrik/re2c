...
#line 14 "encodings/unicode_group_S_x_encoding_policy_ignore.c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x2129) {
...
#line 585 "encodings/unicode_group_S_x_encoding_policy_ignore.c"
yy3:
	++YYCURSOR;
#line 13 "encodings/unicode_group_S_x_encoding_policy_ignore.re"
	{ goto S; }
#line 590 "encodings/unicode_group_S_x_encoding_policy_ignore.c"
yy4:
	yych = *++YYCURSOR;
	if (yych <= 0xDD8E) {
		if (yych <= 0xDD78) {
...
int main ()
{
	unsigned int * buffer_S = new unsigned int [15552];
