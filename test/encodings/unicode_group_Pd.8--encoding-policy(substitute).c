...
#line 14 "encodings/unicode_group_Pd.8--encoding-policy(substitute).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	switch (yych) {
...
#line 32 "encodings/unicode_group_Pd.8--encoding-policy(substitute).c"
yy4:
	++YYCURSOR;
#line 13 "encodings/unicode_group_Pd.8--encoding-policy(substitute).re"
	{ goto Pd; }
#line 37 "encodings/unicode_group_Pd.8--encoding-policy(substitute).c"
yy6:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0x8A:
...
#line 15 "encodings/unicode_group_Pd.8--encoding-policy(substitute).re"
