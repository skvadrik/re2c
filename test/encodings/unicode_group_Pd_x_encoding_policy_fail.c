...
#line 15 "encodings/unicode_group_Pd_x_encoding_policy_fail.c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x2E3F) {
...
#line 86 "encodings/unicode_group_Pd_x_encoding_policy_fail.c"
yy3:
	++YYCURSOR;
#line 14 "encodings/unicode_group_Pd_x_encoding_policy_fail.re"
	{ goto Pd; }
#line 91 "encodings/unicode_group_Pd_x_encoding_policy_fail.c"
yy4:
	yych = *++YYCURSOR;
	if (yych == 0xDEAD) goto yy3;
	goto yy2;
}
#line 16 "encodings/unicode_group_Pd_x_encoding_policy_fail.re"
