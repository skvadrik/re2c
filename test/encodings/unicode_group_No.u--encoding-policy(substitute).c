...
#line 14 "encodings/unicode_group_No.u--encoding-policy(substitute).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x00003289) {
...
#line 186 "encodings/unicode_group_No.u--encoding-policy(substitute).c"
yy4:
	++YYCURSOR;
#line 13 "encodings/unicode_group_No.u--encoding-policy(substitute).re"
	{ goto No; }
#line 191 "encodings/unicode_group_No.u--encoding-policy(substitute).c"
}
#line 15 "encodings/unicode_group_No.u--encoding-policy(substitute).re"
