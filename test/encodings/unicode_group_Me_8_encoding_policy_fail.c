...
#line 15 "encodings/unicode_group_Me_8_encoding_policy_fail.c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	switch (yych) {
...
#line 31 "encodings/unicode_group_Me_8_encoding_policy_fail.c"
yy3:
	yych = *++YYCURSOR;
	switch (yych) {
		case 0x88:
...
#line 14 "encodings/unicode_group_Me_8_encoding_policy_fail.re"
	{ goto Me; }
#line 61 "encodings/unicode_group_Me_8_encoding_policy_fail.c"
yy8:
	yych = *++YYCURSOR;
	switch (yych) {
		case 0xBE: goto yy7;
...
#line 16 "encodings/unicode_group_Me_8_encoding_policy_fail.re"
