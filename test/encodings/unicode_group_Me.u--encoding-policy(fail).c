/* Generated by re2c */
#line 1 "encodings/unicode_group_Me.u--encoding-policy(fail).re"
#include <stdio.h>
...
#line 13 "encodings/unicode_group_Me.u--encoding-policy(fail).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x000020DC) {
...
yy2:
	++YYCURSOR;
#line 13 "encodings/unicode_group_Me.u--encoding-policy(fail).re"
	{ return YYCURSOR == limit; }
#line 35 "encodings/unicode_group_Me.u--encoding-policy(fail).c"
yy4:
	++YYCURSOR;
#line 12 "encodings/unicode_group_Me.u--encoding-policy(fail).re"
	{ goto Me; }
#line 40 "encodings/unicode_group_Me.u--encoding-policy(fail).c"
}
#line 14 "encodings/unicode_group_Me.u--encoding-policy(fail).re"
