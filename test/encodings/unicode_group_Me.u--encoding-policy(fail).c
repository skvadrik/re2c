...
#line 14 "encodings/unicode_group_Me.u--encoding-policy(fail).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x000020DC) {
...
#line 36 "encodings/unicode_group_Me.u--encoding-policy(fail).c"
yy4:
	++YYCURSOR;
#line 13 "encodings/unicode_group_Me.u--encoding-policy(fail).re"
	{ goto Me; }
#line 41 "encodings/unicode_group_Me.u--encoding-policy(fail).c"
}
#line 15 "encodings/unicode_group_Me.u--encoding-policy(fail).re"
