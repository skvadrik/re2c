/* Generated by re2c */
#line 1 "encodings/unicode_group_No_x.re"
...
#line 15 "encodings/unicode_group_No_x.c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x249B) {
...
yy1:
	++YYCURSOR;
yy2:
#line 15 "encodings/unicode_group_No_x.re"
	{ return YYCURSOR - 1 == limit; }
#line 157 "encodings/unicode_group_No_x.c"
yy3:
	++YYCURSOR;
#line 14 "encodings/unicode_group_No_x.re"
	{ goto No; }
#line 162 "encodings/unicode_group_No_x.c"
yy4:
	yych = *++YYCURSOR;
	if (yych <= 0xDD89) {
		if (yych <= 0xDD33) {
...
#line 16 "encodings/unicode_group_No_x.re"
