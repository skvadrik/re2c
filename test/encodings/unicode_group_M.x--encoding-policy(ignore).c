/* Generated by re2c */
#line 1 "encodings/unicode_group_M.x--encoding-policy(ignore).re"
...
#line 14 "encodings/unicode_group_M.x--encoding-policy(ignore).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x0F36) {
...
yy2:
	++YYCURSOR;
yy3:
#line 14 "encodings/unicode_group_M.x--encoding-policy(ignore).re"
	{ return YYCURSOR == limit; }
#line 640 "encodings/unicode_group_M.x--encoding-policy(ignore).c"
yy4:
	++YYCURSOR;
#line 13 "encodings/unicode_group_M.x--encoding-policy(ignore).re"
	{ goto M; }
#line 645 "encodings/unicode_group_M.x--encoding-policy(ignore).c"
yy6:
	yych = *++YYCURSOR;
	if (yych <= 0xDEDF) {
...
#line 15 "encodings/unicode_group_M.x--encoding-policy(ignore).re"
