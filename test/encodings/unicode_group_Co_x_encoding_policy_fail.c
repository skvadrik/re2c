...
#line 14 "encodings/unicode_group_Co_x_encoding_policy_fail.c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0xDBFE) {
...
#line 32 "encodings/unicode_group_Co_x_encoding_policy_fail.c"
yy4:
	yych = *++YYCURSOR;
...
yy6:
	++YYCURSOR;
#line 13 "encodings/unicode_group_Co_x_encoding_policy_fail.re"
	{ goto Co; }
#line 46 "encodings/unicode_group_Co_x_encoding_policy_fail.c"
}
