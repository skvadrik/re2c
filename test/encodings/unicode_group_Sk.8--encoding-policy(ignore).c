/* Generated by re2c */
#line 1 "encodings/unicode_group_Sk.8--encoding-policy(ignore).re"
#include <stdio.h>
#include "utf8.h"
...
#line 13 "encodings/unicode_group_Sk.8--encoding-policy(ignore).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	switch (yych) {
...
yy2:
	++YYCURSOR;
yy3:
#line 13 "encodings/unicode_group_Sk.8--encoding-policy(ignore).re"
	{ return YYCURSOR == limit; }
#line 35 "encodings/unicode_group_Sk.8--encoding-policy(ignore).c"
yy4:
	++YYCURSOR;
#line 12 "encodings/unicode_group_Sk.8--encoding-policy(ignore).re"
	{ goto Sk; }
#line 40 "encodings/unicode_group_Sk.8--encoding-policy(ignore).c"
yy6:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0xA8:
...
#line 14 "encodings/unicode_group_Sk.8--encoding-policy(ignore).re"
