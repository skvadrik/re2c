...
#line 14 "encodings/unicode_group_Sm_8_encoding_policy_fail.c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	switch (yych) {
...
#line 39 "encodings/unicode_group_Sm_8_encoding_policy_fail.c"
yy4:
	++YYCURSOR;
#line 13 "encodings/unicode_group_Sm_8_encoding_policy_fail.re"
	{ goto Sm; }
#line 44 "encodings/unicode_group_Sm_8_encoding_policy_fail.c"
yy6:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0xAC:
