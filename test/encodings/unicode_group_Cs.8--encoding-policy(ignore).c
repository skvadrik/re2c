/* Generated by re2c */
#line 1 "encodings/unicode_group_Cs.8--encoding-policy(ignore).re"
...
#line 14 "encodings/unicode_group_Cs.8--encoding-policy(ignore).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	switch (yych) {
...
yy2:
	++YYCURSOR;
yy3:
#line 14 "encodings/unicode_group_Cs.8--encoding-policy(ignore).re"
	{ return YYCURSOR == limit; }
#line 27 "encodings/unicode_group_Cs.8--encoding-policy(ignore).c"
yy4:
...
yy7:
	++YYCURSOR;
#line 13 "encodings/unicode_group_Cs.8--encoding-policy(ignore).re"
	{ goto Cs; }
#line 141 "encodings/unicode_group_Cs.8--encoding-policy(ignore).c"
}
#line 15 "encodings/unicode_group_Cs.8--encoding-policy(ignore).re"
