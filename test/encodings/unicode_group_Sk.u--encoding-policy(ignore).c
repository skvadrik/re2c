...
#line 14 "encodings/unicode_group_Sk.u--encoding-policy(ignore).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x00001FBD) {
...
#line 101 "encodings/unicode_group_Sk.u--encoding-policy(ignore).c"
yy4:
	++YYCURSOR;
#line 13 "encodings/unicode_group_Sk.u--encoding-policy(ignore).re"
	{ goto Sk; }
#line 106 "encodings/unicode_group_Sk.u--encoding-policy(ignore).c"
}
#line 15 "encodings/unicode_group_Sk.u--encoding-policy(ignore).re"
