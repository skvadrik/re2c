/* Generated by re2c */
#line 1 "encodings/unicode_group_So.x--encoding-policy(substitute).re"
...
#line 14 "encodings/unicode_group_So.x--encoding-policy(substitute).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x2321) {
...
yy2:
	++YYCURSOR;
yy3:
#line 14 "encodings/unicode_group_So.x--encoding-policy(substitute).re"
	{ return YYCURSOR == limit; }
#line 364 "encodings/unicode_group_So.x--encoding-policy(substitute).c"
yy4:
	++YYCURSOR;
#line 13 "encodings/unicode_group_So.x--encoding-policy(substitute).re"
	{ goto So; }
#line 369 "encodings/unicode_group_So.x--encoding-policy(substitute).c"
yy6:
	yych = *++YYCURSOR;
	if (yych <= 0xDD8C) {
		if (yych <= 0xDD78) {
...
#line 15 "encodings/unicode_group_So.x--encoding-policy(substitute).re"
