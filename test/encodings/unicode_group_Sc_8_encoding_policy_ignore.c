...
#line 14 "encodings/unicode_group_Sc_8_encoding_policy_ignore.c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	switch (yych) {
...
#line 35 "encodings/unicode_group_Sc_8_encoding_policy_ignore.c"
yy4:
	++YYCURSOR;
#line 13 "encodings/unicode_group_Sc_8_encoding_policy_ignore.re"
	{ goto Sc; }
#line 40 "encodings/unicode_group_Sc_8_encoding_policy_ignore.c"
yy6:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0xA2:
