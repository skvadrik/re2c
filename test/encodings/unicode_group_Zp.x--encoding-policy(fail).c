...
#line 14 "encodings/unicode_group_Zp.x--encoding-policy(fail).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
...
#line 22 "encodings/unicode_group_Zp.x--encoding-policy(fail).c"
yy4:
	++YYCURSOR;
#line 13 "encodings/unicode_group_Zp.x--encoding-policy(fail).re"
	{ goto Zp; }
#line 27 "encodings/unicode_group_Zp.x--encoding-policy(fail).c"
}
#line 15 "encodings/unicode_group_Zp.x--encoding-policy(fail).re"
