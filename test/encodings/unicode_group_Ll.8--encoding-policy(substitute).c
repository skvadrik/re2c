...
#line 14 "encodings/unicode_group_Ll.8--encoding-policy(substitute).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	switch (yych) {
...
#line 76 "encodings/unicode_group_Ll.8--encoding-policy(substitute).c"
yy4:
	++YYCURSOR;
#line 13 "encodings/unicode_group_Ll.8--encoding-policy(substitute).re"
	{ goto Ll; }
#line 81 "encodings/unicode_group_Ll.8--encoding-policy(substitute).c"
yy6:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0xB5:	goto yy4;
...
#line 15 "encodings/unicode_group_Ll.8--encoding-policy(substitute).re"
