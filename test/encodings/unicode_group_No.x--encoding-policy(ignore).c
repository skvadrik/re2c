/* Generated by re2c */
#line 1 "encodings/unicode_group_No.x--encoding-policy(ignore).re"
...
#line 14 "encodings/unicode_group_No.x--encoding-policy(ignore).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x249B) {
...
yy2:
	++YYCURSOR;
yy3:
#line 14 "encodings/unicode_group_No.x--encoding-policy(ignore).re"
	{ return YYCURSOR == limit; }
#line 141 "encodings/unicode_group_No.x--encoding-policy(ignore).c"
yy4:
	++YYCURSOR;
#line 13 "encodings/unicode_group_No.x--encoding-policy(ignore).re"
	{ goto No; }
#line 146 "encodings/unicode_group_No.x--encoding-policy(ignore).c"
yy6:
	yych = *++YYCURSOR;
	if (yych <= 0xDD89) {
		if (yych <= 0xDD33) {
...
#line 15 "encodings/unicode_group_No.x--encoding-policy(ignore).re"
