...
#line 14 "encodings/unicode_group_Me.8--encoding-policy(substitute).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	switch (yych) {
...
#line 30 "encodings/unicode_group_Me.8--encoding-policy(substitute).c"
yy4:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0x88:
...
#line 13 "encodings/unicode_group_Me.8--encoding-policy(substitute).re"
	{ goto Me; }
#line 60 "encodings/unicode_group_Me.8--encoding-policy(substitute).c"
yy10:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0xBE:	goto yy8;
...
#line 15 "encodings/unicode_group_Me.8--encoding-policy(substitute).re"
