...
#line 14 "encodings/unicode_group_Lt.u--encoding-policy(fail).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x00001F8F) {
...
#line 54 "encodings/unicode_group_Lt.u--encoding-policy(fail).c"
yy4:
	++YYCURSOR;
#line 13 "encodings/unicode_group_Lt.u--encoding-policy(fail).re"
	{ goto Lt; }
#line 59 "encodings/unicode_group_Lt.u--encoding-policy(fail).c"
}
#line 15 "encodings/unicode_group_Lt.u--encoding-policy(fail).re"
