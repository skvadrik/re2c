		...
		if (yych <= 0x32BF) {
			if (yych <= 0x321F) {
				...
				if (yych <= 0x3250) {
					...
					if (yych <= 0x3247) goto yy1;
					if (yych <= 0x324F) goto yy3;
				} else {
					if (yych <= 0x327F) {
						if (yych <= 0x325F) goto yy3;
					} else {
						if (yych <= 0x3289) goto yy3;
						if (yych >= 0x32B1) goto yy3;
					}
				}
			}
		} else {
			if (yych <= 0xD805) {
				...
				if (yych <= 0xD834) {
					...
					if (yych <= 0xD83A) {
						if (yych >= 0xD83A) goto yy11;
					} else {
						if (yych == 0xD83C) goto yy12;
					}
				}
			}
		}
