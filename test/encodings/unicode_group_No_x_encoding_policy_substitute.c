...
#line 15 "encodings/unicode_group_No_x_encoding_policy_substitute.c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x249B) {
...
#line 157 "encodings/unicode_group_No_x_encoding_policy_substitute.c"
yy3:
	++YYCURSOR;
#line 14 "encodings/unicode_group_No_x_encoding_policy_substitute.re"
	{ goto No; }
#line 162 "encodings/unicode_group_No_x_encoding_policy_substitute.c"
yy4:
	yych = *++YYCURSOR;
	if (yych <= 0xDD89) {
		if (yych <= 0xDD33) {
...
#line 16 "encodings/unicode_group_No_x_encoding_policy_substitute.re"
