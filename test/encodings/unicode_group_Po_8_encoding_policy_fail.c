...
#line 14 "encodings/unicode_group_Po_8_encoding_policy_fail.c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	switch (yych) {
...
#line 59 "encodings/unicode_group_Po_8_encoding_policy_fail.c"
yy3:
	++YYCURSOR;
#line 13 "encodings/unicode_group_Po_8_encoding_policy_fail.re"
	{ goto Po; }
#line 64 "encodings/unicode_group_Po_8_encoding_policy_fail.c"
yy4:
	yych = *++YYCURSOR;
	switch (yych) {
		case 0xA1:
