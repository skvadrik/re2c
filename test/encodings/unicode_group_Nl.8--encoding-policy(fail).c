/* Generated by re2c */
#line 1 "encodings/unicode_group_Nl.8--encoding-policy(fail).re"
#include <stdio.h>
#include "utf8.h"
...
#line 13 "encodings/unicode_group_Nl.8--encoding-policy(fail).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	switch (yych) {
...
yy2:
	++YYCURSOR;
yy3:
#line 13 "encodings/unicode_group_Nl.8--encoding-policy(fail).re"
	{ return YYCURSOR == limit; }
#line 30 "encodings/unicode_group_Nl.8--encoding-policy(fail).c"
yy4:
...
yy17:
	++YYCURSOR;
#line 12 "encodings/unicode_group_Nl.8--encoding-policy(fail).re"
	{ goto Nl; }
#line 175 "encodings/unicode_group_Nl.8--encoding-policy(fail).c"
yy19:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0x80:
...
#line 14 "encodings/unicode_group_Nl.8--encoding-policy(fail).re"
