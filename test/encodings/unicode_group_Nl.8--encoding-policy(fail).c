...
#line 14 "encodings/unicode_group_Nl.8--encoding-policy(fail).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	switch (yych) {
...
#line 31 "encodings/unicode_group_Nl.8--encoding-policy(fail).c"
yy4:
...
#line 13 "encodings/unicode_group_Nl.8--encoding-policy(fail).re"
	{ goto Nl; }
#line 176 "encodings/unicode_group_Nl.8--encoding-policy(fail).c"
yy19:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0x80:
...
#line 15 "encodings/unicode_group_Nl.8--encoding-policy(fail).re"
