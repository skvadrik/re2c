/* Generated by re2c */
#line 1 "encodings/range_dot_x.re"
// re2c $INPUT -o $OUTPUT -x

#line 6 "encodings/range_dot_x.c"
{
	YYCTYPE yych;
...
encodings/range_dot_x.re:2:0: warning: control flow is undefined for strings that match '\xA', use default rule '*' [-Wundefined-control-flow]
