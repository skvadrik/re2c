...
#line 13 "encodings/unicode_group_Pe.x--encoding-policy(substitute).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x2998) {
...
#line 232 "encodings/unicode_group_Pe.x--encoding-policy(substitute).c"
yy4:
	++YYCURSOR;
#line 12 "encodings/unicode_group_Pe.x--encoding-policy(substitute).re"
	{ goto Pe; }
#line 237 "encodings/unicode_group_Pe.x--encoding-policy(substitute).c"
}
