/* Generated by re2c */
#line 1 "encodings/unicode_group_S.x--encoding-policy(substitute).re"
#include <stdio.h>
#include "utf16.h"
...
#line 13 "encodings/unicode_group_S.x--encoding-policy(substitute).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x2127) {
					...
					if (yych <= 0x2109) {
						if (yych <= 0x20FF) {
							if (yych <= 0x208C) {
								...
								if (yych <= 0x209F) goto yy2;
								if (yych <= 0x20BD) goto yy4;
							}
						} else {
							if (yych <= 0x2102) {
								if (yych <= 0x2101) goto yy4;
							} else {
			...
			if (yych <= 0x2B73) {
				if (yych <= 0x23FF) {
					if (yych <= 0x2149) {
						...
						if (yych <= 0x2307) {
							if (yych <= 0x214E) {
								if (yych <= 0x214D) goto yy4;
							} else {
								if (yych <= 0x214F) goto yy4;
								if (yych >= 0x2190) goto yy4;
							}
						} else {
							if (yych <= 0x2328) {
								if (yych >= 0x230C) goto yy4;
							} else {
				...
				if (yych <= 0xFF03) {
					if (yych <= 0xFBB1) {
						if (yych <= 0xD83C) {
							...
							if (yych <= 0xD83A) goto yy2;
							if (yych <= 0xD83B) goto yy12;
							goto yy13;
						} else {
							if (yych <= 0xD83E) {
								if (yych <= 0xD83D) goto yy14;
								goto yy15;
							} else {
...
yy2:
	++YYCURSOR;
yy3:
#line 13 "encodings/unicode_group_S.x--encoding-policy(substitute).re"
	{ return YYCURSOR == limit; }
#line 543 "encodings/unicode_group_S.x--encoding-policy(substitute).c"
yy4:
	++YYCURSOR;
#line 12 "encodings/unicode_group_S.x--encoding-policy(substitute).re"
	{ goto S; }
#line 548 "encodings/unicode_group_S.x--encoding-policy(substitute).c"
yy6:
	yych = *++YYCURSOR;
	if (yych <= 0xDD8C) {
		if (yych <= 0xDD78) {
...
#line 14 "encodings/unicode_group_S.x--encoding-policy(substitute).re"
