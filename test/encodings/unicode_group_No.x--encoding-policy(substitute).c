...
#line 14 "encodings/unicode_group_No.x--encoding-policy(substitute).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x249B) {
...
#line 141 "encodings/unicode_group_No.x--encoding-policy(substitute).c"
yy4:
	++YYCURSOR;
#line 13 "encodings/unicode_group_No.x--encoding-policy(substitute).re"
	{ goto No; }
#line 146 "encodings/unicode_group_No.x--encoding-policy(substitute).c"
yy6:
	yych = *++YYCURSOR;
	if (yych <= 0xDD89) {
		if (yych <= 0xDD33) {
...
#line 15 "encodings/unicode_group_No.x--encoding-policy(substitute).re"
