/* Generated by re2c */
#line 1 "encodings/unicode_group_Po.x--encoding-policy(substitute).re"
...
#line 14 "encodings/unicode_group_Po.x--encoding-policy(substitute).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x203A) {
...
yy2:
	++YYCURSOR;
yy3:
#line 14 "encodings/unicode_group_Po.x--encoding-policy(substitute).re"
	{ return YYCURSOR == limit; }
#line 384 "encodings/unicode_group_Po.x--encoding-policy(substitute).c"
yy4:
	++YYCURSOR;
#line 13 "encodings/unicode_group_Po.x--encoding-policy(substitute).re"
	{ goto Po; }
#line 389 "encodings/unicode_group_Po.x--encoding-policy(substitute).c"
yy6:
	yych = *++YYCURSOR;
	if (yych <= 0xDF9E) {
...
#line 15 "encodings/unicode_group_Po.x--encoding-policy(substitute).re"
