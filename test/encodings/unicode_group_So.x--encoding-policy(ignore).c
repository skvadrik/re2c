/* Generated by re2c */
#line 1 "encodings/unicode_group_So.x--encoding-policy(ignore).re"
#include <stdio.h>
#include "utf16.h"
...
#line 13 "encodings/unicode_group_So.x--encoding-policy(ignore).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x2321) {
...
yy2:
	++YYCURSOR;
yy3:
#line 13 "encodings/unicode_group_So.x--encoding-policy(ignore).re"
	{ return YYCURSOR == limit; }
#line 363 "encodings/unicode_group_So.x--encoding-policy(ignore).c"
yy4:
	++YYCURSOR;
#line 12 "encodings/unicode_group_So.x--encoding-policy(ignore).re"
	{ goto So; }
#line 368 "encodings/unicode_group_So.x--encoding-policy(ignore).c"
yy6:
	yych = *++YYCURSOR;
	if (yych <= 0xDD8C) {
		if (yych <= 0xDD78) {
...
#line 14 "encodings/unicode_group_So.x--encoding-policy(ignore).re"
