/* Generated by re2c */
#line 1 "encodings/unicode_group_Sc.u--encoding-policy(fail).re"
...
#line 14 "encodings/unicode_group_Sc.u--encoding-policy(fail).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x00000E3E) {
...
yy2:
	++YYCURSOR;
#line 14 "encodings/unicode_group_Sc.u--encoding-policy(fail).re"
	{ return YYCURSOR == limit; }
#line 71 "encodings/unicode_group_Sc.u--encoding-policy(fail).c"
yy4:
	++YYCURSOR;
#line 13 "encodings/unicode_group_Sc.u--encoding-policy(fail).re"
	{ goto Sc; }
#line 76 "encodings/unicode_group_Sc.u--encoding-policy(fail).c"
}
#line 15 "encodings/unicode_group_Sc.u--encoding-policy(fail).re"
