...
#line 14 "encodings/unicode_group_Po_x_encoding_policy_ignore.c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x2040) {
...
#line 462 "encodings/unicode_group_Po_x_encoding_policy_ignore.c"
yy3:
	++YYCURSOR;
#line 13 "encodings/unicode_group_Po_x_encoding_policy_ignore.re"
	{ goto Po; }
#line 467 "encodings/unicode_group_Po_x_encoding_policy_ignore.c"
yy4:
	yych = *++YYCURSOR;
	if (yych <= 0xDF9E) {
