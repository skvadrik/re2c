/* Generated by re2c */
#line 1 "encodings/unicode_group_S.x--encoding-policy(fail).re"
...
#line 14 "encodings/unicode_group_S.x--encoding-policy(fail).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x2127) {
...
yy2:
	++YYCURSOR;
yy3:
#line 14 "encodings/unicode_group_S.x--encoding-policy(fail).re"
	{ return YYCURSOR == limit; }
#line 544 "encodings/unicode_group_S.x--encoding-policy(fail).c"
yy4:
	++YYCURSOR;
#line 13 "encodings/unicode_group_S.x--encoding-policy(fail).re"
	{ goto S; }
#line 549 "encodings/unicode_group_S.x--encoding-policy(fail).c"
yy6:
	yych = *++YYCURSOR;
	if (yych <= 0xDD8C) {
		if (yych <= 0xDD78) {
...
#line 15 "encodings/unicode_group_S.x--encoding-policy(fail).re"
