...
#line 13 "encodings/unicode_group_S.x--encoding-policy(fail).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x2127) {
...
#line 543 "encodings/unicode_group_S.x--encoding-policy(fail).c"
yy4:
	++YYCURSOR;
#line 12 "encodings/unicode_group_S.x--encoding-policy(fail).re"
	{ goto S; }
#line 548 "encodings/unicode_group_S.x--encoding-policy(fail).c"
yy6:
	yych = *++YYCURSOR;
	if (yych <= 0xDD8C) {
		if (yych <= 0xDD78) {
