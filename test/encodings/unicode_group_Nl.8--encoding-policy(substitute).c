/* Generated by re2c */
#line 1 "encodings/unicode_group_Nl.8--encoding-policy(substitute).re"
...
#line 14 "encodings/unicode_group_Nl.8--encoding-policy(substitute).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	switch (yych) {
...
#line 31 "encodings/unicode_group_Nl.8--encoding-policy(substitute).c"
yy4:
...
yy17:
	++YYCURSOR;
#line 13 "encodings/unicode_group_Nl.8--encoding-policy(substitute).re"
	{ goto Nl; }
#line 176 "encodings/unicode_group_Nl.8--encoding-policy(substitute).c"
yy19:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0x80:
...
#line 15 "encodings/unicode_group_Nl.8--encoding-policy(substitute).re"
