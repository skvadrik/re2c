...
#line 13 "encodings/unicode_group_N.8--encoding-policy(fail).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	switch (yych) {
...
#line 46 "encodings/unicode_group_N.8--encoding-policy(fail).c"
yy4:
	++YYCURSOR;
#line 12 "encodings/unicode_group_N.8--encoding-policy(fail).re"
	{ goto N; }
#line 51 "encodings/unicode_group_N.8--encoding-policy(fail).c"
yy6:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0xB2:
