...
#line 14 "encodings/unicode_group_So_x_encoding_policy_ignore.c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x232A) {
...
#line 373 "encodings/unicode_group_So_x_encoding_policy_ignore.c"
yy3:
	++YYCURSOR;
#line 13 "encodings/unicode_group_So_x_encoding_policy_ignore.re"
	{ goto So; }
#line 378 "encodings/unicode_group_So_x_encoding_policy_ignore.c"
yy4:
	yych = *++YYCURSOR;
	if (yych <= 0xDD8E) {
		if (yych <= 0xDD78) {
