/* Generated by re2c */
#line 1 "encodings/unicode_group_So_x_encoding_policy_ignore.re"
...
#line 15 "encodings/unicode_group_So_x_encoding_policy_ignore.c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x232A) {
...
yy1:
	++YYCURSOR;
yy2:
#line 15 "encodings/unicode_group_So_x_encoding_policy_ignore.re"
	{ return YYCURSOR - 1 == limit; }
#line 374 "encodings/unicode_group_So_x_encoding_policy_ignore.c"
yy3:
	++YYCURSOR;
#line 14 "encodings/unicode_group_So_x_encoding_policy_ignore.re"
	{ goto So; }
#line 379 "encodings/unicode_group_So_x_encoding_policy_ignore.c"
yy4:
	yych = *++YYCURSOR;
	if (yych <= 0xDD8E) {
		if (yych <= 0xDD78) {
...
#line 16 "encodings/unicode_group_So_x_encoding_policy_ignore.re"
