...
#line 14 "encodings/unicode_group_S.8--encoding-policy(ignore).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	switch (yych) {
...
#line 54 "encodings/unicode_group_S.8--encoding-policy(ignore).c"
yy4:
	++YYCURSOR;
#line 13 "encodings/unicode_group_S.8--encoding-policy(ignore).re"
	{ goto S; }
#line 59 "encodings/unicode_group_S.8--encoding-policy(ignore).c"
yy6:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0xA2:
...
#line 15 "encodings/unicode_group_S.8--encoding-policy(ignore).re"
