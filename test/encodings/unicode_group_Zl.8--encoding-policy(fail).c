...
#line 14 "encodings/unicode_group_Zl.8--encoding-policy(fail).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	switch (yych) {
...
#line 27 "encodings/unicode_group_Zl.8--encoding-policy(fail).c"
yy4:
...
#line 13 "encodings/unicode_group_Zl.8--encoding-policy(fail).re"
	{ goto Zl; }
#line 47 "encodings/unicode_group_Zl.8--encoding-policy(fail).c"
}
#line 15 "encodings/unicode_group_Zl.8--encoding-policy(fail).re"
