...
#line 14 "encodings/unicode_group_Sm.8--encoding-policy(ignore).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	switch (yych) {
...
#line 39 "encodings/unicode_group_Sm.8--encoding-policy(ignore).c"
yy4:
	++YYCURSOR;
#line 13 "encodings/unicode_group_Sm.8--encoding-policy(ignore).re"
	{ goto Sm; }
#line 44 "encodings/unicode_group_Sm.8--encoding-policy(ignore).c"
yy6:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0xAC:
...
#line 15 "encodings/unicode_group_Sm.8--encoding-policy(ignore).re"
