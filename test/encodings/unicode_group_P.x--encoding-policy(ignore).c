...
#line 14 "encodings/unicode_group_P.x--encoding-policy(ignore).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x1CD2) {
...
#line 407 "encodings/unicode_group_P.x--encoding-policy(ignore).c"
yy4:
	++YYCURSOR;
#line 13 "encodings/unicode_group_P.x--encoding-policy(ignore).re"
	{ goto P; }
#line 412 "encodings/unicode_group_P.x--encoding-policy(ignore).c"
yy6:
	yych = *++YYCURSOR;
	if (yych <= 0xDF9E) {
...
#line 15 "encodings/unicode_group_P.x--encoding-policy(ignore).re"
