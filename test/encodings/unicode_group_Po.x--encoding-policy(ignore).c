...
#line 14 "encodings/unicode_group_Po.x--encoding-policy(ignore).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x203A) {
...
#line 384 "encodings/unicode_group_Po.x--encoding-policy(ignore).c"
yy4:
	++YYCURSOR;
#line 13 "encodings/unicode_group_Po.x--encoding-policy(ignore).re"
	{ goto Po; }
#line 389 "encodings/unicode_group_Po.x--encoding-policy(ignore).c"
yy6:
	yych = *++YYCURSOR;
	if (yych <= 0xDF9E) {
...
#line 15 "encodings/unicode_group_Po.x--encoding-policy(ignore).re"
