/* Generated by re2c */
#line 1 "encodings/unicode_group_Sc.x--encoding-policy(ignore).re"
...
#line 14 "encodings/unicode_group_Sc.x--encoding-policy(ignore).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x0E3E) {
...
yy2:
	++YYCURSOR;
#line 14 "encodings/unicode_group_Sc.x--encoding-policy(ignore).re"
	{ return YYCURSOR == limit; }
#line 71 "encodings/unicode_group_Sc.x--encoding-policy(ignore).c"
yy4:
	++YYCURSOR;
#line 13 "encodings/unicode_group_Sc.x--encoding-policy(ignore).re"
	{ goto Sc; }
#line 76 "encodings/unicode_group_Sc.x--encoding-policy(ignore).c"
}
#line 15 "encodings/unicode_group_Sc.x--encoding-policy(ignore).re"
