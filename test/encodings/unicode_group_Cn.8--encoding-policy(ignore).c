...
#line 14 "encodings/unicode_group_Cn.8--encoding-policy(ignore).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	switch (yych) {
...
#line 51 "encodings/unicode_group_Cn.8--encoding-policy(ignore).c"
yy4:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0xB8:
...
#line 13 "encodings/unicode_group_Cn.8--encoding-policy(ignore).re"
	{ goto Cn; }
#line 522 "encodings/unicode_group_Cn.8--encoding-policy(ignore).c"
yy30:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0xAE:
...
#line 15 "encodings/unicode_group_Cn.8--encoding-policy(ignore).re"
