...
#line 14 "encodings/unicode_group_Me_x_encoding_policy_substitute.c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x20DC) {
...
#line 36 "encodings/unicode_group_Me_x_encoding_policy_substitute.c"
yy4:
	++YYCURSOR;
#line 13 "encodings/unicode_group_Me_x_encoding_policy_substitute.re"
	{ goto Me; }
#line 41 "encodings/unicode_group_Me_x_encoding_policy_substitute.c"
}
