...
#line 14 "encodings/unicode_group_Lu_8_encoding_policy_fail.c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	switch (yych) {
...
#line 73 "encodings/unicode_group_Lu_8_encoding_policy_fail.c"
yy3:
	++YYCURSOR;
#line 13 "encodings/unicode_group_Lu_8_encoding_policy_fail.re"
	{ goto Lu; }
#line 78 "encodings/unicode_group_Lu_8_encoding_policy_fail.c"
yy4:
	yych = *++YYCURSOR;
	switch (yych) {
		case 0x80:
