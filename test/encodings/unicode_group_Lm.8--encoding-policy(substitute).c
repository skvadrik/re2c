/* Generated by re2c */
#line 1 "encodings/unicode_group_Lm.8--encoding-policy(substitute).re"
...
#line 14 "encodings/unicode_group_Lm.8--encoding-policy(substitute).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	switch (yych) {
...
yy2:
	++YYCURSOR;
yy3:
#line 14 "encodings/unicode_group_Lm.8--encoding-policy(substitute).re"
	{ return YYCURSOR == limit; }
#line 40 "encodings/unicode_group_Lm.8--encoding-policy(substitute).c"
yy4:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0xB0:
...
yy18:
	++YYCURSOR;
#line 13 "encodings/unicode_group_Lm.8--encoding-policy(substitute).re"
	{ goto Lm; }
#line 197 "encodings/unicode_group_Lm.8--encoding-policy(substitute).c"
yy20:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0x9A:
...
#line 15 "encodings/unicode_group_Lm.8--encoding-policy(substitute).re"
