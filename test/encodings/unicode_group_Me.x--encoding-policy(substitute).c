/* Generated by re2c */
#line 1 "encodings/unicode_group_Me.x--encoding-policy(substitute).re"
#include <stdio.h>
#include "utf16.h"
...
#line 13 "encodings/unicode_group_Me.x--encoding-policy(substitute).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x20DC) {
...
yy2:
	++YYCURSOR;
#line 13 "encodings/unicode_group_Me.x--encoding-policy(substitute).re"
	{ return YYCURSOR == limit; }
#line 35 "encodings/unicode_group_Me.x--encoding-policy(substitute).c"
yy4:
	++YYCURSOR;
#line 12 "encodings/unicode_group_Me.x--encoding-policy(substitute).re"
	{ goto Me; }
#line 40 "encodings/unicode_group_Me.x--encoding-policy(substitute).c"
}
#line 14 "encodings/unicode_group_Me.x--encoding-policy(substitute).re"
