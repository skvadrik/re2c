/* Generated by re2c */
#line 1 "encodings/range_dot.8.re"
// re2c $INPUT -o $OUTPUT -8

#line 6 "encodings/range_dot.8.c"
{
	YYCTYPE yych;
...
#line 3 "encodings/range_dot.8.re"
	{return 0;}
#line 197 "encodings/range_dot.8.c"
yy5:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0x80:
...
#line 4 "encodings/range_dot.8.re"

encodings/range_dot.8.re:4:2: warning: control flow is undefined for strings that match 
	'[\xA\x80-\xC1\xF5-\xFF]'
