...
#line 14 "encodings/unicode_group_Co.x--encoding-policy(substitute).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0xDBFE) {
...
#line 32 "encodings/unicode_group_Co.x--encoding-policy(substitute).c"
yy4:
	yych = *++YYCURSOR;
...
#line 13 "encodings/unicode_group_Co.x--encoding-policy(substitute).re"
	{ goto Co; }
#line 46 "encodings/unicode_group_Co.x--encoding-policy(substitute).c"
}
#line 15 "encodings/unicode_group_Co.x--encoding-policy(substitute).re"
