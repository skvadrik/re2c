/* Generated by re2c */
#line 1 "encodings/unicode_group_Co.x--encoding-policy(substitute).re"
#include <stdio.h>
#include "utf16.h"
...
#line 13 "encodings/unicode_group_Co.x--encoding-policy(substitute).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0xDBFE) {
...
yy2:
	++YYCURSOR;
yy3:
#line 13 "encodings/unicode_group_Co.x--encoding-policy(substitute).re"
	{ return YYCURSOR == limit; }
#line 31 "encodings/unicode_group_Co.x--encoding-policy(substitute).c"
yy4:
	yych = *++YYCURSOR;
...
yy6:
	++YYCURSOR;
#line 12 "encodings/unicode_group_Co.x--encoding-policy(substitute).re"
	{ goto Co; }
#line 45 "encodings/unicode_group_Co.x--encoding-policy(substitute).c"
}
#line 14 "encodings/unicode_group_Co.x--encoding-policy(substitute).re"
