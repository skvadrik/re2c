...
#line 14 "encodings/unicode_group_No.8--encoding-policy(substitute).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	switch (yych) {
...
#line 33 "encodings/unicode_group_No.8--encoding-policy(substitute).c"
yy4:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0xB2:
...
#line 13 "encodings/unicode_group_No.8--encoding-policy(substitute).re"
	{ goto No; }
#line 109 "encodings/unicode_group_No.8--encoding-policy(substitute).c"
yy13:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0xB4:
...
#line 15 "encodings/unicode_group_No.8--encoding-policy(substitute).re"
