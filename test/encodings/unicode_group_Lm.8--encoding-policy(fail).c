/* Generated by re2c */
#line 1 "encodings/unicode_group_Lm.8--encoding-policy(fail).re"
#include <stdio.h>
#include "utf8.h"
...
#line 13 "encodings/unicode_group_Lm.8--encoding-policy(fail).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	switch (yych) {
...
yy2:
	++YYCURSOR;
yy3:
#line 13 "encodings/unicode_group_Lm.8--encoding-policy(fail).re"
	{ return YYCURSOR == limit; }
#line 39 "encodings/unicode_group_Lm.8--encoding-policy(fail).c"
yy4:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0xB0:
...
yy18:
	++YYCURSOR;
#line 12 "encodings/unicode_group_Lm.8--encoding-policy(fail).re"
	{ goto Lm; }
#line 196 "encodings/unicode_group_Lm.8--encoding-policy(fail).c"
yy20:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0x9A:
...
#line 14 "encodings/unicode_group_Lm.8--encoding-policy(fail).re"
