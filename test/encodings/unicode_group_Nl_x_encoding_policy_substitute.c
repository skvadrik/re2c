...
#line 14 "encodings/unicode_group_Nl_x_encoding_policy_substitute.c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x3020) {
...
#line 51 "encodings/unicode_group_Nl_x_encoding_policy_substitute.c"
yy4:
	++YYCURSOR;
#line 13 "encodings/unicode_group_Nl_x_encoding_policy_substitute.re"
	{ goto Nl; }
#line 56 "encodings/unicode_group_Nl_x_encoding_policy_substitute.c"
yy6:
	yych = *++YYCURSOR;
	if (yych <= 0xDF41) {
