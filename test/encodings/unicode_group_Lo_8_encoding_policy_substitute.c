...
#line 14 "encodings/unicode_group_Lo_8_encoding_policy_substitute.c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	switch (yych) {
...
#line 55 "encodings/unicode_group_Lo_8_encoding_policy_substitute.c"
yy3:
	yych = *++YYCURSOR;
	switch (yych) {
		case 0xAA:
...
yy26:
	++YYCURSOR;
#line 13 "encodings/unicode_group_Lo_8_encoding_policy_substitute.re"
	{ goto Lo; }
#line 932 "encodings/unicode_group_Lo_8_encoding_policy_substitute.c"
yy27:
	yych = *++YYCURSOR;
	switch (yych) {
		case 0x80:
...
int main ()
{
	unsigned int * buffer_Lo = new unsigned int [528940];
