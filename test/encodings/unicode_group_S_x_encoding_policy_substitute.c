...
#line 15 "encodings/unicode_group_S_x_encoding_policy_substitute.c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x2129) {
...
#line 586 "encodings/unicode_group_S_x_encoding_policy_substitute.c"
yy3:
	++YYCURSOR;
#line 14 "encodings/unicode_group_S_x_encoding_policy_substitute.re"
	{ goto S; }
#line 591 "encodings/unicode_group_S_x_encoding_policy_substitute.c"
yy4:
	yych = *++YYCURSOR;
	if (yych <= 0xDD8E) {
		if (yych <= 0xDD78) {
...
#line 16 "encodings/unicode_group_S_x_encoding_policy_substitute.re"
