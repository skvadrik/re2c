/* Generated by re2c */
#line 1 "encodings/unicode_group_Po.8--encoding-policy(substitute).re"
...
#line 14 "encodings/unicode_group_Po.8--encoding-policy(substitute).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	switch (yych) {
...
yy2:
	++YYCURSOR;
yy3:
#line 14 "encodings/unicode_group_Po.8--encoding-policy(substitute).re"
	{ return YYCURSOR == limit; }
#line 59 "encodings/unicode_group_Po.8--encoding-policy(substitute).c"
yy4:
	++YYCURSOR;
#line 13 "encodings/unicode_group_Po.8--encoding-policy(substitute).re"
	{ goto Po; }
#line 64 "encodings/unicode_group_Po.8--encoding-policy(substitute).c"
yy6:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0xA1:
...
#line 15 "encodings/unicode_group_Po.8--encoding-policy(substitute).re"
...
int main ()
{
	unsigned int * buffer_Po = new unsigned int [1940];
