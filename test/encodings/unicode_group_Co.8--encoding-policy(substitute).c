...
#line 14 "encodings/unicode_group_Co.8--encoding-policy(substitute).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	switch (yych) {
...
#line 30 "encodings/unicode_group_Co.8--encoding-policy(substitute).c"
yy4:
...
#line 13 "encodings/unicode_group_Co.8--encoding-policy(substitute).re"
	{ goto Co; }
#line 397 "encodings/unicode_group_Co.8--encoding-policy(substitute).c"
yy14:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0x80:
...
#line 15 "encodings/unicode_group_Co.8--encoding-policy(substitute).re"
