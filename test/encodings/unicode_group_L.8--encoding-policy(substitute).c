...
#line 13 "encodings/unicode_group_L.8--encoding-policy(substitute).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	switch (yych) {
...
#line 122 "encodings/unicode_group_L.8--encoding-policy(substitute).c"
yy4:
	++YYCURSOR;
#line 12 "encodings/unicode_group_L.8--encoding-policy(substitute).re"
	{ goto L; }
#line 127 "encodings/unicode_group_L.8--encoding-policy(substitute).c"
yy6:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0xAA:
