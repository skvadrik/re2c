/* Generated by re2c */
#line 1 "encodings/unicode_group_Ps.8--encoding-policy(ignore).re"
#include <stdio.h>
#include "utf8.h"
...
#line 13 "encodings/unicode_group_Ps.8--encoding-policy(ignore).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	switch (yych) {
...
yy2:
	++YYCURSOR;
yy3:
#line 13 "encodings/unicode_group_Ps.8--encoding-policy(ignore).re"
	{ return YYCURSOR == limit; }
#line 33 "encodings/unicode_group_Ps.8--encoding-policy(ignore).c"
yy4:
	++YYCURSOR;
#line 12 "encodings/unicode_group_Ps.8--encoding-policy(ignore).re"
	{ goto Ps; }
#line 38 "encodings/unicode_group_Ps.8--encoding-policy(ignore).c"
yy6:
...
#line 14 "encodings/unicode_group_Ps.8--encoding-policy(ignore).re"
