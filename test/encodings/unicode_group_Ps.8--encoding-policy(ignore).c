...
#line 14 "encodings/unicode_group_Ps.8--encoding-policy(ignore).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	switch (yych) {
...
#line 34 "encodings/unicode_group_Ps.8--encoding-policy(ignore).c"
yy4:
	++YYCURSOR;
#line 13 "encodings/unicode_group_Ps.8--encoding-policy(ignore).re"
	{ goto Ps; }
#line 39 "encodings/unicode_group_Ps.8--encoding-policy(ignore).c"
yy6:
...
#line 15 "encodings/unicode_group_Ps.8--encoding-policy(ignore).re"
