...
#line 14 "encodings/unicode_group_Sk_8_encoding_policy_ignore.c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	switch (yych) {
...
#line 38 "encodings/unicode_group_Sk_8_encoding_policy_ignore.c"
yy3:
	++YYCURSOR;
#line 13 "encodings/unicode_group_Sk_8_encoding_policy_ignore.re"
	{ goto Sk; }
#line 43 "encodings/unicode_group_Sk_8_encoding_policy_ignore.c"
yy4:
	yych = *++YYCURSOR;
	switch (yych) {
		case 0xA8:
