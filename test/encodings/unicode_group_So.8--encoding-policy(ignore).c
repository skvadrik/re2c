...
#line 14 "encodings/unicode_group_So.8--encoding-policy(ignore).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	switch (yych) {
...
#line 40 "encodings/unicode_group_So.8--encoding-policy(ignore).c"
yy4:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0xA6:
...
#line 13 "encodings/unicode_group_So.8--encoding-policy(ignore).re"
	{ goto So; }
#line 203 "encodings/unicode_group_So.8--encoding-policy(ignore).c"
yy20:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0xBA:	goto yy18;
...
#line 15 "encodings/unicode_group_So.8--encoding-policy(ignore).re"
