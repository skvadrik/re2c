...
#line 14 "encodings/unicode_group_C.8--encoding-policy(substitute).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	switch (yych) {
...
#line 13 "encodings/unicode_group_C.8--encoding-policy(substitute).re"
	{ goto C; }
#line 86 "encodings/unicode_group_C.8--encoding-policy(substitute).c"
yy4:
	++YYCURSOR;
yy5:
#line 14 "encodings/unicode_group_C.8--encoding-policy(substitute).re"
	{ return YYCURSOR == limit; }
#line 92 "encodings/unicode_group_C.8--encoding-policy(substitute).c"
yy6:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0x80:
...
#line 15 "encodings/unicode_group_C.8--encoding-policy(substitute).re"
