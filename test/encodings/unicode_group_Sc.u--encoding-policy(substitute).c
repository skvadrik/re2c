/* Generated by re2c */
#line 1 "encodings/unicode_group_Sc.u--encoding-policy(substitute).re"
...
#line 14 "encodings/unicode_group_Sc.u--encoding-policy(substitute).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x00000E3E) {
...
#line 71 "encodings/unicode_group_Sc.u--encoding-policy(substitute).c"
yy4:
	++YYCURSOR;
#line 13 "encodings/unicode_group_Sc.u--encoding-policy(substitute).re"
	{ goto Sc; }
#line 76 "encodings/unicode_group_Sc.u--encoding-policy(substitute).c"
}
#line 15 "encodings/unicode_group_Sc.u--encoding-policy(substitute).re"
