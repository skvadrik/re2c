...
#line 15 "encodings/unicode_group_Ps_8_encoding_policy_substitute.c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	switch (yych) {
...
#line 35 "encodings/unicode_group_Ps_8_encoding_policy_substitute.c"
yy3:
	++YYCURSOR;
#line 14 "encodings/unicode_group_Ps_8_encoding_policy_substitute.re"
	{ goto Ps; }
#line 40 "encodings/unicode_group_Ps_8_encoding_policy_substitute.c"
yy4:
...
#line 16 "encodings/unicode_group_Ps_8_encoding_policy_substitute.re"
...
int main() {
	YYCTYPE* buffer_Ps = new YYCTYPE[480];
	uint32_t buffer_Ps_len = encode_utf8(chars_Ps, sizeof(chars_Ps) / sizeof(uint32_t), buffer_Ps);
