/* Generated by re2c */
#line 1 "encodings/unicode_group_L.8--encoding-policy(ignore).re"
...
#line 14 "encodings/unicode_group_L.8--encoding-policy(ignore).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	switch (yych) {
...
yy2:
	++YYCURSOR;
yy3:
#line 14 "encodings/unicode_group_L.8--encoding-policy(ignore).re"
	{ return YYCURSOR == limit; }
#line 123 "encodings/unicode_group_L.8--encoding-policy(ignore).c"
yy4:
	++YYCURSOR;
#line 13 "encodings/unicode_group_L.8--encoding-policy(ignore).re"
	{ goto L; }
#line 128 "encodings/unicode_group_L.8--encoding-policy(ignore).c"
yy6:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0xAA:
...
#line 15 "encodings/unicode_group_L.8--encoding-policy(ignore).re"
