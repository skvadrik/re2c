/* Generated by re2c */
#line 1 "encodings/unicode_group_N.x--encoding-policy(ignore).re"
#include <stdio.h>
#include "utf16.h"
...
#line 13 "encodings/unicode_group_N.x--encoding-policy(ignore).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x1C59) {
...
yy2:
	++YYCURSOR;
yy3:
#line 13 "encodings/unicode_group_N.x--encoding-policy(ignore).re"
	{ return YYCURSOR == limit; }
#line 283 "encodings/unicode_group_N.x--encoding-policy(ignore).c"
yy4:
	++YYCURSOR;
#line 12 "encodings/unicode_group_N.x--encoding-policy(ignore).re"
	{ goto N; }
#line 288 "encodings/unicode_group_N.x--encoding-policy(ignore).c"
yy6:
	yych = *++YYCURSOR;
	if (yych <= 0xDEFB) {
		if (yych <= 0xDD78) {
...
#line 14 "encodings/unicode_group_N.x--encoding-policy(ignore).re"
