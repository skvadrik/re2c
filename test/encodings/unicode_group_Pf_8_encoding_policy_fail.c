...
#line 14 "encodings/unicode_group_Pf_8_encoding_policy_fail.c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	switch (yych) {
...
#line 28 "encodings/unicode_group_Pf_8_encoding_policy_fail.c"
yy4:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0xBB:	goto yy6;
...
yy6:
	++YYCURSOR;
#line 13 "encodings/unicode_group_Pf_8_encoding_policy_fail.re"
	{ goto Pf; }
#line 46 "encodings/unicode_group_Pf_8_encoding_policy_fail.c"
yy8:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0x99:
