/* Generated by re2c */
#line 1 "encodings/unicode_group_P.x--encoding-policy(fail).re"
...
#line 14 "encodings/unicode_group_P.x--encoding-policy(fail).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x1CD2) {
...
yy2:
	++YYCURSOR;
yy3:
#line 14 "encodings/unicode_group_P.x--encoding-policy(fail).re"
	{ return YYCURSOR == limit; }
#line 407 "encodings/unicode_group_P.x--encoding-policy(fail).c"
yy4:
	++YYCURSOR;
#line 13 "encodings/unicode_group_P.x--encoding-policy(fail).re"
	{ goto P; }
#line 412 "encodings/unicode_group_P.x--encoding-policy(fail).c"
yy6:
	yych = *++YYCURSOR;
	if (yych <= 0xDF9E) {
...
#line 15 "encodings/unicode_group_P.x--encoding-policy(fail).re"
