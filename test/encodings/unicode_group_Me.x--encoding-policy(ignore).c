...
#line 14 "encodings/unicode_group_Me.x--encoding-policy(ignore).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x20DC) {
...
#line 36 "encodings/unicode_group_Me.x--encoding-policy(ignore).c"
yy4:
	++YYCURSOR;
#line 13 "encodings/unicode_group_Me.x--encoding-policy(ignore).re"
	{ goto Me; }
#line 41 "encodings/unicode_group_Me.x--encoding-policy(ignore).c"
}
#line 15 "encodings/unicode_group_Me.x--encoding-policy(ignore).re"
