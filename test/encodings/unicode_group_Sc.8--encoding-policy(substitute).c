...
#line 14 "encodings/unicode_group_Sc.8--encoding-policy(substitute).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	switch (yych) {
...
#line 35 "encodings/unicode_group_Sc.8--encoding-policy(substitute).c"
yy4:
	++YYCURSOR;
#line 13 "encodings/unicode_group_Sc.8--encoding-policy(substitute).re"
	{ goto Sc; }
#line 40 "encodings/unicode_group_Sc.8--encoding-policy(substitute).c"
yy6:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0xA2:
...
#line 15 "encodings/unicode_group_Sc.8--encoding-policy(substitute).re"
