...
#line 14 "encodings/unicode_group_S.x--encoding-policy(ignore).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x2127) {
...
#line 544 "encodings/unicode_group_S.x--encoding-policy(ignore).c"
yy4:
	++YYCURSOR;
#line 13 "encodings/unicode_group_S.x--encoding-policy(ignore).re"
	{ goto S; }
#line 549 "encodings/unicode_group_S.x--encoding-policy(ignore).c"
yy6:
	yych = *++YYCURSOR;
	if (yych <= 0xDD8C) {
		if (yych <= 0xDD78) {
...
#line 15 "encodings/unicode_group_S.x--encoding-policy(ignore).re"
