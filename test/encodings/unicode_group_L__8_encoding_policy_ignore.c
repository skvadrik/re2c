...
#line 14 "encodings/unicode_group_L__8_encoding_policy_ignore.c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	switch (yych) {
...
#line 102 "encodings/unicode_group_L__8_encoding_policy_ignore.c"
yy4:
	++YYCURSOR;
#line 13 "encodings/unicode_group_L__8_encoding_policy_ignore.re"
	{ goto L_; }
#line 107 "encodings/unicode_group_L__8_encoding_policy_ignore.c"
yy6:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0xB5:	goto yy4;
