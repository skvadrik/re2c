/* Generated by re2c */
#line 1 "encodings/unicode_group_Z.u--encoding-policy(ignore).re"
...
#line 14 "encodings/unicode_group_Z.u--encoding-policy(ignore).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x0000200A) {
...
#line 43 "encodings/unicode_group_Z.u--encoding-policy(ignore).c"
yy4:
	++YYCURSOR;
#line 13 "encodings/unicode_group_Z.u--encoding-policy(ignore).re"
	{ goto Z; }
#line 48 "encodings/unicode_group_Z.u--encoding-policy(ignore).c"
}
#line 15 "encodings/unicode_group_Z.u--encoding-policy(ignore).re"
