...
#line 14 "encodings/unicode_group_Pd.u--encoding-policy(fail).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x00002E39) {
...
#line 70 "encodings/unicode_group_Pd.u--encoding-policy(fail).c"
yy4:
	++YYCURSOR;
#line 13 "encodings/unicode_group_Pd.u--encoding-policy(fail).re"
	{ goto Pd; }
#line 75 "encodings/unicode_group_Pd.u--encoding-policy(fail).c"
}
#line 15 "encodings/unicode_group_Pd.u--encoding-policy(fail).re"
