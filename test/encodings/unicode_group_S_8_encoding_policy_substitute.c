...
#line 14 "encodings/unicode_group_S_8_encoding_policy_substitute.c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	switch (yych) {
...
#line 54 "encodings/unicode_group_S_8_encoding_policy_substitute.c"
yy3:
	++YYCURSOR;
#line 13 "encodings/unicode_group_S_8_encoding_policy_substitute.re"
	{ goto S; }
#line 59 "encodings/unicode_group_S_8_encoding_policy_substitute.c"
yy4:
	yych = *++YYCURSOR;
	switch (yych) {
		case 0xA2:
...
int main ()
{
	unsigned int * buffer_S = new unsigned int [31104];
