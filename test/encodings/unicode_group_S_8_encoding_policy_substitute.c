/* Generated by re2c */
#line 1 "encodings/unicode_group_S_8_encoding_policy_substitute.re"
...
#line 15 "encodings/unicode_group_S_8_encoding_policy_substitute.c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	switch (yych) {
...
yy1:
	++YYCURSOR;
yy2:
#line 15 "encodings/unicode_group_S_8_encoding_policy_substitute.re"
	{ return YYCURSOR - 1 == limit; }
#line 55 "encodings/unicode_group_S_8_encoding_policy_substitute.c"
yy3:
	++YYCURSOR;
#line 14 "encodings/unicode_group_S_8_encoding_policy_substitute.re"
	{ goto S; }
#line 60 "encodings/unicode_group_S_8_encoding_policy_substitute.c"
yy4:
	yych = *++YYCURSOR;
	switch (yych) {
		case 0xA2:
...
yy94:
	...
	switch (yych) {
		...
		case 0x87: goto yy111;
		case 0x89: goto yy112;
		case 0x8D: goto yy113;
		case 0x9B: goto yy114;
		case 0x9C: goto yy115;
		case 0x9D: goto yy116;
		case 0x9E: goto yy117;
		case 0x9F: goto yy118;
...
yy95:
	...
	switch (yych) {
		...
		case 0xB4: goto yy124;
		case 0xBB: goto yy125;
		default: goto yy24;
	}
yy96:
	yych = *++YYCURSOR;
...
#line 16 "encodings/unicode_group_S_8_encoding_policy_substitute.re"
...
int main() {
	YYCTYPE* buffer_S = new YYCTYPE[46656];
	uint32_t buffer_S_len = encode_utf8(chars_S, sizeof(chars_S) / sizeof(uint32_t), buffer_S);
