...
#line 14 "encodings/unicode_group_Mc.8--encoding-policy(ignore).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	switch (yych) {
...
#line 31 "encodings/unicode_group_Mc.8--encoding-policy(ignore).c"
yy4:
...
#line 13 "encodings/unicode_group_Mc.8--encoding-policy(ignore).re"
	{ goto Mc; }
#line 621 "encodings/unicode_group_Mc.8--encoding-policy(ignore).c"
yy58:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0x80:
...
#line 15 "encodings/unicode_group_Mc.8--encoding-policy(ignore).re"
