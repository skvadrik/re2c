...
#line 14 "encodings/unicode_group_Cs.x--encoding-policy(ignore).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
...
#line 24 "encodings/unicode_group_Cs.x--encoding-policy(ignore).c"
yy4:
	++YYCURSOR;
#line 13 "encodings/unicode_group_Cs.x--encoding-policy(ignore).re"
	{ goto Cs; }
#line 29 "encodings/unicode_group_Cs.x--encoding-policy(ignore).c"
}
#line 15 "encodings/unicode_group_Cs.x--encoding-policy(ignore).re"
