/* Generated by re2c */
#line 1 "encodings/unicode_group_Zl.x--encoding-policy(fail).re"
...
#line 14 "encodings/unicode_group_Zl.x--encoding-policy(fail).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych == 0x2028) goto yy4;
	++YYCURSOR;
#line 14 "encodings/unicode_group_Zl.x--encoding-policy(fail).re"
	{ return YYCURSOR == limit; }
#line 22 "encodings/unicode_group_Zl.x--encoding-policy(fail).c"
yy4:
	++YYCURSOR;
#line 13 "encodings/unicode_group_Zl.x--encoding-policy(fail).re"
	{ goto Zl; }
#line 27 "encodings/unicode_group_Zl.x--encoding-policy(fail).c"
}
#line 15 "encodings/unicode_group_Zl.x--encoding-policy(fail).re"
