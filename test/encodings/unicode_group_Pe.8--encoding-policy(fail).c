...
#line 14 "encodings/unicode_group_Pe.8--encoding-policy(fail).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	switch (yych) {
...
#line 34 "encodings/unicode_group_Pe.8--encoding-policy(fail).c"
yy4:
	++YYCURSOR;
#line 13 "encodings/unicode_group_Pe.8--encoding-policy(fail).re"
	{ goto Pe; }
#line 39 "encodings/unicode_group_Pe.8--encoding-policy(fail).c"
yy6:
...
#line 15 "encodings/unicode_group_Pe.8--encoding-policy(fail).re"
