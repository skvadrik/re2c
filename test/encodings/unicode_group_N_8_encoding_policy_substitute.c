...
#line 14 "encodings/unicode_group_N_8_encoding_policy_substitute.c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	switch (yych) {
...
#line 47 "encodings/unicode_group_N_8_encoding_policy_substitute.c"
yy3:
	++YYCURSOR;
#line 13 "encodings/unicode_group_N_8_encoding_policy_substitute.re"
	{ goto N; }
#line 52 "encodings/unicode_group_N_8_encoding_policy_substitute.c"
yy4:
	yych = *++YYCURSOR;
	switch (yych) {
		case 0xB2:
