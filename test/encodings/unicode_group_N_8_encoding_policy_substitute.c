/* Generated by re2c */
#line 1 "encodings/unicode_group_N_8_encoding_policy_substitute.re"
...
#line 15 "encodings/unicode_group_N_8_encoding_policy_substitute.c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	switch (yych) {
...
yy1:
	++YYCURSOR;
yy2:
#line 15 "encodings/unicode_group_N_8_encoding_policy_substitute.re"
	{ return YYCURSOR - 1 == limit; }
#line 48 "encodings/unicode_group_N_8_encoding_policy_substitute.c"
yy3:
	++YYCURSOR;
#line 14 "encodings/unicode_group_N_8_encoding_policy_substitute.re"
	{ goto N; }
#line 53 "encodings/unicode_group_N_8_encoding_policy_substitute.c"
yy4:
	yych = *++YYCURSOR;
	switch (yych) {
		case 0xB2:
...
#line 16 "encodings/unicode_group_N_8_encoding_policy_substitute.re"
...
int main() {
	YYCTYPE* buffer_N = new YYCTYPE[10992];
	uint32_t buffer_N_len = encode_utf8(chars_N, sizeof(chars_N) / sizeof(uint32_t), buffer_N);
