...
#line 14 "encodings/unicode_group_N.x--encoding-policy(fail).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x1C59) {
...
#line 284 "encodings/unicode_group_N.x--encoding-policy(fail).c"
yy4:
	++YYCURSOR;
#line 13 "encodings/unicode_group_N.x--encoding-policy(fail).re"
	{ goto N; }
#line 289 "encodings/unicode_group_N.x--encoding-policy(fail).c"
yy6:
	yych = *++YYCURSOR;
	if (yych <= 0xDEFB) {
		if (yych <= 0xDD78) {
...
#line 15 "encodings/unicode_group_N.x--encoding-policy(fail).re"
