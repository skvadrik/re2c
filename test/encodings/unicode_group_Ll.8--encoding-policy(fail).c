...
#line 13 "encodings/unicode_group_Ll.8--encoding-policy(fail).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	switch (yych) {
...
#line 75 "encodings/unicode_group_Ll.8--encoding-policy(fail).c"
yy4:
	++YYCURSOR;
#line 12 "encodings/unicode_group_Ll.8--encoding-policy(fail).re"
	{ goto Ll; }
#line 80 "encodings/unicode_group_Ll.8--encoding-policy(fail).c"
yy6:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0xB5:	goto yy4;
