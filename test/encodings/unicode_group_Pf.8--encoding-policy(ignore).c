...
#line 13 "encodings/unicode_group_Pf.8--encoding-policy(ignore).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	switch (yych) {
...
#line 27 "encodings/unicode_group_Pf.8--encoding-policy(ignore).c"
yy4:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0xBB:	goto yy6;
...
yy6:
	++YYCURSOR;
#line 12 "encodings/unicode_group_Pf.8--encoding-policy(ignore).re"
	{ goto Pf; }
#line 45 "encodings/unicode_group_Pf.8--encoding-policy(ignore).c"
yy8:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0x99:
