/* Generated by re2c */
#line 1 "encodings/unicode_group_Pf.8--encoding-policy(ignore).re"
...
#line 14 "encodings/unicode_group_Pf.8--encoding-policy(ignore).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	switch (yych) {
...
yy2:
	++YYCURSOR;
yy3:
#line 14 "encodings/unicode_group_Pf.8--encoding-policy(ignore).re"
	{ return YYCURSOR == limit; }
#line 28 "encodings/unicode_group_Pf.8--encoding-policy(ignore).c"
yy4:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0xBB:	goto yy6;
...
yy6:
	++YYCURSOR;
#line 13 "encodings/unicode_group_Pf.8--encoding-policy(ignore).re"
	{ goto Pf; }
#line 46 "encodings/unicode_group_Pf.8--encoding-policy(ignore).c"
yy8:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0x99:
...
#line 15 "encodings/unicode_group_Pf.8--encoding-policy(ignore).re"
