...
#line 14 "encodings/unicode_group_Lm.u--encoding-policy(ignore).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x0000207F) {
...
#line 181 "encodings/unicode_group_Lm.u--encoding-policy(ignore).c"
yy4:
	++YYCURSOR;
#line 13 "encodings/unicode_group_Lm.u--encoding-policy(ignore).re"
	{ goto Lm; }
#line 186 "encodings/unicode_group_Lm.u--encoding-policy(ignore).c"
}
#line 15 "encodings/unicode_group_Lm.u--encoding-policy(ignore).re"
