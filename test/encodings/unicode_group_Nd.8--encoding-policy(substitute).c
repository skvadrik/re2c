...
#line 14 "encodings/unicode_group_Nd.8--encoding-policy(substitute).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	switch (yych) {
...
#line 44 "encodings/unicode_group_Nd.8--encoding-policy(substitute).c"
yy4:
	++YYCURSOR;
#line 13 "encodings/unicode_group_Nd.8--encoding-policy(substitute).re"
	{ goto Nd; }
#line 49 "encodings/unicode_group_Nd.8--encoding-policy(substitute).c"
yy6:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0xA0:
...
#line 15 "encodings/unicode_group_Nd.8--encoding-policy(substitute).re"
