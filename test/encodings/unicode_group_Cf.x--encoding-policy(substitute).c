...
#line 14 "encodings/unicode_group_Cf.x--encoding-policy(substitute).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x202E) {
...
#line 65 "encodings/unicode_group_Cf.x--encoding-policy(substitute).c"
yy4:
	++YYCURSOR;
#line 13 "encodings/unicode_group_Cf.x--encoding-policy(substitute).re"
	{ goto Cf; }
#line 70 "encodings/unicode_group_Cf.x--encoding-policy(substitute).c"
yy6:
	yych = *++YYCURSOR;
...
#line 15 "encodings/unicode_group_Cf.x--encoding-policy(substitute).re"
