...
#line 14 "encodings/unicode_group_M.8--encoding-policy(ignore).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	switch (yych) {
...
#line 46 "encodings/unicode_group_M.8--encoding-policy(ignore).c"
yy4:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0x80:
...
#line 13 "encodings/unicode_group_M.8--encoding-policy(ignore).re"
	{ goto M; }
#line 505 "encodings/unicode_group_M.8--encoding-policy(ignore).c"
yy26:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0x96:
...
#line 15 "encodings/unicode_group_M.8--encoding-policy(ignore).re"
