...
#line 14 "encodings/unicode_group_Po_8_encoding_policy_ignore.c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	switch (yych) {
...
#line 59 "encodings/unicode_group_Po_8_encoding_policy_ignore.c"
yy3:
	++YYCURSOR;
#line 13 "encodings/unicode_group_Po_8_encoding_policy_ignore.re"
	{ goto Po; }
#line 64 "encodings/unicode_group_Po_8_encoding_policy_ignore.c"
yy4:
	yych = *++YYCURSOR;
	switch (yych) {
		case 0xA1:
...
int main ()
{
	unsigned int * buffer_Po = new unsigned int [2516];
