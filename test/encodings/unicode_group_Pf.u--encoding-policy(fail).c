...
#line 14 "encodings/unicode_group_Pf.u--encoding-policy(fail).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x00002E03) {
...
#line 52 "encodings/unicode_group_Pf.u--encoding-policy(fail).c"
yy4:
	++YYCURSOR;
#line 13 "encodings/unicode_group_Pf.u--encoding-policy(fail).re"
	{ goto Pf; }
#line 57 "encodings/unicode_group_Pf.u--encoding-policy(fail).c"
}
#line 15 "encodings/unicode_group_Pf.u--encoding-policy(fail).re"
