/* Generated by re2c */
#line 1 "encodings/unicode_group_M.x--encoding-policy(substitute).re"
...
#line 14 "encodings/unicode_group_M.x--encoding-policy(substitute).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x0F36) {
...
yy2:
	++YYCURSOR;
yy3:
#line 14 "encodings/unicode_group_M.x--encoding-policy(substitute).re"
	{ return YYCURSOR == limit; }
#line 640 "encodings/unicode_group_M.x--encoding-policy(substitute).c"
yy4:
	++YYCURSOR;
#line 13 "encodings/unicode_group_M.x--encoding-policy(substitute).re"
	{ goto M; }
#line 645 "encodings/unicode_group_M.x--encoding-policy(substitute).c"
yy6:
	yych = *++YYCURSOR;
	if (yych <= 0xDEDF) {
...
#line 15 "encodings/unicode_group_M.x--encoding-policy(substitute).re"
