/* Generated by re2c */
#line 1 "encodings/unicode_group_Pe_8_encoding_policy_ignore.re"
...
#line 15 "encodings/unicode_group_Pe_8_encoding_policy_ignore.c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	switch (yych) {
...
yy1:
	++YYCURSOR;
yy2:
#line 15 "encodings/unicode_group_Pe_8_encoding_policy_ignore.re"
	{ return YYCURSOR - 1 == limit; }
#line 35 "encodings/unicode_group_Pe_8_encoding_policy_ignore.c"
yy3:
	++YYCURSOR;
#line 14 "encodings/unicode_group_Pe_8_encoding_policy_ignore.re"
	{ goto Pe; }
#line 40 "encodings/unicode_group_Pe_8_encoding_policy_ignore.c"
yy4:
...
#line 16 "encodings/unicode_group_Pe_8_encoding_policy_ignore.re"
...
int main() {
	YYCTYPE* buffer_Pe = new YYCTYPE[468];
	uint32_t buffer_Pe_len = encode_utf8(chars_Pe, sizeof(chars_Pe) / sizeof(uint32_t), buffer_Pe);
