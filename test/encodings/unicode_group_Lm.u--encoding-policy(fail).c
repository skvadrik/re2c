/* Generated by re2c */
#line 1 "encodings/unicode_group_Lm.u--encoding-policy(fail).re"
#include <stdio.h>
...
#line 13 "encodings/unicode_group_Lm.u--encoding-policy(fail).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x0000207F) {
...
yy2:
	++YYCURSOR;
#line 13 "encodings/unicode_group_Lm.u--encoding-policy(fail).re"
	{ return YYCURSOR == limit; }
#line 180 "encodings/unicode_group_Lm.u--encoding-policy(fail).c"
yy4:
	++YYCURSOR;
#line 12 "encodings/unicode_group_Lm.u--encoding-policy(fail).re"
	{ goto Lm; }
#line 185 "encodings/unicode_group_Lm.u--encoding-policy(fail).c"
}
#line 14 "encodings/unicode_group_Lm.u--encoding-policy(fail).re"
