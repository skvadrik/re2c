...
#line 14 "encodings/unicode_group_Lm.u--encoding-policy(fail).c"
{
	YYCTYPE yych;
	yych = *YYCURSOR;
	if (yych <= 0x0000207F) {
...
#line 181 "encodings/unicode_group_Lm.u--encoding-policy(fail).c"
yy4:
	++YYCURSOR;
#line 13 "encodings/unicode_group_Lm.u--encoding-policy(fail).re"
	{ goto Lm; }
#line 186 "encodings/unicode_group_Lm.u--encoding-policy(fail).c"
}
#line 15 "encodings/unicode_group_Lm.u--encoding-policy(fail).re"
