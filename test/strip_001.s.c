...
#line 113 "strip_001.s.re"
			{ goto comment; }
#line 103 "strip_001.s.c"
yy7:
			++YYCURSOR;
#line 112 "strip_001.s.re"
			{ goto cppcomment; }
#line 108 "strip_001.s.c"
		}
#line 115 "strip_001.s.re"

comment:
		s.tok = s.cur;

#line 115 "strip_001.s.c"
		{
			YYCTYPE yych;
			if ((YYLIMIT - YYCURSOR) < 2) YYFILL(2);
			yych = *YYCURSOR;
...
#line 119 "strip_001.s.re"
			{ continue; }
#line 132 "strip_001.s.c"
		}
#line 121 "strip_001.s.re"

cppcomment:
		s.tok = s.cur;

#line 139 "strip_001.s.c"
		{
			YYCTYPE yych;
			if ((YYLIMIT - YYCURSOR) < 2) YYFILL(2);
			yych = *YYCURSOR;
