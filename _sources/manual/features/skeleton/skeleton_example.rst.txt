...
:download:`[example.re] </manual/features/skeleton/example.re.txt>`
that tries to match two-digit hexadecimal numbers:

.. literalinclude:: /manual/features/skeleton/example.re.txt
    :language: c

We can see the generated DFA using ```re2c -D example.re | dot -Grankdir=LR -Tpng -o example.png```:

.. image:: /manual/features/skeleton/example.png
    :width: 60%
...
:download:`[example.c.line4.input] </manual/features/skeleton/example.c.line4.input>`:
...
For that re2c generates keys :download:`[example.c.line4.keys] </manual/features/skeleton/example.c.line4.keys>`:
...
The generated program :download:`[example.c] </manual/features/skeleton/example.c.txt>`
